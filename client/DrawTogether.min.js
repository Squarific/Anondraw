...
(function(b){for(var a=CryptoJS,c=a.lib,d=c.WordArray,e=c.Hasher,c=a.algo,f=[],g=[],h=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var m;a:{m=k;for(var n=b.sqrt(m),r=2;r<=n;r++)if(!(m%r)){m=!1;break a}m=!0}m&&(8>l&&(f[l]=h(b.pow(k,0.5))),g[l]=h(b.pow(k,1/3)),l++);k++}var q=[],c=c.SHA256=e.extend({_doReset:function(){this._hash=new d.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,e=c[0],d=c[1],f=c[2],h=c[3],k=c[4],l=c[5],n=c[6],m=c[7],r=0;64>r;r++){if(16>r)q[r]=
b[a+r]|0;else{var I=q[r-15],x=q[r-2];q[r]=((I<<25|I>>>7)^(I<<14|I>>>18)^I>>>3)+q[r-7]+((x<<15|x>>>17)^(x<<13|x>>>19)^x>>>10)+q[r-16]}I=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&l^~k&n)+g[r]+q[r];x=((e<<30|e>>>2)^(e<<19|e>>>13)^(e<<10|e>>>22))+(e&d^e&f^d&f);m=n;n=l;l=k;k=h+I|0;h=f;f=d;d=e;e=I+x|0}c[0]=c[0]+e|0;c[1]=c[1]+d|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+l|0;c[6]=c[6]+n|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,e=8*this._nDataBytes,d=8*a.sigBytes;
...
"'. Server error: "+g+". Trying again in 5 seconds."),setTimeout(this.changeRoom.bind(this,b,a,c,d,e,f),5E3)):(this.setRoom(b+a),this.paint.clear(),this.paint.goto(c||0,d||0),this.paint.changeTool("grab"),this.paint.addPublicDrawings(this.decodeDrawings(h)),this.chat.addMessage("Invite people","http://www.anondraw.com/#"+b+a),this.account.uKey&&this.getFavorites(),this.userSettings.getBoolean("Show welcome")?this.openWelcomeWindow():parseInt(localStorage.getItem("newfeaturewindowversion"))!==this.CLIENT_VERSION&&
this.openNewFeatureWindow(),this.removeLoading())}.bind(this)),this.setLoading(b))};
...
e)}},!1);a(".coinbase-button").each(function(d){return function(d,l){var q,K,B,G,D;q=a(l);B=q.data();B.referrer=document.domain;G=a.param(B);B=q.data("code");D=q.data("width")||g(q.data("button-style"));K=q.data("height")||f(q.data("button-style"));r=b(q.data("env"));K="<iframe src='"+r+"/buttons/"+B+"?"+G+"' id='coinbase_button_iframe_"+B+"' name='coinbase_button_iframe_"+B+"' style='width: "+D+"px; height: "+K+"px; border: none; overflow: hidden;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=A();var p=s(a).height+10,n=s(a).width+20,q=s(b),u="floating";q.left+n>h.width||0>q.left+q.width/2-n?(m(g,"bottom"),m(g,"top")):(q.height+q.top+p>h.height&&m(g,"bottom"),0>q.top-p&&m(g,"top"));q.width+q.left+n>h.width&&m(g,"right");0>q.left-n&&m(g,"left");0<g.length&&(u=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(u=f);h=u}f=s(b);b=s(a);g=A();switch(h){case "top":c.className="introjs-arrow bottom";k(f,d?0:15,b,g,a);a.style.bottom=f.height+20+
...
"").replace(/^\s+|\s+$/g,"");y=document.querySelector(".introjs-showElement");y.className=y.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");a._lastShowElementTimer&&clearTimeout(a._lastShowElementTimer);a._lastShowElementTimer=setTimeout(function(){null!=l&&(l.innerHTML=b.step);m.innerHTML=b.intro;u.style.display="block";h.call(a,b.element,u,q,l);d.querySelector(".introjs-bullets li > a.active").className="";d.querySelector('.introjs-bullets li > a[data-stepnumber="'+b.step+'"]').className=
...
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,e,d){for(var f=[],g=0;g<a.length;g++){var h=a[g];if(h){var k=tinycolor(h),l=0.5>k.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l=l+(tinycolor.equals(c,h)?" sp-thumb-active":""),h=k.toString(d.preferredFormat||"rgb"),n=p?"background-color:"+k.toRgbString():"filter:"+k.toFilter();f.push('<span title="'+
...
!1}function g(b){if(p){if(q&&9>k.documentMode&&!b.button)return h();var e=b.originalEvent&&b.originalEvent.touches,d=e?e[0].pageY:b.pageY,e=Math.max(0,Math.min((e?e[0].pageX:b.pageX)-l.left,m)),d=Math.max(0,Math.min(d-l.top,n));u&&f(b);c.apply(a,[e,d,b])}}function h(){p&&(b(k).unbind(r),b(k.body).removeClass("sp-dragging"),d.apply(a,arguments));p=!1}c=c||function(){};e=e||function(){};d=d||function(){};var k=document,p=!1,l={},n=0,m=0,u="ontouchstart"in window,r={};r.selectstart=f;r.dragstart=f;r["touchmove mousemove"]=
...
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=q.name,E.emit("upgradeError",c)))}))}function e(){r||(r=!0,n(),q.close(),q=null)}function g(c){var d=Error("probe error: "+c);d.transport=q.name;e();k('probe transport "%s" failed because of error: %s',a,c);E.emit("upgradeError",d)}function h(){g("transport closed")}function m(){g("socket closed")}function l(a){q&&a.name!=q.name&&(k('"%s" works - aborting "%s"',a.name,q.name),e())}function n(){q.removeListener("open",c);q.removeListener("error",
g);q.removeListener("close",h);E.removeListener("close",m);E.removeListener("upgrading",l)}k('probing transport "%s"',a);var q=this.createTransport(a,{probe:1}),r=!1,E=this;d.priorWebsocketSuccess=!1;q.once("open",c);q.once("error",g);q.once("close",h);this.once("close",m);this.once("upgrading",l);q.open()};d.prototype.onOpen=function(){k("socket open");this.readyState="open";d.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
...
c);e.on("error",function(a){d.onError("xhr post error",a)});this.sendXhr=e};g.prototype.doPoll=function(){q("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};n(h.prototype);h.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{q("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
...
l=0===h[0],q="",m=1;255!=h[m];m++){if(310<q.length){g=!0;break}q+=h[m]}if(g)return e(u,0,1);a=k(a,2+q.length);q=parseInt(q);h=k(a,0,q);if(l)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(p){for(l=new Uint8Array(h),h="",m=0;m<l.length;m++)h+=String.fromCharCode(l[m])}f.push(h);a=k(a,q)}var n=f.length;f.forEach(function(a,f){e(d.decodePacket(a,c,!0),f,n)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
56320==(g&64512)?c.push(((f&1023)<<10)+(g&1023)+65536):(c.push(f),e--)):c.push(f);return c}function h(){if(u>=p)throw Error("Invalid byte index");var a=q[u]&255;u++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,e,d;if(u>p)throw Error("Invalid byte index");if(u==p)return!1;a=q[u]&255;u++;if(0==(a&128))return a;if(192==(a&224)){c=h();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=h();e=h();a=(a&15)<<12|c<<6|
e;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=h(),e=h(),d=h(),a=(a&15)<<18|c<<12|e<<6|d,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof d&&d,m="object"==typeof c&&c&&c.exports==l&&c,n="object"==typeof a&&a;if(n.global===n||n.window===n)f=n;var r=String.fromCharCode,q,p,u,n={version:"2.0.0",encode:function(a){a=g(a);for(var c=a.length,e=-1,d,f="";++e<c;){d=a[e];if(0==(d&4294967168))d=r(d);else{var h="";0==(d&4294965248)?
h=r(d>>6&31|192):0==(d&4294901760)?(h=r(d>>12&15|224),h+=r(d>>6&63|128)):0==(d&4292870144)&&(h=r(d>>18&7|240),h+=r(d>>12&63|128),h+=r(d>>6&63|128));d=h+=r(d&63|128)}f+=d}return f},decode:function(a){q=g(a);p=q.length;u=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var e=-1,d,f="";++e<c;)d=a[e],65535<d&&(d-=65536,f+=r(d>>>10&1023|55296),d=56320|d&1023),f+=r(d);return f}};if(l&&!l.nodeType)if(m)m.exports=n;else{f={}.hasOwnProperty;for(var A in n)f.call(n,A)&&(l[A]=n[A])}else f.utf8=n})(this)}).call(this,
...
d("01")}catch(p){}if(m)try{m=1!==d("1.")}catch(u){}}}}catch(t){m=!1}d=m}}return c[a]=!!d}var g={}.toString,h,k,l,m="object"==typeof JSON&&JSON,n="object"==typeof d&&d&&!d.nodeType&&d;n&&m?(n.stringify=m.stringify,n.parse=m.parse):n=a.JSON=m||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(q){}if(!c("json")){var p=c("bug-string-char-index");
