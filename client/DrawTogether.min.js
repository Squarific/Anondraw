...
b[a+r]|0;else{var J=q[r-15],y=q[r-2];q[r]=((J<<25|J>>>7)^(J<<14|J>>>18)^J>>>3)+q[r-7]+((y<<15|y>>>17)^(y<<13|y>>>19)^y>>>10)+q[r-16]}J=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&l^~k&n)+g[r]+q[r];y=((e<<30|e>>>2)^(e<<19|e>>>13)^(e<<10|e>>>22))+(e&d^e&f^d&f);m=n;n=l;l=k;k=h+J|0;h=f;f=d;d=e;e=J+y|0}c[0]=c[0]+e|0;c[1]=c[1]+d|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+l|0;c[6]=c[6]+n|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,e=8*this._nDataBytes,d=8*a.sigBytes;
...
$(".favorites-window").show())}.bind(this));b=this.paint.coordDiv.appendChild(document.createElement("div"));b.className="favorites-window";this.favoritesContainer=b.appendChild(document.createElement("div"));this.favoritesContainer.className="favorites-container"};DrawTogether.prototype.searchAndUpdateIndividualFavoriteDom=function(b,a,c,d,e,f,g,h){f=this.favoritesContainer.chindren;for(e=f.length;0<=e;e--)updateIndividualFavoriteDom(b,a,c,d,f[e])};
...
DrawTogether.prototype.insertOneFavorite=function(b,a,c,d){var e=this.favoritesContainer.appendChild(document.createElement("div"));e.className="favorite-container";e.dataset.x=b;e.dataset.y=a;e.dataset.name=c;e.dataset.owner=d;d=e.appendChild(document.createElement("div"));d.className="fav-button fav-minus-button";d.innerHTML="-";d.addEventListener("click",function(b){if(b.srcElement.classList.contains("fav-button-confirmation")){b.srcElement.classList.remove("fav-button-confirmation");var a=b.srcElement.parentElement;
this.removeFavorite(a.dataset.x,a.dataset.y,a.dataset.name,a)}else b.srcElement.classList.add("fav-button-confirmation"),b.srcElement.innerHTML="?",setTimeout(function(){b.srcElement.innerHTML="-";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),4E3)}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-plus-button";d.innerHTML="+";d.addEventListener("click",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/
this.paint.public.zoom],c=b.srcElement.parentElement.dataset.x,e=b.srcElement.parentElement.dataset.y,d=b.srcElement.parentElement.dataset.name,m=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);console.log(m,a);b.srcElement.classList.contains("fav-button-confirmation")?(b.srcElement.classList.remove("fav-button-confirmation"),console.log("set"),this.setCoordFavorite(m,a,c,e,d,b.srcElement.parentElement)):(b.srcElement.classList.add("fav-button-confirmation"),
b.srcElement.innerHTML="?",setTimeout(function(){b.srcElement.innerHTML="+";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),4E3))}.bind(this));d.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);console.log(c,a);b.srcElement.title="Change to "+c+","+a+" ?"}.bind(this));d=
e.appendChild(document.createElement("div"));d.className="fav-button fav-pencil-button";d.innerHTML="\u270e";d=d.appendChild(document.createElement("div"));d.className="fav-rename-container";d=d.appendChild(document.createElement("input"));d.className="fav-rename-input";d.type="text";d.placeholder="Rename";d.addEventListener("input",function(b){void 0!==this._favoriteRenameDelayTimeout&&clearTimeout(this._favoriteRenameDelayTimeout);this._favoriteRenameDelayTimeout=setTimeout(function(){var a=b.srcElement.parentElement.parentElement.parentElement;
this.renameFavorite(a.dataset.x,a.dataset.y,b.srcElement.value,a)}.bind(this),1500)}.bind(this));e=e.appendChild(document.createElement("div"));e.className="fav-button fav-coor-button";e.addEventListener("click",function(b){var a=parseInt(b.srcElement.parentElement.dataset.x);b=parseInt(b.srcElement.parentElement.dataset.y);console.log(a,b);this.moveScreenToPosition([a,b],0)}.bind(this));0<c.length?(e.innerHTML=c,e.title=b+","+a,d.value=c):e.innerHTML=b+","+a};
DrawTogether.prototype.updateFavoriteDom=function(){for(favorites=this.favList;this.favoritesContainer.firstChild;)this.favoritesContainer.removeChild(this.favoritesContainer.firstChild);var b=this.favoritesContainer.appendChild(document.createElement("div"));b.className="fav-button fav-add-new-fav";b.innerHTML="^";b.title="Add new Favorite.";b.addEventListener("click",function(b){this.createFavorite(0,0,"")}.bind(this));for(x=favorites.length-1;0<=x;x--)this.insertOneFavorite(favorites[x].x,favorites[x].y,
favorites[x].name,favorites[x].owner)};DrawTogether.prototype.setCoordFavorite=function(b,a,c,d,e,f){this.network.socket.emit("setcoordfavorite",b,a,c,d,e,function(c,e){c?this.chat.addMessage("Changing coordinate of Favorite","Error: "+c):e.success&&(console.log("changed cord"),this.updateIndividualFavoriteDom(b,a,null,null,f),this.getFavorites())}.bind(this))};
DrawTogether.prototype.removeFavorite=function(b,a,c,d){this.network.socket.emit("removefavorite",b,a,c,function(b,a){b?this.chat.addMessage("Removing Favorite","Error: "+b):a.success&&(console.log("deleted"),d.remove(),this.getFavorites())}.bind(this))};DrawTogether.prototype.renameFavorite=function(b,a,c,d){this.network.socket.emit("renamefavorite",b,a,c,function(b,a){b?this.chat.addMessage("Renaming Favorite","Error: "+b):a.success&&(this.updateIndividualFavoriteDom(null,null,c,null,d),this.getFavorites())}.bind(this))};
DrawTogether.prototype.getFavorites=function(){this.network.socket.emit("getfavorites",function(b,a){b?this.chat.addMessage("Getting Favorites","Error: "+b):this.favList=a}.bind(this))};
...
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,d)return a(document).trigger("coinbase_button_loaded",e)}else if("checkouts frame loaded"===f&&(d=!0,c))return a(document).trigger("coinbase_button_loaded",e)}},!1);a(".coinbase-button").each(function(d){return function(d,l){var q,L,C,H,E;q=a(l);C=q.data();C.referrer=document.domain;H=a.param(C);C=q.data("code");E=q.data("width")||g(q.data("button-style"));L=q.data("height")||f(q.data("button-style"));r=b(q.data("env"));
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=B();var p=s(a).height+10,n=s(a).width+20,q=s(b),u="floating";q.left+n>h.width||0>q.left+q.width/2-n?(m(g,"bottom"),m(g,"top")):(q.height+q.top+p>h.height&&m(g,"bottom"),0>q.top-p&&m(g,"top"));q.width+q.left+n>h.width&&m(g,"right");0>q.left-n&&m(g,"left");0<g.length&&(u=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(u=f);h=u}f=s(b);b=s(a);g=B();switch(h){case "top":c.className="introjs-arrow bottom";k(f,d?0:15,b,g,a);a.style.bottom=f.height+20+
...
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=G(b,360);c=G(c,100);e=G(e,100);if(0===c)e=c=b=e;else{var f=0.5>e?e*(1+c):e+c-e*c,g=2*e-f;e=d(g,f,b+1/3);c=d(g,f,b);b=d(g,f,b-1/3)}return{r:255*e,g:255*c,b:255*b}}function c(b,a,e){b=G(b,255);a=G(a,255);e=G(e,255);var d=D(b,a,e),f=O(b,a,e),g,h=d-f;if(d==f)g=0;else{switch(d){case b:g=(a-e)/h+(a<e?6:0);break;case a:g=(e-b)/h+2;break;case e:g=(b-a)/h+4}g/=6}return{h:g,s:0===d?0:h/d,v:d}}function e(b,a,c,d){b=[Q(w(b).toString(16)),
Q(w(a).toString(16)),Q(w(c).toString(16))];return d&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function d(b,a,c,e){return[Q(Math.round(255*parseFloat(e)).toString(16)),Q(w(b).toString(16)),Q(w(a).toString(16)),Q(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s-=a/100;c.s=O(1,D(0,c.s));return v(c)}function g(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s+=a/100;
...
(e.h-(c*a>>1)+720)%360;--a;)e.h=(e.h+c)%360,b.push(v(e));return b}function B(b,a){a=a||6;for(var c=v(b).toHsv(),e=c.h,d=c.s,c=c.v,f=[],g=1/a;a--;)f.push(v({h:e,s:d,v:c})),c=(c+g)%1;return f}function Y(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function G(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=O(a,D(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>aa.abs(b-a)?1:b%a/parseFloat(a)}function Q(b){return 1==
b.length?"0"+b:""+b}function R(b){1>=b&&(b=100*b+"%");return b}var ya=/^[\s,#]+/,t=/\s+$/,V=0,aa=Math,w=aa.round,O=aa.min,D=aa.max,ba=aa.random,v=function ja(b,c){var e,d,f,g,h;b=b?b:"";c=c||{};if(b instanceof ja)return b;if(!(this instanceof ja))return new ja(b,c);d=b;h={r:0,g:0,b:0};var k=1;f=e=!1;if("string"==typeof d)a:{d=d.replace(ya,"").replace(t,"").toLowerCase();var p=!1;if(M[d])d=M[d],p=!0;else if("transparent"==d){d={r:0,g:0,b:0,a:0,format:"name"};break a}d=(g=N.rgb.exec(d))?{r:g[1],g:g[2],
b:g[3]}:(g=N.rgba.exec(d))?{r:g[1],g:g[2],b:g[3],a:g[4]}:(g=N.hsl.exec(d))?{h:g[1],s:g[2],l:g[3]}:(g=N.hsla.exec(d))?{h:g[1],s:g[2],l:g[3],a:g[4]}:(g=N.hsv.exec(d))?{h:g[1],s:g[2],v:g[3]}:(g=N.hsva.exec(d))?{h:g[1],s:g[2],v:g[3],a:g[4]}:(g=N.hex8.exec(d))?{a:parseInt(g[1],16)/255,r:parseInt(g[2],16),g:parseInt(g[3],16),b:parseInt(g[4],16),format:p?"name":"hex8"}:(g=N.hex6.exec(d))?{r:parseInt(g[1],16),g:parseInt(g[2],16),b:parseInt(g[3],16),format:p?"name":"hex"}:(g=N.hex3.exec(d))?{r:parseInt(g[1]+
""+g[1],16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:p?"name":"hex"}:!1}if("object"==typeof d){if(d.hasOwnProperty("r")&&d.hasOwnProperty("g")&&d.hasOwnProperty("b"))h={r:255*G(d.r,255),g:255*G(d.g,255),b:255*G(d.b,255)},e=!0,f="%"===String(d.r).substr(-1)?"prgb":"rgb";else if(d.hasOwnProperty("h")&&d.hasOwnProperty("s")&&d.hasOwnProperty("v")){d.s=R(d.s);d.v=R(d.v);f=d.h;p=d.s;h=d.v;f=6*G(f,360);p=G(p,100);h=G(h,100);e=aa.floor(f);var l=f-e;f=h*(1-p);g=h*(1-l*p);p=h*(1-(1-l)*
p);e%=6;h={r:255*[h,g,f,f,p,h][e],g:255*[p,h,h,g,f,f][e],b:255*[f,f,p,h,h,g][e]};e=!0;f="hsv"}else d.hasOwnProperty("h")&&(d.hasOwnProperty("s")&&d.hasOwnProperty("l"))&&(d.s=R(d.s),d.l=R(d.l),h=a(d.h,d.s,d.l),e=!0,f="hsl");d.hasOwnProperty("a")&&(k=d.a)}k=Y(k);d=d.format||f;f=O(255,D(h.r,0));g=O(255,D(h.g,0));h=O(255,D(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=k;this._roundA=w(100*this._a)/100;this._format=c.format||d;this._gradientType=c.gradientType;1>this._r&&(this._r=
...
f.g)+Math.max(d.b,f.b)-Math.min(d.b,f.b);return{brightness:Math.abs(c-e),color:d}};v.isReadable=function(b,a){var c=v.readability(b,a);return 125<c.brightness&&500<c.color};v.mostReadable=function(b,a){for(var c=null,e=0,d=!1,f=0;f<a.length;f++){var g=v.readability(b,a[f]),h=125<g.brightness&&500<g.color,g=3*(g.brightness/125)+g.color/500;if(h&&!d||h&&d&&g>e||!h&&!d&&g>e)d=h,e=g,c=v(a[f])}return c};var M=v.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",
...
c,!0,e)};return f.readAsArrayBuffer(a.data)}function g(a,c,e){var d=Array(a.length);e=m(a.length,e);for(var f=function(a,e,f){c(e,function(c,e){d[a]=e;f(c,d)})},g=0;g<a.length;g++)f(g,a[g],e)}var h=a("./keys"),k=a("arraybuffer.slice"),l=a("base64-arraybuffer"),m=a("after"),n=a("utf8"),r=navigator.userAgent.match(/Android/i);d.protocol=3;var q=d.packets={open:0,close:1,ping:2,pong:3,message:4,upgrade:5,noop:6},p=h(q),u={type:"error",data:"parser error"},B=a("blob");d.encodePacket=function(a,g,h,k){"function"==
typeof g&&(k=g,g=!1);"function"==typeof h&&(k=h,h=null);var l=void 0===a.data?void 0:a.data.buffer||a.data;if(c.ArrayBuffer&&l instanceof ArrayBuffer){if(g){h=a.data;g=new Uint8Array(h);h=new Uint8Array(1+h.byteLength);h[0]=q[a.type];for(a=0;a<g.length;a++)h[a+1]=g[a];a=k(h.buffer)}else a=d.encodeBase64Packet(a,k);return a}if(B&&l instanceof c.Blob)return g?r?a=f(a,g,k):(g=new Uint8Array(1),g[0]=q[a.type],a=new B([g.buffer,a.data]),a=k(a)):a=d.encodeBase64Packet(a,k),a;g=q[a.type];void 0!==a.data&&
(g+=h?n.encode(String(a.data)):String(a.data));return k(""+g)};d.encodeBase64Packet=function(a,f){var g="b"+d.packets[a.type];if(B&&a.data instanceof B){var h=new FileReader;h.onload=function(){var a=h.result.split(",")[1];f(g+a)};return h.readAsDataURL(a.data)}var k;try{k=String.fromCharCode.apply(null,new Uint8Array(a.data))}catch(l){k=new Uint8Array(a.data);for(var q=Array(k.length),m=0;m<k.length;m++)q[m]=k[m];k=String.fromCharCode.apply(null,q)}g+=c.btoa(k);return f(g)};d.decodePacket=function(a,
c,e){if("string"==typeof a||void 0===a){if("b"==a.charAt(0))return d.decodeBase64Packet(a.substr(1),c);if(e)try{a=n.decode(a)}catch(f){return u}e=a.charAt(0);return Number(e)==e&&p[e]?1<a.length?{type:p[e],data:a.substring(1)}:{type:p[e]}:u}e=(new Uint8Array(a))[0];a=k(a,1);B&&"blob"===c&&(a=new B([a]));return{type:p[e],data:a}};d.decodeBase64Packet=function(a,d){var f=p[a.charAt(0)];if(!c.ArrayBuffer)return{type:f,data:{base64:!0,data:a.substr(1)}};var g=l.decode(a.substr(1));"blob"===d&&B&&(g=new B([g]));
return{type:f,data:g}};d.encodePayload=function(a,c,e){"function"==typeof c&&(e=c,c=null);if(c)return B&&!r?d.encodePayloadAsBlob(a,e):d.encodePayloadAsArrayBuffer(a,e);if(!a.length)return e("0:");g(a,function(a,e){d.encodePacket(a,c,!0,function(a){e(null,a.length+":"+a)})},function(a,c){return e(c.join(""))})};d.decodePayload=function(a,c,e){if("string"!=typeof a)return d.decodePayloadAsBinary(a,c,e);"function"===typeof c&&(e=c,c=null);var f;if(""==a)return e(u,0,1);f="";for(var g,h,k=0,l=a.length;k<
...
g.call(e))for(f=e.length;f--;)la(e,f,d);else k(e,function(a){la(e,a,d)});return d.call(a,c,e)};n.parse=function(a,c){var d,e;s=0;J=""+a;d=ka(S());"$"!=S()&&y();s=J=null;return c&&"[object Function]"==g.call(c)?pa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,d){c.exports=function(a,c){for(var d=[],h=(c=c||0)||0;h<a.length;h++)d[h-c]=a[h];return d}},{}]},{},[1])(1)});
