...
a._placeholder)return c[a.num];if(f(a))for(var d=0;d<a.length;d++)a[d]=e(a[d]);else if(a&&"object"==typeof a)for(d in a)a[d]=e(a[d]);return a}a.data=e(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,h,q){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){n++;var u=new FileReader;u.onload=function(){q?q[h]=this.result:p=this.result;--n||e(p)};u.readAsArrayBuffer(a)}else if(f(a))for(u=0;u<a.length;u++)l(a[u],u,a);else if(a&&"object"==typeof a&&!g(a))for(u in a)l(a[u],
u,a)}var n=0,p=a;l(p);n||e(p)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=n.stringify(a.data));l("encoded %j as %s",a,c);return c}function g(a,c){p.removeBlobs(a,function(a){var d=p.deconstructPacket(a);
