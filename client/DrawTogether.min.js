...
2),16)<<24-4*(d%8);return new h.init(c,a/2)}},l=g.Latin1={stringify:function(b){var a=b.words;b=b.sigBytes;for(var c=[],d=0;d<b;d++)c.push(String.fromCharCode(a[d>>>2]>>>24-8*(d%4)&255));return c.join("")},parse:function(b){for(var a=b.length,c=[],d=0;d<a;d++)c[d>>>2]|=(b.charCodeAt(d)&255)<<24-8*(d%4);return new h.init(c,a)}},m=g.Utf8={stringify:function(b){try{return decodeURIComponent(escape(l.stringify(b)))}catch(a){throw Error("Malformed UTF-8 data");}},parse:function(b){return l.parse(unescape(encodeURIComponent(b)))}},
...
(function(b){for(var a=CryptoJS,c=a.lib,e=c.WordArray,d=c.Hasher,c=a.algo,f=[],h=[],g=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var m;a:{m=k;for(var n=b.sqrt(m),r=2;r<=n;r++)if(!(m%r)){m=!1;break a}m=!0}m&&(8>l&&(f[l]=g(b.pow(k,0.5))),h[l]=g(b.pow(k,1/3)),l++);k++}var q=[],c=c.SHA256=d.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,d=c[0],e=c[1],f=c[2],g=c[3],k=c[4],n=c[5],l=c[6],m=c[7],r=0;64>r;r++){if(16>r)q[r]=
b[a+r]|0;else{var I=q[r-15],x=q[r-2];q[r]=((I<<25|I>>>7)^(I<<14|I>>>18)^I>>>3)+q[r-7]+((x<<15|x>>>17)^(x<<13|x>>>19)^x>>>10)+q[r-16]}I=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&n^~k&l)+h[r]+q[r];x=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);m=l;l=n;n=k;k=g+I|0;g=f;f=e;e=d;d=I+x|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+g|0;c[4]=c[4]+k|0;c[5]=c[5]+n|0;c[6]=c[6]+l|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,d=8*this._nDataBytes,e=8*a.sigBytes;
...
DrawTogether.prototype.createProtectedRegion=function(b,a){this.memberlevel?this.network.socket.emit("createprotectedregion",b,a,function(b,a){b?this.chat.addMessage("Regions","Error: "+b):a&&this.chat.addMessage("Regions",a)}.bind(this)):this.chat.addMessage("Creating a protected region is a member only feature.")};
DrawTogether.prototype.resetProtectedRegions=function(){this.network.socket.emit("resetprotectedregions",function(b,a){b?this.chat.addMessage("Regions","Reset Error: "+b):a&&this.chat.addMessage("Regions",a)})};DrawTogether.prototype.exportImage=function(b,a){var c=document.createElement("img");c.src=this.paint.exportImage(b,a);c.alt="Exported image";var e=this.gui.createWindow({title:"Exported image (right click to save)"});e.classList.add("exportwindow");e.appendChild(c)};
...
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,e)return a(document).trigger("coinbase_button_loaded",d)}else if("checkouts frame loaded"===f&&(e=!0,c))return a(document).trigger("coinbase_button_loaded",d)}},!1);a(".coinbase-button").each(function(e){return function(e,l){var q,K,B,G,D;q=a(l);B=q.data();B.referrer=document.domain;G=a.param(B);B=q.data("code");D=q.data("width")||h(q.data("button-style"));K=q.data("height")||f(q.data("button-style"));r=b(q.data("env"));
...
parseInt(e.fn.jquery.split(".")[1])||0,c=c>u||c===u&&f>=A;if(e&&c)return a(e);p=document.createElement("script");p.type="text/javascript";p.src="https://code.jquery.com/jquery-1.8.3.min.js";p.onload=p.onreadystatechange=function(){if(!(h||(d=this.readyState)&&"loaded"!==d&&"complete"!==d))return a((e=window.jQuery).noConflict(1)),e(p).remove()};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(p)})("1.7",function(b){return a(b,c)})}).call(this)};
...
typeof c._introCompleteCallback&&c._introCompleteCallback.call(c),void 0!=c._introExitCallback&&c._introExitCallback.call(c),h.call(c,b)):d.call(c);a.preventDefault?a.preventDefault():a.returnValue=!1}},c._onResize=function(b){n.call(c,document.querySelector(".introjs-helperLayer"));n.call(c,document.querySelector(".introjs-tooltipReferenceLayer"))},window.addEventListener?(this._options.keyboardNavigation&&window.addEventListener("keydown",c._onKeyDown,!0),window.addEventListener("resize",c._onResize,
...
"floating"!=g){f=g;h=this._options.positionPrecedence.slice();g=A();var p=s(a).height+10,n=s(a).width+20,q=s(b),u="floating";q.left+n>g.width||0>q.left+q.width/2-n?(m(h,"bottom"),m(h,"top")):(q.height+q.top+p>g.height&&m(h,"bottom"),0>q.top-p&&m(h,"top"));q.width+q.left+n>g.width&&m(h,"right");0>q.left-n&&m(h,"left");0<h.length&&(u=h[0]);f&&"auto"!=f&&-1<h.indexOf(f)&&(u=f);g=u}f=s(b);b=s(a);h=A();switch(g){case "top":c.className="introjs-arrow bottom";k(f,e?0:15,b,h,a);a.style.bottom=f.height+20+
...
b.element);var a=this,c=document.querySelector(".introjs-helperLayer"),e=document.querySelector(".introjs-tooltipReferenceLayer"),k="introjs-helperLayer";s(b.element);"string"===typeof b.highlightClass&&(k+=" "+b.highlightClass);"string"===typeof this._options.highlightClass&&(k+=" "+this._options.highlightClass);if(null!=c){var l=e.querySelector(".introjs-helperNumberLayer"),m=e.querySelector(".introjs-tooltiptext"),q=e.querySelector(".introjs-arrow"),u=e.querySelector(".introjs-tooltip"),B=e.querySelector(".introjs-skipbutton"),
D=e.querySelector(".introjs-prevbutton"),G=e.querySelector(".introjs-nextbutton");c.className=k;u.style.opacity=0;u.style.display="none";if(null!=l){var y=this._introItems[0<=b.step-2?b.step-2:0];if(null!=y&&"forward"==this._direction&&"floating"==y.position||"backward"==this._direction&&"floating"==b.position)l.style.opacity=0}n.call(a,c);n.call(a,e);if((y=document.querySelectorAll(".introjs-fixParent"))&&0<y.length)for(k=y.length-1;0<=k;k--)y[k].className=y[k].className.replace(/introjs-fixParent/g,
"").replace(/^\s+|\s+$/g,"");y=document.querySelector(".introjs-showElement");y.className=y.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");a._lastShowElementTimer&&clearTimeout(a._lastShowElementTimer);a._lastShowElementTimer=setTimeout(function(){null!=l&&(l.innerHTML=b.step);m.innerHTML=b.intro;u.style.display="block";g.call(a,b.element,u,q,l);e.querySelector(".introjs-bullets li > a.active").className="";e.querySelector('.introjs-bullets li > a[data-stepnumber="'+b.step+'"]').className=
"active";e.querySelector(".introjs-progress .introjs-progressbar").setAttribute("style","width:"+I.call(a)+"%;");u.style.opacity=1;l&&(l.style.opacity=1);-1===G.tabIndex?B.focus():G.focus()},350)}else{var t=document.createElement("div"),D=document.createElement("div"),c=document.createElement("div"),H=document.createElement("div"),E=document.createElement("div"),S=document.createElement("div"),x=document.createElement("div"),C=document.createElement("div");t.className=k;D.className="introjs-tooltipReferenceLayer";
...
h=document.createElement("div");d.className="introjs-tooltip";d.onclick=function(b){b.stopPropagation?b.stopPropagation():b.cancelBubble=!0};e.className="introjs-tooltiptext";var k=document.createElement("p");k.innerHTML=a.hint;a=document.createElement("a");a.className="introjs-button";a.innerHTML=this._options.hintButtonLabel;a.onclick=H.bind(this,c);e.appendChild(k);e.appendChild(a);f.className="introjs-arrow";d.appendChild(f);d.appendChild(e);this._currentStep=b.getAttribute("data-step");h.className=
"introjs-tooltipReferenceLayer introjs-hintReference";h.setAttribute("data-step",b.getAttribute("data-step"));n.call(this,h);h.appendChild(d);document.body.appendChild(h);g.call(this,b,d,f,null,!0)}}function s(b){var a={};a.width=b.offsetWidth;a.height=b.offsetHeight;for(var c=0,d=0;b&&!isNaN(b.offsetLeft)&&!isNaN(b.offsetTop);)c+=b.offsetLeft,d+=b.offsetTop,b=b.offsetParent;a.top=d;a.left=c;return a}function I(){return 100*(parseInt(this._currentStep+1,10)/this._introItems.length)}var x=function(b){if("object"===
...
b-2;"undefined"!==typeof this._introItems&&d.call(this);return this},nextStep:function(){d.call(this);return this},previousStep:function(){f.call(this);return this},exit:function(){h.call(this,this._targetElement);return this},refresh:function(){n.call(this,document.querySelector(".introjs-helperLayer"));n.call(this,document.querySelector(".introjs-tooltipReferenceLayer"));return this},onbeforechange:function(b){if("function"===typeof b)this._introBeforeChangeCallback=b;else throw Error("Provided callback for onbeforechange was not a function");
...
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,d,e){for(var f=[],h=0;h<a.length;h++){var g=a[h];if(g){var k=tinycolor(g),l=0.5>k.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l=l+(tinycolor.equals(c,g)?" sp-thumb-active":""),g=k.toString(e.preferredFormat||"rgb"),n=p?"background-color:"+k.toRgbString():"filter:"+k.toFilter();f.push('<span title="'+
...
C.hide(O()),J.trigger("hide.spectrum",[O()]))}function Y(b,a){if(tinycolor.equals(b,O()))X();else{var c,d;!b&&fa?da=!0:(da=!1,c=tinycolor(b),d=c.toHsv(),qa=d.h%360/360,ra=d.s,sa=d.v,W=d.a);X();c&&(c.isValid()&&!a)&&(ta=Ja||c.getFormat())}}function O(b){b=b||{};return fa&&da?null:tinycolor.fromRatio({h:qa,s:ra,v:sa,a:Math.round(100*W)/100},{format:b.format||ta})}function la(){X();C.move(O());J.trigger("move.spectrum",[O()])}function X(){ca.removeClass("sp-validation-error");F();var b=tinycolor.fromRatio({h:qa,
s:1,v:1});Ba.css("background-color",b.toHexString());b=ta;!(1>W)||0===W&&"name"===b||"hex"!==b&&"hex3"!==b&&"hex6"!==b&&"name"!==b||(b="rgb");var a=O({format:b}),c="";na.removeClass("sp-clear-display");na.css("background-color","transparent");if(!a&&fa)na.addClass("sp-clear-display");else{var c=a.toHexString(),d=a.toRgbString();p||1===a.alpha?na.css("background-color",d):(na.css("background-color","transparent"),na.css("filter",a.toFilter()));if(t.showAlpha){d=a.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),
e="linear-gradient(left, "+d+", "+c+")";q?ua.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ua.css("background","-webkit-"+e),ua.css("background","-moz-"+e),ua.css("background","-ms-"+e),ua.css("background","linear-gradient(to right, "+d+", "+c+")"))}c=a.toString(b)}t.showInput&&ca.val(c);t.showPalette&&E();s()}function F(){var b=ra,a=sa;fa&&da?(Ca.hide(),Da.hide(),Ea.hide()):(Ca.show(),Da.show(),Ea.show(),b*=L,a=T-a*T,b=Math.max(-M,Math.min(L-M,b-M)),a=Math.max(-M,Math.min(T-M,a-M)),Ea.css({top:a+
"px",left:b+"px"}),Ca.css({left:W*ia-Ra/2+"px"}),Da.css({top:qa*Aa-Sa+"px"}))}function P(b){var a=O(),c="",d=!tinycolor.equals(a,ha);a&&(c=a.toString(ta),y(a));Fa&&J.val(c);b&&d&&(C.change(a),J.trigger("change",[a]))}function Q(){L=Ba.width();T=Ba.height();M=Ea.height();Ka.width();Aa=Ka.height();Sa=Da.height();ia=Ta.width();Ra=Ca.width();U||(z.css("position","absolute"),t.offset?z.offset(t.offset):z.offset(f(z,va)));F();t.showPalette&&E();J.trigger("reflow.spectrum")}function xa(){ea();La=!0;J.attr("disabled",
!0);va.addClass("sp-disabled")}var t=e(h,d),U=t.flat,Z=t.showSelectionPalette,w=t.localStorageKey,N=t.theme,C=t.callbacks,aa=m(Q,10),v=!1,L=0,T=0,M=0,Aa=0,ia=0,Ra=0,Sa=0,qa=0,ra=0,sa=0,W=1,ya=[],pa=[],za={},V=t.selectionPalette.slice(0),Wa=t.maxSelectionSize,Qa="sp-dragging",ba=null,Ia=d.ownerDocument,J=b(d),La=!1,z=b(K,Ia).addClass(N),Ya=z.find(".sp-picker-container"),Ba=z.find(".sp-color"),Ea=z.find(".sp-dragger"),Ka=z.find(".sp-hue"),Da=z.find(".sp-slider"),ua=z.find(".sp-alpha-inner"),Ta=z.find(".sp-alpha"),
...
b(h).scrollLeft(),h=g.clientHeight+b(h).scrollTop(),g=c.offset();g.top+=f;g.left-=Math.min(g.left,g.left+d>k&&k>d?Math.abs(g.left+d-k):0);g.top-=Math.min(g.top,g.top+e>h&&h>e?Math.abs(e+f-0):0);return g}function h(){}function g(b){b.stopPropagation()}function k(b,a){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return b.apply(a,d.concat(c.call(arguments)))}}function l(a,c,d,e){function f(b){b.stopPropagation&&b.stopPropagation();b.preventDefault&&b.preventDefault();b.returnValue=
!1}function h(b){if(p){if(q&&9>k.documentMode&&!b.button)return g();var d=b.originalEvent&&b.originalEvent.touches,e=d?d[0].pageY:b.pageY,d=Math.max(0,Math.min((d?d[0].pageX:b.pageX)-l.left,m)),e=Math.max(0,Math.min(e-l.top,n));u&&f(b);c.apply(a,[d,e,b])}}function g(){p&&(b(k).unbind(r),b(k.body).removeClass("sp-dragging"),e.apply(a,arguments));p=!1}c=c||function(){};d=d||function(){};e=e||function(){};var k=document,p=!1,l={},n=0,m=0,u="ontouchstart"in window,r={};r.selectstart=f;r.dragstart=f;r["touchmove mousemove"]=
h;r["touchend mouseup"]=g;b(a).bind("touchstart mousedown",function(c){(c.which?3==c.which:2==c.button)||p||!1===d.apply(a,arguments)||(p=!0,n=b(a).height(),m=b(a).width(),l=b(a).offset(),b(k).bind(r),b(k.body).addClass("sp-dragging"),u||h(c),f(c))})}function m(b,a,c){var d;return function(){var e=this,f=arguments,h=function(){d=null;b.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(h,a)}}var n={beforeShow:h,move:h,change:h,show:h,hide:h,color:!1,flat:!1,showInput:!1,allowEmpty:!1,showButtons:!0,
...
l;b.fn.spectrum.defaults=n;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){u||b("input[type=color]").spectrum({preferredFormat:"hex6"})};(function(){function b(a,c,d){a=F(a,255);c=F(c,255);d=F(d,255);var e=C(a,c,d),f=N(a,c,d),h,g=(e+f)/2;if(e==f)h=f=0;else{var k=e-f,f=0.5<g?k/(2-e-f):k/(e+f);switch(e){case a:h=(c-d)/k+(c<d?6:0);break;case c:h=(d-a)/k+2;break;case d:h=(a-c)/k+4}h/=6}return{h:h,s:f,l:g}}function a(b,c,d){function e(b,
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=F(b,360);c=F(c,100);d=F(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,h=2*d-f;d=e(h,f,b+1/3);c=e(h,f,b);b=e(h,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=F(b,255);a=F(a,255);d=F(d,255);var e=C(b,a,d),f=N(b,a,d),h,g=e-f;if(e==f)h=0;else{switch(e){case b:h=(a-d)/g+(a<d?6:0);break;case a:h=(d-b)/g+2;break;case d:h=(b-a)/g+4}h/=6}return{h:h,s:0===e?0:g/e,v:e}}function d(b,a,c,e){b=[P(w(b).toString(16)),
P(w(a).toString(16)),P(w(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[P(Math.round(255*parseFloat(d)).toString(16)),P(w(b).toString(16)),P(w(a).toString(16)),P(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s-=a/100;c.s=N(1,C(0,c.s));return v(c)}function h(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s+=a/100;
c.s=N(1,C(0,c.s));return v(c)}function g(b){return v(b).desaturate(100)}function k(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l+=a/100;c.l=N(1,C(0,c.l));return v(c)}function p(b,a){a=0===a?0:a||10;var c=v(b).toRgb();c.r=C(0,N(255,c.r-w(255*-(a/100))));c.g=C(0,N(255,c.g-w(255*-(a/100))));c.b=C(0,N(255,c.b-w(255*-(a/100))));return v(c)}function l(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l-=a/100;c.l=N(1,C(0,c.l));return v(c)}function n(b,a){var c=v(b).toHsl(),d=(w(c.h)+a)%360;c.h=0>d?360+d:d;return v(c)}
function m(b){b=v(b).toHsl();b.h=(b.h+180)%360;return v(b)}function q(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+120)%360,s:a.s,l:a.l}),v({h:(c+240)%360,s:a.s,l:a.l})]}function u(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+90)%360,s:a.s,l:a.l}),v({h:(c+180)%360,s:a.s,l:a.l}),v({h:(c+270)%360,s:a.s,l:a.l})]}function r(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+72)%360,s:a.s,l:a.l}),v({h:(c+216)%360,s:a.s,l:a.l})]}function K(b,a,c){a=a||6;c=c||30;var d=v(b).toHsl();c=360/c;b=[v(b)];for(d.h=
(d.h-(c*a>>1)+720)%360;--a;)d.h=(d.h+c)%360,b.push(v(d));return b}function A(b,a){a=a||6;for(var c=v(b).toHsv(),d=c.h,e=c.s,c=c.v,f=[],h=1/a;a--;)f.push(v({h:d,s:e,v:c})),c=(c+h)%1;return f}function X(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function F(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=N(a,C(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>Z.abs(b-a)?1:b%a/parseFloat(a)}function P(b){return 1==
b.length?"0"+b:""+b}function Q(b){1>=b&&(b=100*b+"%");return b}var xa=/^[\s,#]+/,t=/\s+$/,U=0,Z=Math,w=Z.round,N=Z.min,C=Z.max,aa=Z.random,v=function ia(b,c){var d,e,f,h,g;b=b?b:"";c=c||{};if(b instanceof ia)return b;if(!(this instanceof ia))return new ia(b,c);e=b;g={r:0,g:0,b:0};var k=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(xa,"").replace(t,"").toLowerCase();var p=!1;if(L[e])e=L[e],p=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(h=M.rgb.exec(e))?{r:h[1],g:h[2],b:h[3]}:
(h=M.rgba.exec(e))?{r:h[1],g:h[2],b:h[3],a:h[4]}:(h=M.hsl.exec(e))?{h:h[1],s:h[2],l:h[3]}:(h=M.hsla.exec(e))?{h:h[1],s:h[2],l:h[3],a:h[4]}:(h=M.hsv.exec(e))?{h:h[1],s:h[2],v:h[3]}:(h=M.hsva.exec(e))?{h:h[1],s:h[2],v:h[3],a:h[4]}:(h=M.hex8.exec(e))?{a:parseInt(h[1],16)/255,r:parseInt(h[2],16),g:parseInt(h[3],16),b:parseInt(h[4],16),format:p?"name":"hex8"}:(h=M.hex6.exec(e))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16),format:p?"name":"hex"}:(h=M.hex3.exec(e))?{r:parseInt(h[1]+""+h[1],
16),g:parseInt(h[2]+""+h[2],16),b:parseInt(h[3]+""+h[3],16),format:p?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))g={r:255*F(e.r,255),g:255*F(e.g,255),b:255*F(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=Q(e.s);e.v=Q(e.v);f=e.h;p=e.s;g=e.v;f=6*F(f,360);p=F(p,100);g=F(g,100);d=Z.floor(f);var l=f-d;f=g*(1-p);h=g*(1-l*p);p=g*(1-(1-l)*p);d%=6;
g={r:255*[g,h,f,f,p,g][d],g:255*[p,g,g,h,f,f][d],b:255*[f,f,p,g,g,h][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=Q(e.s),e.l=Q(e.l),g=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(k=e.a)}k=X(k);e=e.format||f;f=N(255,C(g.r,0));h=N(255,C(g.g,0));g=N(255,C(g.b,0));this._originalInput=b;this._r=f;this._g=h;this._b=g;this._a=k;this._roundA=w(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
...
l.label=c[k];g.add(l)}d&&(g.selectedIndex=d);var m=this._globalChangeHandler,n=this;g.addEventListener("change",function(){var c=g.selectedIndex,d=g.options;e&&e({index:c,value:d[c].label});m&&m();n._callCallbacks(b,{index:c,value:d[c].label})});g.className="msettings_select";f.appendChild(h);f.appendChild(g);this._content.appendChild(f);this._controls[b]={container:f,control:g,label:h,callback:e}},getDropDownValue:function(b){b=this._controls[b].control;var c=b.selectedIndex;return{index:c,value:b.options[c].label}},
...
b),f.startDragY=g.page("Y",b),f.dragWatchers={current:0,last:0,hold:0,state:""},f.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(b){if(f.isDragging&&d.touchToDrag){var c=g.page("X",b),e=g.page("Y",b),h=f.translation,q=k.translate.get.matrix(4),p=c-f.startDragX,u=0<q,A=p;if(!f.intentChecked||f.hasIntent){d.addBodyClasses&&(0<q?(g.klass.add(a.body,"snapjs-left"),g.klass.remove(a.body,
"snapjs-right")):0>q&&(g.klass.add(a.body,"snapjs-right"),g.klass.remove(a.body,"snapjs-left")));if(!1===f.hasIntent||null===f.hasIntent){var e=g.angleOfDrag(c,e),K=0<=e&&e<=d.slideIntent||360>=e&&e>360-d.slideIntent;f.hasIntent=180<=e&&e<=180+d.slideIntent||180>=e&&e>=180-d.slideIntent||K?!0:!1;f.intentChecked=!0}d.minDragDistance>=Math.abs(c-f.startDragX)||!1===f.hasIntent||(g.events.prevent(b),g.dispatchEvent("drag"),f.dragWatchers.current=c,f.dragWatchers.last>c?("left"!==f.dragWatchers.state&&
(f.dragWatchers.state="left",f.dragWatchers.hold=c),f.dragWatchers.last=c):f.dragWatchers.last<c&&("right"!==f.dragWatchers.state&&(f.dragWatchers.state="right",f.dragWatchers.hold=c),f.dragWatchers.last=c),u?(d.maxPosition<q&&(b=(q-d.maxPosition)*d.resistance,A=p-b),f.simpleStates={opening:"left",towards:f.dragWatchers.state,hyperExtending:d.maxPosition<q,halfway:q>d.maxPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:q,relative:p,sinceDirectionChange:f.dragWatchers.current-
f.dragWatchers.hold,percentage:100*(q/d.maxPosition)}}):(d.minPosition>q&&(b=(q-d.minPosition)*d.resistance,A=p-b),f.simpleStates={opening:"right",towards:f.dragWatchers.state,hyperExtending:d.minPosition>q,halfway:q<d.minPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:q,relative:p,sinceDirectionChange:f.dragWatchers.current-f.dragWatchers.hold,percentage:100*(q/d.minPosition)}}),k.translate.x(A+h))}}},endDrag:function(b){if(f.isDragging){g.dispatchEvent("end");
...
!this._reconnection||0!==this.attempts)||(this.openReconnect=!0,this.reconnect())};d.prototype.open=d.prototype.connect=function(a){m("readyState %s",this.readyState);if(~this.readyState.indexOf("open"))return this;m("opening %s",this.uri);var c=this.engine=f(this.uri,this.opts),d=this;this.readyState="opening";var e=k(c,"open",function(){d.onopen();a&&a()}),h=k(c,"error",function(c){m("connect_error");d.cleanup();d.readyState="closed";d.emitAll("connect_error",c);if(a){var e=Error("Connection error");
e.data=c;a(e)}d.maybeReconnectOnOpen()});if(!1!==this._timeout){var g=this._timeout;m("connect attempt will timeout after %d",g);var l=setTimeout(function(){m("connect attempt timed out after %d",g);e.destroy();c.close();c.emit("error","timeout");d.emitAll("connect_timeout",g)},g);this.subs.push({destroy:function(){clearTimeout(l)}})}this.subs.push(e);this.subs.push(h);return this};d.prototype.onopen=function(){m("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(k(a,
...
this.io;this.subs=[g(a,"open",k(this,"onopen")),g(a,"packet",k(this,"onpacket")),g(a,"close",k(this,"onclose"))]};d.prototype.open=d.prototype.connect=function(){if(this.connected)return this;this.io.open();if("open"==this.io.readyState)this.onopen();return this};d.prototype.send=function(){var a=h(arguments);a.unshift("message");this.emit.apply(this,a);return this};d.prototype.emit=function(a){if(n.hasOwnProperty(a))return r.apply(this,arguments),this;var c=h(arguments),d=f.EVENT;m(c)&&(d=f.BINARY_EVENT);
...
c):this.receiveBuffer.push(c)};d.prototype.ack=function(a){var c=this,d=!1;return function(){if(!d){d=!0;var e=h(arguments);l("sending ack %j",e);var g=m(e)?f.BINARY_ACK:f.ACK;c.packet({type:g,id:a,data:e})}}};d.prototype.onack=function(a){l("calling ack %s with %j",a.id,a.data);this.acks[a.id].apply(this,a.data);delete this.acks[a.id]};d.prototype.onconnect=function(){this.connected=!0;this.disconnected=!1;this.emit("connect");this.emitBuffered()};d.prototype.emitBuffered=function(){var a;for(a=
...
function(a){k("setting transport %s",a.name);var c=this;this.transport&&(k("clearing existing transport %s",this.transport.name),this.transport.removeAllListeners());this.transport=a;a.on("drain",function(){c.onDrain()}).on("packet",function(a){c.onPacket(a)}).on("error",function(a){c.onError(a)}).on("close",function(){c.onClose("transport close")})};e.prototype.probe=function(a){function c(){if(E.onlyBinaryUpgrades){var d=!this.supportsBinary&&E.transport.supportsBinary;r=r||d}r||(k('probe transport "%s" opened',
a),q.send([{type:"ping",data:"probe"}]),q.once("packet",function(c){r||("pong"==c.type&&"probe"==c.data?(k('probe transport "%s" pong',a),E.upgrading=!0,E.emit("upgrading",q),e.priorWebsocketSuccess="websocket"==q.name,k('pausing current transport "%s"',E.transport.name),E.transport.pause(function(){r||("closed"==E.readyState||"closing"==E.readyState)||(k("changing transport and sending upgrade packet"),n(),E.setTransport(q),q.send([{type:"upgrade"}]),E.emit("upgrade",q),q=null,E.upgrading=!1,E.flush())})):
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=q.name,E.emit("upgradeError",c)))}))}function d(){r||(r=!0,n(),q.close(),q=null)}function h(c){var e=Error("probe error: "+c);e.transport=q.name;d();k('probe transport "%s" failed because of error: %s',a,c);E.emit("upgradeError",e)}function g(){h("transport closed")}function m(){h("socket closed")}function l(a){q&&a.name!=q.name&&(k('"%s" works - aborting "%s"',a.name,q.name),d())}function n(){q.removeListener("open",c);q.removeListener("error",
h);q.removeListener("close",g);E.removeListener("close",m);E.removeListener("upgrading",l)}k('probing transport "%s"',a);var q=this.createTransport(a,{probe:1}),r=!1,E=this;e.priorWebsocketSuccess=!1;q.once("open",c);q.once("error",h);q.once("close",g);this.once("close",m);this.once("upgrading",l);q.open()};e.prototype.onOpen=function(){k("socket open");this.readyState="open";e.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
...
c)};var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(c,d);this.script=c;"undefined"!=typeof navigator&&/gecko/i.test(navigator.userAgent)&&setTimeout(function(){var a=document.createElement("iframe");document.body.appendChild(a);document.body.removeChild(a)},100)};h.prototype.doWrite=function(a,c){function d(){e();c()}function e(){if(f.iframe)try{f.form.removeChild(f.iframe)}catch(a){f.onError("jsonp polling iframe removal error",a)}try{n=document.createElement('<iframe src="javascript:0" name="'+
...
this.form=h;this.area=g}this.form.action=this.uri();e();a=a.replace(m,"\\\n");this.area.value=a.replace(l,"\\n");try{this.form.submit()}catch(H){}this.iframe.attachEvent?this.iframe.onreadystatechange=function(){"complete"==f.iframe.readyState&&d()}:this.iframe.onload=d}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./polling":17,"component-inherit":20}],16:[function(a,c,e){(function(d){function e(){}function h(a){m.call(this,a);if(d.location){var c="https:"==
...
c);d.on("error",function(a){e.onError("xhr post error",a)});this.sendXhr=d};h.prototype.doPoll=function(){q("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};n(g.prototype);g.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{q("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
...
l=0===g[0],q="",m=1;255!=g[m];m++){if(310<q.length){h=!0;break}q+=g[m]}if(h)return d(u,0,1);a=k(a,2+q.length);q=parseInt(q);g=k(a,0,q);if(l)try{g=String.fromCharCode.apply(null,new Uint8Array(g))}catch(p){for(l=new Uint8Array(g),g="",m=0;m<l.length;m++)g+=String.fromCharCode(l[m])}f.push(g);a=k(a,q)}var n=f.length;f.forEach(function(a,f){d(e.decodePacket(a,c,!0),f,n)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
56320==(h&64512)?c.push(((f&1023)<<10)+(h&1023)+65536):(c.push(f),d--)):c.push(f);return c}function g(){if(u>=p)throw Error("Invalid byte index");var a=q[u]&255;u++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,d,e;if(u>p)throw Error("Invalid byte index");if(u==p)return!1;a=q[u]&255;u++;if(0==(a&128))return a;if(192==(a&224)){c=g();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=g();d=g();a=(a&15)<<12|c<<6|
d;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=g(),d=g(),e=g(),a=(a&15)<<18|c<<12|d<<6|e,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof e&&e,m="object"==typeof c&&c&&c.exports==l&&c,n="object"==typeof a&&a;if(n.global===n||n.window===n)f=n;var r=String.fromCharCode,q,p,u,n={version:"2.0.0",encode:function(a){a=h(a);for(var c=a.length,d=-1,e,f="";++d<c;){e=a[d];if(0==(e&4294967168))e=r(e);else{var g="";0==(e&4294965248)?
g=r(e>>6&31|192):0==(e&4294901760)?(g=r(e>>12&15|224),g+=r(e>>6&63|128)):0==(e&4292870144)&&(g=r(e>>18&7|240),g+=r(e>>12&63|128),g+=r(e>>6&63|128));e=g+=r(e&63|128)}f+=e}return f},decode:function(a){q=h(a);p=q.length;u=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var d=-1,e,f="";++d<c;)e=a[d],65535<e&&(e-=65536,f+=r(e>>>10&1023|55296),e=56320|e&1023),f+=r(e);return f}};if(l&&!l.nodeType)if(m)m.exports=n;else{f={}.hasOwnProperty;for(var A in n)f.call(n,A)&&(l[A]=n[A])}else f.utf8=n})(this)}).call(this,
"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{}],28:[function(a,c,e){(function(a){var e=/^[\],:{}\s]*$/,h=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,g=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,k=/(?:^|:|,)(?:\s*\[)+/g,l=/^\s+/,m=/\s+$/;c.exports=function(c){if("string"!=typeof c||!c)return null;c=c.replace(l,"").replace(m,"");if(a.JSON&&JSON.parse)return JSON.parse(c);if(e.test(c.replace(h,"@").replace(g,"]").replace(k,"")))return(new Function("return "+
...
a._placeholder)return c[a.num];if(f(a))for(var d=0;d<a.length;d++)a[d]=e(a[d]);else if(a&&"object"==typeof a)for(d in a)a[d]=e(a[d]);return a}a.data=e(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,g,p){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){m++;var u=new FileReader;u.onload=function(){p?p[g]=this.result:n=this.result;--m||e(n)};u.readAsArrayBuffer(a)}else if(f(a))for(u=0;u<a.length;u++)l(a[u],u,a);else if(a&&"object"==typeof a&&!h(a))for(u in a)l(a[u],
u,a)}var m=0,n=a;l(n);m||e(n)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=m.stringify(a.data));l("encoded %j as %s",a,c);return c}function h(a,c){n.removeBlobs(a,function(a){var d=n.deconstructPacket(a);
a=f(d.packet);d=d.buffers;d.unshift(a);c(d)})}function g(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),m=a("json3");a("isarray");c=a("component-emitter");var n=a("./binary"),r=a("./is-buffer");e.protocol=4;e.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");e.CONNECT=0;e.DISCONNECT=1;e.EVENT=2;e.ACK=3;e.ERROR=4;e.BINARY_EVENT=5;e.BINARY_ACK=6;e.Encoder=d;e.Decoder=g;d.prototype.encode=function(a,c){l("encoding packet %j",
...
1==a.length)break}else c.nsp="/";f=a.charAt(d+1);if(""!=f&&Number(f)==f){for(c.id="";++d;){f=a.charAt(d);if(null==f||Number(f)!=f){--d;break}c.id+=a.charAt(d);if(d+1==a.length)break}c.id=Number(c.id)}if(a.charAt(++d))try{c.data=m.parse(a.substr(d))}catch(h){a={type:e.ERROR,data:"parser error"};break a}l("decoded %s as %j",a,c);a=c}}e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type?(this.reconstructor=new k(a),0==this.reconstructor.reconPack.attachments&&this.emit("decoded",a)):this.emit("decoded",a)}else if(r(a)||
...
d("01")}catch(p){}if(m)try{m=1!==d("1.")}catch(u){}}}}catch(t){m=!1}d=m}}return c[a]=!!d}var h={}.toString,g,k,l,m="object"==typeof JSON&&JSON,n="object"==typeof e&&e&&!e.nodeType&&e;n&&m?(n.stringify=m.stringify,n.parse=m.parse):n=a.JSON=m||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(q){}if(!c("json")){var p=c("bug-string-char-index");
...
h.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};n.parse=function(a,c){var d,e;s=0;I=""+a;d=ja(R());"$"!=R()&&x();s=I=null;return c&&"[object Function]"==h.call(c)?oa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],g=(c=c||0)||0;g<a.length;g++)e[g-c]=a[g];return e}},{}]},{},[1])(1)});
