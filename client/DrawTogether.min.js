...
DrawTogether.prototype.insertOneFavorite=function(b,a,c,d){var e=this.favoritesContainer.appendChild(document.createElement("div"));e.className="favorite-container";e.dataset.x=b;e.dataset.y=a;e.dataset.name=c;e.dataset.owner=d;d=e.appendChild(document.createElement("div"));d.className="fav-button fav-minus-button";d.innerHTML="-";d.addEventListener("click",function(b){if(b.srcElement.classList.contains("fav-button-confirmation")){b.srcElement.innerHTML="-";b.srcElement.classList.remove("fav-button-confirmation");
var a=b.srcElement.parentElement;this.removeFavorite(a.dataset.x,a.dataset.y,a.dataset.name,a)}else b.srcElement.classList.add("fav-button-confirmation"),b.srcElement.innerHTML="?",setTimeout(function(){b.srcElement.innerHTML="-";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),4E3)}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-plus-button";d.innerHTML="+";d.addEventListener("click",function(b){var a=[this.paint.public.canvas.width/
this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=b.srcElement.parentElement.dataset.x,e=b.srcElement.parentElement.dataset.y,d=b.srcElement.parentElement.dataset.name,m=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);b.srcElement.classList.contains("fav-button-confirmation")?(b.srcElement.innerHTML="+",b.srcElement.classList.remove("fav-button-confirmation"),this.setCoordFavorite(m,a,c,e,d,b.srcElement.parentElement)):(b.srcElement.classList.add("fav-button-confirmation"),
b.srcElement.innerHTML="?",setTimeout(function(){b.srcElement.innerHTML="+";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),4E3))}.bind(this));d.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);b.srcElement.title="Change to "+c+","+a+" ?"}.bind(this));d=e.appendChild(document.createElement("div"));
d.className="fav-button fav-pencil-button";d.innerHTML="\u270e";d=d.appendChild(document.createElement("div"));d.className="fav-rename-container";d=d.appendChild(document.createElement("input"));d.className="fav-rename-input";d.type="text";d.placeholder="Rename";d.addEventListener("input",function(b){void 0!==this._favoriteRenameDelayTimeout&&clearTimeout(this._favoriteRenameDelayTimeout);this._favoriteRenameDelayTimeout=setTimeout(function(){var a=b.srcElement.parentElement.parentElement.parentElement;
this.renameFavorite(a.dataset.x,a.dataset.y,b.srcElement.value,a)}.bind(this),1500)}.bind(this));e=e.appendChild(document.createElement("div"));e.className="fav-button fav-coor-button";e.addEventListener("click",function(b){var a=parseInt(b.srcElement.parentElement.dataset.x);b=parseInt(b.srcElement.parentElement.dataset.y);this.moveScreenToPosition([a,b],0)}.bind(this));0<c.length?(e.innerHTML=c,e.title=b+","+a,d.value=c):e.innerHTML=b+","+a};
