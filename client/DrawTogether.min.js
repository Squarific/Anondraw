...
this.paint.addEventListener("enduserpath",function(b){this.network.socket.emit("ep",function(a,c){b.removePath(!0,a)})}.bind(this));this.paint.addEventListener("userpathpoint",this.handlePaintUserPathPoint.bind(this));this.paint.addEventListener("select",this.handlePaintSelection.bind(this));var a,c=function(){location.hash=this.current_room+","+this.paint.public.leftTopX.toFixed()+","+this.paint.public.leftTopY.toFixed()}.bind(this);this.paint.addEventListener("move",function(b){clearTimeout(a);
