...
DrawTogether.prototype.bindSocketHandlers=function(){var c=this;this.network.on("connect",function(){localStorage.getItem("drawtogether-name")&&c.changeName(localStorage.getItem("drawtogether-name"));if(c.current_room){var a=c.current_room;delete c.current_room;c.changeRoom(a)}});this.network.on("initname",function(a){localStorage.getItem("drawtogether-name")||c.setName(a)});this.network.on("drawing",function(a){var b=c.decodeDrawing(a.drawing);c.paint.drawDrawing("public",b);c.setPlayerPosition(a.socketid,
