...
k&&clearTimeout(k);k=setTimeout(function(){var b=a.value,c=e.dataset.x,d=e.dataset.y;g.style.visibility="";g.style.opacity=0;this.renameFavorite(c,d,b,e)}.bind(this),2500)}.bind(this));f.addEventListener("click",function(){"visible"==g.style.visibility?(g.style.visibility="",g.style.opacity=0,clearTimeout(k),this.renameFavorite(b,a,newName,curFavContainer)):(g.style.visibility="visible",g.style.opacity=1,h.focus(),h.select(),h.setSelectionRange(0,h.value.length))});0<c.length?(d.textContent=c,d.title=
b+","+a,h.value=c):d.textContent=b+","+a;e.appendChild(this.createSetPositionButton());e.appendChild(this.createFavoriteDeleteButton())};
