...
DrawTogether.prototype.openNewFeatureWindow=function(){localStorage.setItem("newfeaturewindowversion",this.CLIENT_VERSION);var b=this.gui.createWindow({title:"New features!"});b.classList.add("feature-window");var a=b.appendChild(document.createElement("div"));a.className="content";a.appendChild(document.createElement("h2")).appendChild(document.createTextNode("We just had an update!"));var c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Current new feature:"));
for(var c=a.appendChild(document.createElement("ol")),e=["Private regions for premium members"],d=0;d<e.length;d++)c.appendChild(document.createElement("li")).appendChild(document.createTextNode(e[d]));c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("If you are premium you can create a private region. Noone besides you can then draw there."));c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("In the future you will be able to pick who gets to draw in it and who doesn't."));
a=a.appendChild(document.createElement("div"));a.appendChild(document.createTextNode("Want to enjoy this feature? Get premium!"));a.className="drawtogether-button";a.addEventListener("click",function(){b.parentNode&&b.parentNode.removeChild(b);this.openPremiumBuyWindow()}.bind(this))};
