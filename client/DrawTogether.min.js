...
Account.prototype.setCoordFavorite=function(b,a,c,d,e,f){this.request("/setcoordfavorite",{uKey:this.uKey,room:room,newX:b,newY:a,x:c,y:d,name:e},this.parseData.bind(this,f))};Account.prototype.removeFavorite=function(b,a,c,d){this.request("/removefavorite",{uKey:this.uKey,room:room,x:b,y:a,name:c},this.parseData.bind(this,d))};Account.prototype.renameFavorite=function(b,a,c,d){this.request("/renamefavorite",{uKey:this.uKey,room:room,x:b,y:a,name:c},this.parseData.bind(this,d))};
Account.prototype.createFavorite=function(b,a,c,d){this.request("/createfavorite",{uKey:this.uKey,room:room,x:b,y:a,name:c},this.parseData.bind(this,d))};Account.prototype.getFavorites=function(b,a){this.request("/getfavorites",{uKey:this.uKey,room:b},this.parseData.bind(this,a))};
...
DrawTogether.prototype.insertOneFavorite=function(b,a,c,d){var e=this.favoritesContainer.appendChild(document.createElement("div"));e.className="favorite-container";e.dataset.x=b;e.dataset.y=a;e.dataset.name=c;e.dataset.owner=d;d=e.appendChild(document.createElement("div"));d.className="fav-button fav-minus-button";d.textContent="-";d.addEventListener("click",function(b){var a=b.srcElement||b.target;a.classList.contains("fav-button-confirmation")?(b=a.parentNode.getElementsByClassName("fav-coor-button")[0],
b.dataset.tempConf=b.innerHTML,a.innerHTML="-",a.classList.remove("fav-button-confirmation"),b=a.parentNode,this.removeFavorite(b.dataset.x,b.dataset.y,b.dataset.name,b)):(b=a.parentNode.getElementsByClassName("fav-coor-button")[0],b.dataset.tempConf=b.innerHTML,b.innerHTML="Delete?",a.classList.add("fav-button-confirmation"),a.innerHTML="?",setTimeout(function(){var b=a.parentNode.getElementsByClassName("fav-coor-button")[0];b.innerHTML=b.dataset.tempConf;a.innerHTML="-";a.classList.remove("fav-button-confirmation")}.bind(this),
4E3))}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-plus-button";d.textContent="+";d.addEventListener("click",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=b.srcElement||b.target;b=c.parentNode.dataset.x;var e=c.parentNode.dataset.y,d=c.parentNode.dataset.name,m=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);if(c.classList.contains("fav-button-confirmation")){var q=
c.parentNode.getElementsByClassName("fav-coor-button")[0];q.innerHTML=q.dataset.tempConf;q.dataset.tempConf="5215random_string_tempconf5152";c.innerHTML="+";c.classList.remove("fav-button-confirmation");this.setCoordFavorite(m,a,b,e,d,c.parentNode)}else q=c.parentNode.getElementsByClassName("fav-coor-button")[0],q.dataset.tempConf=q.innerHTML,q.innerHTML=m+","+a+"?",c.classList.add("fav-button-confirmation"),c.innerHTML="?",setTimeout(function(){var b=c.parentNode.getElementsByClassName("fav-coor-button")[0];
"5215random_string_tempconf5152"!==b.dataset.tempConf&&(b.innerHTML=b.dataset.tempConf);c.innerHTML="+";c.classList.remove("fav-button-confirmation")}.bind(this),2E3)}.bind(this));d.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom];b=b.srcElement||b.target;var c=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);b.title="Change to "+c+","+a+" ?"}.bind(this));
d=e.appendChild(document.createElement("div"));d.className="fav-button fav-pencil-button";d.textContent="\u270e";d=d.appendChild(document.createElement("div"));d.className="fav-rename-container";d=d.appendChild(document.createElement("input"));d.className="fav-rename-input";d.type="text";d.placeholder="Rename";d.addEventListener("input",function(b){var a=b.srcElement||b.target;void 0!==this._favoriteRenameDelayTimeout&&clearTimeout(this._favoriteRenameDelayTimeout);this._favoriteRenameDelayTimeout=
setTimeout(function(){var b=a.parentNode.parentNode.parentNode;this.renameFavorite(b.dataset.x,b.dataset.y,a.value,b)}.bind(this),1500)}.bind(this));e=e.appendChild(document.createElement("div"));e.className="fav-button fav-coor-button";e.addEventListener("click",function(b){var a=b.srcElement||b.target;b=parseInt(a.parentNode.dataset.x);a=parseInt(a.parentNode.dataset.y);this.moveScreenToPosition([b,a],0)}.bind(this));0<c.length?(e.textContent=c,e.title=b+","+a,d.value=c):e.textContent=b+","+a};
DrawTogether.prototype.updateFavoriteDom=function(){for(;this.favoritesContainer.firstChild;)this.favoritesContainer.removeChild(this.favoritesContainer.firstChild);var b=this.favoritesContainer.appendChild(document.createElement("div"));b.className="fav-button fav-add-new-fav";b.textContent="^";b.title="Add new Favorite.";b.addEventListener("click",function(b){var c=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom];b=parseInt(this.paint.public.leftTopX+
