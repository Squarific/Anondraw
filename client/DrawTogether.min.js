...
DrawTogether.prototype.updateFavoriteDom=function(){for(;this.favoritesContainer.firstChild;)this.favoritesContainer.removeChild(this.favoritesContainer.firstChild);var b=this.favoritesContainer.appendChild(document.createElement("div"));b.className="fav-button fav-add-new-fav";b.innerHTML="^";b.title="Add new Favorite.";b.addEventListener("click",function(b){this.createFavorite(0,0,"")}.bind(this));for(b=this.favList.length-1;0<=b;b--)this.insertOneFavorite(this.favList[b].x,this.favList[b].y,this.favList[b].name,
this.favList[b].owner)};DrawTogether.prototype.setCoordFavorite=function(b,a,c,d,e,f){this.account.setCoordFavorite(b,a,c,d,e,function(c,e){c?this.chat.addMessage("Changing coordinate of Favorite","Error: "+c):e.success&&(this.updateIndividualFavoriteDom(b,a,null,null,f),this.getFavorites())}.bind(this))};DrawTogether.prototype.removeFavorite=function(b,a,c,d){this.account.removeFavorite(b,a,c,function(b,a){b?this.chat.addMessage("Removing Favorite","Error: "+b):a.success&&(d.remove(),this.getFavorites())}.bind(this))};
DrawTogether.prototype.renameFavorite=function(b,a,c,d){this.account.renameFavorite(b,a,c,function(b,a){b?this.chat.addMessage("Renaming Favorite","Error: "+b):a.success&&(this.updateIndividualFavoriteDom(null,null,c,null,d),this.getFavorites())}.bind(this))};DrawTogether.prototype.getFavorites=function(){this.account.getFavorites(drawTogether.current_room,function(b,a){b?this.chat.addMessage("Getting Favorites","Error: "+b):this.favList=a}.bind(this))};
DrawTogether.prototype.createFavorite=function(b,a,c){null===this.account.mail?this.chat.addMessage("You must login to save or create favorites!"):!this.memberlevel&&5<=this.favList.length?this.chat.addMessage("Creating favorites past 5 is limited to Premium Users."):this.account.createFavorite(b,a,c,function(b,a){b?this.chat.addMessage("Favorite","Error: "+b):a.success&&(this.chat.addMessage("Favorite added",a.success),this.insertOneFavorite(0,0,"",a.owner),this.getFavorites())}.bind(this))};
