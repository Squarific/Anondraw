...
": "));h.style.color=this.string2Color(b)}this.addMessageToDom(d,a);d.title=f;d.alt=f;c<=e&&(this.messagesDom.scrollTop=this.messagesDom.scrollHeight-this.messagesDom.getBoundingClientRect().height);b===a||this.userSettings.getBoolean("Mute chat")||this.messageSound.play()};
...
Chat.prototype.createUrl=function(b){var a=document.createElement("a");a.href=-1==b.indexOf("://")?"http://"+b:b;a.target="_blank";a.appendChild(document.createTextNode(b));return a};Chat.prototype.createEmote=function(b,a){var c=document.createElement("img");c.title=b;c.alt=b;c.src=a;c.className="drawtogether-emote";return c};Chat.prototype.sendChat=function(){this.onMessage(this.input.value);this.input.value=""};function DrawTogether(b,a){this.container=b;this.settings=this.utils.merge(this.utils.copy(a),this.defaultSettings);this.userSettings=QuickSettings.create(0,0,"settings");this.userSettings.setDraggable(!1);this.userSettings.setCollapsible(!1);this.playerList=[];this.moveQueue=[];this.ink=0;this.previousInk=Infinity;this.lastViewDeduction=this.lastZoomWarning=this.lastBrushSizeWarning=this.lastInkWarning=0;this.lastScreenMove=Date.now();this.lastScreenMoveStartPosition;this._forceFollow;this._autoMoveScreen;
this._followingPlayer;this.network=new Network(this.settings.loadbalancer);this.account=new Account(this.settings.accountServer);this.bindSocketHandlers();this.initDom();this.gui=new Gui(b);this.updateInk();"ask"==this.settings.mode?this.openModeSelector():"askjoin"==this.settings.mode?(this.changeRoom("main"),this.openModeSelector()):"join"==this.settings.mode?(0==this.settings.room.indexOf("private_")?0==this.settings.room.indexOf("private_game_")?ga("send","event","autojoin","privategame"):ga("send",
"event","autojoin","private"):this.settings.room.indexOf("game_")?ga("send","event","autojoin","game"):ga("send","event","autojoin","public"),this.changeRoom(this.settings.room,void 0,this.settings.leftTopX,this.settings.leftTopY,!0)):"private"==this.settings.mode?(this.settings.room="private_"+Math.random().toString(36).substr(2,5),this.changeRoom(this.settings.room,void 0,0,0,!0)):"member"==this.settings.mode?this.changeRoom("member-main"):"auto"==this.settings.mode&&this.changeRoom("main");requestAnimationFrame(this.drawLoop.bind(this));
this.needsClear=!1;document.addEventListener("keydown",function(b){b.target===document.body&&(27==b.keyCode&&(this.closeAccountWindow(),this.closeShareWindow(),this.closeRoomWindow(),this.closeSettingsWindow()),65==b.keyCode&&this.advancedOptions.toggleVisibility())}.bind(this));setInterval(this.displayTip.bind(this),3E5);setTimeout(this.autoMoveScreen.bind(this),0)}DrawTogether.prototype.KICKBAN_MIN_REP=50;DrawTogether.prototype.BIG_BRUSH_MIN_REP=5;DrawTogether.prototype.ZOOMED_OUT_MIN_REP=2;
DrawTogether.prototype.CLIENT_VERSION=2;DrawTogether.prototype.defaultSettings={mode:"ask",room:"main",leftTopX:0,leftTopY:0,loadbalancer:"http://direct.anondraw.com:3552",accountServer:"http://direct.anondraw.com:4552",imageServer:"http://direct.anondraw.com:5552"};DrawTogether.prototype.defaultUserSettings=[{title:"Mute chat",type:"boolean",value:!1},{title:"Show tips",type:"boolean",value:!0},{title:"Show welcome",type:"boolean",value:!0}];DrawTogether.prototype.drawingTypes=["line","brush","block"];
...
e.className="drawtogether-player-button drawtogether-kickban-button";e.innerText="B";e.textContent="B";e.addEventListener("click",this.kickban.bind(this,b.id));a.appendChild(e)}var d=document.createElement("span");d.className="drawtogether-player-name";var f="",h="",g="",e="";"undefined"!==typeof b.reputation&&(f=" ("+b.reputation+" R)");"undefined"!==typeof b.gamescore&&(h=" ["+b.gamescore+" Points]");b.currentPlayer&&(g=" | DRAWING");1==b.memberlevel&&(e+="\u2665",d.className+=" premium");d.appendChild(document.createTextNode(b.name+
f+h+g));a.appendChild(c);a.appendChild(d);b=document.createElement("span");b.appendChild(document.createTextNode(e));b.className="icons";a.appendChild(b);return a};
...
c&&this.gui.prompt("What is the reason you want to ban him?","freepick;Drawings swastikas;Destroying drawings;Being a dick in chat;Spam;Cancel".split(";"),function(e){"Cancel"!=e&&this.gui.prompt("Are you sure you want to ban "+this.usernameFromSocketid(b)+" (bantype: "+c+") for "+a+" minutes. Reason: "+e,["Yes","No"],function(d){"Yes"==d&&this.network.socket.emit("kickban",[b,a,c,e],function(b){this.chat.addMessage("SERVER",b.error||b.success)}.bind(this))}.bind(this))}.bind(this))}.bind(this)))}.bind(this))};
...
e.appendChild(document.createElement("div"));this.account.mail&&this.accountSuccess("Logged in as "+this.account.mail);a&&this.accountError("Error getting session state: "+a);if(c){var d=e.appendChild(document.createElement("div"));d.appendChild(document.createTextNode("Premium"));d.className="drawtogether-button";d.addEventListener("click",function(){this.closeAccountWindow();this.openPremiumBuyWindow()}.bind(this));d=e.appendChild(document.createElement("div"));d.appendChild(document.createTextNode("Logout"));
d.className="drawtogether-button drawtogether-logout-button";d.addEventListener("click",function(){this.account.logout(function(b){b?this.accountError("Couldn't logout: "+b):(this.createAccountWindow(),this.network.socket.emit("uKey",this.account.uKey))}.bind(this))}.bind(this))}else d=e.appendChild(document.createElement("input")),d.type="email",d.placeholder="email@example.com",this.emailInput=d,d=e.appendChild(document.createElement("input")),d.type="password",d.placeholder="*********",this.passInput=
d,this.emailInput.addEventListener("keydown",function(b){13==b.keyCode&&this.formLogin()}.bind(this)),this.passInput.addEventListener("keydown",function(b){13==b.keyCode&&this.formLogin()}.bind(this)),d=e.appendChild(document.createElement("div")),d.appendChild(document.createTextNode("Login")),d.className="drawtogether-button drawtogether-login-button",d.addEventListener("click",this.formLogin.bind(this)),d=e.appendChild(document.createElement("div")),d.appendChild(document.createTextNode("Register")),
d.className="drawtogether-button drawtogether-register-button",d.addEventListener("click",this.formRegister.bind(this));e=e.appendChild(document.createElement("div"));e.appendChild(document.createTextNode("Close account window"));e.className="drawtogether-button drawtogether-close-button";e.addEventListener("click",this.closeAccountWindow.bind(this))}.bind(this))};
...
"drawtogether-redditdrawings";this.populateRedditDrawings();b=b.appendChild(document.createElement("div"));b.appendChild(document.createTextNode("Feedback/contact: info@anondraw.com"));b.classList.add("contactinfo")};
DrawTogether.prototype.populateRedditDrawings=function(){var b=new XMLHttpRequest;b.addEventListener("readystatechange",function(a){if(4==b.readyState&&200==b.status){a=JSON.parse(b.responseText).data.children;var c=this.redditDrawings.appendChild(document.createElement("a"));c.appendChild(document.createTextNode("Reddit gallery (/r/anondraw)"));c.href="http://www.reddit.com/r/anondraw";c.className="drawtogether-redditdrawings-title";c=document.createElement("div");c.innerHTML='<iframe width="560" height="315" src="https://www.youtube.com/embed/VOxqb3_0IpE?start=261" frameborder="0" allowfullscreen></iframe>';
this.redditDrawings.appendChild(c);for(c=0;c<a.length;c++)this.redditDrawings.appendChild(this.createRedditPost(a[c].data))}}.bind(this));b.open("GET","https://www.reddit.com/r/anondraw/.json");b.send()};
...
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,e)return a(document).trigger("coinbase_button_loaded",d)}else if("checkouts frame loaded"===f&&(e=!0,c))return a(document).trigger("coinbase_button_loaded",d)}},!1);a(".coinbase-button").each(function(e){return function(e,m){var l,G,B,H,C;l=a(m);B=l.data();B.referrer=document.domain;H=a.param(B);B=l.data("code");C=l.data("width")||h(l.data("button-style"));G=l.data("height")||f(l.data("button-style"));r=b(l.data("env"));
G="<iframe src='"+r+"/buttons/"+B+"?"+H+"' id='coinbase_button_iframe_"+B+"' name='coinbase_button_iframe_"+B+"' style='width: "+C+"px; height: "+G+"px; border: none; overflow: hidden;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";B="<iframe src='"+r+"/checkouts/"+B+"/widget?"+H+"' id='coinbase_modal_iframe_"+B+"' name='coinbase_modal_iframe_"+B+"' style='background-color: transparent; border: 0px none transparent; display: none; position: fixed; visibility: visible; margin: 0px; padding: 0px; left: 0px; top: 0px; width: 100%; height: 100%; z-index: 9999;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";
"none"===l.data("button-style")?c=!0:l.replaceWith(G);return a("body").append(B)}}(this));return a(document).on("coinbase_show_modal",function(b,c){if(0<a("#coinbase_modal_iframe_"+c).length)return a("#coinbase_modal_iframe_"+c).show(),frames["coinbase_modal_iframe_"+c].postMessage("show modal|"+c,r)})};(function(b,a){var c,d,e,f,h,q,u,A;f=[null,null,!1];e=f[0];d=f[1];h=f[2];if(e=window.jQuery)u=parseInt(b.split(".")[0])||0,A=parseInt(b.split(".")[1])||0,c=parseInt(e.fn.jquery.split(".")[0])||0,f=
parseInt(e.fn.jquery.split(".")[1])||0,c=c>u||c===u&&f>=A;if(e&&c)return a(e);q=document.createElement("script");q.type="text/javascript";q.src="https://code.jquery.com/jquery-1.8.3.min.js";q.onload=q.onreadystatechange=function(){if(!(h||(d=this.readyState)&&"loaded"!==d&&"complete"!==d))return a((e=window.jQuery).noConflict(1)),e(q).remove()};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(q)})("1.7",function(b){return a(b,c)})}).call(this)};
...
!1,!0)}.bind(this))};
DrawTogether.prototype.openFeedbackWindow=function(){this.gui.createWindow({title:"Feedback"}).classList.add("feedback-window");var b=welcomeWindow.appendChild(document.createElement("div"));b.className="content";b.appendChild(document.createElement("h2")).appendChild(document.createTextNode("Feedback"));var a=b.appendChild(document.createElement("p"));a.appendChild(document.createTextNode("Hey we would like to ask you a question!"));a=b.appendChild(document.createElement("p"));a.appendChild(document.createTextNode("What feature would you want before you'd consider becoming a premium user?"));
...
for(var c=a.appendChild(document.createElement("ol")),e=["Export in high quality"],d=0;d<e.length;d++)c.appendChild(document.createElement("li")).appendChild(document.createTextNode(e[d]));c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Regards,"));c.appendChild(document.createElement("br"));c.appendChild(document.createTextNode("Anondraw Team"));c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Ps. want more features?"));c=a.appendChild(document.createElement("p"));
c.appendChild(document.createTextNode("Getting premium helps us pay for development time and the server hosting."));a=a.appendChild(document.createElement("div"));a.appendChild(document.createTextNode("Get premium!"));a.className="drawtogether-button";a.addEventListener("click",function(){b.parentNode&&b.parentNode.removeChild(b);this.openPremiumBuyWindow()}.bind(this))};
...
answer:"You probably don't have any ink left. You can get more ink by waiting 30 seconds. If you still don't get enough ink try making an account, the more reputation you have the more ink you get."},{question:"What is that number with an R behind peoples names?",answer:"That is the amount of reputation someone has. The more they have the more benefits they get."},{question:"What benefits does reputation give you?",answer:"At "+this.ZOOMED_OUT_MIN_REP+" reputation, you are allowed to draw while zoomed out. \nAt "+
this.BIG_BRUSH_MIN_REP+" reputation, you are allowed to use brush sizes bigger than 10. \nAt 15 reputation, you can join the member only rooms and share an ip with other users without affecting your ink. \nAt 20 reputation, you can give upvotes to other people who have less reputation than you. \nAt "+this.KICKBAN_MIN_REP+"+ reputation, you can kickban people for a certain amount of time when they misbehave. \n "},{question:"How do I get reputation?",answer:"Other people have to give you an upvote, every upvote is one reputation."},
{question:"Am I allowed to destroy doodles or drawings?",answer:"The goal is to let people draw together. You should never be afraid to help or change a drawing. However griefing on purpose is not allowed."},{question:"I want to draw in group but I don't want people to destroy my drawing/doodle.",answer:"Move away from the center where there are less people then get some reputation from your drawings and use the member rooms."}],c=0;c<a.length;c++){var e=b.appendChild(document.createElement("div"));
...
Gui.prototype.makeDraggable=function(b,a){function c(){h=!0;d=[event.clientX||0,event.clientY||0];event.changedTouches&&event.changedTouches[0]&&(d=[event.changedTouches[0].clientX||0,event.changedTouches[0].clientY||0]);var a=b.getBoundingClientRect();f=[a.left,a.top];event.preventDefault()}function e(){h&&(b.style.left=f[0]-d[0]+(event.clientX||event.changedTouches[0].clientX)+"px",b.style.top=f[1]-d[1]+(event.clientY||event.changedTouches[0].clientY)+"px",event.preventDefault())}a||(a=b);var d=
[],f=[],h=!1;a.addEventListener("mousedown",c);a.addEventListener("touchstart",c);document.addEventListener("mousemove",e);document.addEventListener("touchmove",e);a.addEventListener("mouseup",function(b){h=!1});a.addEventListener("touchend",function(b){h=!1})};
...
TiledCanvas.prototype.drawToCanvas=function(b,a,c){var e=Math.min(a[0],c[0]),d=Math.max(a[0],c[0]),f=Math.min(a[1],c[1]),h=Math.max(a[1],c[1]),g=h-f;c=Math.floor(e/this.settings.chunkSize);d=Math.ceil((e+(d-e))/this.settings.chunkSize);a=Math.floor(f/this.settings.chunkSize);h=Math.ceil((h+g)/this.settings.chunkSize);for(b=b.getContext("2d");c<d;c++)for(g=a;g<h;g++)this.chunks[c]&&(this.chunks[c][g]&&"empty"!==this.chunks[c][g])&&b.drawImage(this.chunks[c][g].canvas,c*this.settings.chunkSize-e,g*
...
positionPrecedence:["bottom","top","right","left"],disableInteraction:!1,hintPosition:"top-middle",hintButtonLabel:"Got it"}}function c(b){var a=[],c=this;if(this._options.steps)for(var g=0,q=this._options.steps.length;g<q;g++){var m=e(this._options.steps[g]);m.step=a.length+1;"string"===typeof m.element&&(m.element=document.querySelector(m.element));if("undefined"===typeof m.element||null==m.element){var l=document.querySelector(".introjsFloatingElement");null==l&&(l=document.createElement("div"),
l.className="introjsFloatingElement",document.body.appendChild(l));m.element=l;m.position="floating"}null!=m.element&&a.push(m)}else{q=b.querySelectorAll("*[data-intro]");if(1>q.length)return!1;g=0;for(m=q.length;g<m;g++){var l=q[g],k=parseInt(l.getAttribute("data-step"),10);0<k&&(a[k-1]={element:l,intro:l.getAttribute("data-intro"),step:parseInt(l.getAttribute("data-step"),10),tooltipClass:l.getAttribute("data-tooltipClass"),highlightClass:l.getAttribute("data-highlightClass"),position:l.getAttribute("data-position")||
this._options.tooltipPosition})}g=k=0;for(m=q.length;g<m;g++)if(l=q[g],null==l.getAttribute("data-step")){for(;"undefined"!=typeof a[k];)k++;a[k]={element:l,intro:l.getAttribute("data-intro"),step:k+1,tooltipClass:l.getAttribute("data-tooltipClass"),highlightClass:l.getAttribute("data-highlightClass"),position:l.getAttribute("data-position")||this._options.tooltipPosition}}}g=[];for(q=0;q<a.length;q++)a[q]&&g.push(a[q]);a=g;a.sort(function(b,a){return b.step-a.step});c._introItems=a;B.call(c,b)&&
(d.call(c),b.querySelector(".introjs-skipbutton"),b.querySelector(".introjs-nextbutton"),c._onKeyDown=function(a){if(27===a.keyCode&&!0==c._options.exitOnEsc)void 0!=c._introExitCallback&&c._introExitCallback.call(c),h.call(c,b);else if(37===a.keyCode)f.call(c);else if(39===a.keyCode)d.call(c);else if(13===a.keyCode){var e=a.target||a.srcElement;e&&0<e.className.indexOf("introjs-prevbutton")?f.call(c):e&&0<e.className.indexOf("introjs-skipbutton")?(c._introItems.length-1==c._currentStep&&"function"===
typeof c._introCompleteCallback&&c._introCompleteCallback.call(c),void 0!=c._introExitCallback&&c._introExitCallback.call(c),h.call(c,b)):d.call(c);a.preventDefault?a.preventDefault():a.returnValue=!1}},c._onResize=function(b){p.call(c,document.querySelector(".introjs-helperLayer"));p.call(c,document.querySelector(".introjs-tooltipReferenceLayer"))},window.addEventListener?(this._options.keyboardNavigation&&window.addEventListener("keydown",c._onKeyDown,!0),window.addEventListener("resize",c._onResize,
...
"floating"!=g){f=g;h=this._options.positionPrecedence.slice();g=A();var q=t(a).height+10,m=t(a).width+20,p=t(b),u="floating";p.left+m>g.width||0>p.left+p.width/2-m?(n(h,"bottom"),n(h,"top")):(p.height+p.top+q>g.height&&n(h,"bottom"),0>p.top-q&&n(h,"top"));p.width+p.left+m>g.width&&n(h,"right");0>p.left-m&&n(h,"left");0<h.length&&(u=h[0]);f&&"auto"!=f&&-1<h.indexOf(f)&&(u=f);g=u}f=t(b);b=t(a);h=A();switch(g){case "top":c.className="introjs-arrow bottom";k(f,e?0:15,b,h,a);a.style.bottom=f.height+20+
"px";break;case "right":a.style.left=f.width+20+"px";f.top+b.height>h.height?(c.className="introjs-arrow left-bottom",a.style.top="-"+(b.height-f.height-20)+"px"):c.className="introjs-arrow left";break;case "left":e||!0!=this._options.showStepNumbers||(a.style.top="15px");f.top+b.height>h.height?(a.style.top="-"+(b.height-f.height-20)+"px",c.className="introjs-arrow right-bottom"):c.className="introjs-arrow right";a.style.right=f.width+20+"px";break;case "floating":c.style.display="none";a.style.left=
...
break;default:c.className="introjs-arrow top",k(f,0,b,h,a),a.style.top=f.height+20+"px"}}}function k(b,a,c,d,e){if(b.left+a+c.width>d.width)return e.style.left=d.width-c.width-b.left+"px",!1;e.style.left=a+"px";return!0}function l(b,a,c,d){if(0>b.left+b.width-a-c.width)return d.style.left=-b.left+"px",!1;d.style.right=a+"px";return!0}function n(b,a){-1<b.indexOf(a)&&b.splice(b.indexOf(a),1)}function p(b){if(b&&this._introItems[this._currentStep]){var a=this._introItems[this._currentStep],c=t(a.element),
d=10;u(a.element)&&(b.className+=" introjs-fixedTooltip");"floating"==a.position&&(d=0);b.setAttribute("style","width: "+(c.width+d)+"px; height:"+(c.height+d)+"px; top:"+(c.top-5)+"px;left: "+(c.left-5)+"px;")}}function r(){var b=document.querySelector(".introjs-disableInteraction");null===b&&(b=document.createElement("div"),b.className="introjs-disableInteraction",this._targetElement.appendChild(b));p.call(this,b)}function m(b){"undefined"!==typeof this._introChangeCallback&&this._introChangeCallback.call(this,
b.element);var a=this,c=document.querySelector(".introjs-helperLayer"),e=document.querySelector(".introjs-tooltipReferenceLayer"),m="introjs-helperLayer";t(b.element);"string"===typeof b.highlightClass&&(m+=" "+b.highlightClass);"string"===typeof this._options.highlightClass&&(m+=" "+this._options.highlightClass);if(null!=c){var l=e.querySelector(".introjs-helperNumberLayer"),k=e.querySelector(".introjs-tooltiptext"),n=e.querySelector(".introjs-arrow"),u=e.querySelector(".introjs-tooltip"),B=e.querySelector(".introjs-skipbutton"),
C=e.querySelector(".introjs-prevbutton"),H=e.querySelector(".introjs-nextbutton");c.className=m;u.style.opacity=0;u.style.display="none";if(null!=l){var x=this._introItems[0<=b.step-2?b.step-2:0];if(null!=x&&"forward"==this._direction&&"floating"==x.position||"backward"==this._direction&&"floating"==b.position)l.style.opacity=0}p.call(a,c);p.call(a,e);if((x=document.querySelectorAll(".introjs-fixParent"))&&0<x.length)for(m=x.length-1;0<=m;m--)x[m].className=x[m].className.replace(/introjs-fixParent/g,
"").replace(/^\s+|\s+$/g,"");x=document.querySelector(".introjs-showElement");x.className=x.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");a._lastShowElementTimer&&clearTimeout(a._lastShowElementTimer);a._lastShowElementTimer=setTimeout(function(){null!=l&&(l.innerHTML=b.step);k.innerHTML=b.intro;u.style.display="block";g.call(a,b.element,u,n,l);e.querySelector(".introjs-bullets li > a.active").className="";e.querySelector('.introjs-bullets li > a[data-stepnumber="'+b.step+'"]').className=
"active";e.querySelector(".introjs-progress .introjs-progressbar").setAttribute("style","width:"+J.call(a)+"%;");u.style.opacity=1;l&&(l.style.opacity=1);-1===H.tabIndex?B.focus():H.focus()},350)}else{var s=document.createElement("div"),C=document.createElement("div"),c=document.createElement("div"),I=document.createElement("div"),F=document.createElement("div"),S=document.createElement("div"),y=document.createElement("div"),D=document.createElement("div");s.className=m;C.className="introjs-tooltipReferenceLayer";
p.call(a,s);p.call(a,C);this._targetElement.appendChild(s);this._targetElement.appendChild(C);c.className="introjs-arrow";F.className="introjs-tooltiptext";F.innerHTML=b.intro;S.className="introjs-bullets";!1===this._options.showBullets&&(S.style.display="none");for(var s=document.createElement("ul"),m=0,aa=this._introItems.length;m<aa;m++){var v=document.createElement("li"),L=document.createElement("a");L.onclick=function(){a.goToStep(this.getAttribute("data-stepnumber"))};m===b.step-1&&(L.className=
"active");L.href="javascript:void(0);";L.innerHTML="&nbsp;";L.setAttribute("data-stepnumber",this._introItems[m].step);v.appendChild(L);s.appendChild(v)}S.appendChild(s);y.className="introjs-progress";!1===this._options.showProgress&&(y.style.display="none");m=document.createElement("div");m.className="introjs-progressbar";m.setAttribute("style","width:"+J.call(this)+"%;");y.appendChild(m);D.className="introjs-tooltipbuttons";!1===this._options.showButtons&&(D.style.display="none");I.className="introjs-tooltip";
I.appendChild(F);I.appendChild(S);I.appendChild(y);!0==this._options.showStepNumbers&&(x=document.createElement("span"),x.className="introjs-helperNumberLayer",x.innerHTML=b.step,C.appendChild(x));I.appendChild(c);C.appendChild(I);H=document.createElement("a");H.onclick=function(){a._introItems.length-1!=a._currentStep&&d.call(a)};H.href="javascript:void(0);";H.innerHTML=this._options.nextLabel;C=document.createElement("a");C.onclick=function(){0!=a._currentStep&&f.call(a)};C.href="javascript:void(0);";
C.innerHTML=this._options.prevLabel;B=document.createElement("a");B.className="introjs-button introjs-skipbutton";B.href="javascript:void(0);";B.innerHTML=this._options.skipLabel;B.onclick=function(){a._introItems.length-1==a._currentStep&&"function"===typeof a._introCompleteCallback&&a._introCompleteCallback.call(a);a._introItems.length-1!=a._currentStep&&"function"===typeof a._introExitCallback&&a._introExitCallback.call(a);h.call(a,a._targetElement)};D.appendChild(B);1<this._introItems.length&&
(D.appendChild(C),D.appendChild(H));I.appendChild(D);g.call(a,b.element,I,c,x)}!0===this._options.disableInteraction&&r.call(a);C.removeAttribute("tabIndex");H.removeAttribute("tabIndex");0==this._currentStep&&1<this._introItems.length?(C.className="introjs-button introjs-prevbutton introjs-disabled",C.tabIndex="-1",H.className="introjs-button introjs-nextbutton",B.innerHTML=this._options.skipLabel):this._introItems.length-1==this._currentStep||1==this._introItems.length?(B.innerHTML=this._options.doneLabel,
C.className="introjs-button introjs-prevbutton",H.className="introjs-button introjs-nextbutton introjs-disabled",H.tabIndex="-1"):(C.className="introjs-button introjs-prevbutton",H.className="introjs-button introjs-nextbutton",B.innerHTML=this._options.skipLabel);H.focus();b.element.className+=" introjs-showElement";x=q(b.element,"position");"absolute"!==x&&"relative"!==x&&(b.element.className+=" introjs-relativePosition");for(x=b.element.parentNode;null!=x&&"body"!==x.tagName.toLowerCase();){c=q(x,
"z-index");I=parseFloat(q(x,"opacity"));D=q(x,"transform")||q(x,"-webkit-transform")||q(x,"-moz-transform")||q(x,"-ms-transform")||q(x,"-o-transform");if(/[0-9]+/.test(c)||1>I||"none"!==D&&void 0!==D)x.className+=" introjs-fixParent";x=x.parentNode}G(b.element)||!0!==this._options.scrollToElement||(I=b.element.getBoundingClientRect(),x=A().height,c=I.bottom-(I.bottom-I.top),I=I.bottom-x,0>c||b.element.clientHeight>x?window.scrollBy(0,c-30):window.scrollBy(0,I+100));"undefined"!==typeof this._introAfterChangeCallback&&
...
b-2;"undefined"!==typeof this._introItems&&d.call(this);return this},nextStep:function(){d.call(this);return this},previousStep:function(){f.call(this);return this},exit:function(){h.call(this,this._targetElement);return this},refresh:function(){p.call(this,document.querySelector(".introjs-helperLayer"));p.call(this,document.querySelector(".introjs-tooltipReferenceLayer"));return this},onbeforechange:function(b){if("function"===typeof b)this._introBeforeChangeCallback=b;else throw Error("Provided callback for onbeforechange was not a function");
...
b=0;for(a=c.length;b<a;b++){var d=c[b];this._introItems.push({element:d,hint:d.getAttribute("data-hint"),hintPosition:d.getAttribute("data-hintPosition")||this._options.hintPosition,tooltipClass:d.getAttribute("data-tooltipClass"),position:d.getAttribute("data-position")||this._options.tooltipPosition})}}x.call(this);document.addEventListener?(document.addEventListener("click",H.bind(this),!1),window.addEventListener("resize",C.bind(this),!0)):document.attachEvent&&(document.attachEvent("onclick",
H.bind(this)),document.attachEvent("onresize",C.bind(this)))}return this}};return b.introJs=y});
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,d,e){for(var f=[],h=0;h<a.length;h++){var g=a[h];if(g){var m=tinycolor(g),l=0.5>m.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l=l+(tinycolor.equals(c,g)?" sp-thumb-active":""),g=m.toString(e.preferredFormat||"rgb"),k=q?"background-color:"+m.toRgbString():"filter:"+m.toFilter();f.push('<span title="'+
g+'" data-color="'+m.toRgbString()+'" class="'+l+'"><span class="sp-thumb-inner" style="'+k+';" /></span>')}else f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",e.noColorSelectedText)).html())}return"<div class='sp-cf "+d+"'>"+f.join("")+"</div>"}function e(a,c){var d=b.extend({},p,a);d.callbacks={move:k(d.move,c),change:k(d.change,c),show:k(d.show,c),hide:k(d.hide,c),beforeShow:k(d.beforeShow,c)};return d}function d(d,
h){function k(){s.showPaletteOnly&&(s.showPalette=!0);Ha.text(s.showPaletteOnly?s.togglePaletteMoreText:s.togglePaletteLessText);if(s.palette){ya=s.palette.slice(0);pa=b.isArray(ya[0])?ya:[ya];za={};for(var a=0;a<pa.length;a++)for(var c=0;c<pa[a].length;c++){var d=tinycolor(pa[a][c]).toRgbString();za[d]=!0}}z.toggleClass("sp-flat",U);z.toggleClass("sp-input-disabled",!s.showInput);z.toggleClass("sp-alpha-enabled",s.showAlpha);z.toggleClass("sp-clear-enabled",fa);z.toggleClass("sp-buttons-disabled",
!s.showButtons);z.toggleClass("sp-palette-buttons-disabled",!s.togglePaletteOnly);z.toggleClass("sp-palette-disabled",!s.showPalette);z.toggleClass("sp-palette-only",s.showPaletteOnly);z.toggleClass("sp-initial-disabled",!s.showInitial);z.addClass(s.className).addClass(s.containerClassName);Q()}function p(){if(w&&window.localStorage){try{var a=window.localStorage[w].split(",#");1<a.length&&(delete window.localStorage[w],b.each(a,function(b,a){x(a)}))}catch(c){}try{V=window.localStorage[w].split(";")}catch(d){}}}
function x(a){if(Z){a=tinycolor(a).toRgbString();if(!za[a]&&-1===b.inArray(a,V))for(V.push(a);V.length>Wa;)V.shift();if(w&&window.localStorage)try{window.localStorage[w]=V.join(";")}catch(c){}}}function S(){var b=[];if(s.showPalette)for(var a=0;a<V.length;a++){var c=tinycolor(V[a]).toRgbString();za[c]||b.push(V[a])}return b.reverse().slice(0,s.maxSelectionSize)}function F(){var a=O(),d=b.map(pa,function(b,d){return c(b,a,"sp-palette-row sp-palette-row-"+d,s)});p();V&&d.push(c(S(),a,"sp-palette-row sp-palette-row-selection",
s));Oa.html(d.join(""))}function t(){if(s.showInitial){var b=ha,a=O();Pa.html(c([b,a],a,"sp-palette-row-initial",s))}}function J(){(0>=T||0>=L||0>=Aa)&&Q();z.addClass(Qa);ba=null;K.trigger("dragstart.spectrum",[O()])}function y(){z.removeClass(Qa);K.trigger("dragstop.spectrum",[O()])}function R(){var b=ca.val();null!==b&&""!==b||!fa?(b=tinycolor(b),b.isValid()?(Y(b),P(!0)):ca.addClass("sp-validation-error")):(Y(null),P(!0))}function ja(){v?ea():ka()}function ka(){var a=b.Event("beforeShow.spectrum");
if(v)Q();else if(K.trigger(a,[O()]),!1!==D.beforeShow(O())&&!a.isDefaultPrevented()){for(a=0;a<r.length;a++)r[a]&&r[a].hide();v=!0;b(Ia).bind("click.spectrum",oa);b(window).bind("resize.spectrum",aa);ma.addClass("sp-active");z.removeClass("sp-hidden");Q();X();ha=O();t();D.show(ha);K.trigger("show.spectrum",[ha])}}function oa(b){2!=b.button&&(Xa?P(!0):Y(ha,!0),ea())}function ea(){v&&!U&&(v=!1,b(Ia).unbind("click.spectrum",oa),b(window).unbind("resize.spectrum",aa),ma.removeClass("sp-active"),z.addClass("sp-hidden"),
D.hide(O()),K.trigger("hide.spectrum",[O()]))}function Y(b,a){if(tinycolor.equals(b,O()))X();else{var c,d;!b&&fa?da=!0:(da=!1,c=tinycolor(b),d=c.toHsv(),qa=d.h%360/360,ra=d.s,sa=d.v,W=d.a);X();c&&(c.isValid()&&!a)&&(ta=Ja||c.getFormat())}}function O(b){b=b||{};return fa&&da?null:tinycolor.fromRatio({h:qa,s:ra,v:sa,a:Math.round(100*W)/100},{format:b.format||ta})}function la(){X();D.move(O());K.trigger("move.spectrum",[O()])}function X(){ca.removeClass("sp-validation-error");E();var b=tinycolor.fromRatio({h:qa,
...
e="linear-gradient(left, "+d+", "+c+")";m?ua.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ua.css("background","-webkit-"+e),ua.css("background","-moz-"+e),ua.css("background","-ms-"+e),ua.css("background","linear-gradient(to right, "+d+", "+c+")"))}c=a.toString(b)}s.showInput&&ca.val(c);s.showPalette&&F();t()}function E(){var b=ra,a=sa;fa&&da?(Ca.hide(),Da.hide(),Ea.hide()):(Ca.show(),Da.show(),Ea.show(),b*=L,a=T-a*T,b=Math.max(-M,Math.min(L-M,b-M)),a=Math.max(-M,Math.min(T-M,a-M)),Ea.css({top:a+
"px",left:b+"px"}),Ca.css({left:W*ia-Ra/2+"px"}),Da.css({top:qa*Aa-Sa+"px"}))}function P(b){var a=O(),c="",d=!tinycolor.equals(a,ha);a&&(c=a.toString(ta),x(a));Fa&&K.val(c);b&&d&&(D.change(a),K.trigger("change",[a]))}function Q(){L=Ba.width();T=Ba.height();M=Ea.height();Ka.width();Aa=Ka.height();Sa=Da.height();ia=Ta.width();Ra=Ca.width();U||(z.css("position","absolute"),s.offset?z.offset(s.offset):z.offset(f(z,va)));E();s.showPalette&&F();K.trigger("reflow.spectrum")}function xa(){ea();La=!0;K.attr("disabled",
!0);va.addClass("sp-disabled")}var s=e(h,d),U=s.flat,Z=s.showSelectionPalette,w=s.localStorageKey,N=s.theme,D=s.callbacks,aa=n(Q,10),v=!1,L=0,T=0,M=0,Aa=0,ia=0,Ra=0,Sa=0,qa=0,ra=0,sa=0,W=1,ya=[],pa=[],za={},V=s.selectionPalette.slice(0),Wa=s.maxSelectionSize,Qa="sp-dragging",ba=null,Ia=d.ownerDocument,K=b(d),La=!1,z=b(G,Ia).addClass(N),Ya=z.find(".sp-picker-container"),Ba=z.find(".sp-color"),Ea=z.find(".sp-dragger"),Ka=z.find(".sp-hue"),Da=z.find(".sp-slider"),ua=z.find(".sp-alpha-inner"),Ta=z.find(".sp-alpha"),
Ca=z.find(".sp-alpha-handle"),ca=z.find(".sp-input"),Oa=z.find(".sp-palette"),Pa=z.find(".sp-initial"),Ua=z.find(".sp-cancel"),Ma=z.find(".sp-clear"),Va=z.find(".sp-choose"),Ha=z.find(".sp-palette-toggle"),Fa=K.is("input"),Za=Fa&&u&&"color"===K.attr("type"),Na=Fa&&!U,ma=Na?b(A).addClass(N).addClass(s.className).addClass(s.replacerClassName):b([]),va=Na?ma:K,na=ma.find(".sp-preview-inner"),wa=s.color||Fa&&K.val(),ha=!1,Ja=s.preferredFormat,ta=Ja,Xa=!s.showButtons||s.clickoutFiresChange,da=!wa,fa=s.allowEmpty&&
!Za;(function(){function a(c){c.data&&c.data.ignore?(Y(b(c.target).closest(".sp-thumb-el").data("color")),la()):(Y(b(c.target).closest(".sp-thumb-el").data("color")),la(),P(!0),s.hideAfterPaletteSelect&&ea());return!1}m&&z.find("*:not(input)").attr("unselectable","on");k();Na&&K.after(ma).hide();fa||Ma.hide();if(U)K.after(z).hide();else{var c="parent"===s.appendTo?K.parent():b(s.appendTo);1!==c.length&&(c=b("body"));c.append(z)}p();va.bind("click.spectrum touchstart.spectrum",function(a){La||ja();
a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(K.is(":disabled")||!0===s.disabled)&&xa();z.click(g);ca.change(R);ca.bind("paste",function(){setTimeout(R,1)});ca.keydown(function(b){13==b.keyCode&&R()});Ua.text(s.cancelText);Ua.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();Y(ha,!0);ea()});Ma.attr("title",s.clearText);Ma.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();da=!0;la();U&&P(!0)});Va.text(s.chooseText);Va.bind("click.spectrum",
function(b){b.stopPropagation();b.preventDefault();ca.hasClass("sp-validation-error")||(P(!0),ea())});Ha.text(s.showPaletteOnly?s.togglePaletteMoreText:s.togglePaletteLessText);Ha.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();s.showPaletteOnly=!s.showPaletteOnly;s.showPaletteOnly||U||z.css("left","-="+(Ya.outerWidth(!0)+5));k()});l(Ta,function(b,a,c){W=b/ia;da=!1;c.shiftKey&&(W=Math.round(10*W)/10);la()},J,y);l(Ka,function(b,a){qa=parseFloat(a/Aa);da=!1;s.showAlpha||(W=
1);la()},J,y);l(Ba,function(b,a,c){c.shiftKey?ba||(c=T-sa*T,ba=Math.abs(b-ra*L)>Math.abs(a-c)?"x":"y"):ba=null;c=!ba||"y"===ba;ba&&"x"!==ba||(ra=parseFloat(b/L));c&&(sa=parseFloat((T-a)/T));da=!1;s.showAlpha||(W=1);la()},J,y);wa?(Y(wa),X(),ta=Ja||tinycolor(wa).format,x(wa)):X();U&&ka();c=m?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Oa.delegate(".sp-thumb-el",c,a);Pa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},a)})();var Ga={show:ka,hide:ea,toggle:ja,reflow:Q,option:function(c,
d){if(c===a)return b.extend({},s);if(d===a)return s[c];s[c]=d;k()},enable:function(){La=!1;K.attr("disabled",!1);va.removeClass("sp-disabled")},disable:xa,offset:function(b){s.offset=b;Q()},set:function(b){Y(b);P()},get:O,destroy:function(){K.show();va.unbind("click.spectrum touchstart.spectrum");z.remove();ma.remove();r[Ga.id]=null},container:z};Ga.id=r.push(Ga)-1;return Ga}function f(a,c){var d=a.outerWidth(),e=a.outerHeight(),f=c.outerHeight(),h=a[0].ownerDocument,g=h.documentElement,q=g.clientWidth+
b(h).scrollLeft(),h=g.clientHeight+b(h).scrollTop(),g=c.offset();g.top+=f;g.left-=Math.min(g.left,g.left+d>q&&q>d?Math.abs(g.left+d-q):0);g.top-=Math.min(g.top,g.top+e>h&&h>e?Math.abs(e+f-0):0);return g}function h(){}function g(b){b.stopPropagation()}function k(b,a){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return b.apply(a,d.concat(c.call(arguments)))}}function l(a,c,d,e){function f(b){b.stopPropagation&&b.stopPropagation();b.preventDefault&&b.preventDefault();b.returnValue=
!1}function h(b){if(l){if(m&&9>q.documentMode&&!b.button)return g();var d=b.originalEvent&&b.originalEvent.touches,e=d?d[0].pageY:b.pageY,d=Math.max(0,Math.min((d?d[0].pageX:b.pageX)-k.left,n)),e=Math.max(0,Math.min(e-k.top,p));u&&f(b);c.apply(a,[d,e,b])}}function g(){l&&(b(q).unbind(G),b(q.body).removeClass("sp-dragging"),e.apply(a,arguments));l=!1}c=c||function(){};d=d||function(){};e=e||function(){};var q=document,l=!1,k={},p=0,n=0,u="ontouchstart"in window,G={};G.selectstart=f;G.dragstart=f;G["touchmove mousemove"]=
h;G["touchend mouseup"]=g;b(a).bind("touchstart mousedown",function(c){(c.which?3==c.which:2==c.button)||l||!1===d.apply(a,arguments)||(l=!0,p=b(a).height(),n=b(a).width(),k=b(a).offset(),b(q).bind(G),b(q.body).addClass("sp-dragging"),u||h(c),f(c))})}function n(b,a,c){var d;return function(){var e=this,f=arguments,h=function(){d=null;b.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(h,a)}}var p={beforeShow:h,move:h,change:h,show:h,hide:h,color:!1,flat:!1,showInput:!1,allowEmpty:!1,showButtons:!0,
...
l;b.fn.spectrum.defaults=p;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){u||b("input[type=color]").spectrum({preferredFormat:"hex6"})};(function(){function b(a,c,d){a=E(a,255);c=E(c,255);d=E(d,255);var e=D(a,c,d),f=N(a,c,d),h,g=(e+f)/2;if(e==f)h=f=0;else{var q=e-f,f=0.5<g?q/(2-e-f):q/(e+f);switch(e){case a:h=(c-d)/q+(c<d?6:0);break;case c:h=(d-a)/q+2;break;case d:h=(a-c)/q+4}h/=6}return{h:h,s:f,l:g}}function a(b,c,d){function e(b,
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=E(b,360);c=E(c,100);d=E(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,h=2*d-f;d=e(h,f,b+1/3);c=e(h,f,b);b=e(h,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=E(b,255);a=E(a,255);d=E(d,255);var e=D(b,a,d),f=N(b,a,d),h,g=e-f;if(e==f)h=0;else{switch(e){case b:h=(a-d)/g+(a<d?6:0);break;case a:h=(d-b)/g+2;break;case d:h=(b-a)/g+4}h/=6}return{h:h,s:0===e?0:g/e,v:e}}function d(b,a,c,e){b=[P(w(b).toString(16)),
P(w(a).toString(16)),P(w(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[P(Math.round(255*parseFloat(d)).toString(16)),P(w(b).toString(16)),P(w(a).toString(16)),P(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s-=a/100;c.s=N(1,D(0,c.s));return v(c)}function h(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s+=a/100;
c.s=N(1,D(0,c.s));return v(c)}function g(b){return v(b).desaturate(100)}function q(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l+=a/100;c.l=N(1,D(0,c.l));return v(c)}function m(b,a){a=0===a?0:a||10;var c=v(b).toRgb();c.r=D(0,N(255,c.r-w(255*-(a/100))));c.g=D(0,N(255,c.g-w(255*-(a/100))));c.b=D(0,N(255,c.b-w(255*-(a/100))));return v(c)}function l(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l-=a/100;c.l=N(1,D(0,c.l));return v(c)}function k(b,a){var c=v(b).toHsl(),d=(w(c.h)+a)%360;c.h=0>d?360+d:d;return v(c)}
function p(b){b=v(b).toHsl();b.h=(b.h+180)%360;return v(b)}function n(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+120)%360,s:a.s,l:a.l}),v({h:(c+240)%360,s:a.s,l:a.l})]}function u(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+90)%360,s:a.s,l:a.l}),v({h:(c+180)%360,s:a.s,l:a.l}),v({h:(c+270)%360,s:a.s,l:a.l})]}function G(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+72)%360,s:a.s,l:a.l}),v({h:(c+216)%360,s:a.s,l:a.l})]}function A(b,a,c){a=a||6;c=c||30;var d=v(b).toHsl();c=360/c;b=[v(b)];for(d.h=
(d.h-(c*a>>1)+720)%360;--a;)d.h=(d.h+c)%360,b.push(v(d));return b}function r(b,a){a=a||6;for(var c=v(b).toHsv(),d=c.h,e=c.s,c=c.v,f=[],h=1/a;a--;)f.push(v({h:d,s:e,v:c})),c=(c+h)%1;return f}function X(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function E(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=N(a,D(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>Z.abs(b-a)?1:b%a/parseFloat(a)}function P(b){return 1==
b.length?"0"+b:""+b}function Q(b){1>=b&&(b=100*b+"%");return b}var xa=/^[\s,#]+/,s=/\s+$/,U=0,Z=Math,w=Z.round,N=Z.min,D=Z.max,aa=Z.random,v=function ia(b,c){var d,e,f,h,g;b=b?b:"";c=c||{};if(b instanceof ia)return b;if(!(this instanceof ia))return new ia(b,c);e=b;g={r:0,g:0,b:0};var q=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(xa,"").replace(s,"").toLowerCase();var m=!1;if(L[e])e=L[e],m=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(h=M.rgb.exec(e))?{r:h[1],g:h[2],b:h[3]}:
(h=M.rgba.exec(e))?{r:h[1],g:h[2],b:h[3],a:h[4]}:(h=M.hsl.exec(e))?{h:h[1],s:h[2],l:h[3]}:(h=M.hsla.exec(e))?{h:h[1],s:h[2],l:h[3],a:h[4]}:(h=M.hsv.exec(e))?{h:h[1],s:h[2],v:h[3]}:(h=M.hsva.exec(e))?{h:h[1],s:h[2],v:h[3],a:h[4]}:(h=M.hex8.exec(e))?{a:parseInt(h[1],16)/255,r:parseInt(h[2],16),g:parseInt(h[3],16),b:parseInt(h[4],16),format:m?"name":"hex8"}:(h=M.hex6.exec(e))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16),format:m?"name":"hex"}:(h=M.hex3.exec(e))?{r:parseInt(h[1]+""+h[1],
16),g:parseInt(h[2]+""+h[2],16),b:parseInt(h[3]+""+h[3],16),format:m?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))g={r:255*E(e.r,255),g:255*E(e.g,255),b:255*E(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=Q(e.s);e.v=Q(e.v);f=e.h;m=e.s;g=e.v;f=6*E(f,360);m=E(m,100);g=E(g,100);d=Z.floor(f);var l=f-d;f=g*(1-m);h=g*(1-l*m);m=g*(1-(1-l)*m);d%=6;
g={r:255*[g,h,f,f,m,g][d],g:255*[m,g,g,h,f,f][d],b:255*[f,f,m,g,g,h][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=Q(e.s),e.l=Q(e.l),g=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(q=e.a)}q=X(q);e=e.format||f;f=N(255,D(g.r,0));h=N(255,D(g.g,0));g=N(255,D(g.b,0));this._originalInput=b;this._r=f;this._g=h;this._b=g;this._a=q;this._roundA=w(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
1>this._g&&(this._g=w(this._g));1>this._b&&(this._b=w(this._b));this._ok=d;this._tc_id=U++};v.prototype={isDark:function(){return 128>this.getBrightness()},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var b=this.toRgb();return(299*b.r+587*b.g+114*b.b)/1E3},setAlpha:function(b){this._a=X(b);this._roundA=w(100*
...
brighten:function(){return this._applyModification(m,arguments)},darken:function(){return this._applyModification(l,arguments)},desaturate:function(){return this._applyModification(f,arguments)},saturate:function(){return this._applyModification(h,arguments)},greyscale:function(){return this._applyModification(g,arguments)},spin:function(){return this._applyModification(k,arguments)},_applyCombination:function(b,a){return b.apply(null,[this].concat([].slice.call(a)))},analogous:function(){return this._applyCombination(A,
arguments)},complement:function(){return this._applyCombination(p,arguments)},monochromatic:function(){return this._applyCombination(r,arguments)},splitcomplement:function(){return this._applyCombination(G,arguments)},triad:function(){return this._applyCombination(n,arguments)},tetrad:function(){return this._applyCombination(u,arguments)}};v.fromRatio=function(b,a){if("object"==typeof b){var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]="a"===d?b[d]:Q(b[d]));b=c}return v(b,a)};v.equals=function(b,
a){return b&&a?v(b).toRgbString()==v(a).toRgbString():!1};v.random=function(){return v.fromRatio({r:aa(),g:aa(),b:aa()})};v.mix=function(b,a,c){c=0===c?0:c||50;b=v(b).toRgb();a=v(a).toRgb();c/=100;var d=2*c-1,e=a.a-b.a,d=((-1==d*e?d:(d+e)/(1+d*e))+1)/2,e=1-d;return v({r:a.r*d+b.r*e,g:a.g*d+b.g*e,b:a.b*d+b.b*e,a:a.a*c+b.a*(1-c)})};v.readability=function(b,a){var c=v(b),d=v(a),e=c.toRgb(),f=d.toRgb(),c=c.getBrightness(),d=d.getBrightness(),e=Math.max(e.r,f.r)-Math.min(e.r,f.r)+Math.max(e.g,f.g)-Math.min(e.g,
f.g)+Math.max(e.b,f.b)-Math.min(e.b,f.b);return{brightness:Math.abs(c-d),color:e}};v.isReadable=function(b,a){var c=v.readability(b,a);return 125<c.brightness&&500<c.color};v.mostReadable=function(b,a){for(var c=null,d=0,e=!1,f=0;f<a.length;f++){var h=v.readability(b,a[f]),g=125<h.brightness&&500<h.color,h=3*(h.brightness/125)+h.color/500;if(g&&!e||g&&e&&h>d||!g&&!e&&h>d)e=g,d=h,c=v(a[f])}return c};var L=v.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",
...
c.execute()};
Paint.prototype.drawPath=function(b,a,c){a=a||this.pathContext;if(b.points&&b.points[0])if(c)this.drawPathTiledCanvas(b,a,c);else{a.beginPath();c=b.points[0][0]-this.public.leftTopX;var e=b.points[0][1]-this.public.leftTopY;a.moveTo(c*this.public.zoom,e*this.public.zoom);for(var d=Infinity,f=-Infinity,h=1;h<b.points.length;h++)c=b.points[h][0]-this.public.leftTopX,e=b.points[h][1]-this.public.leftTopY,a.lineTo(c*this.public.zoom,e*this.public.zoom),c<d&&(d=c),c>f&&(f=c);if("gradient"==b.color.type){c=
...
b.lastZoomPoint[0]/b.local.zoom),f=Math.round(b.local.leftTopY+b.lastZoomPoint[1]/b.local.zoom),h=Math.round(b.local.leftTopX+e[0]/b.local.zoom),g=Math.round(b.local.leftTopY+e[1]/b.local.zoom),c=Math.min(d,h),k=Math.min(f,g),d=Math.abs(d-h),f=Math.abs(f-g),g=Math.min(b.canvasArray[0].width/d,b.canvasArray[1].height/f),d=(b.canvasArray[0].width-g*d)/2,f=(b.canvasArray[1].height-g*f)/2;b.zoomAbsolute(g);b.goto(c-d/g,k-f/g);delete b.lastZoomPoint;b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,
b.effectsCanvas.height)}"mousemove"!=a.type&&"touchmove"!=a.type||!b.lastZoomPoint||(b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,b.effectsCanvas.height),d=e[0],f=e[1],h=b.lastZoomPoint[0],g=b.lastZoomPoint[1],c=Math.min(d,h),k=Math.min(f,g),d=Math.abs(d-h),f=Math.abs(f-g),e=b.effectsCanvasCtx,e.beginPath(),"function"==typeof e.setLineDash&&e.setLineDash([6]),e.rect(c,k,d,f),e.lineWidth=3,e.strokeStyle="gray",e.stroke())}},select:function(b,a){if("remove"==a)delete b.lastSelectPoint,b.effectsCanvas.style.cursor=
...
c[0]/b.local.zoom),h=Math.round(b.local.leftTopY+c[1]/b.local.zoom);b.dispatchEvent({type:"select",from:[e,d],to:[f,h]});delete b.lastSelectPoint;b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,b.effectsCanvas.height)}if(("mousemove"==a.type||"touchmove"==a.type)&&b.lastSelectPoint){b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,b.effectsCanvas.height);var e=c[0],d=c[1],f=b.lastSelectPoint[0],h=b.lastSelectPoint[1],c=Math.min(e,f),g=Math.min(d,h),e=Math.abs(e-f),d=Math.abs(d-h),h=b.effectsCanvasCtx;
h.beginPath();"function"==typeof h.setLineDash&&h.setLineDash([4]);h.rect(c,g,e,d);h.lineWidth=2;h.strokeStyle="darkgray";h.stroke()}}},grab:function(b,a){if("remove"==a||"mouseup"==a.type||"touchend"==a.type||"mouseleave"===a.type)delete b.lastGrabCoords,b.effectsCanvas.style.cursor="";else{var c=b.getCoords(a),c=b.scaledCoords(c,a);b.lastGrabCoords||"mousedown"!=a.type&&"touchstart"!=a.type||(b.lastGrabCoords=c,b.effectsCanvas.style.cursor="move");"mousemove"!=a.type&&"touchmove"!=a.type||!b.lastGrabCoords||
...
2),16)<<24-4*(d%8);return new h.init(c,a/2)}},l=g.Latin1={stringify:function(b){var a=b.words;b=b.sigBytes;for(var c=[],d=0;d<b;d++)c.push(String.fromCharCode(a[d>>>2]>>>24-8*(d%4)&255));return c.join("")},parse:function(b){for(var a=b.length,c=[],d=0;d<a;d++)c[d>>>2]|=(b.charCodeAt(d)&255)<<24-8*(d%4);return new h.init(c,a)}},n=g.Utf8={stringify:function(b){try{return decodeURIComponent(escape(l.stringify(b)))}catch(a){throw Error("Malformed UTF-8 data");}},parse:function(b){return l.parse(unescape(encodeURIComponent(b)))}},
p=e.BufferedBlockAlgorithm=f.extend({reset:function(){this._data=new h.init;this._nDataBytes=0},_append:function(b){"string"==typeof b&&(b=n.parse(b));this._data.concat(b);this._nDataBytes+=b.sigBytes},_process:function(a){var c=this._data,d=c.words,e=c.sigBytes,f=this.blockSize,g=e/(4*f),g=a?b.ceil(g):b.max((g|0)-this._minBufferSize,0);a=g*f;e=b.min(4*a,e);if(a){for(var l=0;l<a;l+=f)this._doProcessBlock(d,l);l=d.splice(0,a);c.sigBytes-=e}return new h.init(l,e)},clone:function(){var b=f.clone.call(this);
b._data=this._data.clone();return b},_minBufferSize:0});e.Hasher=p.extend({cfg:f.extend(),init:function(b){this.cfg=this.cfg.extend(b);this.reset()},reset:function(){p.reset.call(this);this._doReset()},update:function(b){this._append(b);this._process();return this},finalize:function(b){b&&this._append(b);return this._doFinalize()},blockSize:16,_createHelper:function(b){return function(a,c){return(new b.init(c)).finalize(a)}},_createHmacHelper:function(b){return function(a,c){return(new r.HMAC.init(b,
c)).finalize(a)}}});var r=c.algo={};return c}(Math);
(function(b){for(var a=CryptoJS,c=a.lib,e=c.WordArray,d=c.Hasher,c=a.algo,f=[],h=[],g=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var n;a:{n=k;for(var p=b.sqrt(n),r=2;r<=p;r++)if(!(n%r)){n=!1;break a}n=!0}n&&(8>l&&(f[l]=g(b.pow(k,0.5))),h[l]=g(b.pow(k,1/3)),l++);k++}var m=[],c=c.SHA256=d.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,d=c[0],e=c[1],f=c[2],g=c[3],l=c[4],k=c[5],p=c[6],n=c[7],r=0;64>r;r++){if(16>r)m[r]=
b[a+r]|0;else{var J=m[r-15],y=m[r-2];m[r]=((J<<25|J>>>7)^(J<<14|J>>>18)^J>>>3)+m[r-7]+((y<<15|y>>>17)^(y<<13|y>>>19)^y>>>10)+m[r-16]}J=n+((l<<26|l>>>6)^(l<<21|l>>>11)^(l<<7|l>>>25))+(l&k^~l&p)+h[r]+m[r];y=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);n=p;p=k;k=l;l=g+J|0;g=f;f=e;e=d;d=J+y|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+g|0;c[4]=c[4]+l|0;c[5]=c[5]+k|0;c[6]=c[6]+p|0;c[7]=c[7]+n|0},_doFinalize:function(){var a=this._data,c=a.words,d=8*this._nDataBytes,e=8*a.sigBytes;
...
function(c){localStorage.setItem("quicksettings-"+b.title,c.index||c.value)})},addRange:function(b,c,e,d,f,h){var g=this._createContainer(),k=document.createElement("input");k.type="range";k.id=b;k.min=c||0;k.max=e||100;k.step=f||1;k.value=d||0;k.className="msettings_range";var l=this._createLabel("<b>"+b+":</b> "+k.value);g.appendChild(l);g.appendChild(k);this._content.appendChild(g);this._controls[b]={container:g,control:k,label:l,callback:h};c="input";this._isIE()&&(c="change");var n=this._globalChangeHandler,
p=this;k.addEventListener(c,function(){l.innerHTML="<b>"+b+":</b> "+k.value;h&&h(parseFloat(k.value));n&&n();p._callCallbacks(b,{value:parseFloat(k.value)})})},_isIE:function(){return-1!=navigator.userAgent.indexOf("rv:11")||-1!=navigator.userAgent.indexOf("MSIE")?!0:!1},getRangeValue:function(b){return this._controls[b].control.value},setRangeValue:function(b,c,e){var d=this._controls[b];d.control.value=c;d.label.innerHTML="<b>"+b+":</b> "+d.control.value;e&&(d.callback&&d.callback(parseFloat(d.control.value)),
this._globalChangeHandler&&this._globalChangeHandler())},setRangeParameters:function(b,c,e,d){b=this._controls[b];b.control.min=c;b.control.max=e;b.control.step=d},bindBoolean:function(b,c,e){this.addBoolean(b,c,function(c){e[b]=c})},addBoolean:function(b,c,e){var d=this._createContainer(),f=document.createElement("span");f.className="msettings_checkbox_label";f.textContent=b;var h=document.createElement("input");h.type="checkbox";h.id=b;h.checked=c;h.className="msettings_checkbox";d.appendChild(h);
d.appendChild(f);this._content.appendChild(d);this._controls[b]={container:d,control:h,callback:e};var g=this._globalChangeHandler,k=this;h.addEventListener("change",function(){e&&e(h.checked);g&&g();k._callCallbacks(b,{value:h.checked})});f.addEventListener("click",function(){h.disabled||(h.checked=!h.checked,e&&e(h.checked),g&&g(),k._callCallbacks(b,{value:h.checked}))})},getBoolean:function(b){return this._controls[b].control.checked},setBoolean:function(b,c,e){this._controls[b].control.checked=
c;e&&(this._controls[b].callback&&this._controls[b].callback(c),this._globalChangeHandler&&this._globalChangeHandler(),this._callCallbacks(b,{value:c}))},addButton:function(b,c){var e=this._createContainer(),d=document.createElement("input");d.type="button";d.id=b;d.value=b;d.className="msettings_button";e.appendChild(d);this._content.appendChild(e);this._controls[b]={container:e,control:d};var f=this._globalChangeHandler,h=this;d.addEventListener("click",function(){c&&c(d);f&&f();h._callCallbacks(b,
{button:d})})},bindColor:function(b,c,e){this.addColor(b,c,function(c){e[b]=c})},addColor:function(b,c,e){var d=this._createContainer(),f=this._createLabel("<b>"+b+":</b> "+c),h=document.createElement("input");try{h.type="color"}catch(g){h.type="text"}h.id=b;h.value=c||"#ff0000";h.className="msettings_color";d.appendChild(f);d.appendChild(h);this._content.appendChild(d);this._controls[b]={container:d,control:h,label:f,callback:e};var k=this._globalChangeHandler,l=this;h.addEventListener("input",function(){f.innerHTML=
"<b>"+b+":</b> "+h.value;e&&e(h.value);k&&k();l._callCallbacks(b,{value:h.value})})},getColor:function(b){return this._controls[b].control.value},setColor:function(b,c,e){var d=this._controls[b];d.control.value=c;d.label.innerHTML="<b>"+b+":</b> "+d.control.value;e&&(d.callback&&d.callback(d.control.value),this._globalChangeHandler&&this._globalChangeHandler(),this._callCallbacks(b,{value:c}))},bindText:function(b,c,e){this.addText(b,c,function(c){e[b]=c})},addText:function(b,c,e){var d=this._createContainer(),
f=this._createLabel("<b>"+b+"</b>"),h=document.createElement("input");h.type="text";h.id=b;h.value=c||"";h.className="msettings_text_input";d.appendChild(f);d.appendChild(h);this._content.appendChild(d);this._controls[b]={container:d,control:h,label:f,callback:e};var g=this._globalChangeHandler,k=this;h.addEventListener("input",function(){e&&e(h.value);g&&g();k._callCallbacks(b,{value:h.value})})},addTextArea:function(b,c,e){var d=this._createContainer(),f=this._createLabel("<b>"+b+"</b>"),h=document.createElement("textarea");
h.id=b;h.rows=5;h.value=c||"";h.className="msettings_textarea";d.appendChild(f);d.appendChild(h);this._content.appendChild(d);this._controls[b]={container:d,control:h,label:f,callback:e};var g=this._globalChangeHandler,k=this;h.addEventListener("input",function(){e&&e(h.value);g&&g();k._callCallbacks(b,{value:h.value})})},setTextAreaRows:function(b,c){this._controls[b].control.rows=c},getText:function(b){return this._controls[b].control.value},setText:function(b,c,e){var d=this._controls[b];d.control.value=
c;e&&(d.callback&&d.callback(c),this._globalChangeHandler&&this._globalChangeHandler(),this._callCallbacks(b,{value:c}))},addInfo:function(b,c){var e=this._createContainer();e.innerHTML=c;this._controls[b]={container:e};this._content.appendChild(e)},bindDropDown:function(b,c,e){this.addDropDown(b,c,function(c){e[b]=c.value})},addDropDown:function(b,c,e,d){for(var f=this._createContainer(),h=this._createLabel("<b>"+b+"</b>"),g=document.createElement("select"),k=0;k<c.length;k++){var l=document.createElement("option");
l.label=c[k];g.add(l)}d&&(g.selectedIndex=d);var n=this._globalChangeHandler,p=this;g.addEventListener("change",function(){var c=g.selectedIndex,d=g.options;e&&e({index:c,value:d[c].label});n&&n();p._callCallbacks(b,{index:c,value:d[c].label})});g.className="msettings_select";f.appendChild(h);f.appendChild(g);this._content.appendChild(f);this._controls[b]={container:f,control:g,label:h,callback:e}},getDropDownValue:function(b){b=this._controls[b].control;var c=b.selectedIndex;return{index:c,value:b.options[c].label}},
...
eventType:function(b){return{down:g.hasTouch?"touchstart":"mousedown",move:g.hasTouch?"touchmove":"mousemove",up:g.hasTouch?"touchend":"mouseup",out:g.hasTouch?"touchcancel":"mouseout"}[b]},page:function(b,a){return g.hasTouch&&a.touches.length&&a.touches[0]?a.touches[0]["page"+b]:a["page"+b]},klass:{has:function(b,a){return-1!==b.className.indexOf(a)},add:function(b,a){!g.klass.has(b,a)&&d.addBodyClasses&&(b.className+=" "+a)},remove:function(b,a){d.addBodyClasses&&(b.className=b.className.replace(a,
...
10)}},easeCallback:function(){d.element.style[f.vendor+"Transition"]="";f.translation=k.translate.get.matrix(4);f.easing=!1;clearInterval(f.animatingInterval);0===f.easingTo&&(g.klass.remove(a.body,"snapjs-right"),g.klass.remove(a.body,"snapjs-left"));g.dispatchEvent("animated");g.events.removeEvent(d.element,g.transitionCallback(),k.translate.easeCallback)},easeTo:function(b){g.canTransform()?(f.easing=!0,f.easingTo=b,d.element.style[f.vendor+"Transition"]="all "+d.transitionSpeed+"s "+d.easing,
f.animatingInterval=setInterval(function(){g.dispatchEvent("animating")},1),g.events.addEvent(d.element,g.transitionCallback(),k.translate.easeCallback)):f.translation=b;k.translate.x(b);0===b&&(d.element.style[f.vendor+"Transform"]="")},x:function(c){if(!("left"===d.disable&&0<c||"right"===d.disable&&0>c)){if(!d.hyperextensible)if(c===d.maxPosition||c>d.maxPosition)c=d.maxPosition;else if(c===d.minPosition||c<d.minPosition)c=d.minPosition;c=parseInt(c,10);isNaN(c)&&(c=0);g.canTransform()?d.element.style[f.vendor+
"Transform"]="translate3d("+c+"px, 0,0)":(d.element.style.width=(b.innerWidth||a.documentElement.clientWidth)+"px",d.element.style.left=c+"px",d.element.style.right="")}}},drag:{listen:function(){f.translation=0;f.easing=!1;g.events.addEvent(d.element,g.eventType("down"),k.drag.startDrag);g.events.addEvent(d.element,g.eventType("move"),k.drag.dragging);g.events.addEvent(d.element,g.eventType("up"),k.drag.endDrag)},stopListening:function(){g.events.removeEvent(d.element,g.eventType("down"),k.drag.startDrag);
g.events.removeEvent(d.element,g.eventType("move"),k.drag.dragging);g.events.removeEvent(d.element,g.eventType("up"),k.drag.endDrag)},startDrag:function(b){var a=b.target?b.target:b.srcElement;if(g.parentUntil(a,"data-snap-ignore"))g.dispatchEvent("ignore");else if(!d.dragger||g.parentUntil(a,d.dragger)||f.translation===d.minPosition||f.translation===d.maxPosition)g.dispatchEvent("start"),d.element.style[f.vendor+"Transition"]="",f.isDragging=!0,f.hasIntent=null,f.intentChecked=!1,f.startDragX=g.page("X",
b),f.startDragY=g.page("Y",b),f.dragWatchers={current:0,last:0,hold:0,state:""},f.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(b){if(f.isDragging&&d.touchToDrag){var c=g.page("X",b),e=g.page("Y",b),h=f.translation,m=k.translate.get.matrix(4),q=c-f.startDragX,u=0<m,A=q;if(!f.intentChecked||f.hasIntent){d.addBodyClasses&&(0<m?(g.klass.add(a.body,"snapjs-left"),g.klass.remove(a.body,
"snapjs-right")):0>m&&(g.klass.add(a.body,"snapjs-right"),g.klass.remove(a.body,"snapjs-left")));if(!1===f.hasIntent||null===f.hasIntent){var e=g.angleOfDrag(c,e),G=0<=e&&e<=d.slideIntent||360>=e&&e>360-d.slideIntent;f.hasIntent=180<=e&&e<=180+d.slideIntent||180>=e&&e>=180-d.slideIntent||G?!0:!1;f.intentChecked=!0}d.minDragDistance>=Math.abs(c-f.startDragX)||!1===f.hasIntent||(g.events.prevent(b),g.dispatchEvent("drag"),f.dragWatchers.current=c,f.dragWatchers.last>c?("left"!==f.dragWatchers.state&&
(f.dragWatchers.state="left",f.dragWatchers.hold=c),f.dragWatchers.last=c):f.dragWatchers.last<c&&("right"!==f.dragWatchers.state&&(f.dragWatchers.state="right",f.dragWatchers.hold=c),f.dragWatchers.last=c),u?(d.maxPosition<m&&(b=(m-d.maxPosition)*d.resistance,A=q-b),f.simpleStates={opening:"left",towards:f.dragWatchers.state,hyperExtending:d.maxPosition<m,halfway:m>d.maxPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:m,relative:q,sinceDirectionChange:f.dragWatchers.current-
f.dragWatchers.hold,percentage:100*(m/d.maxPosition)}}):(d.minPosition>m&&(b=(m-d.minPosition)*d.resistance,A=q-b),f.simpleStates={opening:"right",towards:f.dragWatchers.state,hyperExtending:d.minPosition>m,halfway:m<d.minPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:m,relative:q,sinceDirectionChange:f.dragWatchers.current-f.dragWatchers.hold,percentage:100*(m/d.minPosition)}}),k.translate.x(A+h))}}},endDrag:function(b){if(f.isDragging){g.dispatchEvent("end");
var a=k.translate.get.matrix(4);0===f.dragWatchers.current&&0!==a&&d.tapToClose?(g.dispatchEvent("close"),g.events.prevent(b),k.translate.easeTo(0),f.isDragging=!1,f.startDragX=0):("left"===f.simpleStates.opening?f.simpleStates.halfway||f.simpleStates.hyperExtending||f.simpleStates.flick?f.simpleStates.flick&&"left"===f.simpleStates.towards?k.translate.easeTo(0):(f.simpleStates.flick&&"right"===f.simpleStates.towards||f.simpleStates.halfway||f.simpleStates.hyperExtending)&&k.translate.easeTo(d.maxPosition):
k.translate.easeTo(0):"right"===f.simpleStates.opening&&(f.simpleStates.halfway||f.simpleStates.hyperExtending||f.simpleStates.flick?f.simpleStates.flick&&"right"===f.simpleStates.towards?k.translate.easeTo(0):(f.simpleStates.flick&&"left"===f.simpleStates.towards||f.simpleStates.halfway||f.simpleStates.hyperExtending)&&k.translate.easeTo(d.minPosition):k.translate.easeTo(0)),f.isDragging=!1,f.startDragX=g.page("X",b))}}}};this.open=function(b){g.dispatchEvent("open");g.klass.remove(a.body,"snapjs-expand-left");
g.klass.remove(a.body,"snapjs-expand-right");"left"===b?(f.simpleStates.opening="left",f.simpleStates.towards="right",g.klass.add(a.body,"snapjs-left"),g.klass.remove(a.body,"snapjs-right"),k.translate.easeTo(d.maxPosition)):"right"===b&&(f.simpleStates.opening="right",f.simpleStates.towards="left",g.klass.remove(a.body,"snapjs-left"),g.klass.add(a.body,"snapjs-right"),k.translate.easeTo(d.minPosition))};this.close=function(){g.dispatchEvent("close");k.translate.easeTo(0)};this.expand=function(c){var d=
b.innerWidth||a.documentElement.clientWidth;"left"===c?(g.dispatchEvent("expandLeft"),g.klass.add(a.body,"snapjs-expand-left"),g.klass.remove(a.body,"snapjs-expand-right")):(g.dispatchEvent("expandRight"),g.klass.add(a.body,"snapjs-expand-right"),g.klass.remove(a.body,"snapjs-expand-left"),d*=-1);k.translate.easeTo(d)};this.on=function(b,a){h[b]=a;return this};this.off=function(b){h[b]&&(h[b]=!1)};this.enable=function(){g.dispatchEvent("enable");k.drag.listen()};this.disable=function(){g.dispatchEvent("disable");
k.drag.stopListening()};this.settings=function(b){g.deepExtend(d,b)};this.state=function(){var b=k.translate.get.matrix(4);return{state:b===d.maxPosition?"left":b===d.minPosition?"right":"closed",info:f.simpleStates}};c.element&&(g.deepExtend(d,c),f.vendor=g.vendor(),k.drag.listen())};"undefined"!==typeof module&&module.exports&&(module.exports=c);"undefined"===typeof ender&&(this.Snap=c);"function"===typeof define&&define.amd&&define("snap",[],function(){return c})}).call(this,window,document);!function(b){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=b();else if("function"==typeof define&&define.amd)define([],b);else{var a;"undefined"!=typeof window?a=window:"undefined"!=typeof global?a=global:"undefined"!=typeof self&&(a=self);a.io=b()}}(function(){return function a(c,e,d){function f(g,l){if(!e[g]){if(!c[g]){var n="function"==typeof require&&require;if(!l&&n)return n(g,!0);if(h)return h(g,!0);throw Error("Cannot find module '"+g+"'");}n=e[g]={exports:{}};c[g][0].call(n.exports,
function(a){var d=c[g][1][a];return f(d?d:a)},n,n.exports,a,c,e,d)}return e[g].exports}for(var h="function"==typeof require&&require,g=0;g<d.length;g++)f(d[g]);return f}({1:[function(a,c,e){c.exports=a("./lib/")},{"./lib/":2}],2:[function(a,c,e){function d(a,c){"object"==typeof a&&(c=a,a=void 0);c=c||{};var d=f(a),e=d.source,h=d.id;c.forceNew||c["force new connection"]||!1===c.multiplex?(k("ignoring socket cache for %s",e),e=g(e,c)):(l[h]||(k("new io instance for %s",e),l[h]=g(e,c)),e=l[h]);return e.socket(d.path)}
...
!this._reconnection||0!==this.attempts)||(this.openReconnect=!0,this.reconnect())};d.prototype.open=d.prototype.connect=function(a){n("readyState %s",this.readyState);if(~this.readyState.indexOf("open"))return this;n("opening %s",this.uri);var c=this.engine=f(this.uri,this.opts),d=this;this.readyState="opening";var e=k(c,"open",function(){d.onopen();a&&a()}),h=k(c,"error",function(c){n("connect_error");d.cleanup();d.readyState="closed";d.emitAll("connect_error",c);if(a){var e=Error("Connection error");
e.data=c;a(e)}d.maybeReconnectOnOpen()});if(!1!==this._timeout){var g=this._timeout;n("connect attempt will timeout after %d",g);var l=setTimeout(function(){n("connect attempt timed out after %d",g);e.destroy();c.close();c.emit("error","timeout");d.emitAll("connect_timeout",g)},g);this.subs.push({destroy:function(){clearTimeout(l)}})}this.subs.push(e);this.subs.push(h);return this};d.prototype.onopen=function(){n("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(k(a,
...
c):this.receiveBuffer.push(c)};d.prototype.ack=function(a){var c=this,d=!1;return function(){if(!d){d=!0;var e=h(arguments);l("sending ack %j",e);var g=n(e)?f.BINARY_ACK:f.ACK;c.packet({type:g,id:a,data:e})}}};d.prototype.onack=function(a){l("calling ack %s with %j",a.id,a.data);this.acks[a.id].apply(this,a.data);delete this.acks[a.id]};d.prototype.onconnect=function(){this.connected=!0;this.disconnected=!1;this.emit("connect");this.emitBuffered()};d.prototype.emitBuffered=function(){var a;for(a=
...
Error&&(c=c.stack||c.message);var e=new Date,f=e-(d[a]||e);d[a]=e;c=a+" "+c+" +"+d.humanize(f);window.console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)}:function(){}}c.exports=d;d.names=[];d.skips=[];d.enable=function(a){try{localStorage.debug=a}catch(c){}for(var e=(a||"").split(/[\s,]+/),f=e.length,n=0;n<f;n++)a=e[n].replace("*",".*?"),"-"===a[0]?d.skips.push(RegExp("^"+a.substr(1)+"$")):d.names.push(RegExp("^"+a+"$"))};d.disable=function(){d.enable("")};d.humanize=
...
"engine.io-parser":21}],12:[function(a,c,e){(function(d){function e(a,c){if(!(this instanceof e))return new e(a,c);c=c||{};a&&"object"==typeof a&&(c=a,a=null);a&&(a=p(a),c.host=a.host,c.secure="https"==a.protocol||"wss"==a.protocol,c.port=a.port,a.query&&(c.query=a.query));this.secure=null!=c.secure?c.secure:d.location&&"https:"==location.protocol;if(c.host){var h=c.host.split(":");c.hostname=h.shift();h.length&&(c.port=h.pop())}this.agent=c.agent||!1;this.hostname=c.hostname||(d.location?location.hostname:
...
a),p.send([{type:"ping",data:"probe"}]),p.once("packet",function(c){r||("pong"==c.type&&"probe"==c.data?(k('probe transport "%s" pong',a),F.upgrading=!0,F.emit("upgrading",p),e.priorWebsocketSuccess="websocket"==p.name,k('pausing current transport "%s"',F.transport.name),F.transport.pause(function(){r||("closed"==F.readyState||"closing"==F.readyState)||(k("changing transport and sending upgrade packet"),n(),F.setTransport(p),p.send([{type:"upgrade"}]),F.emit("upgrade",p),p=null,F.upgrading=!1,F.flush())})):
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=p.name,F.emit("upgradeError",c)))}))}function d(){r||(r=!0,n(),p.close(),p=null)}function h(c){var e=Error("probe error: "+c);e.transport=p.name;d();k('probe transport "%s" failed because of error: %s',a,c);F.emit("upgradeError",e)}function g(){h("transport closed")}function l(){h("socket closed")}function m(a){p&&a.name!=p.name&&(k('"%s" works - aborting "%s"',a.name,p.name),d())}function n(){p.removeListener("open",c);p.removeListener("error",
h);p.removeListener("close",g);F.removeListener("close",l);F.removeListener("upgrading",m)}k('probing transport "%s"',a);var p=this.createTransport(a,{probe:1}),r=!1,F=this;e.priorWebsocketSuccess=!1;p.once("open",c);p.once("error",h);p.once("close",g);this.once("close",l);this.once("upgrading",m);p.open()};e.prototype.onOpen=function(){k("socket open");this.readyState="open";e.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
...
"engine.io-parser":21}],14:[function(a,c,e){(function(c){var f=a("xmlhttprequest"),h=a("./polling-xhr"),g=a("./polling-jsonp"),k=a("./websocket");e.polling=function(a){var e=!1,k=!1,r=!1!==a.jsonp;c.location&&(k="https:"==location.protocol,(e=location.port)||(e=k?443:80),e=a.hostname!=location.hostname||e!=a.port,k=a.secure!=k);a.xdomain=e;a.xscheme=k;if("open"in new f(a)&&!a.forceJSONP)return new h(a);if(!r)throw Error("JSONP disabled");return new g(a)};e.websocket=k}).call(this,"undefined"!==typeof self?
self:"undefined"!==typeof window?window:{})},{"./polling-jsonp":15,"./polling-xhr":16,"./websocket":18,xmlhttprequest:19}],15:[function(a,c,e){(function(d){function e(){}function h(a){g.call(this,a);this.query=this.query||{};p||(d.___eio||(d.___eio=[]),p=d.___eio);this.index=p.length;var c=this;p.push(function(a){c.onData(a)});this.query.j=this.index;d.document&&d.addEventListener&&d.addEventListener("beforeunload",function(){c.script&&(c.script.onerror=e)})}var g=a("./polling"),k=a("component-inherit");
...
c)};var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(c,d);this.script=c;"undefined"!=typeof navigator&&/gecko/i.test(navigator.userAgent)&&setTimeout(function(){var a=document.createElement("iframe");document.body.appendChild(a);document.body.removeChild(a)},100)};h.prototype.doWrite=function(a,c){function d(){e();c()}function e(){if(f.iframe)try{f.form.removeChild(f.iframe)}catch(a){f.onError("jsonp polling iframe removal error",a)}try{p=document.createElement('<iframe src="javascript:0" name="'+
...
n=a("./polling"),p=a("component-emitter"),r=a("component-inherit"),m=a("debug")("engine.io-client:polling-xhr");c.exports=h;c.exports.Request=g;r(h,n);h.prototype.supportsBinary=!0;h.prototype.request=function(a){a=a||{};a.uri=this.uri();a.xd=this.xd;a.xs=this.xs;a.agent=this.agent||!1;a.supportsBinary=this.supportsBinary;a.enablesXDR=this.enablesXDR;return new g(a)};h.prototype.doWrite=function(a,c){var d=this.request({method:"POST",data:a,isBinary:"string"!==typeof a&&void 0!==a}),e=this;d.on("success",
c);d.on("error",function(a){e.onError("xhr post error",a)});this.sendXhr=d};h.prototype.doPoll=function(){m("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};p(g.prototype);g.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{m("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
(a.responseType="arraybuffer");if("POST"==this.method)try{this.isBinary?a.setRequestHeader("Content-type","application/octet-stream"):a.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch(e){}"withCredentials"in a&&(a.withCredentials=!0);this.hasXDR()?(a.onload=function(){c.onLoad()},a.onerror=function(){c.onError(a.responseText)}):a.onreadystatechange=function(){if(4==a.readyState)if(200==a.status||1223==a.status)c.onLoad();else setTimeout(function(){c.onError(a.status)},0)};m("xhr data %s",
...
c,!0,d)};return f.readAsArrayBuffer(a.data)}function h(a,c,d){var e=Array(a.length);d=n(a.length,d);for(var f=function(a,d,f){c(d,function(c,d){e[a]=d;f(c,e)})},h=0;h<a.length;h++)f(h,a[h],d)}var g=a("./keys"),k=a("arraybuffer.slice"),l=a("base64-arraybuffer"),n=a("after"),p=a("utf8"),r=navigator.userAgent.match(/Android/i);e.protocol=3;var m=e.packets={open:0,close:1,ping:2,pong:3,message:4,upgrade:5,noop:6},q=g(m),u={type:"error",data:"parser error"},A=a("blob");e.encodePacket=function(a,h,g,k){"function"==
typeof h&&(k=h,h=!1);"function"==typeof g&&(k=g,g=null);var l=void 0===a.data?void 0:a.data.buffer||a.data;if(c.ArrayBuffer&&l instanceof ArrayBuffer){if(h){g=a.data;h=new Uint8Array(g);g=new Uint8Array(1+g.byteLength);g[0]=m[a.type];for(a=0;a<h.length;a++)g[a+1]=h[a];a=k(g.buffer)}else a=e.encodeBase64Packet(a,k);return a}if(A&&l instanceof c.Blob)return h?r?a=f(a,h,k):(h=new Uint8Array(1),h[0]=m[a.type],a=new A([h.buffer,a.data]),a=k(a)):a=e.encodeBase64Packet(a,k),a;h=m[a.type];void 0!==a.data&&
(h+=g?p.encode(String(a.data)):String(a.data));return k(""+h)};e.encodeBase64Packet=function(a,f){var h="b"+e.packets[a.type];if(A&&a.data instanceof A){var g=new FileReader;g.onload=function(){var a=g.result.split(",")[1];f(h+a)};return g.readAsDataURL(a.data)}var k;try{k=String.fromCharCode.apply(null,new Uint8Array(a.data))}catch(l){k=new Uint8Array(a.data);for(var m=Array(k.length),p=0;p<k.length;p++)m[p]=k[p];k=String.fromCharCode.apply(null,m)}h+=c.btoa(k);return f(h)};e.decodePacket=function(a,
c,d){if("string"==typeof a||void 0===a){if("b"==a.charAt(0))return e.decodeBase64Packet(a.substr(1),c);if(d)try{a=p.decode(a)}catch(f){return u}d=a.charAt(0);return Number(d)==d&&q[d]?1<a.length?{type:q[d],data:a.substring(1)}:{type:q[d]}:u}d=(new Uint8Array(a))[0];a=k(a,1);A&&"blob"===c&&(a=new A([a]));return{type:q[d],data:a}};e.decodeBase64Packet=function(a,e){var f=q[a.charAt(0)];if(!c.ArrayBuffer)return{type:f,data:{base64:!0,data:a.substr(1)}};var h=l.decode(a.substr(1));"blob"===e&&A&&(h=new A([h]));
return{type:f,data:h}};e.encodePayload=function(a,c,d){"function"==typeof c&&(d=c,c=null);if(c)return A&&!r?e.encodePayloadAsBlob(a,d):e.encodePayloadAsArrayBuffer(a,d);if(!a.length)return d("0:");h(a,function(a,d){e.encodePacket(a,c,!0,function(a){d(null,a.length+":"+a)})},function(a,c){return d(c.join(""))})};e.decodePayload=function(a,c,d){if("string"!=typeof a)return e.decodePayloadAsBinary(a,c,d);"function"===typeof c&&(d=c,c=null);var f;if(""==a)return d(u,0,1);f="";for(var h,g,k=0,l=a.length;k<
l;k++)if(g=a.charAt(k),":"!=g)f+=g;else{if(""==f||f!=(h=Number(f)))return d(u,0,1);g=a.substr(k+1,h);if(f!=g.length)return d(u,0,1);if(g.length){f=e.decodePacket(g,c,!0);if(u.type==f.type&&u.data==f.data)return d(u,0,1);if(!1===d(f,k+h,l))return}k+=h;f=""}if(""!=f)return d(u,0,1)};e.encodePayloadAsArrayBuffer=function(a,c){if(!a.length)return c(new ArrayBuffer(0));h(a,function(a,c){e.encodePacket(a,!0,!0,function(a){return c(null,a)})},function(a,d){var e=d.reduce(function(a,c){var d;d="string"===
...
new Uint8Array(1);d[0]=1;if("string"===typeof a){for(var e=new Uint8Array(a.length),f=0;f<a.length;f++)e[f]=a.charCodeAt(f);a=e.buffer;d[0]=0}for(var e=(a instanceof ArrayBuffer?a.byteLength:a.size).toString(),h=new Uint8Array(e.length+1),f=0;f<e.length;f++)h[f]=parseInt(e[f]);h[e.length]=255;A&&(a=new A([d.buffer,h.buffer,a]),c(null,a))})},function(a,d){return c(new A(d))})};e.decodePayloadAsBinary=function(a,c,d){"function"===typeof c&&(d=c,c=null);for(var f=[],h=!1;0<a.byteLength;){for(var g=new Uint8Array(a),
l=0===g[0],m="",p=1;255!=g[p];p++){if(310<m.length){h=!0;break}m+=g[p]}if(h)return d(u,0,1);a=k(a,2+m.length);m=parseInt(m);g=k(a,0,m);if(l)try{g=String.fromCharCode.apply(null,new Uint8Array(g))}catch(n){for(l=new Uint8Array(g),g="",p=0;p<l.length;p++)g+=String.fromCharCode(l[p])}f.push(g);a=k(a,m)}var q=f.length;f.forEach(function(a,f){d(e.decodePacket(a,c,!0),f,q)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
return k};e.decode=function(c){var e=0.75*c.length,g=c.length,k=0,l,n,p,r;"="===c[c.length-1]&&(e--,"="===c[c.length-2]&&e--);for(var m=new ArrayBuffer(e),q=new Uint8Array(m),e=0;e<g;e+=4)l=a.indexOf(c[e]),n=a.indexOf(c[e+1]),p=a.indexOf(c[e+2]),r=a.indexOf(c[e+3]),q[k++]=l<<2|n>>4,q[k++]=(n&15)<<4|p>>2,q[k++]=(p&3)<<6|r&63;return m}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")},{}],26:[function(a,c,e){(function(a){function e(a,c){c=c||{};for(var d=new h,f=0;f<a.length;f++)d.append(a[f]);
...
56320==(h&64512)?c.push(((f&1023)<<10)+(h&1023)+65536):(c.push(f),d--)):c.push(f);return c}function g(){if(u>=q)throw Error("Invalid byte index");var a=m[u]&255;u++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,d,e;if(u>q)throw Error("Invalid byte index");if(u==q)return!1;a=m[u]&255;u++;if(0==(a&128))return a;if(192==(a&224)){c=g();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=g();d=g();a=(a&15)<<12|c<<6|
d;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=g(),d=g(),e=g(),a=(a&15)<<18|c<<12|d<<6|e,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof e&&e,n="object"==typeof c&&c&&c.exports==l&&c,p="object"==typeof a&&a;if(p.global===p||p.window===p)f=p;var r=String.fromCharCode,m,q,u,p={version:"2.0.0",encode:function(a){a=h(a);for(var c=a.length,d=-1,e,f="";++d<c;){e=a[d];if(0==(e&4294967168))e=r(e);else{var g="";0==(e&4294965248)?
g=r(e>>6&31|192):0==(e&4294901760)?(g=r(e>>12&15|224),g+=r(e>>6&63|128)):0==(e&4292870144)&&(g=r(e>>18&7|240),g+=r(e>>12&63|128),g+=r(e>>6&63|128));e=g+=r(e&63|128)}f+=e}return f},decode:function(a){m=h(a);q=m.length;u=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var d=-1,e,f="";++d<c;)e=a[d],65535<e&&(e-=65536,f+=r(e>>>10&1023|55296),e=56320|e&1023),f+=r(e);return f}};if(l&&!l.nodeType)if(n)n.exports=p;else{f={}.hasOwnProperty;for(var A in p)f.call(p,A)&&(l[A]=p[A])}else f.utf8=p})(this)}).call(this,
"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{}],28:[function(a,c,e){(function(a){var e=/^[\],:{}\s]*$/,h=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,g=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,k=/(?:^|:|,)(?:\s*\[)+/g,l=/^\s+/,n=/\s+$/;c.exports=function(c){if("string"!=typeof c||!c)return null;c=c.replace(l,"").replace(n,"");if(a.JSON&&JSON.parse)return JSON.parse(c);if(e.test(c.replace(h,"@").replace(g,"]").replace(k,"")))return(new Function("return "+
...
f="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");c.exports=function(a){var c=a,e=a.indexOf("["),l=a.indexOf("]");-1!=e&&-1!=l&&(a=a.substring(0,e)+a.substring(e,l).replace(/:/g,";")+a.substring(l,a.length));a=d.exec(a||"");for(var n={},p=14;p--;)n[f[p]]=a[p]||"";-1!=e&&-1!=l&&(n.source=c,n.host=n.host.substring(1,n.host.length-1).replace(/;/g,":"),n.authority=n.authority.replace("[","").replace("]","").replace(/;/g,":"),n.ipv6uri=
...
a._placeholder)return c[a.num];if(f(a))for(var d=0;d<a.length;d++)a[d]=e(a[d]);else if(a&&"object"==typeof a)for(d in a)a[d]=e(a[d]);return a}a.data=e(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,g,q){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){n++;var u=new FileReader;u.onload=function(){q?q[g]=this.result:p=this.result;--n||e(p)};u.readAsArrayBuffer(a)}else if(f(a))for(u=0;u<a.length;u++)l(a[u],u,a);else if(a&&"object"==typeof a&&!h(a))for(u in a)l(a[u],
u,a)}var n=0,p=a;l(p);n||e(p)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=n.stringify(a.data));l("encoded %j as %s",a,c);return c}function h(a,c){p.removeBlobs(a,function(a){var d=p.deconstructPacket(a);
a=f(d.packet);d=d.buffers;d.unshift(a);c(d)})}function g(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),n=a("json3");a("isarray");c=a("component-emitter");var p=a("./binary"),r=a("./is-buffer");e.protocol=4;e.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");e.CONNECT=0;e.DISCONNECT=1;e.EVENT=2;e.ACK=3;e.ERROR=4;e.BINARY_EVENT=5;e.BINARY_ACK=6;e.Encoder=d;e.Decoder=g;d.prototype.encode=function(a,c){l("encoding packet %j",
...
1==a.length)break}else c.nsp="/";f=a.charAt(d+1);if(""!=f&&Number(f)==f){for(c.id="";++d;){f=a.charAt(d);if(null==f||Number(f)!=f){--d;break}c.id+=a.charAt(d);if(d+1==a.length)break}c.id=Number(c.id)}if(a.charAt(++d))try{c.data=n.parse(a.substr(d))}catch(h){a={type:e.ERROR,data:"parser error"};break a}l("decoded %s as %j",a,c);a=c}}e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type?(this.reconstructor=new k(a),0==this.reconstructor.reconPack.attachments&&this.emit("decoded",a)):this.emit("decoded",a)}else if(r(a)||
...
d("01")}catch(q){}if(m)try{m=1!==d("1.")}catch(u){}}}}catch(s){m=!1}d=m}}return c[a]=!!d}var h={}.toString,g,k,l,n="object"==typeof JSON&&JSON,p="object"==typeof e&&e&&!e.nodeType&&e;p&&n?(p.stringify=n.stringify,p.parse=n.parse):p=a.JSON=n||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(m){}if(!c("json")){var q=c("bug-string-char-index");
if(!r)var u=Math.floor,A=[0,31,59,90,120,151,181,212,243,273,304,334],G=function(a,c){return A[c]+365*(a-1970)+u((a-1969+(c=+(1<c)))/4)-u((a-1901+c)/100)+u((a-1601+c)/400)};(g={}.hasOwnProperty)||(g=function(a){var c={},d;(c.__proto__=null,c.__proto__={toString:1},c).toString!=h?g=function(a){var c=this.__proto__;a=a in(this.__proto__=null,this);this.__proto__=c;return a}:(d=c.constructor,g=function(a){var c=(this.constructor||d).prototype;return a in this&&!(a in c&&this[a]===c[a])});c=null;return g.call(this,
...
k=function(a,c){var d="[object Function]"==h.call(a),e,k;if(k=!d)if(k="function"!=typeof a.constructor)k=typeof a.hasOwnProperty,k="object"==k?!!a.hasOwnProperty:!B[k];k=k?a.hasOwnProperty:g;for(e in a)d&&"prototype"==e||!k.call(a,e)||c(e);for(d=f.length;e=f[--d];k.call(a,e)&&c(e));});return k(a,c)};if(!c("json-stringify")){var H={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},C=function(a,c){return("000000"+(c||0)).slice(-a)},I=function(a){var c='"',d=0,e=a.length,f=10<e&&q,h;for(f&&
(h=a.split(""));d<e;d++){var g=a.charCodeAt(d);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=H[g];break;default:if(32>g){c+="\\u00"+C(2,g.toString(16));break}c+=f?h[d]:q?a.charAt(d):a[d]}}return c+'"'},x=function(a,c,d,e,f,m,p){var n,q,s,r,t,w,y,A,B;try{n=c[a]}catch(v){}if("object"==typeof n&&n)if(q=h.call(n),"[object Date]"!=q||g.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=q&&"[object String]"!=q&&"[object Array]"!=q||g.call(n,"toJSON"))&&(n=n.toJSON(a));
else if(n>-1/0&&n<1/0){if(G){r=u(n/864E5);for(q=u(r/365.2425)+1970-1;G(q+1,0)<=r;q++);for(s=u((r-G(q,0))/30.42);G(q,s+1)<=r;s++);r=1+r-G(q,s);t=(n%864E5+864E5)%864E5;w=u(t/36E5)%24;y=u(t/6E4)%60;A=u(t/1E3)%60;t%=1E3}else q=n.getUTCFullYear(),s=n.getUTCMonth(),r=n.getUTCDate(),w=n.getUTCHours(),y=n.getUTCMinutes(),A=n.getUTCSeconds(),t=n.getUTCMilliseconds();n=(0>=q||1E4<=q?(0>q?"-":"+")+C(6,0>q?-q:q):C(4,q))+"-"+C(2,s+1)+"-"+C(2,r)+"T"+C(2,w)+":"+C(2,y)+":"+C(2,A)+"."+C(3,t)+"Z"}else n=null;d&&(n=
d.call(c,a,n));if(null===n)return"null";q=h.call(n);if("[object Boolean]"==q)return""+n;if("[object Number]"==q)return n>-1/0&&n<1/0?""+n:"null";if("[object String]"==q)return I(""+n);if("object"==typeof n){for(a=p.length;a--;)if(p[a]===n)throw TypeError();p.push(n);B=[];c=m;m+=f;if("[object Array]"==q){s=0;for(a=n.length;s<a;s++)q=x(s,n,d,e,f,m,p),B.push(q===l?"null":q);a=B.length?f?"[\n"+m+B.join(",\n"+m)+"\n"+c+"]":"["+B.join(",")+"]":"[]"}else k(e||n,function(a){var c=x(a,n,d,e,f,m,p);c!==l&&
B.push(I(a)+":"+(f?" ":"")+c)}),a=B.length?f?"{\n"+m+B.join(",\n"+m)+"\n"+c+"}":"{"+B.join(",")+"}":"{}";p.pop();return a}};p.stringify=function(a,c,d){var e,f,g,k;if("function"==typeof c||"object"==typeof c&&c)if("[object Function]"==(k=h.call(c)))f=c;else if("[object Array]"==k){g={};for(var l=0,n=c.length,m;l<n;m=c[l++],(k=h.call(m),"[object String]"==k||"[object Number]"==k)&&(g[m]=1));}if(d)if("[object Number]"==(k=h.call(d))){if(0<(d-=d%1))for(e="",10<d&&(d=10);e.length<d;e+=" ");}else"[object String]"==
k&&(e=10>=d.length?d:d.slice(0,10));return x("",(m={},m[""]=a,m),f,g,e,"",[])}}if(!c("json-parse")){var S=String.fromCharCode,F={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},t,J,y=function(){t=J=null;throw SyntaxError();},R=function(){for(var a=J,c=a.length,d,e,f,h,g;t<c;)switch(g=a.charCodeAt(t),g){case 9:case 10:case 13:case 32:t++;break;case 123:case 125:case 91:case 93:case 58:case 44:return d=q?a.charAt(t):a[t],t++,d;case 34:d="@";for(t++;t<c;)if(g=a.charCodeAt(t),32>g)y();
else if(92==g)switch(g=a.charCodeAt(++t),g){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:d+=F[g];t++;break;case 117:e=++t;for(f=t+4;t<f;t++)g=a.charCodeAt(t),48<=g&&57>=g||(97<=g&&102>=g||65<=g&&70>=g)||y();d+=S("0x"+a.slice(e,t));break;default:y()}else{if(34==g)break;g=a.charCodeAt(t);for(e=t;32<=g&&92!=g&&34!=g;)g=a.charCodeAt(++t);d+=a.slice(e,t)}if(34==a.charCodeAt(t))return t++,d;y();default:e=t;45==g&&(h=!0,g=a.charCodeAt(++t));if(48<=g&&57>=g){for(48==g&&(g=a.charCodeAt(t+
...
h.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};p.parse=function(a,c){var d,e;t=0;J=""+a;d=ja(R());"$"!=R()&&y();t=J=null;return c&&"[object Function]"==h.call(c)?oa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],g=(c=c||0)||0;g<a.length;g++)e[g-c]=a[g];return e}},{}]},{},[1])(1)});
