...
DrawTogether.prototype.createFavorite=function(b,a,c){this.chat.addMessage("Hey.");this.network.socket.emit("createfavorite",b,a,c,function(b,a){b?this.chat.addMessage("Favorite","Error: "+b):a.success&&(this.chat.addMessage("Favorite added",a.success),this.paint.insertOneFavorite(0,0,"",a.owner),this.getFavorites())}.bind(this))};
...
Paint.prototype.insertOneFavorite=function(b,a,c,e){var d=this.favoritesContainer.appendChild(document.createElement("div"));d.className="favorite-container";d.dataset.x=b;d.dataset.y=a;d.dataset.name=c;d.dataset.owner=e;e=d.appendChild(document.createElement("div"));e.className="fav-button fav-minus-button";e.innerHTML="-";e.addEventListener("click",function(b){b=b.srcElement.parentElement;drawTogether.removeFavorite(b.dataset.x,b.dataset.y,b.dataset.name,b);console.log("delete",b.dataset.x,b.dataset.y,
b.dataset.name)}.bind(this));e=d.appendChild(document.createElement("div"));e.className="fav-button fav-plus-button";e.innerHTML="+";e.addEventListener("click",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=b.srcElement.parentElement.dataset.x,d=b.srcElement.parentElement.dataset.y,e=b.srcElement.parentElement.dataset.name,m=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);
console.log(m,a);b.srcElement.classList.contains("fav-button-confirmation")?(b.srcElement.classList.remove("fav-button-confirmation"),console.log("set"),this.setCoordFavorite(m,a,c,d,e,b.srcElement.parentElement)):(b.srcElement.classList.add("fav-button-confirmation"),setTimeout(function(){b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),7E3))}.bind(drawTogether));e.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/
this.paint.public.zoom],c=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);console.log(c,a);b.srcElement.title="Change to "+c+","+a+" ?"}.bind(drawTogether));e=d.appendChild(document.createElement("div"));e.className="fav-button fav-pencil-button";e.innerHTML="\u270e";e=e.appendChild(document.createElement("div"));e.className="fav-rename-container";e=e.appendChild(document.createElement("input"));e.className="fav-rename-input";e.type="text";e.placeholder="Rename";
e.addEventListener("input",function(b){void 0!==drawTogether._favoriteRenameDelayTimeout&&clearTimeout(drawTogether._favoriteRenameDelayTimeout);drawTogether._favoriteRenameDelayTimeout=setTimeout(function(){var b=this.srcElement.parentElement.parentElement.parentElement;drawTogether.renameFavorite(b.dataset.x,b.dataset.y,this.srcElement.value,b)}.bind(b),1500)}.bind(this));d=d.appendChild(document.createElement("div"));d.className="fav-button fav-coor-button";0<c.length?(d.innerHTML=c,d.title=b+
