...
1>this.paint.public.zoom){5E3<Date.now()-this.lastZoomWarning&&(this.chat.addMessage("Drawing while zoomed out this far is only allowed if you have more than "+this.ZOOMED_OUT_MIN_REP+" reputation."),this.lastZoomWarning=Date.now());b.removePathPoint();return}this.ink-=a;this.updateInk()}this.network.socket.emit("pp",b.point,timeoutCallback(function(a){a||(b.removePathPoint(),a=Date.now(),a-this.lastTimeoutError>this.TIME_BETWEEN_TIMEOUT_WARNINGS&&(this.chat.addMessage("The server took longer than "+
Math.round(this.SOCKET_TIMEOUT/1E3)+" seconds to respond. You should probably refresh your page."),this.lastTimeoutError=a))},this.SOCKET_TIMEOUT,this,[!1]));this.lastPathPoint=b.point}else this.displayMessage("Not your turn!"),b.removePathPoint()};
