...
b[a+r]|0;else{var I=q[r-15],x=q[r-2];q[r]=((I<<25|I>>>7)^(I<<14|I>>>18)^I>>>3)+q[r-7]+((x<<15|x>>>17)^(x<<13|x>>>19)^x>>>10)+q[r-16]}I=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&n^~k&l)+g[r]+q[r];x=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);m=l;l=n;n=k;k=h+I|0;h=f;f=e;e=d;d=I+x|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+n|0;c[6]=c[6]+l|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,d=8*this._nDataBytes,e=8*a.sigBytes;
...
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,e)return a(document).trigger("coinbase_button_loaded",d)}else if("checkouts frame loaded"===f&&(e=!0,c))return a(document).trigger("coinbase_button_loaded",d)}},!1);a(".coinbase-button").each(function(e){return function(e,l){var q,K,B,G,D;q=a(l);B=q.data();B.referrer=document.domain;G=a.param(B);B=q.data("code");D=q.data("width")||g(q.data("button-style"));K=q.data("height")||f(q.data("button-style"));r=b(q.data("env"));
...
parseInt(e.fn.jquery.split(".")[1])||0,c=c>u||c===u&&f>=A;if(e&&c)return a(e);p=document.createElement("script");p.type="text/javascript";p.src="https://code.jquery.com/jquery-1.8.3.min.js";p.onload=p.onreadystatechange=function(){if(!(g||(d=this.readyState)&&"loaded"!==d&&"complete"!==d))return a((e=window.jQuery).noConflict(1)),e(p).remove()};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(p)})("1.7",function(b){return a(b,c)})}).call(this)};
...
{question:"Are 3d party programs allowed?",answer:'They are as long as they are reasonable. So be cool about it. An example of drawing bots: <a href="http://anonbots.bitballoon.com/" alt="Anondraw bot">http://anonbots.bitballoon.com</a>'}],c=0;c<a.length;c++){var e=b.appendChild(document.createElement("div"));e.className="drawtogether-question";var d=e.appendChild(document.createElement("h2"));d.className="drawtogether-question-question";d.innerHTML=a[c].question;e=e.appendChild(document.createElement("div"));
e.className="drawtogether-question-answer";for(var d=a[c].answer.split("\n"),f=0;f<d.length;f++)e.appendChild(document.createElement("div")).innerHTML=d[f]}return b};
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=A();var p=s(a).height+10,n=s(a).width+20,q=s(b),u="floating";q.left+n>h.width||0>q.left+q.width/2-n?(m(g,"bottom"),m(g,"top")):(q.height+q.top+p>h.height&&m(g,"bottom"),0>q.top-p&&m(g,"top"));q.width+q.left+n>h.width&&m(g,"right");0>q.left-n&&m(g,"left");0<g.length&&(u=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(u=f);h=u}f=s(b);b=s(a);g=A();switch(h){case "top":c.className="introjs-arrow bottom";k(f,e?0:15,b,g,a);a.style.bottom=f.height+20+
...
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=F(b,360);c=F(c,100);d=F(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,g=2*d-f;d=e(g,f,b+1/3);c=e(g,f,b);b=e(g,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=F(b,255);a=F(a,255);d=F(d,255);var e=C(b,a,d),f=N(b,a,d),g,h=e-f;if(e==f)g=0;else{switch(e){case b:g=(a-d)/h+(a<d?6:0);break;case a:g=(d-b)/h+2;break;case d:g=(b-a)/h+4}g/=6}return{h:g,s:0===e?0:h/e,v:e}}function d(b,a,c,e){b=[P(w(b).toString(16)),
P(w(a).toString(16)),P(w(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[P(Math.round(255*parseFloat(d)).toString(16)),P(w(b).toString(16)),P(w(a).toString(16)),P(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s-=a/100;c.s=N(1,C(0,c.s));return v(c)}function g(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s+=a/100;
...
(d.h-(c*a>>1)+720)%360;--a;)d.h=(d.h+c)%360,b.push(v(d));return b}function A(b,a){a=a||6;for(var c=v(b).toHsv(),d=c.h,e=c.s,c=c.v,f=[],g=1/a;a--;)f.push(v({h:d,s:e,v:c})),c=(c+g)%1;return f}function X(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function F(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=N(a,C(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>Z.abs(b-a)?1:b%a/parseFloat(a)}function P(b){return 1==
b.length?"0"+b:""+b}function Q(b){1>=b&&(b=100*b+"%");return b}var xa=/^[\s,#]+/,t=/\s+$/,U=0,Z=Math,w=Z.round,N=Z.min,C=Z.max,aa=Z.random,v=function ia(b,c){var d,e,f,g,h;b=b?b:"";c=c||{};if(b instanceof ia)return b;if(!(this instanceof ia))return new ia(b,c);e=b;h={r:0,g:0,b:0};var k=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(xa,"").replace(t,"").toLowerCase();var p=!1;if(L[e])e=L[e],p=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(g=M.rgb.exec(e))?{r:g[1],g:g[2],b:g[3]}:
...
16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:p?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))h={r:255*F(e.r,255),g:255*F(e.g,255),b:255*F(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=Q(e.s);e.v=Q(e.v);f=e.h;p=e.s;h=e.v;f=6*F(f,360);p=F(p,100);h=F(h,100);d=Z.floor(f);var l=f-d;f=h*(1-p);g=h*(1-l*p);p=h*(1-(1-l)*p);d%=6;
h={r:255*[h,g,f,f,p,h][d],g:255*[p,h,h,g,f,f][d],b:255*[f,f,p,h,h,g][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=Q(e.s),e.l=Q(e.l),h=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(k=e.a)}k=X(k);e=e.format||f;f=N(255,C(h.r,0));g=N(255,C(h.g,0));h=N(255,C(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=k;this._roundA=w(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
...
c,d){if("string"==typeof a||void 0===a){if("b"==a.charAt(0))return e.decodeBase64Packet(a.substr(1),c);if(d)try{a=n.decode(a)}catch(f){return u}d=a.charAt(0);return Number(d)==d&&p[d]?1<a.length?{type:p[d],data:a.substring(1)}:{type:p[d]}:u}d=(new Uint8Array(a))[0];a=k(a,1);A&&"blob"===c&&(a=new A([a]));return{type:p[d],data:a}};e.decodeBase64Packet=function(a,e){var f=p[a.charAt(0)];if(!c.ArrayBuffer)return{type:f,data:{base64:!0,data:a.substr(1)}};var g=l.decode(a.substr(1));"blob"===e&&A&&(g=new A([g]));
...
g.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};n.parse=function(a,c){var d,e;s=0;I=""+a;d=ja(R());"$"!=R()&&x();s=I=null;return c&&"[object Function]"==g.call(c)?oa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],h=(c=c||0)||0;h<a.length;h++)e[h-c]=a[h];return e}},{}]},{},[1])(1)});
