...
this._autoMoveScreen;this._followingPlayer;this.network=new Network(this.settings.loadbalancer);this.account=new Account(this.settings.accountServer);this.bindSocketHandlers();this.initDom();this.gui=new Gui(b);this.updateInk();"ask"==this.settings.mode?this.openModeSelector():"join"==this.settings.mode?this.changeRoom(this.settings.room,void 0,this.settings.leftTopX,this.settings.leftTopY,!0):"private"==this.settings.mode?(this.settings.room="private_"+Math.random().toString(36).substr(2,5),this.changeRoom(this.settings.room,
...
0)}DrawTogether.prototype.defaultSettings={mode:"ask",room:"main",leftTopX:0,leftTopY:0,loadbalancer:"http://direct.anondraw.com:3552",accountServer:"http://direct.anondraw.com:4552",imageServer:"http://direct.anondraw.com:5552"};DrawTogether.prototype.defaultUserSettings=[{title:"Mute chat",type:"boolean",value:!1},{title:"Show tips",type:"boolean",value:!0}];DrawTogether.prototype.drawingTypes=["line","brush","block"];DrawTogether.prototype.drawingTypesByName={line:0,brush:1,block:2};
...
" is now drawing. You have "+Math.round(a.timeLeft/1E3)+" seconds left.");b.chat.addMessage("GAME","The word contains some of the following letters: "+a.letters.join(", "));b.displayMessage("The word contains some of the following letters: "+a.letters.join(", "));for(var c=0;c<a.players.length;c++)for(var e=0;e<b.playerList.length;e++)b.playerList[e].id==a.players[c].id&&(b.playerList[e].gamescore=a.players[c].score);b.updatePlayerList()});this.network.on("gamewords",function(a){b.gui.prompt("It is your turn! Pick a word to draw.",
...
"'. Server error: "+g+". Trying again in 5 seconds."),setTimeout(this.changeRoom.bind(this,b,a,c,e,d,f),5E3)):(this.setRoom(b+a),this.paint.clear(),this.paint.goto(c||0,e||0),this.paint.addPublicDrawings(this.decodeDrawings(h)),this.chat.addMessage("Invite people","http://www.anondraw.com/#"+b+a),"PLEASE_WAIT"!==b&&this.removeLoading())}.bind(this)),this.setLoading(b))};
...
DrawTogether.prototype.createDrawZone=function(){var b=this.container.appendChild(document.createElement("div"));b.className="drawtogether-paint-container";this.paintContainer=b;this.paint=new Paint(b);this.userCtx=this.paint.newCanvasOnTop("userinteraction").getContext("2d");this.setLoadImage();this.paint.background.requestUserChunk=function(b,a,c,g){var h=new Image;g=g||0;g+=5E3;h.onload=function(b){c(h)};h.onerror=function(h){console.error("Failed to load chunk ",b,a," retrying in "+Math.round(g/
...
this.inkUsageFromPath(b.point,this.lastPathPoint,this.lastPathSize);if(this.ink<a){2E4<Date.now()-this.lastInkWarning&&(this.chat.addMessage("CLIENT","Not enough ink! You will regain ink every 20 seconds."),this.chat.addMessage("CLIENT","Tip: Small brushes use less ink."),this.chat.addMessage("CLIENT","Tip: logged in users receive more ink"),this.lastInkWarning=Date.now());b.removePathPoint();return}this.ink-=a;this.updateInk()}this.network.socket.emit("pp",b.point,function(a){a||b.removePathPoint()});
this.lastPathPoint=b.point}}.bind(this));var a,c=function(){location.hash=this.current_room+","+this.paint.public.leftTopX.toFixed()+","+this.paint.public.leftTopY.toFixed()}.bind(this);this.paint.addEventListener("move",function(b){clearTimeout(a);a=setTimeout(c,100)});this.paint.changeTool("grab")};DrawTogether.prototype.createMessage=function(){this.messageDom=this.container.appendChild(document.createElement("div"));this.messageDom.className="drawtogether-general-message"};
...
Network.prototype.joinGame=function(b,a){this._joinGame(b,function(b,e){b?a(b):(console.log("We got gameroom "+e.room+" on server: "+e.server),this.changeServer(e.server,function(b){b?a(b):this.socket.emit("changeroom",e.room,a)}))}.bind(this))};
...
Controls.prototype.constructors.integer=function(b){var a=document.createElement("div");a.className=(b.classAppend||"")+"control-integer";var c=document.createElement("input");c.type=b.range?"range":"number";c.value=b.value;c.className=(b.classAppend||"")+"control-integer-input";b.text&&(c.placeholder=b.text);b.title&&(c.title=b.title);b.max&&(c.max=b.max);b.min&&(c.min=b.min);c.addEventListener("input",function(){b.action(c.value)});a.appendChild(this.button({text:"-",action:function(){var a=parseInt(c.max||
Infinity),d=parseInt(c.value)-1;c.value=Math.min(a,d);b.action(c.value)}}).containerAppend);a.appendChild(c);a.appendChild(this.button({text:"+",action:function(){var a=parseInt(c.max||Infinity),d=parseInt(c.value)+1;c.value=Math.min(a,d);b.action(c.value)}}).containerAppend);return{input:c,containerAppend:a}};
...
function TiledCanvas(b,a){this.canvas=b;this.ctx=this.canvas.getContext("2d");this.leftTopY=this.leftTopX=0;this.zoom=1;this.affecting=[[0,0],[0,0]];this.chunks={};this.settings=this.normalizeDefaults(a,this.defaultSettings);this.contextQueue=[];this.context=this.createContext();this.lastClear=Date.now()}TiledCanvas.prototype.defaultSettings={chunkSize:256};TiledCanvas.prototype.setRotation=function(){};TiledCanvas.prototype.setHorizontalMirror=function(){};
TiledCanvas.prototype.setVerticalMirror=function(){};TiledCanvas.prototype.cloneObject=function(b){var a={},c;for(c in b)a[c]="object"!==typeof b[c]||b[c]instanceof Array?b[c]:this.cloneObject(b[c]);return a};TiledCanvas.prototype.normalizeDefaults=function(b,a){b=b||{};var c=this.cloneObject(b),e;for(e in a)c[e]="object"!==typeof a[e]||a[e]instanceof Array?b[e]||a[e]:this.normalizeDefaults(b[e]||{},a[e]);return c};
TiledCanvas.prototype.redrawOnce=function(){this._redrawTimeout||(this._redrawTimeout=requestAnimationFrame(this.redraw.bind(this,!1)))};
...
c)));return b};
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,d,e){for(var f=[],g=0;g<a.length;g++){var h=a[g];if(h){var n=tinycolor(h),k=0.5>n.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k=k+(tinycolor.equals(c,h)?" sp-thumb-active":""),h=n.toString(e.preferredFormat||"rgb"),m=q?"background-color:"+n.toRgbString():"filter:"+n.toFilter();f.push('<span title="'+h+
'" data-color="'+n.toRgbString()+'" class="'+k+'"><span class="sp-thumb-inner" style="'+m+';" /></span>')}else f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",e.noColorSelectedText)).html())}return"<div class='sp-cf "+d+"'>"+f.join("")+"</div>"}function e(a,c){var d=b.extend({},m,a);d.callbacks={move:k(d.move,c),change:k(d.change,c),show:k(d.show,c),hide:k(d.hide,c),beforeShow:k(d.beforeShow,c)};return d}function d(d,
g){function k(){s.showPaletteOnly&&(s.showPalette=!0);Ha.text(s.showPaletteOnly?s.togglePaletteMoreText:s.togglePaletteLessText);if(s.palette){xa=s.palette.slice(0);oa=b.isArray(xa[0])?xa:[xa];ya={};for(var a=0;a<oa.length;a++)for(var c=0;c<oa[a].length;c++){var d=tinycolor(oa[a][c]).toRgbString();ya[d]=!0}}z.toggleClass("sp-flat",T);z.toggleClass("sp-input-disabled",!s.showInput);z.toggleClass("sp-alpha-enabled",s.showAlpha);z.toggleClass("sp-clear-enabled",ea);z.toggleClass("sp-buttons-disabled",
!s.showButtons);z.toggleClass("sp-palette-buttons-disabled",!s.togglePaletteOnly);z.toggleClass("sp-palette-disabled",!s.showPalette);z.toggleClass("sp-palette-only",s.showPaletteOnly);z.toggleClass("sp-initial-disabled",!s.showInitial);z.addClass(s.className).addClass(s.containerClassName);Q()}function m(){if(w&&window.localStorage){try{var a=window.localStorage[w].split(",#");1<a.length&&(delete window.localStorage[w],b.each(a,function(b,a){x(a)}))}catch(c){}try{U=window.localStorage[w].split(";")}catch(d){}}}
function x(a){if(Y){a=tinycolor(a).toRgbString();if(!ya[a]&&-1===b.inArray(a,U))for(U.push(a);U.length>Wa;)U.shift();if(w&&window.localStorage)try{window.localStorage[w]=U.join(";")}catch(c){}}}function N(){var b=[];if(s.showPalette)for(var a=0;a<U.length;a++){var c=tinycolor(U[a]).toRgbString();ya[c]||b.push(U[a])}return b.reverse().slice(0,s.maxSelectionSize)}function A(){var a=P(),d=b.map(oa,function(b,d){return c(b,a,"sp-palette-row sp-palette-row-"+d,s)});m();U&&d.push(c(N(),a,"sp-palette-row sp-palette-row-selection",
s));Oa.html(d.join(""))}function t(){if(s.showInitial){var b=fa,a=P();Pa.html(c([b,a],a,"sp-palette-row-initial",s))}}function H(){(0>=S||0>=L||0>=za)&&Q();z.addClass(Qa);Z=null;I.trigger("dragstart.spectrum",[P()])}function y(){z.removeClass(Qa);I.trigger("dragstop.spectrum",[P()])}function R(){var b=aa.val();null!==b&&""!==b||!ea?(b=tinycolor(b),b.isValid()?(ba(b),C(!0)):aa.addClass("sp-validation-error")):(ba(null),C(!0))}function ja(){u?ha():ka()}function ka(){var a=b.Event("beforeShow.spectrum");
if(u)Q();else if(I.trigger(a,[P()]),!1!==K.beforeShow(P())&&!a.isDefaultPrevented()){for(a=0;a<r.length;a++)r[a]&&r[a].hide();u=!0;b(Ia).bind("click.spectrum",pa);b(window).bind("resize.spectrum",ca);la.addClass("sp-active");z.removeClass("sp-hidden");Q();X();fa=P();t();K.show(fa);I.trigger("show.spectrum",[fa])}}function pa(b){2!=b.button&&(Xa?C(!0):ba(fa,!0),ha())}function ha(){u&&!T&&(u=!1,b(Ia).unbind("click.spectrum",pa),b(window).unbind("resize.spectrum",ca),la.removeClass("sp-active"),z.addClass("sp-hidden"),
K.hide(P()),I.trigger("hide.spectrum",[P()]))}function ba(b,a){if(tinycolor.equals(b,P()))X();else{var c,d;!b&&ea?da=!0:(da=!1,c=tinycolor(b),d=c.toHsv(),qa=d.h%360/360,ra=d.s,sa=d.v,V=d.a);X();c&&(c.isValid()&&!a)&&(ta=Ja||c.getFormat())}}function P(b){b=b||{};return ea&&da?null:tinycolor.fromRatio({h:qa,s:ra,v:sa,a:Math.round(100*V)/100},{format:b.format||ta})}function ma(){X();K.move(P());I.trigger("move.spectrum",[P()])}function X(){aa.removeClass("sp-validation-error");D();var b=tinycolor.fromRatio({h:qa,
s:1,v:1});Aa.css("background-color",b.toHexString());b=ta;!(1>V)||0===V&&"name"===b||"hex"!==b&&"hex3"!==b&&"hex6"!==b&&"name"!==b||(b="rgb");var a=P({format:b}),c="";na.removeClass("sp-clear-display");na.css("background-color","transparent");if(!a&&ea)na.addClass("sp-clear-display");else{var c=a.toHexString(),d=a.toRgbString();q||1===a.alpha?na.css("background-color",d):(na.css("background-color","transparent"),na.css("filter",a.toFilter()));if(s.showAlpha){d=a.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),
e="linear-gradient(left, "+d+", "+c+")";n?ua.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ua.css("background","-webkit-"+e),ua.css("background","-moz-"+e),ua.css("background","-ms-"+e),ua.css("background","linear-gradient(to right, "+d+", "+c+")"))}c=a.toString(b)}s.showInput&&aa.val(c);s.showPalette&&A();t()}function D(){var b=ra,a=sa;ea&&da?(Ba.hide(),Ca.hide(),Da.hide()):(Ba.show(),Ca.show(),Da.show(),b*=L,a=S-a*S,b=Math.max(-M,Math.min(L-M,b-M)),a=Math.max(-M,Math.min(S-M,a-M)),Da.css({top:a+
"px",left:b+"px"}),Ba.css({left:V*ia-Ra/2+"px"}),Ca.css({top:qa*za-Sa+"px"}))}function C(b){var a=P(),c="",d=!tinycolor.equals(a,fa);a&&(c=a.toString(ta),x(a));Ea&&I.val(c);b&&d&&(K.change(a),I.trigger("change",[a]))}function Q(){L=Aa.width();S=Aa.height();M=Da.height();Ka.width();za=Ka.height();Sa=Ca.height();ia=Ta.width();Ra=Ba.width();T||(z.css("position","absolute"),s.offset?z.offset(s.offset):z.offset(f(z,va)));D();s.showPalette&&A();I.trigger("reflow.spectrum")}function Fa(){ha();La=!0;I.attr("disabled",
!0);va.addClass("sp-disabled")}var s=e(g,d),T=s.flat,Y=s.showSelectionPalette,w=s.localStorageKey,O=s.theme,K=s.callbacks,ca=p(Q,10),u=!1,L=0,S=0,M=0,za=0,ia=0,Ra=0,Sa=0,qa=0,ra=0,sa=0,V=1,xa=[],oa=[],ya={},U=s.selectionPalette.slice(0),Wa=s.maxSelectionSize,Qa="sp-dragging",Z=null,Ia=d.ownerDocument,I=b(d),La=!1,z=b(J,Ia).addClass(O),Ya=z.find(".sp-picker-container"),Aa=z.find(".sp-color"),Da=z.find(".sp-dragger"),Ka=z.find(".sp-hue"),Ca=z.find(".sp-slider"),ua=z.find(".sp-alpha-inner"),Ta=z.find(".sp-alpha"),
Ba=z.find(".sp-alpha-handle"),aa=z.find(".sp-input"),Oa=z.find(".sp-palette"),Pa=z.find(".sp-initial"),Ua=z.find(".sp-cancel"),Ma=z.find(".sp-clear"),Va=z.find(".sp-choose"),Ha=z.find(".sp-palette-toggle"),Ea=I.is("input"),Za=Ea&&v&&"color"===I.attr("type"),Na=Ea&&!T,la=Na?b(B).addClass(O).addClass(s.className).addClass(s.replacerClassName):b([]),va=Na?la:I,na=la.find(".sp-preview-inner"),wa=s.color||Ea&&I.val(),fa=!1,Ja=s.preferredFormat,ta=Ja,Xa=!s.showButtons||s.clickoutFiresChange,da=!wa,ea=s.allowEmpty&&
!Za;(function(){function a(c){c.data&&c.data.ignore?(ba(b(c.target).closest(".sp-thumb-el").data("color")),ma()):(ba(b(c.target).closest(".sp-thumb-el").data("color")),ma(),C(!0),s.hideAfterPaletteSelect&&ha());return!1}n&&z.find("*:not(input)").attr("unselectable","on");k();Na&&I.after(la).hide();ea||Ma.hide();if(T)I.after(z).hide();else{var c="parent"===s.appendTo?I.parent():b(s.appendTo);1!==c.length&&(c=b("body"));c.append(z)}m();va.bind("click.spectrum touchstart.spectrum",function(a){La||ja();
a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(I.is(":disabled")||!0===s.disabled)&&Fa();z.click(h);aa.change(R);aa.bind("paste",function(){setTimeout(R,1)});aa.keydown(function(b){13==b.keyCode&&R()});Ua.text(s.cancelText);Ua.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();ba(fa,!0);ha()});Ma.attr("title",s.clearText);Ma.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();da=!0;ma();T&&C(!0)});Va.text(s.chooseText);Va.bind("click.spectrum",
function(b){b.stopPropagation();b.preventDefault();aa.hasClass("sp-validation-error")||(C(!0),ha())});Ha.text(s.showPaletteOnly?s.togglePaletteMoreText:s.togglePaletteLessText);Ha.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();s.showPaletteOnly=!s.showPaletteOnly;s.showPaletteOnly||T||z.css("left","-="+(Ya.outerWidth(!0)+5));k()});l(Ta,function(b,a,c){V=b/ia;da=!1;c.shiftKey&&(V=Math.round(10*V)/10);ma()},H,y);l(Ka,function(b,a){qa=parseFloat(a/za);da=!1;s.showAlpha||(V=
1);ma()},H,y);l(Aa,function(b,a,c){c.shiftKey?Z||(c=S-sa*S,Z=Math.abs(b-ra*L)>Math.abs(a-c)?"x":"y"):Z=null;c=!Z||"y"===Z;Z&&"x"!==Z||(ra=parseFloat(b/L));c&&(sa=parseFloat((S-a)/S));da=!1;s.showAlpha||(V=1);ma()},H,y);wa?(ba(wa),X(),ta=Ja||tinycolor(wa).format,x(wa)):X();T&&ka();c=n?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Oa.delegate(".sp-thumb-el",c,a);Pa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},a)})();var Ga={show:ka,hide:ha,toggle:ja,reflow:Q,option:function(c,d){if(c===
a)return b.extend({},s);if(d===a)return s[c];s[c]=d;k()},enable:function(){La=!1;I.attr("disabled",!1);va.removeClass("sp-disabled")},disable:Fa,offset:function(b){s.offset=b;Q()},set:function(b){ba(b);C()},get:P,destroy:function(){I.show();va.unbind("click.spectrum touchstart.spectrum");z.remove();la.remove();r[Ga.id]=null},container:z};Ga.id=r.push(Ga)-1;return Ga}function f(a,c){var d=a.outerWidth(),e=a.outerHeight(),f=c.outerHeight(),g=a[0].ownerDocument,h=g.documentElement,q=h.clientWidth+b(g).scrollLeft(),
g=h.clientHeight+b(g).scrollTop(),h=c.offset();h.top+=f;h.left-=Math.min(h.left,h.left+d>q&&q>d?Math.abs(h.left+d-q):0);h.top-=Math.min(h.top,h.top+e>g&&g>e?Math.abs(e+f-0):0);return h}function g(){}function h(b){b.stopPropagation()}function k(b,a){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return b.apply(a,d.concat(c.call(arguments)))}}function l(a,c,d,e){function f(b){b.stopPropagation&&b.stopPropagation();b.preventDefault&&b.preventDefault();b.returnValue=!1}function g(b){if(k){if(n&&
9>q.documentMode&&!b.button)return h();var d=b.originalEvent&&b.originalEvent.touches,e=d?d[0].pageY:b.pageY,d=Math.max(0,Math.min((d?d[0].pageX:b.pageX)-m.left,p)),e=Math.max(0,Math.min(e-m.top,l));v&&f(b);c.apply(a,[d,e,b])}}function h(){k&&(b(q).unbind(J),b(q.body).removeClass("sp-dragging"),e.apply(a,arguments));k=!1}c=c||function(){};d=d||function(){};e=e||function(){};var q=document,k=!1,m={},l=0,p=0,v="ontouchstart"in window,J={};J.selectstart=f;J.dragstart=f;J["touchmove mousemove"]=g;J["touchend mouseup"]=
h;b(a).bind("touchstart mousedown",function(c){(c.which?3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,l=b(a).height(),p=b(a).width(),m=b(a).offset(),b(q).bind(J),b(q.body).addClass("sp-dragging"),v||g(c),f(c))})}function p(b,a,c){var d;return function(){var e=this,f=arguments,g=function(){d=null;b.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(g,a)}}var m={beforeShow:g,move:g,change:g,show:g,hide:g,color:!1,flat:!1,showInput:!1,allowEmpty:!1,showButtons:!0,clickoutFiresChange:!1,
...
l;b.fn.spectrum.defaults=m;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){v||b("input[type=color]").spectrum({preferredFormat:"hex6"})};(function(){function b(a,c,d){a=D(a,255);c=D(c,255);d=D(d,255);var e=K(a,c,d),f=O(a,c,d),g,h=(e+f)/2;if(e==f)g=f=0;else{var q=e-f,f=0.5<h?q/(2-e-f):q/(e+f);switch(e){case a:g=(c-d)/q+(c<d?6:0);break;case c:g=(d-a)/q+2;break;case d:g=(a-c)/q+4}g/=6}return{h:g,s:f,l:h}}function a(b,c,d){function e(b,
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=D(b,360);c=D(c,100);d=D(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,g=2*d-f;d=e(g,f,b+1/3);c=e(g,f,b);b=e(g,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=D(b,255);a=D(a,255);d=D(d,255);var e=K(b,a,d),f=O(b,a,d),g,h=e-f;if(e==f)g=0;else{switch(e){case b:g=(a-d)/h+(a<d?6:0);break;case a:g=(d-b)/h+2;break;case d:g=(b-a)/h+4}g/=6}return{h:g,s:0===e?0:h/e,v:e}}function d(b,a,c,e){b=[C(w(b).toString(16)),
C(w(a).toString(16)),C(w(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[C(Math.round(255*parseFloat(d)).toString(16)),C(w(b).toString(16)),C(w(a).toString(16)),C(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.s-=a/100;c.s=O(1,K(0,c.s));return u(c)}function g(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.s+=a/100;
c.s=O(1,K(0,c.s));return u(c)}function h(b){return u(b).desaturate(100)}function q(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.l+=a/100;c.l=O(1,K(0,c.l));return u(c)}function n(b,a){a=0===a?0:a||10;var c=u(b).toRgb();c.r=K(0,O(255,c.r-w(255*-(a/100))));c.g=K(0,O(255,c.g-w(255*-(a/100))));c.b=K(0,O(255,c.b-w(255*-(a/100))));return u(c)}function k(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.l-=a/100;c.l=O(1,K(0,c.l));return u(c)}function m(b,a){var c=u(b).toHsl(),d=(w(c.h)+a)%360;c.h=0>d?360+d:d;return u(c)}
function l(b){b=u(b).toHsl();b.h=(b.h+180)%360;return u(b)}function p(b){var a=u(b).toHsl(),c=a.h;return[u(b),u({h:(c+120)%360,s:a.s,l:a.l}),u({h:(c+240)%360,s:a.s,l:a.l})]}function v(b){var a=u(b).toHsl(),c=a.h;return[u(b),u({h:(c+90)%360,s:a.s,l:a.l}),u({h:(c+180)%360,s:a.s,l:a.l}),u({h:(c+270)%360,s:a.s,l:a.l})]}function J(b){var a=u(b).toHsl(),c=a.h;return[u(b),u({h:(c+72)%360,s:a.s,l:a.l}),u({h:(c+216)%360,s:a.s,l:a.l})]}function B(b,a,c){a=a||6;c=c||30;var d=u(b).toHsl();c=360/c;b=[u(b)];for(d.h=
(d.h-(c*a>>1)+720)%360;--a;)d.h=(d.h+c)%360,b.push(u(d));return b}function r(b,a){a=a||6;for(var c=u(b).toHsv(),d=c.h,e=c.s,c=c.v,f=[],g=1/a;a--;)f.push(u({h:d,s:e,v:c})),c=(c+g)%1;return f}function X(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function D(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=O(a,K(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>Y.abs(b-a)?1:b%a/parseFloat(a)}function C(b){return 1==
b.length?"0"+b:""+b}function Q(b){1>=b&&(b=100*b+"%");return b}var Fa=/^[\s,#]+/,s=/\s+$/,T=0,Y=Math,w=Y.round,O=Y.min,K=Y.max,ca=Y.random,u=function ia(b,c){var d,e,f,g,h;b=b?b:"";c=c||{};if(b instanceof ia)return b;if(!(this instanceof ia))return new ia(b,c);e=b;h={r:0,g:0,b:0};var q=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(Fa,"").replace(s,"").toLowerCase();var n=!1;if(L[e])e=L[e],n=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(g=M.rgb.exec(e))?{r:g[1],g:g[2],b:g[3]}:
(g=M.rgba.exec(e))?{r:g[1],g:g[2],b:g[3],a:g[4]}:(g=M.hsl.exec(e))?{h:g[1],s:g[2],l:g[3]}:(g=M.hsla.exec(e))?{h:g[1],s:g[2],l:g[3],a:g[4]}:(g=M.hsv.exec(e))?{h:g[1],s:g[2],v:g[3]}:(g=M.hsva.exec(e))?{h:g[1],s:g[2],v:g[3],a:g[4]}:(g=M.hex8.exec(e))?{a:parseInt(g[1],16)/255,r:parseInt(g[2],16),g:parseInt(g[3],16),b:parseInt(g[4],16),format:n?"name":"hex8"}:(g=M.hex6.exec(e))?{r:parseInt(g[1],16),g:parseInt(g[2],16),b:parseInt(g[3],16),format:n?"name":"hex"}:(g=M.hex3.exec(e))?{r:parseInt(g[1]+""+g[1],
16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:n?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))h={r:255*D(e.r,255),g:255*D(e.g,255),b:255*D(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=Q(e.s);e.v=Q(e.v);f=e.h;n=e.s;h=e.v;f=6*D(f,360);n=D(n,100);h=D(h,100);d=Y.floor(f);var k=f-d;f=h*(1-n);g=h*(1-k*n);n=h*(1-(1-k)*n);d%=6;
h={r:255*[h,g,f,f,n,h][d],g:255*[n,h,h,g,f,f][d],b:255*[f,f,n,h,h,g][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=Q(e.s),e.l=Q(e.l),h=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(q=e.a)}q=X(q);e=e.format||f;f=O(255,K(h.r,0));g=O(255,K(h.g,0));h=O(255,K(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=q;this._roundA=w(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
1>this._g&&(this._g=w(this._g));1>this._b&&(this._b=w(this._b));this._ok=d;this._tc_id=T++};u.prototype={isDark:function(){return 128>this.getBrightness()},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var b=this.toRgb();return(299*b.r+587*b.g+114*b.b)/1E3},setAlpha:function(b){this._a=X(b);this._roundA=w(100*
...
brighten:function(){return this._applyModification(n,arguments)},darken:function(){return this._applyModification(k,arguments)},desaturate:function(){return this._applyModification(f,arguments)},saturate:function(){return this._applyModification(g,arguments)},greyscale:function(){return this._applyModification(h,arguments)},spin:function(){return this._applyModification(m,arguments)},_applyCombination:function(b,a){return b.apply(null,[this].concat([].slice.call(a)))},analogous:function(){return this._applyCombination(B,
arguments)},complement:function(){return this._applyCombination(l,arguments)},monochromatic:function(){return this._applyCombination(r,arguments)},splitcomplement:function(){return this._applyCombination(J,arguments)},triad:function(){return this._applyCombination(p,arguments)},tetrad:function(){return this._applyCombination(v,arguments)}};u.fromRatio=function(b,a){if("object"==typeof b){var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]="a"===d?b[d]:Q(b[d]));b=c}return u(b,a)};u.equals=function(b,
a){return b&&a?u(b).toRgbString()==u(a).toRgbString():!1};u.random=function(){return u.fromRatio({r:ca(),g:ca(),b:ca()})};u.mix=function(b,a,c){c=0===c?0:c||50;b=u(b).toRgb();a=u(a).toRgb();c/=100;var d=2*c-1,e=a.a-b.a,d=((-1==d*e?d:(d+e)/(1+d*e))+1)/2,e=1-d;return u({r:a.r*d+b.r*e,g:a.g*d+b.g*e,b:a.b*d+b.b*e,a:a.a*c+b.a*(1-c)})};u.readability=function(b,a){var c=u(b),d=u(a),e=c.toRgb(),f=d.toRgb(),c=c.getBrightness(),d=d.getBrightness(),e=Math.max(e.r,f.r)-Math.min(e.r,f.r)+Math.max(e.g,f.g)-Math.min(e.g,
f.g)+Math.max(e.b,f.b)-Math.min(e.b,f.b);return{brightness:Math.abs(c-d),color:e}};u.isReadable=function(b,a){var c=u.readability(b,a);return 125<c.brightness&&500<c.color};u.mostReadable=function(b,a){for(var c=null,d=0,e=!1,f=0;f<a.length;f++){var g=u.readability(b,a[f]),h=125<g.brightness&&500<g.color,g=3*(g.brightness/125)+g.color/500;if(h&&!e||h&&e&&g>d||!h&&!e&&g>d)e=h,d=g,c=u(a[f])}return c};var L=u.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",
...
thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},S=u.hexNames=function(b){var a={},c;for(c in b)b.hasOwnProperty(c)&&(a[b[c]]=c);return a}(L),M={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),rgba:RegExp("rgba[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
Paint.prototype.addCanvas=function(b){var a=b.appendChild(this.createCanvas("background")),c=b.appendChild(this.createCanvas("public")),e=b.appendChild(this.createCanvas("local"));b=b.appendChild(this.createCanvas("effect"));this.background=new TiledCanvas(a);this.public=new TiledCanvas(c);this.public.requestUserChunk=function(b,a,c){c();this.background.requestChunk(b,a)}.bind(this);this.local=new TiledCanvas(e);this.effectsCanvas=b;this.effectsCanvasCtx=b.getContext("2d");b.addEventListener("mousedown",
this.exectool.bind(this));b.addEventListener("mousemove",this.exectool.bind(this));b.addEventListener("mouseup",this.exectool.bind(this));b.addEventListener("mouseleave",this.exectool.bind(this));b.addEventListener("touchstart",this.exectool.bind(this));b.addEventListener("touchmove",this.exectool.bind(this));b.addEventListener("touchend",this.exectool.bind(this));this.canvasArray=[a,c,e,b];this.lastCanvas=e;this.pathCanvas=this.newCanvasOnTop("paths");this.pathContext=this.pathCanvas.getContext("2d")};
Paint.prototype.addCoordDom=function(b){this.coordDiv=b.appendChild(document.createElement("div"));this.coordDiv.className="mouse-coords";this.coordDiv.appendChild(document.createTextNode("x:"));b=this.coordDiv.appendChild(document.createElement("input"));this.coordDiv.appendChild(document.createTextNode("y:"));var a=this.coordDiv.appendChild(document.createElement("input"));b.type="number";a.type="number";b.min=-65536;a.min=-65536;b.max=65536;a.max=65536;b.addEventListener("input",function(b){this.goto(parseInt(b.target.value)||
0,this.public.leftTopY)}.bind(this));a.addEventListener("input",function(b){this.goto(this.public.leftTopX,parseInt(b.target.value)||0)}.bind(this))};Paint.prototype.setMouseCoords=function(b,a){for(var c=!1,e=0;e<this.coordDiv.children.length;e++)if("number"==this.coordDiv.children[e].type){this.coordDiv.children[e].value=c?a.toFixed():b.toFixed();if(c)break;c=!0}};
...
typeof c._introCompleteCallback&&c._introCompleteCallback.call(c),void 0!=c._introExitCallback&&c._introExitCallback.call(c),g.call(c,b)):d.call(c);a.preventDefault?a.preventDefault():a.returnValue=!1}},c._onResize=function(b){m.call(c,document.querySelector(".introjs-helperLayer"));m.call(c,document.querySelector(".introjs-tooltipReferenceLayer"))},window.addEventListener?(this._options.keyboardNavigation&&window.addEventListener("keydown",c._onKeyDown,!0),window.addEventListener("resize",c._onResize,
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=B();var q=t(a).height+10,m=t(a).width+20,n=t(b),v="floating";n.left+m>h.width||0>n.left+n.width/2-m?(p(g,"bottom"),p(g,"top")):(n.height+n.top+q>h.height&&p(g,"bottom"),0>n.top-q&&p(g,"top"));n.width+n.left+m>h.width&&p(g,"right");0>n.left-m&&p(g,"left");0<g.length&&(v=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(v=f);h=v}f=t(b);b=t(a);g=B();switch(h){case "top":c.className="introjs-arrow bottom";k(f,e?0:15,b,g,a);a.style.bottom=f.height+20+
...
break;default:c.className="introjs-arrow top",k(f,0,b,g,a),a.style.top=f.height+20+"px"}}}function k(b,a,c,d,e){if(b.left+a+c.width>d.width)return e.style.left=d.width-c.width-b.left+"px",!1;e.style.left=a+"px";return!0}function l(b,a,c,d){if(0>b.left+b.width-a-c.width)return d.style.left=-b.left+"px",!1;d.style.right=a+"px";return!0}function p(b,a){-1<b.indexOf(a)&&b.splice(b.indexOf(a),1)}function m(b){if(b&&this._introItems[this._currentStep]){var a=this._introItems[this._currentStep],c=t(a.element),
d=10;v(a.element)&&(b.className+=" introjs-fixedTooltip");"floating"==a.position&&(d=0);b.setAttribute("style","width: "+(c.width+d)+"px; height:"+(c.height+d)+"px; top:"+(c.top-5)+"px;left: "+(c.left-5)+"px;")}}function r(){var b=document.querySelector(".introjs-disableInteraction");null===b&&(b=document.createElement("div"),b.className="introjs-disableInteraction",this._targetElement.appendChild(b));m.call(this,b)}function n(b){"undefined"!==typeof this._introChangeCallback&&this._introChangeCallback.call(this,
b.element);var a=this,c=document.querySelector(".introjs-helperLayer"),e=document.querySelector(".introjs-tooltipReferenceLayer"),k="introjs-helperLayer";t(b.element);"string"===typeof b.highlightClass&&(k+=" "+b.highlightClass);"string"===typeof this._options.highlightClass&&(k+=" "+this._options.highlightClass);if(null!=c){var l=e.querySelector(".introjs-helperNumberLayer"),p=e.querySelector(".introjs-tooltiptext"),n=e.querySelector(".introjs-arrow"),v=e.querySelector(".introjs-tooltip"),E=e.querySelector(".introjs-skipbutton"),
C=e.querySelector(".introjs-prevbutton"),G=e.querySelector(".introjs-nextbutton");c.className=k;v.style.opacity=0;v.style.display="none";if(null!=l){var x=this._introItems[0<=b.step-2?b.step-2:0];if(null!=x&&"forward"==this._direction&&"floating"==x.position||"backward"==this._direction&&"floating"==b.position)l.style.opacity=0}m.call(a,c);m.call(a,e);if((x=document.querySelectorAll(".introjs-fixParent"))&&0<x.length)for(k=x.length-1;0<=k;k--)x[k].className=x[k].className.replace(/introjs-fixParent/g,
"").replace(/^\s+|\s+$/g,"");x=document.querySelector(".introjs-showElement");x.className=x.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");a._lastShowElementTimer&&clearTimeout(a._lastShowElementTimer);a._lastShowElementTimer=setTimeout(function(){null!=l&&(l.innerHTML=b.step);p.innerHTML=b.intro;v.style.display="block";h.call(a,b.element,v,n,l);e.querySelector(".introjs-bullets li > a.active").className="";e.querySelector('.introjs-bullets li > a[data-stepnumber="'+b.step+'"]').className=
"active";e.querySelector(".introjs-progress .introjs-progressbar").setAttribute("style","width:"+H.call(a)+"%;");v.style.opacity=1;l&&(l.style.opacity=1);-1===G.tabIndex?E.focus():G.focus()},350)}else{var s=document.createElement("div"),C=document.createElement("div"),c=document.createElement("div"),F=document.createElement("div"),W=document.createElement("div"),A=document.createElement("div"),y=document.createElement("div"),N=document.createElement("div");s.className=k;C.className="introjs-tooltipReferenceLayer";
m.call(a,s);m.call(a,C);this._targetElement.appendChild(s);this._targetElement.appendChild(C);c.className="introjs-arrow";W.className="introjs-tooltiptext";W.innerHTML=b.intro;A.className="introjs-bullets";!1===this._options.showBullets&&(A.style.display="none");for(var s=document.createElement("ul"),k=0,ca=this._introItems.length;k<ca;k++){var u=document.createElement("li"),L=document.createElement("a");L.onclick=function(){a.goToStep(this.getAttribute("data-stepnumber"))};k===b.step-1&&(L.className=
"active");L.href="javascript:void(0);";L.innerHTML="&nbsp;";L.setAttribute("data-stepnumber",this._introItems[k].step);u.appendChild(L);s.appendChild(u)}A.appendChild(s);y.className="introjs-progress";!1===this._options.showProgress&&(y.style.display="none");k=document.createElement("div");k.className="introjs-progressbar";k.setAttribute("style","width:"+H.call(this)+"%;");y.appendChild(k);N.className="introjs-tooltipbuttons";!1===this._options.showButtons&&(N.style.display="none");F.className="introjs-tooltip";
F.appendChild(W);F.appendChild(A);F.appendChild(y);!0==this._options.showStepNumbers&&(x=document.createElement("span"),x.className="introjs-helperNumberLayer",x.innerHTML=b.step,C.appendChild(x));F.appendChild(c);C.appendChild(F);G=document.createElement("a");G.onclick=function(){a._introItems.length-1!=a._currentStep&&d.call(a)};G.href="javascript:void(0);";G.innerHTML=this._options.nextLabel;C=document.createElement("a");C.onclick=function(){0!=a._currentStep&&f.call(a)};C.href="javascript:void(0);";
C.innerHTML=this._options.prevLabel;E=document.createElement("a");E.className="introjs-button introjs-skipbutton";E.href="javascript:void(0);";E.innerHTML=this._options.skipLabel;E.onclick=function(){a._introItems.length-1==a._currentStep&&"function"===typeof a._introCompleteCallback&&a._introCompleteCallback.call(a);a._introItems.length-1!=a._currentStep&&"function"===typeof a._introExitCallback&&a._introExitCallback.call(a);g.call(a,a._targetElement)};N.appendChild(E);1<this._introItems.length&&
(N.appendChild(C),N.appendChild(G));F.appendChild(N);h.call(a,b.element,F,c,x)}!0===this._options.disableInteraction&&r.call(a);C.removeAttribute("tabIndex");G.removeAttribute("tabIndex");0==this._currentStep&&1<this._introItems.length?(C.className="introjs-button introjs-prevbutton introjs-disabled",C.tabIndex="-1",G.className="introjs-button introjs-nextbutton",E.innerHTML=this._options.skipLabel):this._introItems.length-1==this._currentStep||1==this._introItems.length?(E.innerHTML=this._options.doneLabel,
C.className="introjs-button introjs-prevbutton",G.className="introjs-button introjs-nextbutton introjs-disabled",G.tabIndex="-1"):(C.className="introjs-button introjs-prevbutton",G.className="introjs-button introjs-nextbutton",E.innerHTML=this._options.skipLabel);G.focus();b.element.className+=" introjs-showElement";x=q(b.element,"position");"absolute"!==x&&"relative"!==x&&(b.element.className+=" introjs-relativePosition");for(x=b.element.parentNode;null!=x&&"body"!==x.tagName.toLowerCase();){c=q(x,
"z-index");F=parseFloat(q(x,"opacity"));N=q(x,"transform")||q(x,"-webkit-transform")||q(x,"-moz-transform")||q(x,"-ms-transform")||q(x,"-o-transform");if(/[0-9]+/.test(c)||1>F||"none"!==N&&void 0!==N)x.className+=" introjs-fixParent";x=x.parentNode}J(b.element)||!0!==this._options.scrollToElement||(F=b.element.getBoundingClientRect(),x=B().height,c=F.bottom-(F.bottom-F.top),F=F.bottom-x,0>c||b.element.clientHeight>x?window.scrollBy(0,c-30):window.scrollBy(0,F+100));"undefined"!==typeof this._introAfterChangeCallback&&
this._introAfterChangeCallback.call(this,b.element)}function q(b,a){var c="";b.currentStyle?c=b.currentStyle[a]:document.defaultView&&document.defaultView.getComputedStyle&&(c=document.defaultView.getComputedStyle(b,null).getPropertyValue(a));return c&&c.toLowerCase?c.toLowerCase():c}function v(b){var a=b.parentNode;return"HTML"===a.nodeName?!1:"fixed"==q(b,"position")?!0:v(a)}function B(){if(void 0!=window.innerWidth)return{width:window.innerWidth,height:window.innerHeight};var b=document.documentElement;
return{width:b.clientWidth,height:b.clientHeight}}function J(b){b=b.getBoundingClientRect();return 0<=b.top&&0<=b.left&&b.bottom+80<=window.innerHeight&&b.right<=window.innerWidth}function F(b){var a=document.createElement("div"),c="",d=this;a.className="introjs-overlay";if("body"===b.tagName.toLowerCase())c+="top: 0;bottom: 0; left: 0;right: 0;position: fixed;",a.setAttribute("style",c);else{var e=t(b);e&&(c+="width: "+e.width+"px; height:"+e.height+"px; top:"+e.top+"px;left: "+e.left+"px;",a.setAttribute("style",
...
N.call(this,c.hintPosition,c.element,c.targetElement)}}function W(b){G.call(this);var a=this._targetElement.querySelector('.introjs-hint[data-step="'+b+'"]');a&&(a.className+=" introjs-hidehint");"undefined"!==typeof this._hintCloseCallback&&this._hintCloseCallback.call(this,b)}function x(){var b=this,a=document.querySelector(".introjs-hints");null==a&&(a=document.createElement("div"),a.className="introjs-hints");for(var c=0,d=this._introItems.length;c<d;c++){var e=this._introItems[c];if(!document.querySelector('.introjs-hint[data-step="'+
c+'"]')){var f=document.createElement("a");f.href="javascript:void(0);";(function(a,c,d){a.onclick=function(e){e=e?e:window.event;e.stopPropagation&&e.stopPropagation();null!=e.cancelBubble&&(e.cancelBubble=!0);A.call(b,a,c,d)}})(f,e,c);f.className="introjs-hint";v(e.element)&&(f.className+=" introjs-fixedhint");var g=document.createElement("div");g.className="introjs-hint-dot";var h=document.createElement("div");h.className="introjs-hint-pulse";f.appendChild(g);f.appendChild(h);f.setAttribute("data-step",
c);e.targetElement=e.element;e.element=f;N.call(this,e.hintPosition,f,e.targetElement);a.appendChild(f)}}document.body.appendChild(a);"undefined"!==typeof this._hintsAddedCallback&&this._hintsAddedCallback.call(this)}function N(b,a,c){c=t.call(this,c);switch(b){default:case "top-left":a.style.left=c.left+"px";a.style.top=c.top+"px";break;case "top-right":a.style.left=c.left+c.width+"px";a.style.top=c.top+"px";break;case "bottom-left":a.style.left=c.left+"px";a.style.top=c.top+c.height+"px";break;
case "bottom-right":a.style.left=c.left+c.width+"px";a.style.top=c.top+c.height+"px";break;case "bottom-middle":a.style.left=c.left+c.width/2+"px";a.style.top=c.top+c.height+"px";break;case "top-middle":a.style.left=c.left+c.width/2+"px",a.style.top=c.top+"px"}}function A(b,a,c){"undefined"!==typeof this._hintClickCallback&&this._hintClickCallback.call(this,b,a,c);var d=G.call(this);if(parseInt(d,10)!=c){var d=document.createElement("div"),e=document.createElement("div"),f=document.createElement("div"),
g=document.createElement("div");d.className="introjs-tooltip";d.onclick=function(b){b.stopPropagation?b.stopPropagation():b.cancelBubble=!0};e.className="introjs-tooltiptext";var k=document.createElement("p");k.innerHTML=a.hint;a=document.createElement("a");a.className="introjs-button";a.innerHTML=this._options.hintButtonLabel;a.onclick=W.bind(this,c);e.appendChild(k);e.appendChild(a);f.className="introjs-arrow";d.appendChild(f);d.appendChild(e);this._currentStep=b.getAttribute("data-step");g.className=
"introjs-tooltipReferenceLayer introjs-hintReference";g.setAttribute("data-step",b.getAttribute("data-step"));m.call(this,g);g.appendChild(d);document.body.appendChild(g);h.call(this,b,d,f,null,!0)}}function t(b){var a={};a.width=b.offsetWidth;a.height=b.offsetHeight;for(var c=0,d=0;b&&!isNaN(b.offsetLeft)&&!isNaN(b.offsetTop);)c+=b.offsetLeft,d+=b.offsetTop,b=b.offsetParent;a.top=d;a.left=c;return a}function H(){return 100*(parseInt(this._currentStep+1,10)/this._introItems.length)}var y=function(b){if("object"===
...
b-2;"undefined"!==typeof this._introItems&&d.call(this);return this},nextStep:function(){d.call(this);return this},previousStep:function(){f.call(this);return this},exit:function(){g.call(this,this._targetElement);return this},refresh:function(){m.call(this,document.querySelector(".introjs-helperLayer"));m.call(this,document.querySelector(".introjs-tooltipReferenceLayer"));return this},onbeforechange:function(b){if("function"===typeof b)this._introBeforeChangeCallback=b;else throw Error("Provided callback for onbeforechange was not a function");
...
this._drag),document.addEventListener("mouseup",this._endDrag),this._startX=a.clientX,this._startY=a.clientY);a.preventDefault()},_drag:function(b){var c=parseInt(this._panel.style.left),e=parseInt(this._panel.style.top),d=b.clientX,f=b.clientY;this.setPosition(c+d-this._startX,e+f-this._startY);this._startX=d;this._startY=f;b.preventDefault()},_endDrag:function(b){document.removeEventListener("mousemove",this._drag);document.removeEventListener("mouseup",this._endDrag);b.preventDefault()},_doubleClickTitle:function(){this._collapsible&&
...
e,d,f,g){this.addRange(b,c,e,d,f,function(c){g[b]=c})},addControl:function(b){if("string"!==typeof b.type)throw"AddControl needs an object with a type";var c=localStorage.getItem("quicksettings-"+b.title)||b.value||b.color||b.text,e=b.callback||function(){};switch(b.type.toLowerCase()){case "range":this.addRange(b.title,b.min,b.max,parseFloat(c),b.step,e);break;case "color":this.addColor(b.title,c,e);break;case "boolean":this.addBoolean(b.title,"string"==typeof c?"true"==c:c,e);break;case "text":this.addText(b.title,
c,e);break;case "textarea":this.addTextArea(b);break;case "dropdown":this.addDropDown(b.title,b.items,e,c)}this.addCallbackHandler(b.title,function(c){localStorage.setItem("quicksettings-"+b.title,c.index||c.value)})},addRange:function(b,c,e,d,f,g){var h=this._createContainer(),k=document.createElement("input");k.type="range";k.id=b;k.min=c||0;k.max=e||100;k.step=f||1;k.value=d||0;k.className="msettings_range";var l=this._createLabel("<b>"+b+":</b> "+k.value);h.appendChild(l);h.appendChild(k);this._content.appendChild(h);
this._controls[b]={container:h,control:k,label:l,callback:g};c="input";this._isIE()&&(c="change");var p=this._globalChangeHandler,m=this;k.addEventListener(c,function(){l.innerHTML="<b>"+b+":</b> "+k.value;g&&g(parseFloat(k.value));p&&p();m._callCallbacks(b,{value:parseFloat(k.value)})})},_isIE:function(){return-1!=navigator.userAgent.indexOf("rv:11")||-1!=navigator.userAgent.indexOf("MSIE")?!0:!1},getRangeValue:function(b){return this._controls[b].control.value},setRangeValue:function(b,c,e){var d=
this._controls[b];d.control.value=c;d.label.innerHTML="<b>"+b+":</b> "+d.control.value;e&&(d.callback&&d.callback(parseFloat(d.control.value)),this._globalChangeHandler&&this._globalChangeHandler())},setRangeParameters:function(b,c,e,d){b=this._controls[b];b.control.min=c;b.control.max=e;b.control.step=d},bindBoolean:function(b,c,e){this.addBoolean(b,c,function(c){e[b]=c})},addBoolean:function(b,c,e){var d=this._createContainer(),f=document.createElement("span");f.className="msettings_checkbox_label";
f.textContent=b;var g=document.createElement("input");g.type="checkbox";g.id=b;g.checked=c;g.className="msettings_checkbox";d.appendChild(g);d.appendChild(f);this._content.appendChild(d);this._controls[b]={container:d,control:g,callback:e};var h=this._globalChangeHandler,k=this;g.addEventListener("change",function(){e&&e(g.checked);h&&h();k._callCallbacks(b,{value:g.checked})});f.addEventListener("click",function(){g.disabled||(g.checked=!g.checked,e&&e(g.checked),h&&h(),k._callCallbacks(b,{value:g.checked}))})},
...
control:d};var f=this._globalChangeHandler,g=this;d.addEventListener("click",function(){c&&c(d);f&&f();g._callCallbacks(b,{button:d})})},bindColor:function(b,c,e){this.addColor(b,c,function(c){e[b]=c})},addColor:function(b,c,e){var d=this._createContainer(),f=this._createLabel("<b>"+b+":</b> "+c),g=document.createElement("input");try{g.type="color"}catch(h){g.type="text"}g.id=b;g.value=c||"#ff0000";g.className="msettings_color";d.appendChild(f);d.appendChild(g);this._content.appendChild(d);this._controls[b]=
{container:d,control:g,label:f,callback:e};var k=this._globalChangeHandler,l=this;g.addEventListener("input",function(){f.innerHTML="<b>"+b+":</b> "+g.value;e&&e(g.value);k&&k();l._callCallbacks(b,{value:g.value})})},getColor:function(b){return this._controls[b].control.value},setColor:function(b,c,e){var d=this._controls[b];d.control.value=c;d.label.innerHTML="<b>"+b+":</b> "+d.control.value;e&&(d.callback&&d.callback(d.control.value),this._globalChangeHandler&&this._globalChangeHandler(),this._callCallbacks(b,
{value:c}))},bindText:function(b,c,e){this.addText(b,c,function(c){e[b]=c})},addText:function(b,c,e){var d=this._createContainer(),f=this._createLabel("<b>"+b+"</b>"),g=document.createElement("input");g.type="text";g.id=b;g.value=c||"";g.className="msettings_text_input";d.appendChild(f);d.appendChild(g);this._content.appendChild(d);this._controls[b]={container:d,control:g,label:f,callback:e};var h=this._globalChangeHandler,k=this;g.addEventListener("input",function(){e&&e(g.value);h&&h();k._callCallbacks(b,
{value:g.value})})},addTextArea:function(b,c,e){var d=this._createContainer(),f=this._createLabel("<b>"+b+"</b>"),g=document.createElement("textarea");g.id=b;g.rows=5;g.value=c||"";g.className="msettings_textarea";d.appendChild(f);d.appendChild(g);this._content.appendChild(d);this._controls[b]={container:d,control:g,label:f,callback:e};var h=this._globalChangeHandler,k=this;g.addEventListener("input",function(){e&&e(g.value);h&&h();k._callCallbacks(b,{value:g.value})})},setTextAreaRows:function(b,
...
c,e,d){for(var f=this._createContainer(),g=this._createLabel("<b>"+b+"</b>"),h=document.createElement("select"),k=0;k<c.length;k++){var l=document.createElement("option");l.label=c[k];h.add(l)}d&&(h.selectedIndex=d);var p=this._globalChangeHandler,m=this;h.addEventListener("change",function(){var c=h.selectedIndex,d=h.options;e&&e({index:c,value:d[c].label});p&&p();m._callCallbacks(b,{index:c,value:d[c].label})});h.className="msettings_select";f.appendChild(g);f.appendChild(h);this._content.appendChild(f);
this._controls[b]={container:f,control:h,label:g,callback:e}},getDropDownValue:function(b){b=this._controls[b].control;var c=b.selectedIndex;return{index:c,value:b.options[c].label}},setDropDownIndex:function(b,c,e){var d=this._controls[b],f=d.control.options;d.control.selectedIndex=c;e&&(d.callback&&d.callback({index:c,value:f[c].label}),this._globalChangeHandler&&this._globalChangeHandler(),this._callCallbacks(b,{index:c,value:f[c].label}))},getInfo:function(b){return this._controls[b].container.innerHTML},
setInfo:function(b,c){this._controls[b].container.innerHTML=c},addImage:function(b,c){var e=this._createContainer(),d=this._createLabel("<b>"+b+"</b>");img=document.createElement("img");img.className="msettings_image";img.src=c;e.appendChild(d);e.appendChild(img);this._content.appendChild(e);this._controls[b]={container:e,control:img,label:d}},setImageURL:function(b,c){this._controls[b].control.src=c},addProgressBar:function(b,c,e,d){var f=this._createContainer(),g=this._createLabel("");progress=
document.createElement("progress");progress.className="msettings_progress";progress.max=c;progress.value=e;g.innerHTML=d?"<b>"+b+":<b> "+e+" / "+c:"<b>"+b+"<b>";f.appendChild(g);f.appendChild(progress);this._content.appendChild(f);this._controls[b]={container:f,control:progress,showNumbers:d,label:g}},getProgress:function(b){return this._controls[b].control.value},setProgress:function(b,c){var e=this._controls[b].control;e.value=c;this._controls[b].label.innerHTML=this._controls[b].showNumbers?"<b>"+
...
b),f.startDragY=h.page("Y",b),f.dragWatchers={current:0,last:0,hold:0,state:""},f.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(b){if(f.isDragging&&d.touchToDrag){var c=h.page("X",b),e=h.page("Y",b),g=f.translation,n=k.translate.get.matrix(4),q=c-f.startDragX,v=0<n,B=q;if(!f.intentChecked||f.hasIntent){d.addBodyClasses&&(0<n?(h.klass.add(a.body,"snapjs-left"),h.klass.remove(a.body,
"snapjs-right")):0>n&&(h.klass.add(a.body,"snapjs-right"),h.klass.remove(a.body,"snapjs-left")));if(!1===f.hasIntent||null===f.hasIntent){var e=h.angleOfDrag(c,e),J=0<=e&&e<=d.slideIntent||360>=e&&e>360-d.slideIntent;f.hasIntent=180<=e&&e<=180+d.slideIntent||180>=e&&e>=180-d.slideIntent||J?!0:!1;f.intentChecked=!0}d.minDragDistance>=Math.abs(c-f.startDragX)||!1===f.hasIntent||(h.events.prevent(b),h.dispatchEvent("drag"),f.dragWatchers.current=c,f.dragWatchers.last>c?("left"!==f.dragWatchers.state&&
(f.dragWatchers.state="left",f.dragWatchers.hold=c),f.dragWatchers.last=c):f.dragWatchers.last<c&&("right"!==f.dragWatchers.state&&(f.dragWatchers.state="right",f.dragWatchers.hold=c),f.dragWatchers.last=c),v?(d.maxPosition<n&&(b=(n-d.maxPosition)*d.resistance,B=q-b),f.simpleStates={opening:"left",towards:f.dragWatchers.state,hyperExtending:d.maxPosition<n,halfway:n>d.maxPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:n,relative:q,sinceDirectionChange:f.dragWatchers.current-
f.dragWatchers.hold,percentage:100*(n/d.maxPosition)}}):(d.minPosition>n&&(b=(n-d.minPosition)*d.resistance,B=q-b),f.simpleStates={opening:"right",towards:f.dragWatchers.state,hyperExtending:d.minPosition>n,halfway:n<d.minPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:n,relative:q,sinceDirectionChange:f.dragWatchers.current-f.dragWatchers.hold,percentage:100*(n/d.minPosition)}}),k.translate.x(B+g))}}},endDrag:function(b){if(f.isDragging){h.dispatchEvent("end");
...
!this._reconnection||0!==this.attempts)||(this.openReconnect=!0,this.reconnect())};d.prototype.open=d.prototype.connect=function(a){p("readyState %s",this.readyState);if(~this.readyState.indexOf("open"))return this;p("opening %s",this.uri);var c=this.engine=f(this.uri,this.opts),d=this;this.readyState="opening";var e=k(c,"open",function(){d.onopen();a&&a()}),g=k(c,"error",function(c){p("connect_error");d.cleanup();d.readyState="closed";d.emitAll("connect_error",c);if(a){var e=Error("Connection error");
e.data=c;a(e)}d.maybeReconnectOnOpen()});if(!1!==this._timeout){var h=this._timeout;p("connect attempt will timeout after %d",h);var l=setTimeout(function(){p("connect attempt timed out after %d",h);e.destroy();c.close();c.emit("error","timeout");d.emitAll("connect_timeout",h)},h);this.subs.push({destroy:function(){clearTimeout(l)}})}this.subs.push(e);this.subs.push(g);return this};d.prototype.onopen=function(){p("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(k(a,
"data",l(this,"ondata")));this.subs.push(k(this.decoder,"decoded",l(this,"ondecoded")));this.subs.push(k(a,"error",l(this,"onerror")));this.subs.push(k(a,"close",l(this,"onclose")))};d.prototype.ondata=function(a){this.decoder.add(a)};d.prototype.ondecoded=function(a){this.emit("packet",a)};d.prototype.onerror=function(a){p("error",a);this.emitAll("error",a)};d.prototype.socket=function(a){var c=this.nsps[a];if(!c){c=new g(this,a);this.nsps[a]=c;var d=this;c.on("connect",function(){d.connected++})}return c};
d.prototype.destroy=function(a){--this.connected||this.close()};d.prototype.packet=function(a){p("writing packet %j",a);var c=this;c.encoding?c.packetBuffer.push(a):(c.encoding=!0,this.encoder.encode(a,function(a){for(var d=0;d<a.length;d++)c.engine.write(a[d]);c.encoding=!1;c.processPacketQueue()}))};d.prototype.processPacketQueue=function(){if(0<this.packetBuffer.length&&!this.encoding){var a=this.packetBuffer.shift();this.packet(a)}};d.prototype.cleanup=function(){for(var a;a=this.subs.shift();)a.destroy();
this.packetBuffer=[];this.encoding=!1;this.decoder.destroy()};d.prototype.close=d.prototype.disconnect=function(){this.skipReconnect=!0;this.engine.close()};d.prototype.onclose=function(a){p("close");this.cleanup();this.readyState="closed";this.emit("close",a);this._reconnection&&!this.skipReconnect&&this.reconnect()};d.prototype.reconnect=function(){if(this.reconnecting)return this;var a=this;this.attempts++;if(this.attempts>this._reconnectionAttempts)p("reconnect failed"),this.emitAll("reconnect_failed"),
this.reconnecting=!1;else{var c=this.attempts*this.reconnectionDelay(),c=Math.min(c,this.reconnectionDelayMax());p("will wait %dms before reconnect attempt",c);this.reconnecting=!0;var d=setTimeout(function(){p("attempting reconnect");a.emitAll("reconnect_attempt",a.attempts);a.emitAll("reconnecting",a.attempts);a.open(function(c){c?(p("reconnect attempt error"),a.reconnecting=!1,a.reconnect(),a.emitAll("reconnect_error",c.data)):(p("reconnect success"),a.onreconnect())})},c);this.subs.push({destroy:function(){clearTimeout(d)}})}};
...
c):this.receiveBuffer.push(c)};d.prototype.ack=function(a){var c=this,d=!1;return function(){if(!d){d=!0;var e=g(arguments);l("sending ack %j",e);var h=p(e)?f.BINARY_ACK:f.ACK;c.packet({type:h,id:a,data:e})}}};d.prototype.onack=function(a){l("calling ack %s with %j",a.id,a.data);this.acks[a.id].apply(this,a.data);delete this.acks[a.id]};d.prototype.onconnect=function(){this.connected=!0;this.disconnected=!1;this.emit("connect");this.emitBuffered()};d.prototype.emitBuffered=function(){var a;for(a=
...
Error&&(c=c.stack||c.message);var e=new Date,f=e-(d[a]||e);d[a]=e;c=a+" "+c+" +"+d.humanize(f);window.console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)}:function(){}}c.exports=d;d.names=[];d.skips=[];d.enable=function(a){try{localStorage.debug=a}catch(c){}for(var e=(a||"").split(/[\s,]+/),f=e.length,p=0;p<f;p++)a=e[p].replace("*",".*?"),"-"===a[0]?d.skips.push(RegExp("^"+a.substr(1)+"$")):d.names.push(RegExp("^"+a+"$"))};d.disable=function(){d.enable("")};d.humanize=
...
function(a){k("setting transport %s",a.name);var c=this;this.transport&&(k("clearing existing transport %s",this.transport.name),this.transport.removeAllListeners());this.transport=a;a.on("drain",function(){c.onDrain()}).on("packet",function(a){c.onPacket(a)}).on("error",function(a){c.onError(a)}).on("close",function(){c.onClose("transport close")})};e.prototype.probe=function(a){function c(){if(A.onlyBinaryUpgrades){var d=!this.supportsBinary&&A.transport.supportsBinary;r=r||d}r||(k('probe transport "%s" opened',
a),m.send([{type:"ping",data:"probe"}]),m.once("packet",function(c){r||("pong"==c.type&&"probe"==c.data?(k('probe transport "%s" pong',a),A.upgrading=!0,A.emit("upgrading",m),e.priorWebsocketSuccess="websocket"==m.name,k('pausing current transport "%s"',A.transport.name),A.transport.pause(function(){r||("closed"==A.readyState||"closing"==A.readyState)||(k("changing transport and sending upgrade packet"),n(),A.setTransport(m),m.send([{type:"upgrade"}]),A.emit("upgrade",m),m=null,A.upgrading=!1,A.flush())})):
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=m.name,A.emit("upgradeError",c)))}))}function d(){r||(r=!0,n(),m.close(),m=null)}function g(c){var e=Error("probe error: "+c);e.transport=m.name;d();k('probe transport "%s" failed because of error: %s',a,c);A.emit("upgradeError",e)}function h(){g("transport closed")}function p(){g("socket closed")}function l(a){m&&a.name!=m.name&&(k('"%s" works - aborting "%s"',a.name,m.name),d())}function n(){m.removeListener("open",c);m.removeListener("error",
g);m.removeListener("close",h);A.removeListener("close",p);A.removeListener("upgrading",l)}k('probing transport "%s"',a);var m=this.createTransport(a,{probe:1}),r=!1,A=this;e.priorWebsocketSuccess=!1;m.once("open",c);m.once("error",g);m.once("close",h);this.once("close",p);this.once("upgrading",l);m.open()};e.prototype.onOpen=function(){k("socket open");this.readyState="open";e.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
...
this.form=g;this.area=h}this.form.action=this.uri();e();a=a.replace(p,"\\\n");this.area.value=a.replace(l,"\\n");try{this.form.submit()}catch(W){}this.iframe.attachEvent?this.iframe.onreadystatechange=function(){"complete"==f.iframe.readyState&&d()}:this.iframe.onload=d}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./polling":17,"component-inherit":20}],16:[function(a,c,e){(function(d){function e(){}function g(a){p.call(this,a);if(d.location){var c="https:"==
...
p=a("./polling"),m=a("component-emitter"),r=a("component-inherit"),n=a("debug")("engine.io-client:polling-xhr");c.exports=g;c.exports.Request=h;r(g,p);g.prototype.supportsBinary=!0;g.prototype.request=function(a){a=a||{};a.uri=this.uri();a.xd=this.xd;a.xs=this.xs;a.agent=this.agent||!1;a.supportsBinary=this.supportsBinary;a.enablesXDR=this.enablesXDR;return new h(a)};g.prototype.doWrite=function(a,c){var d=this.request({method:"POST",data:a,isBinary:"string"!==typeof a&&void 0!==a}),e=this;d.on("success",
c);d.on("error",function(a){e.onError("xhr post error",a)});this.sendXhr=d};g.prototype.doPoll=function(){n("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};m(h.prototype);h.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{n("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
...
l=0===h[0],m="",n=1;255!=h[n];n++){if(310<m.length){g=!0;break}m+=h[n]}if(g)return d(v,0,1);a=k(a,2+m.length);m=parseInt(m);h=k(a,0,m);if(l)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(p){for(l=new Uint8Array(h),h="",n=0;n<l.length;n++)h+=String.fromCharCode(l[n])}f.push(h);a=k(a,m)}var q=f.length;f.forEach(function(a,f){d(e.decodePacket(a,c,!0),f,q)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
return k};e.decode=function(c){var e=0.75*c.length,h=c.length,k=0,l,p,m,r;"="===c[c.length-1]&&(e--,"="===c[c.length-2]&&e--);for(var n=new ArrayBuffer(e),q=new Uint8Array(n),e=0;e<h;e+=4)l=a.indexOf(c[e]),p=a.indexOf(c[e+1]),m=a.indexOf(c[e+2]),r=a.indexOf(c[e+3]),q[k++]=l<<2|p>>4,q[k++]=(p&15)<<4|m>>2,q[k++]=(m&3)<<6|r&63;return n}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")},{}],26:[function(a,c,e){(function(a){function e(a,c){c=c||{};for(var d=new g,f=0;f<a.length;f++)d.append(a[f]);
...
56320==(h&64512)?c.push(((f&1023)<<10)+(h&1023)+65536):(c.push(f),d--)):c.push(f);return c}function h(){if(v>=q)throw Error("Invalid byte index");var a=n[v]&255;v++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,d,e;if(v>q)throw Error("Invalid byte index");if(v==q)return!1;a=n[v]&255;v++;if(0==(a&128))return a;if(192==(a&224)){c=h();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=h();d=h();a=(a&15)<<12|c<<6|
d;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=h(),d=h(),e=h(),a=(a&15)<<18|c<<12|d<<6|e,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof e&&e,p="object"==typeof c&&c&&c.exports==l&&c,m="object"==typeof a&&a;if(m.global===m||m.window===m)f=m;var r=String.fromCharCode,n,q,v,m={version:"2.0.0",encode:function(a){a=g(a);for(var c=a.length,d=-1,e,f="";++d<c;){e=a[d];if(0==(e&4294967168))e=r(e);else{var h="";0==(e&4294965248)?
h=r(e>>6&31|192):0==(e&4294901760)?(h=r(e>>12&15|224),h+=r(e>>6&63|128)):0==(e&4292870144)&&(h=r(e>>18&7|240),h+=r(e>>12&63|128),h+=r(e>>6&63|128));e=h+=r(e&63|128)}f+=e}return f},decode:function(a){n=g(a);q=n.length;v=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var d=-1,e,f="";++d<c;)e=a[d],65535<e&&(e-=65536,f+=r(e>>>10&1023|55296),e=56320|e&1023),f+=r(e);return f}};if(l&&!l.nodeType)if(p)p.exports=m;else{f={}.hasOwnProperty;for(var B in m)f.call(m,B)&&(l[B]=m[B])}else f.utf8=m})(this)}).call(this,
"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{}],28:[function(a,c,e){(function(a){var e=/^[\],:{}\s]*$/,g=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,h=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,k=/(?:^|:|,)(?:\s*\[)+/g,l=/^\s+/,p=/\s+$/;c.exports=function(c){if("string"!=typeof c||!c)return null;c=c.replace(l,"").replace(p,"");if(a.JSON&&JSON.parse)return JSON.parse(c);if(e.test(c.replace(g,"@").replace(h,"]").replace(k,"")))return(new Function("return "+
...
a._placeholder)return c[a.num];if(f(a))for(var e=0;e<a.length;e++)a[e]=d(a[e]);else if(a&&"object"==typeof a)for(e in a)a[e]=d(a[e]);return a}a.data=d(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,h,q){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){p++;var v=new FileReader;v.onload=function(){q?q[h]=this.result:m=this.result;--p||e(m)};v.readAsArrayBuffer(a)}else if(f(a))for(v=0;v<a.length;v++)l(a[v],v,a);else if(a&&"object"==typeof a&&!g(a))for(v in a)l(a[v],
v,a)}var p=0,m=a;l(m);p||e(m)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=p.stringify(a.data));l("encoded %j as %s",a,c);return c}function g(a,c){m.removeBlobs(a,function(a){var d=m.deconstructPacket(a);
a=f(d.packet);d=d.buffers;d.unshift(a);c(d)})}function h(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),p=a("json3");a("isarray");c=a("component-emitter");var m=a("./binary"),r=a("./is-buffer");e.protocol=4;e.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");e.CONNECT=0;e.DISCONNECT=1;e.EVENT=2;e.ACK=3;e.ERROR=4;e.BINARY_EVENT=5;e.BINARY_ACK=6;e.Encoder=d;e.Decoder=h;d.prototype.encode=function(a,c){l("encoding packet %j",
...
1==a.length)break}else c.nsp="/";f=a.charAt(d+1);if(""!=f&&Number(f)==f){for(c.id="";++d;){f=a.charAt(d);if(null==f||Number(f)!=f){--d;break}c.id+=a.charAt(d);if(d+1==a.length)break}c.id=Number(c.id)}if(a.charAt(++d))try{c.data=p.parse(a.substr(d))}catch(h){a={type:e.ERROR,data:"parser error"};break a}l("decoded %s as %j",a,c);a=c}}e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type?(this.reconstructor=new k(a),0==this.reconstructor.reconPack.attachments&&this.emit("decoded",a)):this.emit("decoded",a)}else if(r(a)||
...
var d;if("bug-string-char-index"==a)d="a"!="a"[0];else if("json"==a)d=c("json-stringify")&&c("json-parse");else{var e;if("json-stringify"==a){d=m.stringify;var h="function"==typeof d&&r;if(h){(e=function(){return 1}).toJSON=e;try{h="0"===d(0)&&"0"===d(new Number)&&'""'==d(new String)&&d(g)===l&&d(l)===l&&d()===l&&"1"===d(e)&&"[1]"==d([e])&&"[null]"==d([l])&&"null"==d(null)&&"[null,null,null]"==d([l,g,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==d({a:[e,!0,!1,null,"\x00\b\n\f\r\t"]})&&
"1"===d(null,e)&&"[\n 1,\n 2\n]"==d([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==d(new Date(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==d(new Date(864E13))&&'"-000001-01-01T00:00:00.000Z"'==d(new Date(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==d(new Date(-1))}catch(k){h=!1}}d=h}if("json-parse"==a){d=m.parse;if("function"==typeof d)try{if(0===d("0")&&!d(!1)){e=d('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var p=5==e.a.length&&1===e.a[0];if(p){try{p=!d('"\t"')}catch(C){}if(p)try{p=1!==
d("01")}catch(n){}if(p)try{p=1!==d("1.")}catch(q){}}}}catch(s){p=!1}d=p}}return c[a]=!!d}var g={}.toString,h,k,l,p="object"==typeof JSON&&JSON,m="object"==typeof e&&e&&!e.nodeType&&e;m&&p?(m.stringify=p.stringify,m.parse=p.parse):m=a.JSON=p||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(n){}if(!c("json")){var q=c("bug-string-char-index");
if(!r)var v=Math.floor,B=[0,31,59,90,120,151,181,212,243,273,304,334],J=function(a,c){return B[c]+365*(a-1970)+v((a-1969+(c=+(1<c)))/4)-v((a-1901+c)/100)+v((a-1601+c)/400)};(h={}.hasOwnProperty)||(h=function(a){var c={},d;(c.__proto__=null,c.__proto__={toString:1},c).toString!=g?h=function(a){var c=this.__proto__;a=a in(this.__proto__=null,this);this.__proto__=c;return a}:(d=c.constructor,h=function(a){var c=(this.constructor||d).prototype;return a in this&&!(a in c&&this[a]===c[a])});c=null;return h.call(this,
a)});var F={"boolean":1,number:1,string:1,undefined:1};k=function(a,c){var d=0,e,f,l;(e=function(){this.valueOf=0}).prototype.valueOf=0;f=new e;for(l in f)h.call(f,l)&&d++;e=f=null;d?k=2==d?function(a,c){var d={},e="[object Function]"==g.call(a),f;for(f in a)e&&"prototype"==f||(h.call(d,f)||!(d[f]=1)||!h.call(a,f))||c(f)}:function(a,c){var d="[object Function]"==g.call(a),e,f;for(e in a)d&&"prototype"==e||(!h.call(a,e)||(f="constructor"===e))||c(e);(f||h.call(a,e="constructor"))&&c(e)}:(f="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),
k=function(a,c){var d="[object Function]"==g.call(a),e,k;if(k=!d)if(k="function"!=typeof a.constructor)k=typeof a.hasOwnProperty,k="object"==k?!!a.hasOwnProperty:!F[k];k=k?a.hasOwnProperty:h;for(e in a)d&&"prototype"==e||!k.call(a,e)||c(e);for(d=f.length;e=f[--d];k.call(a,e)&&c(e));});return k(a,c)};if(!c("json-stringify")){var G={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},E=function(a,c){return("000000"+(c||0)).slice(-a)},W=function(a){var c='"',d=0,e=a.length,f=10<e&&q,h;for(f&&
(h=a.split(""));d<e;d++){var g=a.charCodeAt(d);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=G[g];break;default:if(32>g){c+="\\u00"+E(2,g.toString(16));break}c+=f?h[d]:q?a.charAt(d):a[d]}}return c+'"'},x=function(a,c,d,e,f,m,p){var n,q,s,r,t,w,y,B,A;try{n=c[a]}catch(u){}if("object"==typeof n&&n)if(q=g.call(n),"[object Date]"!=q||h.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=q&&"[object String]"!=q&&"[object Array]"!=q||h.call(n,"toJSON"))&&(n=n.toJSON(a));
else if(n>-1/0&&n<1/0){if(J){r=v(n/864E5);for(q=v(r/365.2425)+1970-1;J(q+1,0)<=r;q++);for(s=v((r-J(q,0))/30.42);J(q,s+1)<=r;s++);r=1+r-J(q,s);t=(n%864E5+864E5)%864E5;w=v(t/36E5)%24;y=v(t/6E4)%60;B=v(t/1E3)%60;t%=1E3}else q=n.getUTCFullYear(),s=n.getUTCMonth(),r=n.getUTCDate(),w=n.getUTCHours(),y=n.getUTCMinutes(),B=n.getUTCSeconds(),t=n.getUTCMilliseconds();n=(0>=q||1E4<=q?(0>q?"-":"+")+E(6,0>q?-q:q):E(4,q))+"-"+E(2,s+1)+"-"+E(2,r)+"T"+E(2,w)+":"+E(2,y)+":"+E(2,B)+"."+E(3,t)+"Z"}else n=null;d&&(n=
d.call(c,a,n));if(null===n)return"null";q=g.call(n);if("[object Boolean]"==q)return""+n;if("[object Number]"==q)return n>-1/0&&n<1/0?""+n:"null";if("[object String]"==q)return W(""+n);if("object"==typeof n){for(a=p.length;a--;)if(p[a]===n)throw TypeError();p.push(n);A=[];c=m;m+=f;if("[object Array]"==q){s=0;for(a=n.length;s<a;s++)q=x(s,n,d,e,f,m,p),A.push(q===l?"null":q);a=A.length?f?"[\n"+m+A.join(",\n"+m)+"\n"+c+"]":"["+A.join(",")+"]":"[]"}else k(e||n,function(a){var c=x(a,n,d,e,f,m,p);c!==l&&
A.push(W(a)+":"+(f?" ":"")+c)}),a=A.length?f?"{\n"+m+A.join(",\n"+m)+"\n"+c+"}":"{"+A.join(",")+"}":"{}";p.pop();return a}};m.stringify=function(a,c,d){var e,f,h,k;if("function"==typeof c||"object"==typeof c&&c)if("[object Function]"==(k=g.call(c)))f=c;else if("[object Array]"==k){h={};for(var l=0,m=c.length,n;l<m;n=c[l++],(k=g.call(n),"[object String]"==k||"[object Number]"==k)&&(h[n]=1));}if(d)if("[object Number]"==(k=g.call(d))){if(0<(d-=d%1))for(e="",10<d&&(d=10);e.length<d;e+=" ");}else"[object String]"==
k&&(e=10>=d.length?d:d.slice(0,10));return x("",(n={},n[""]=a,n),f,h,e,"",[])}}if(!c("json-parse")){var N=String.fromCharCode,A={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},t,H,y=function(){t=H=null;throw SyntaxError();},R=function(){for(var a=H,c=a.length,d,e,f,h,g;t<c;)switch(g=a.charCodeAt(t),g){case 9:case 10:case 13:case 32:t++;break;case 123:case 125:case 91:case 93:case 58:case 44:return d=q?a.charAt(t):a[t],t++,d;case 34:d="@";for(t++;t<c;)if(g=a.charCodeAt(t),32>g)y();
else if(92==g)switch(g=a.charCodeAt(++t),g){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:d+=A[g];t++;break;case 117:e=++t;for(f=t+4;t<f;t++)g=a.charCodeAt(t),48<=g&&57>=g||(97<=g&&102>=g||65<=g&&70>=g)||y();d+=N("0x"+a.slice(e,t));break;default:y()}else{if(34==g)break;g=a.charCodeAt(t);for(e=t;32<=g&&92!=g&&34!=g;)g=a.charCodeAt(++t);d+=a.slice(e,t)}if(34==a.charCodeAt(t))return t++,d;y();default:e=t;45==g&&(h=!0,g=a.charCodeAt(++t));if(48<=g&&57>=g){for(48==g&&(g=a.charCodeAt(t+
...
g.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};m.parse=function(a,c){var d,e;t=0;H=""+a;d=ja(R());"$"!=R()&&y();t=H=null;return c&&"[object Function]"==g.call(c)?pa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],h=(c=c||0)||0;h<a.length;h++)e[h-c]=a[h];return e}},{}]},{},[1])(1)});
