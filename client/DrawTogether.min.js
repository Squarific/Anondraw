...
(function(b){for(var a=CryptoJS,c=a.lib,d=c.WordArray,e=c.Hasher,c=a.algo,f=[],h=[],g=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var m;a:{m=k;for(var n=b.sqrt(m),r=2;r<=n;r++)if(!(m%r)){m=!1;break a}m=!0}m&&(8>l&&(f[l]=g(b.pow(k,0.5))),h[l]=g(b.pow(k,1/3)),l++);k++}var q=[],c=c.SHA256=e.extend({_doReset:function(){this._hash=new d.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,e=c[0],d=c[1],f=c[2],g=c[3],k=c[4],n=c[5],l=c[6],m=c[7],r=0;64>r;r++){if(16>r)q[r]=
b[a+r]|0;else{var J=q[r-15],y=q[r-2];q[r]=((J<<25|J>>>7)^(J<<14|J>>>18)^J>>>3)+q[r-7]+((y<<15|y>>>17)^(y<<13|y>>>19)^y>>>10)+q[r-16]}J=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&n^~k&l)+h[r]+q[r];y=((e<<30|e>>>2)^(e<<19|e>>>13)^(e<<10|e>>>22))+(e&d^e&f^d&f);m=l;l=n;n=k;k=g+J|0;g=f;f=d;d=e;e=J+y|0}c[0]=c[0]+e|0;c[1]=c[1]+d|0;c[2]=c[2]+f|0;c[3]=c[3]+g|0;c[4]=c[4]+k|0;c[5]=c[5]+n|0;c[6]=c[6]+l|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,e=8*this._nDataBytes,d=8*a.sigBytes;
...
DrawTogether.prototype.createDrawZone=function(){var b=this.container.appendChild(document.createElement("div"));b.className="drawtogether-paint-container";this.paintContainer=b;this.paint=new Paint(b);this.userCtx=this.paint.newCanvasOnTop("userinteraction").getContext("2d");this.setLoadImage();this.paint.background.requestUserChunk=function(b,a,c,h){var g=new Image;h=h||0;h+=5E3*Math.random()+2500;g.onload=function(b){c(g)};g.onerror=function(g){console.error("Failed to load chunk ",b,a," retrying in "+
Math.round(h/1E3)+" seconds");setTimeout(function(){this.paint.background.requestUserChunk(b,a,c,h)}.bind(this),h)}.bind(this);var k=encodeURIComponent(this.current_room);b=encodeURIComponent(b);a=encodeURIComponent(a);g.crossOrigin="Anonymous";this.current_room?g.src=this.settings.imageServer+"/chunk?room="+k+"&x="+b+"&y="+a+"&t="+(this.lastImageUpdate||Date.now()):c(g)}.bind(this);this.paint.addEventListener("userdrawing",function(b){if(0!==this.current_room.indexOf("game_")&&0!==this.current_room.indexOf("private_game_")||
...
DrawTogether.prototype.setCoordFavorite=function(b,a,c,d,e,f){this.network.socket.emit("setcoordfavorite",b,a,c,d,e,function(b,a){b?this.chat.addMessage("Changing coordinate of Favorite","Error: "+b):a.success&&console.log("changed cord")}.bind(this))};DrawTogether.prototype.removeFavorite=function(b,a,c,d){this.network.socket.emit("removefavorite",b,a,c,function(b,a){b?this.chat.addMessage("Removing Favorite","Error: "+b):a.success&&(console.log("deleted"),d.remove(),this.getFavorites())}.bind(this))};
DrawTogether.prototype.renameFavorite=function(b,a,c,d){this.network.socket.emit("renamefavorite",b,a,c,function(e,f){if(e)this.chat.addMessage("Renaming Favorite","Error: "+e);else if(f.success){d.dataset.name=c;var h=d.getElementsByClassName("fav-coor-button")[0];h.innerHTML=c;h.title=b+","+a}}.bind(this))};DrawTogether.prototype.updateFavoriteDom=function(){this.paint.updateFavoriteDom(this.favList)};
DrawTogether.prototype.getFavorites=function(){this.network.socket.emit("getfavorites",function(b,a){b?this.chat.addMessage("Getting Favorites","Error: "+b):this.favList=a}.bind(this))};DrawTogether.prototype.createFavorite=function(b,a,c){this.chat.addMessage("Hey.");this.network.socket.emit("createfavorite",b,a,c,function(b,a){b?this.chat.addMessage("Favorite","Error: "+b):a.success&&(this.chat.addMessage("Favorite added",a.success),this.getFavorites(),this.updateFavoriteDom())}.bind(this))};
...
if(window.coinbaseCookieLoading)return setTimeout(function(){return a(c,d)},200);h=b(c("body").data("env"));window.coinbaseCookieLoading=!0;m=document.createElement("script");m.src=h+"/checkouts/get_cookie.js";m.onload=m.onreadystatechange=function(){window.coinbaseCookieLoaded=!0;window.coinbaseCookieLoading=!1;c(m).remove();return d(c)};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(m)};c=function(a){var c,d,f,h,r;d=c=!1;r=b(a("body").data("env"));h=function(b){switch(b){case "custom_large":return 276;
...
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,d)return a(document).trigger("coinbase_button_loaded",e)}else if("checkouts frame loaded"===f&&(d=!0,c))return a(document).trigger("coinbase_button_loaded",e)}},!1);a(".coinbase-button").each(function(d){return function(d,l){var q,L,C,H,E;q=a(l);C=q.data();C.referrer=document.domain;H=a.param(C);C=q.data("code");E=q.data("width")||h(q.data("button-style"));L=q.data("height")||f(q.data("button-style"));r=b(q.data("env"));
...
"floating"!=g){f=g;h=this._options.positionPrecedence.slice();g=B();var p=s(a).height+10,n=s(a).width+20,q=s(b),u="floating";q.left+n>g.width||0>q.left+q.width/2-n?(m(h,"bottom"),m(h,"top")):(q.height+q.top+p>g.height&&m(h,"bottom"),0>q.top-p&&m(h,"top"));q.width+q.left+n>g.width&&m(h,"right");0>q.left-n&&m(h,"left");0<h.length&&(u=h[0]);f&&"auto"!=f&&-1<h.indexOf(f)&&(u=f);g=u}f=s(b);b=s(a);h=B();switch(g){case "top":c.className="introjs-arrow bottom";k(f,d?0:15,b,h,a);a.style.bottom=f.height+20+
...
b.element);var a=this,c=document.querySelector(".introjs-helperLayer"),d=document.querySelector(".introjs-tooltipReferenceLayer"),k="introjs-helperLayer";s(b.element);"string"===typeof b.highlightClass&&(k+=" "+b.highlightClass);"string"===typeof this._options.highlightClass&&(k+=" "+this._options.highlightClass);if(null!=c){var l=d.querySelector(".introjs-helperNumberLayer"),m=d.querySelector(".introjs-tooltiptext"),q=d.querySelector(".introjs-arrow"),u=d.querySelector(".introjs-tooltip"),C=d.querySelector(".introjs-skipbutton"),
E=d.querySelector(".introjs-prevbutton"),H=d.querySelector(".introjs-nextbutton");c.className=k;u.style.opacity=0;u.style.display="none";if(null!=l){var z=this._introItems[0<=b.step-2?b.step-2:0];if(null!=z&&"forward"==this._direction&&"floating"==z.position||"backward"==this._direction&&"floating"==b.position)l.style.opacity=0}n.call(a,c);n.call(a,d);if((z=document.querySelectorAll(".introjs-fixParent"))&&0<z.length)for(k=z.length-1;0<=k;k--)z[k].className=z[k].className.replace(/introjs-fixParent/g,
...
"active";d.querySelector(".introjs-progress .introjs-progressbar").setAttribute("style","width:"+J.call(a)+"%;");u.style.opacity=1;l&&(l.style.opacity=1);-1===H.tabIndex?C.focus():H.focus()},350)}else{var t=document.createElement("div"),E=document.createElement("div"),c=document.createElement("div"),I=document.createElement("div"),F=document.createElement("div"),T=document.createElement("div"),y=document.createElement("div"),D=document.createElement("div");t.className=k;E.className="introjs-tooltipReferenceLayer";
...
h){function k(){t.showPaletteOnly&&(t.showPalette=!0);Ia.text(t.showPaletteOnly?t.togglePaletteMoreText:t.togglePaletteLessText);if(t.palette){za=t.palette.slice(0);qa=b.isArray(za[0])?za:[za];Aa={};for(var a=0;a<qa.length;a++)for(var c=0;c<qa[a].length;c++){var e=tinycolor(qa[a][c]).toRgbString();Aa[e]=!0}}A.toggleClass("sp-flat",V);A.toggleClass("sp-input-disabled",!t.showInput);A.toggleClass("sp-alpha-enabled",t.showAlpha);A.toggleClass("sp-clear-enabled",ha);A.toggleClass("sp-buttons-disabled",
!t.showButtons);A.toggleClass("sp-palette-buttons-disabled",!t.togglePaletteOnly);A.toggleClass("sp-palette-disabled",!t.showPalette);A.toggleClass("sp-palette-only",t.showPaletteOnly);A.toggleClass("sp-initial-disabled",!t.showInitial);A.addClass(t.className).addClass(t.containerClassName);R()}function n(){if(w&&window.localStorage){try{var a=window.localStorage[w].split(",#");1<a.length&&(delete window.localStorage[w],b.each(a,function(b,a){z(a)}))}catch(c){}try{W=window.localStorage[w].split(";")}catch(e){}}}
function z(a){if(aa){a=tinycolor(a).toRgbString();if(!Aa[a]&&-1===b.inArray(a,W))for(W.push(a);W.length>Xa;)W.shift();if(w&&window.localStorage)try{window.localStorage[w]=W.join(";")}catch(c){}}}function T(){var b=[];if(t.showPalette)for(var a=0;a<W.length;a++){var c=tinycolor(W[a]).toRgbString();Aa[c]||b.push(W[a])}return b.reverse().slice(0,t.maxSelectionSize)}function F(){var a=P(),e=b.map(qa,function(b,e){return c(b,a,"sp-palette-row sp-palette-row-"+e,t)});n();W&&e.push(c(T(),a,"sp-palette-row sp-palette-row-selection",
t));Pa.html(e.join(""))}function s(){if(t.showInitial){var b=ia,a=P();Qa.html(c([b,a],a,"sp-palette-row-initial",t))}}function J(){(0>=U||0>=M||0>=Ba)&&R();A.addClass(Ra);ca=null;K.trigger("dragstart.spectrum",[P()])}function y(){A.removeClass(Ra);K.trigger("dragstop.spectrum",[P()])}function S(){var b=da.val();null!==b&&""!==b||!ha?(b=tinycolor(b),b.isValid()?(Z(b),Q(!0)):da.addClass("sp-validation-error")):(Z(null),Q(!0))}function ka(){v?fa():la()}function la(){var a=b.Event("beforeShow.spectrum");
...
D.hide(P()),K.trigger("hide.spectrum",[P()]))}function Z(b,a){if(tinycolor.equals(b,P()))Y();else{var c,e;!b&&ha?ea=!0:(ea=!1,c=tinycolor(b),e=c.toHsv(),ra=e.h%360/360,sa=e.s,ta=e.v,X=e.a);Y();c&&(c.isValid()&&!a)&&(ua=Ka||c.getFormat())}}function P(b){b=b||{};return ha&&ea?null:tinycolor.fromRatio({h:ra,s:sa,v:ta,a:Math.round(100*X)/100},{format:b.format||ua})}function ma(){Y();D.move(P());K.trigger("move.spectrum",[P()])}function Y(){da.removeClass("sp-validation-error");G();var b=tinycolor.fromRatio({h:ra,
s:1,v:1});Ca.css("background-color",b.toHexString());b=ua;!(1>X)||0===X&&"name"===b||"hex"!==b&&"hex3"!==b&&"hex6"!==b&&"name"!==b||(b="rgb");var a=P({format:b}),c="";oa.removeClass("sp-clear-display");oa.css("background-color","transparent");if(!a&&ha)oa.addClass("sp-clear-display");else{var c=a.toHexString(),e=a.toRgbString();p||1===a.alpha?oa.css("background-color",e):(oa.css("background-color","transparent"),oa.css("filter",a.toFilter()));if(t.showAlpha){e=a.toRgb();e.a=0;var e=tinycolor(e).toRgbString(),
d="linear-gradient(left, "+e+", "+c+")";q?va.css("filter",tinycolor(e).toFilter({gradientType:1},c)):(va.css("background","-webkit-"+d),va.css("background","-moz-"+d),va.css("background","-ms-"+d),va.css("background","linear-gradient(to right, "+e+", "+c+")"))}c=a.toString(b)}t.showInput&&da.val(c);t.showPalette&&F();s()}function G(){var b=sa,a=ta;ha&&ea?(Da.hide(),Ea.hide(),Fa.hide()):(Da.show(),Ea.show(),Fa.show(),b*=M,a=U-a*U,b=Math.max(-N,Math.min(M-N,b-N)),a=Math.max(-N,Math.min(U-N,a-N)),Fa.css({top:a+
"px",left:b+"px"}),Da.css({left:X*ja-Sa/2+"px"}),Ea.css({top:ra*Ba-Ta+"px"}))}function Q(b){var a=P(),c="",e=!tinycolor.equals(a,ia);a&&(c=a.toString(ua),z(a));Ga&&K.val(c);b&&e&&(D.change(a),K.trigger("change",[a]))}function R(){M=Ca.width();U=Ca.height();N=Fa.height();La.width();Ba=La.height();Ta=Ea.height();ja=Ua.width();Sa=Da.width();V||(A.css("position","absolute"),t.offset?A.offset(t.offset):A.offset(f(A,wa)));G();t.showPalette&&F();K.trigger("reflow.spectrum")}function ya(){fa();Ma=!0;K.attr("disabled",
!0);wa.addClass("sp-disabled")}var t=d(h,e),V=t.flat,aa=t.showSelectionPalette,w=t.localStorageKey,O=t.theme,D=t.callbacks,ba=m(R,10),v=!1,M=0,U=0,N=0,Ba=0,ja=0,Sa=0,Ta=0,ra=0,sa=0,ta=0,X=1,za=[],qa=[],Aa={},W=t.selectionPalette.slice(0),Xa=t.maxSelectionSize,Ra="sp-dragging",ca=null,Ja=e.ownerDocument,K=b(e),Ma=!1,A=b(L,Ja).addClass(O),Za=A.find(".sp-picker-container"),Ca=A.find(".sp-color"),Fa=A.find(".sp-dragger"),La=A.find(".sp-hue"),Ea=A.find(".sp-slider"),va=A.find(".sp-alpha-inner"),Ua=A.find(".sp-alpha"),
...
a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(K.is(":disabled")||!0===t.disabled)&&ya();A.click(g);da.change(S);da.bind("paste",function(){setTimeout(S,1)});da.keydown(function(b){13==b.keyCode&&S()});Va.text(t.cancelText);Va.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();Z(ia,!0);fa()});Na.attr("title",t.clearText);Na.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();ea=!0;ma();V&&Q(!0)});Wa.text(t.chooseText);Wa.bind("click.spectrum",
...
l;b.fn.spectrum.defaults=n;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){u||b("input[type=color]").spectrum({preferredFormat:"hex6"})};(function(){function b(a,c,e){a=G(a,255);c=G(c,255);e=G(e,255);var d=D(a,c,e),f=O(a,c,e),h,g=(d+f)/2;if(d==f)h=f=0;else{var k=d-f,f=0.5<g?k/(2-d-f):k/(d+f);switch(d){case a:h=(c-e)/k+(c<e?6:0);break;case c:h=(e-a)/k+2;break;case e:h=(a-c)/k+4}h/=6}return{h:h,s:f,l:g}}function a(b,c,e){function d(b,
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=G(b,360);c=G(c,100);e=G(e,100);if(0===c)e=c=b=e;else{var f=0.5>e?e*(1+c):e+c-e*c,h=2*e-f;e=d(h,f,b+1/3);c=d(h,f,b);b=d(h,f,b-1/3)}return{r:255*e,g:255*c,b:255*b}}function c(b,a,e){b=G(b,255);a=G(a,255);e=G(e,255);var d=D(b,a,e),f=O(b,a,e),h,g=d-f;if(d==f)h=0;else{switch(d){case b:h=(a-e)/g+(a<e?6:0);break;case a:h=(e-b)/g+2;break;case e:h=(b-a)/g+4}h/=6}return{h:h,s:0===d?0:g/d,v:d}}function e(b,a,c,d){b=[Q(w(b).toString(16)),
Q(w(a).toString(16)),Q(w(c).toString(16))];return d&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function d(b,a,c,e){return[Q(Math.round(255*parseFloat(e)).toString(16)),Q(w(b).toString(16)),Q(w(a).toString(16)),Q(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s-=a/100;c.s=O(1,D(0,c.s));return v(c)}function h(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s+=a/100;
c.s=O(1,D(0,c.s));return v(c)}function g(b){return v(b).desaturate(100)}function k(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l+=a/100;c.l=O(1,D(0,c.l));return v(c)}function p(b,a){a=0===a?0:a||10;var c=v(b).toRgb();c.r=D(0,O(255,c.r-w(255*-(a/100))));c.g=D(0,O(255,c.g-w(255*-(a/100))));c.b=D(0,O(255,c.b-w(255*-(a/100))));return v(c)}function l(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l-=a/100;c.l=O(1,D(0,c.l));return v(c)}function n(b,a){var c=v(b).toHsl(),e=(w(c.h)+a)%360;c.h=0>e?360+e:e;return v(c)}
function m(b){b=v(b).toHsl();b.h=(b.h+180)%360;return v(b)}function q(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+120)%360,s:a.s,l:a.l}),v({h:(c+240)%360,s:a.s,l:a.l})]}function u(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+90)%360,s:a.s,l:a.l}),v({h:(c+180)%360,s:a.s,l:a.l}),v({h:(c+270)%360,s:a.s,l:a.l})]}function r(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+72)%360,s:a.s,l:a.l}),v({h:(c+216)%360,s:a.s,l:a.l})]}function L(b,a,c){a=a||6;c=c||30;var e=v(b).toHsl();c=360/c;b=[v(b)];for(e.h=
(e.h-(c*a>>1)+720)%360;--a;)e.h=(e.h+c)%360,b.push(v(e));return b}function B(b,a){a=a||6;for(var c=v(b).toHsv(),e=c.h,d=c.s,c=c.v,f=[],h=1/a;a--;)f.push(v({h:e,s:d,v:c})),c=(c+h)%1;return f}function Y(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function G(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=O(a,D(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>aa.abs(b-a)?1:b%a/parseFloat(a)}function Q(b){return 1==
b.length?"0"+b:""+b}function R(b){1>=b&&(b=100*b+"%");return b}var ya=/^[\s,#]+/,t=/\s+$/,V=0,aa=Math,w=aa.round,O=aa.min,D=aa.max,ba=aa.random,v=function ja(b,c){var e,d,f,h,g;b=b?b:"";c=c||{};if(b instanceof ja)return b;if(!(this instanceof ja))return new ja(b,c);d=b;g={r:0,g:0,b:0};var k=1;f=e=!1;if("string"==typeof d)a:{d=d.replace(ya,"").replace(t,"").toLowerCase();var p=!1;if(M[d])d=M[d],p=!0;else if("transparent"==d){d={r:0,g:0,b:0,a:0,format:"name"};break a}d=(h=N.rgb.exec(d))?{r:h[1],g:h[2],
b:h[3]}:(h=N.rgba.exec(d))?{r:h[1],g:h[2],b:h[3],a:h[4]}:(h=N.hsl.exec(d))?{h:h[1],s:h[2],l:h[3]}:(h=N.hsla.exec(d))?{h:h[1],s:h[2],l:h[3],a:h[4]}:(h=N.hsv.exec(d))?{h:h[1],s:h[2],v:h[3]}:(h=N.hsva.exec(d))?{h:h[1],s:h[2],v:h[3],a:h[4]}:(h=N.hex8.exec(d))?{a:parseInt(h[1],16)/255,r:parseInt(h[2],16),g:parseInt(h[3],16),b:parseInt(h[4],16),format:p?"name":"hex8"}:(h=N.hex6.exec(d))?{r:parseInt(h[1],16),g:parseInt(h[2],16),b:parseInt(h[3],16),format:p?"name":"hex"}:(h=N.hex3.exec(d))?{r:parseInt(h[1]+
""+h[1],16),g:parseInt(h[2]+""+h[2],16),b:parseInt(h[3]+""+h[3],16),format:p?"name":"hex"}:!1}if("object"==typeof d){if(d.hasOwnProperty("r")&&d.hasOwnProperty("g")&&d.hasOwnProperty("b"))g={r:255*G(d.r,255),g:255*G(d.g,255),b:255*G(d.b,255)},e=!0,f="%"===String(d.r).substr(-1)?"prgb":"rgb";else if(d.hasOwnProperty("h")&&d.hasOwnProperty("s")&&d.hasOwnProperty("v")){d.s=R(d.s);d.v=R(d.v);f=d.h;p=d.s;g=d.v;f=6*G(f,360);p=G(p,100);g=G(g,100);e=aa.floor(f);var l=f-e;f=g*(1-p);h=g*(1-l*p);p=g*(1-(1-l)*
p);e%=6;g={r:255*[g,h,f,f,p,g][e],g:255*[p,g,g,h,f,f][e],b:255*[f,f,p,g,g,h][e]};e=!0;f="hsv"}else d.hasOwnProperty("h")&&(d.hasOwnProperty("s")&&d.hasOwnProperty("l"))&&(d.s=R(d.s),d.l=R(d.l),g=a(d.h,d.s,d.l),e=!0,f="hsl");d.hasOwnProperty("a")&&(k=d.a)}k=Y(k);d=d.format||f;f=O(255,D(g.r,0));h=O(255,D(g.g,0));g=O(255,D(g.b,0));this._originalInput=b;this._r=f;this._g=h;this._b=g;this._a=k;this._roundA=w(100*this._a)/100;this._format=c.format||d;this._gradientType=c.gradientType;1>this._r&&(this._r=
w(this._r));1>this._g&&(this._g=w(this._g));1>this._b&&(this._b=w(this._b));this._ok=e;this._tc_id=V++};v.prototype={isDark:function(){return 128>this.getBrightness()},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var b=this.toRgb();return(299*b.r+587*b.g+114*b.b)/1E3},setAlpha:function(b){this._a=Y(b);this._roundA=
...
"favorites-container"};
Paint.prototype.insertOneFavorite=function(b,a,c,d){var e=this.favoritesContainer.appendChild(document.createElement("div"));e.className="favorite-container";e.dataset.x=b;e.dataset.y=a;e.dataset.name=c;e.dataset.owner=d;d=e.appendChild(document.createElement("div"));d.className="fav-button fav-minus-button";d.innerHTML="-";d.addEventListener("click",function(b){b=b.srcElement.parentElement;drawTogether.removeFavorite(b.dataset.x,b.dataset.y,b.dataset.name,b);console.log("delete",b.dataset.x,b.dataset.y,
b.dataset.name)}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-plus-button";d.innerHTML="+";d.addEventListener("click",function(b){b=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom];console.log(this.paint.public.leftTopX+b[0]/2,this.paint.public.leftTopY+b[1]/2)}.bind(drawTogether));d.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/
this.paint.public.zoom],c=this.paint.public.leftTopX+a[0]/2,a=this.paint.public.leftTopY+a[1]/2;console.log(c,a);b.srcElement.title="Change to "+c+","+a+" ?"}.bind(drawTogether));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-pencil-button";d.innerHTML="\u270e";d=d.appendChild(document.createElement("div"));d.className="fav-rename-container";d=d.appendChild(document.createElement("input"));d.className="fav-rename-input";d.type="text";d.placeholder="Rename";d.addEventListener("input",
function(b){void 0!==drawTogether._favoriteRenameDelayTimeout&&clearTimeout(drawTogether._favoriteRenameDelayTimeout);drawTogether._favoriteRenameDelayTimeout=setTimeout(function(){var b=this.srcElement.parentElement.parentElement.parentElement;drawTogether.renameFavorite(b.dataset.x,b.dataset.y,this.srcElement.value,b)}.bind(b),1500)}.bind(this));e=e.appendChild(document.createElement("div"));e.className="fav-button fav-coor-button";0<c.length?(e.innerHTML=c,e.title=b+","+a,d.value=c):e.innerHTML=
b+","+a};Paint.prototype.updateFavoriteDom=function(b){for(;this.favoritesContainer.firstChild;)this.favoritesContainer.removeChild(this.favoritesContainer.firstChild);var a=this.favoritesContainer.appendChild(document.createElement("div"));a.className="fav-button fav-add-new-fav";a.innerHTML="^";a.addEventListener("click",function(b){drawTogether.createFavorite(0,0,"")}.bind(this));for(x=b.length-1;0<=x;x--)this.insertOneFavorite(b[x].x,b[x].y,b[x].name,b[x].owner)};
...
c,!0,e)};return f.readAsArrayBuffer(a.data)}function h(a,c,e){var d=Array(a.length);e=m(a.length,e);for(var f=function(a,e,f){c(e,function(c,e){d[a]=e;f(c,d)})},h=0;h<a.length;h++)f(h,a[h],e)}var g=a("./keys"),k=a("arraybuffer.slice"),l=a("base64-arraybuffer"),m=a("after"),n=a("utf8"),r=navigator.userAgent.match(/Android/i);d.protocol=3;var q=d.packets={open:0,close:1,ping:2,pong:3,message:4,upgrade:5,noop:6},p=g(q),u={type:"error",data:"parser error"},B=a("blob");d.encodePacket=function(a,h,g,k){"function"==
typeof h&&(k=h,h=!1);"function"==typeof g&&(k=g,g=null);var l=void 0===a.data?void 0:a.data.buffer||a.data;if(c.ArrayBuffer&&l instanceof ArrayBuffer){if(h){g=a.data;h=new Uint8Array(g);g=new Uint8Array(1+g.byteLength);g[0]=q[a.type];for(a=0;a<h.length;a++)g[a+1]=h[a];a=k(g.buffer)}else a=d.encodeBase64Packet(a,k);return a}if(B&&l instanceof c.Blob)return h?r?a=f(a,h,k):(h=new Uint8Array(1),h[0]=q[a.type],a=new B([h.buffer,a.data]),a=k(a)):a=d.encodeBase64Packet(a,k),a;h=q[a.type];void 0!==a.data&&
(h+=g?n.encode(String(a.data)):String(a.data));return k(""+h)};d.encodeBase64Packet=function(a,f){var h="b"+d.packets[a.type];if(B&&a.data instanceof B){var g=new FileReader;g.onload=function(){var a=g.result.split(",")[1];f(h+a)};return g.readAsDataURL(a.data)}var k;try{k=String.fromCharCode.apply(null,new Uint8Array(a.data))}catch(l){k=new Uint8Array(a.data);for(var q=Array(k.length),m=0;m<k.length;m++)q[m]=k[m];k=String.fromCharCode.apply(null,q)}h+=c.btoa(k);return f(h)};d.decodePacket=function(a,
c,e){if("string"==typeof a||void 0===a){if("b"==a.charAt(0))return d.decodeBase64Packet(a.substr(1),c);if(e)try{a=n.decode(a)}catch(f){return u}e=a.charAt(0);return Number(e)==e&&p[e]?1<a.length?{type:p[e],data:a.substring(1)}:{type:p[e]}:u}e=(new Uint8Array(a))[0];a=k(a,1);B&&"blob"===c&&(a=new B([a]));return{type:p[e],data:a}};d.decodeBase64Packet=function(a,d){var f=p[a.charAt(0)];if(!c.ArrayBuffer)return{type:f,data:{base64:!0,data:a.substr(1)}};var h=l.decode(a.substr(1));"blob"===d&&B&&(h=new B([h]));
return{type:f,data:h}};d.encodePayload=function(a,c,e){"function"==typeof c&&(e=c,c=null);if(c)return B&&!r?d.encodePayloadAsBlob(a,e):d.encodePayloadAsArrayBuffer(a,e);if(!a.length)return e("0:");h(a,function(a,e){d.encodePacket(a,c,!0,function(a){e(null,a.length+":"+a)})},function(a,c){return e(c.join(""))})};d.decodePayload=function(a,c,e){if("string"!=typeof a)return d.decodePayloadAsBinary(a,c,e);"function"===typeof c&&(e=c,c=null);var f;if(""==a)return e(u,0,1);f="";for(var h,g,k=0,l=a.length;k<
...
k=function(a,c){var d="[object Function]"==h.call(a),e,k;if(k=!d)if(k="function"!=typeof a.constructor)k=typeof a.hasOwnProperty,k="object"==k?!!a.hasOwnProperty:!C[k];k=k?a.hasOwnProperty:g;for(e in a)d&&"prototype"==e||!k.call(a,e)||c(e);for(d=f.length;e=f[--d];k.call(a,e)&&c(e));});return k(a,c)};if(!c("json-stringify")){var H={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},E=function(a,c){return("000000"+(c||0)).slice(-a)},I=function(a){var c='"',d=0,e=a.length,f=10<e&&p,h;for(f&&
(h=a.split(""));d<e;d++){var g=a.charCodeAt(d);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=H[g];break;default:if(32>g){c+="\\u00"+E(2,g.toString(16));break}c+=f?h[d]:p?a.charAt(d):a[d]}}return c+'"'},z=function(a,c,d,e,f,m,q){var n,p,r,s,y,w,B,D,C;try{n=c[a]}catch(v){}if("object"==typeof n&&n)if(p=h.call(n),"[object Date]"!=p||g.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=p&&"[object String]"!=p&&"[object Array]"!=p||g.call(n,"toJSON"))&&(n=n.toJSON(a));
...
d.call(c,a,n));if(null===n)return"null";p=h.call(n);if("[object Boolean]"==p)return""+n;if("[object Number]"==p)return n>-1/0&&n<1/0?""+n:"null";if("[object String]"==p)return I(""+n);if("object"==typeof n){for(a=q.length;a--;)if(q[a]===n)throw TypeError();q.push(n);C=[];c=m;m+=f;if("[object Array]"==p){r=0;for(a=n.length;r<a;r++)p=z(r,n,d,e,f,m,q),C.push(p===l?"null":p);a=C.length?f?"[\n"+m+C.join(",\n"+m)+"\n"+c+"]":"["+C.join(",")+"]":"[]"}else k(e||n,function(a){var c=z(a,n,d,e,f,m,q);c!==l&&
...
h.call(e))for(f=e.length;f--;)la(e,f,d);else k(e,function(a){la(e,a,d)});return d.call(a,c,e)};n.parse=function(a,c){var d,e;s=0;J=""+a;d=ka(S());"$"!=S()&&y();s=J=null;return c&&"[object Function]"==h.call(c)?pa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,d){c.exports=function(a,c){for(var d=[],g=(c=c||0)||0;g<a.length;g++)d[g-c]=a[g];return d}},{}]},{},[1])(1)});
