...
0)}DrawTogether.prototype.KICKBAN_MIN_REP=50;DrawTogether.prototype.BIG_BRUSH_MIN_REP=5;DrawTogether.prototype.ZOOMED_OUT_MIN_REP=2;DrawTogether.prototype.defaultSettings={mode:"ask",room:"main",leftTopX:0,leftTopY:0,loadbalancer:"http://direct.anondraw.com:3552",accountServer:"http://direct.anondraw.com:4552",imageServer:"http://direct.anondraw.com:5552"};
...
b.usernameFromSocketid(a.currentPlayer)+" is now drawing. You have "+Math.round(a.timeLeft/1E3)+" seconds left.");0==a.letters?b.chat.addMessage("GAME",b.usernameFromSocketid(a.currentPlayer)+" is picking a word."):(b.chat.addMessage("GAME","The word: "+Array(a.letters+1).join("_ ")+"("+a.letters+" letters)"),b.displayMessage("The word: "+Array(a.letters+1).join("_ ")+"("+a.letters+" letters)"));for(var c=0;c<a.players.length;c++)for(var e=0;e<b.playerList.length;e++)b.playerList[e].id==a.players[c].id&&
(b.playerList[e].gamescore=a.players[c].score);b.updatePlayerList()});this.network.on("words",function(a){var c=b.gui.prompt("It is your turn! Pick a word to draw. You have 10 seconds.",a,function(a){b.network.socket.emit("word",a)});setTimeout(function(){c.parentNode&&c.parentNode.removeChild(c)},1E4)});this.network.on("gameword",function(a){b.displayMessage("You picked "+a);b.chat.addMessage("GAME","You picked "+a)});this.network.on("chatmessage",function(a){a=a||{};b.chat.addMessage(a.user,a.message)});
this.network.on("emote",function(a){a=a||{};b.chat.addMessage(a.user+" "+a.message)});this.network.on("setreputation",function(a){b.reputation=a});this.network.on("setink",function(a){b.ink=a;b.updateInk()})};DrawTogether.prototype.sendMessage=function(b){this.network.socket.emit("chatmessage",b)};
...
"'. Server error: "+g+". Trying again in 5 seconds."),setTimeout(this.changeRoom.bind(this,b,a,c,e,d,f),5E3)):(this.setRoom(b+a),this.paint.clear(),this.paint.goto(c||0,e||0),this.paint.addPublicDrawings(this.decodeDrawings(h)),this.chat.addMessage("Invite people","http://www.anondraw.com/#"+b+a),0!==b.indexOf("private_")&&(0!==b.indexOf("game_")&&this.userSettings.getBoolean("Show welcome"))&&(this.openWelcomeWindow(),this.userSettings.setBoolean("Show welcome",!1,!0)),this.removeLoading())}.bind(this)),
this.setLoading(b))};
...
DrawTogether.prototype.inkUsageFromDrawing=function(b){var a=b.size;"number"==typeof b.x1&&(a=2*this.utils.distance(b.x,b.y,b.x1,b.y1));"string"==typeof b.text&&(a*=b.text.length);return Math.ceil(b.size*a)};
...
"drawtogether-modeselect-button";c.innerHTML='<img src="images/invite.png"/><br/>Alone or with friends';c.addEventListener("click",function(){this.settings.room="private_"+Math.random().toString(36).substr(2,5);this.changeRoom(this.settings.room,void 0,0,0,!0);ga("send","event","modeselector","private");this.selectWindow.style.display=""}.bind(this));a=a.appendChild(document.createElement("div"));a.className="drawtogether-modeselect-button";a.innerHTML='<img src="images/game.png"/><br/>Play guess word (NEW!)';
...
DrawTogether.prototype.openWelcomeWindow=function(){var b=this.gui.createWindow({title:"Welcome!"});b.classList.add("welcome-window");var a=b.appendChild(document.createElement("div"));a.className="content";a.appendChild(document.createElement("h2")).appendChild(document.createTextNode("Hey you seem to be new!"));var c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("First of all welcome on anondraw.Anondraw is a website where artists of all skill levels come together to draw.All drawings are allowed so that means this website might contain NSFW (18+) images.If you do not feel comfortable with that, you should not join the public rooms."));
c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Lastly we like to create, not destroy. Griefing will result in a ban of up to 10 years."));c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Regards,"));c.appendChild(document.createElement("br"));c.appendChild(document.createTextNode("Anondraw Team"));a=a.appendChild(document.createElement("div"));a.appendChild(document.createTextNode("Tutorial"));a.className="drawtogether-button";
a.addEventListener("click",function(){b.parentNode&&b.parentNode.removeChild(b);introJs().setOptions({tooltipPosition:"auto",showProgress:!0}).onexit(this.openWelcomeWindow.bind(this)).oncomplete(this.openWelcomeWindow.bind(this)).start()}.bind(this))};
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=z();var q=t(a).height+10,p=t(a).width+20,m=t(b),v="floating";m.left+p>h.width||0>m.left+m.width/2-p?(n(g,"bottom"),n(g,"top")):(m.height+m.top+q>h.height&&n(g,"bottom"),0>m.top-q&&n(g,"top"));m.width+m.left+p>h.width&&n(g,"right");0>m.left-p&&n(g,"left");0<g.length&&(v=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(v=f);h=v}f=t(b);b=t(a);g=z();switch(h){case "top":c.className="introjs-arrow bottom";k(f,e?0:15,b,g,a);a.style.bottom=f.height+20+
...
"").replace(/^\s+|\s+$/g,"");x=document.querySelector(".introjs-showElement");x.className=x.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");a._lastShowElementTimer&&clearTimeout(a._lastShowElementTimer);a._lastShowElementTimer=setTimeout(function(){null!=k&&(k.innerHTML=b.step);l.innerHTML=b.intro;v.style.display="block";h.call(a,b.element,v,n,k);e.querySelector(".introjs-bullets li > a.active").className="";e.querySelector('.introjs-bullets li > a[data-stepnumber="'+b.step+'"]').className=
...
case "bottom-right":a.style.left=c.left+c.width+"px";a.style.top=c.top+c.height+"px";break;case "bottom-middle":a.style.left=c.left+c.width/2+"px";a.style.top=c.top+c.height+"px";break;case "top-middle":a.style.left=c.left+c.width/2+"px",a.style.top=c.top+"px"}}function D(b,a,c){"undefined"!==typeof this._hintClickCallback&&this._hintClickCallback.call(this,b,a,c);var d=J.call(this);if(parseInt(d,10)!=c){var d=document.createElement("div"),e=document.createElement("div"),f=document.createElement("div"),
g=document.createElement("div");d.className="introjs-tooltip";d.onclick=function(b){b.stopPropagation?b.stopPropagation():b.cancelBubble=!0};e.className="introjs-tooltiptext";var q=document.createElement("p");q.innerHTML=a.hint;a=document.createElement("a");a.className="introjs-button";a.innerHTML=this._options.hintButtonLabel;a.onclick=F.bind(this,c);e.appendChild(q);e.appendChild(a);f.className="introjs-arrow";d.appendChild(f);d.appendChild(e);this._currentStep=b.getAttribute("data-step");g.className=
...
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,d,e){for(var f=[],g=0;g<a.length;g++){var h=a[g];if(h){var p=tinycolor(h),k=0.5>p.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k=k+(tinycolor.equals(c,h)?" sp-thumb-active":""),h=p.toString(e.preferredFormat||"rgb"),m=q?"background-color:"+p.toRgbString():"filter:"+p.toFilter();f.push('<span title="'+
h+'" data-color="'+p.toRgbString()+'" class="'+k+'"><span class="sp-thumb-inner" style="'+m+';" /></span>')}else f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",e.noColorSelectedText)).html())}return"<div class='sp-cf "+d+"'>"+f.join("")+"</div>"}function e(a,c){var d=b.extend({},m,a);d.callbacks={move:k(d.move,c),change:k(d.change,c),show:k(d.show,c),hide:k(d.hide,c),beforeShow:k(d.beforeShow,c)};return d}function d(d,
...
"px",left:b+"px"}),Ca.css({left:W*ia-Ra/2+"px"}),Da.css({top:qa*Aa-Sa+"px"}))}function P(b){var a=O(),c="",d=!tinycolor.equals(a,ha);a&&(c=a.toString(ta),x(a));Fa&&K.val(c);b&&d&&(B.change(a),K.trigger("change",[a]))}function Q(){L=Ba.width();T=Ba.height();M=Ea.height();Ka.width();Aa=Ka.height();Sa=Da.height();ia=Ta.width();Ra=Ca.width();U||(A.css("position","absolute"),s.offset?A.offset(s.offset):A.offset(f(A,va)));C();s.showPalette&&D();K.trigger("reflow.spectrum")}function xa(){ea();La=!0;K.attr("disabled",
!0);va.addClass("sp-disabled")}var s=e(g,d),U=s.flat,Z=s.showSelectionPalette,w=s.localStorageKey,N=s.theme,B=s.callbacks,aa=n(Q,10),u=!1,L=0,T=0,M=0,Aa=0,ia=0,Ra=0,Sa=0,qa=0,ra=0,sa=0,W=1,ya=[],pa=[],za={},V=s.selectionPalette.slice(0),Wa=s.maxSelectionSize,Qa="sp-dragging",ba=null,Ia=d.ownerDocument,K=b(d),La=!1,A=b(G,Ia).addClass(N),Ya=A.find(".sp-picker-container"),Ba=A.find(".sp-color"),Ea=A.find(".sp-dragger"),Ka=A.find(".sp-hue"),Da=A.find(".sp-slider"),ua=A.find(".sp-alpha-inner"),Ta=A.find(".sp-alpha"),
...
a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(K.is(":disabled")||!0===s.disabled)&&xa();A.click(h);ca.change(R);ca.bind("paste",function(){setTimeout(R,1)});ca.keydown(function(b){13==b.keyCode&&R()});Ua.text(s.cancelText);Ua.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();Y(ha,!0);ea()});Ma.attr("title",s.clearText);Ma.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();da=!0;la();U&&P(!0)});Va.text(s.chooseText);Va.bind("click.spectrum",
...
!1}function g(b){if(k){if(p&&9>q.documentMode&&!b.button)return h();var d=b.originalEvent&&b.originalEvent.touches,e=d?d[0].pageY:b.pageY,d=Math.max(0,Math.min((d?d[0].pageX:b.pageX)-m.left,n)),e=Math.max(0,Math.min(e-m.top,l));v&&f(b);c.apply(a,[d,e,b])}}function h(){k&&(b(q).unbind(G),b(q.body).removeClass("sp-dragging"),e.apply(a,arguments));k=!1}c=c||function(){};d=d||function(){};e=e||function(){};var q=document,k=!1,m={},l=0,n=0,v="ontouchstart"in window,G={};G.selectstart=f;G.dragstart=f;G["touchmove mousemove"]=
g;G["touchend mouseup"]=h;b(a).bind("touchstart mousedown",function(c){(c.which?3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,l=b(a).height(),n=b(a).width(),m=b(a).offset(),b(q).bind(G),b(q.body).addClass("sp-dragging"),v||g(c),f(c))})}function n(b,a,c){var d;return function(){var e=this,f=arguments,g=function(){d=null;b.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(g,a)}}var m={beforeShow:g,move:g,change:g,show:g,hide:g,color:!1,flat:!1,showInput:!1,allowEmpty:!1,showButtons:!0,
...
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=C(b,360);c=C(c,100);d=C(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,g=2*d-f;d=e(g,f,b+1/3);c=e(g,f,b);b=e(g,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=C(b,255);a=C(a,255);d=C(d,255);var e=B(b,a,d),f=N(b,a,d),g,h=e-f;if(e==f)g=0;else{switch(e){case b:g=(a-d)/h+(a<d?6:0);break;case a:g=(d-b)/h+2;break;case d:g=(b-a)/h+4}g/=6}return{h:g,s:0===e?0:h/e,v:e}}function d(b,a,c,e){b=[P(w(b).toString(16)),
P(w(a).toString(16)),P(w(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[P(Math.round(255*parseFloat(d)).toString(16)),P(w(b).toString(16)),P(w(a).toString(16)),P(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.s-=a/100;c.s=N(1,B(0,c.s));return u(c)}function g(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.s+=a/100;
...
b.length?"0"+b:""+b}function Q(b){1>=b&&(b=100*b+"%");return b}var xa=/^[\s,#]+/,s=/\s+$/,U=0,Z=Math,w=Z.round,N=Z.min,B=Z.max,aa=Z.random,u=function ia(b,c){var d,e,f,g,h;b=b?b:"";c=c||{};if(b instanceof ia)return b;if(!(this instanceof ia))return new ia(b,c);e=b;h={r:0,g:0,b:0};var q=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(xa,"").replace(s,"").toLowerCase();var p=!1;if(L[e])e=L[e],p=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(g=M.rgb.exec(e))?{r:g[1],g:g[2],b:g[3]}:
(g=M.rgba.exec(e))?{r:g[1],g:g[2],b:g[3],a:g[4]}:(g=M.hsl.exec(e))?{h:g[1],s:g[2],l:g[3]}:(g=M.hsla.exec(e))?{h:g[1],s:g[2],l:g[3],a:g[4]}:(g=M.hsv.exec(e))?{h:g[1],s:g[2],v:g[3]}:(g=M.hsva.exec(e))?{h:g[1],s:g[2],v:g[3],a:g[4]}:(g=M.hex8.exec(e))?{a:parseInt(g[1],16)/255,r:parseInt(g[2],16),g:parseInt(g[3],16),b:parseInt(g[4],16),format:p?"name":"hex8"}:(g=M.hex6.exec(e))?{r:parseInt(g[1],16),g:parseInt(g[2],16),b:parseInt(g[3],16),format:p?"name":"hex"}:(g=M.hex3.exec(e))?{r:parseInt(g[1]+""+g[1],
16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:p?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))h={r:255*C(e.r,255),g:255*C(e.g,255),b:255*C(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=Q(e.s);e.v=Q(e.v);f=e.h;p=e.s;h=e.v;f=6*C(f,360);p=C(p,100);h=C(h,100);d=Z.floor(f);var k=f-d;f=h*(1-p);g=h*(1-k*p);p=h*(1-(1-k)*p);d%=6;
h={r:255*[h,g,f,f,p,h][d],g:255*[p,h,h,g,f,f][d],b:255*[f,f,p,h,h,g][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=Q(e.s),e.l=Q(e.l),h=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(q=e.a)}q=X(q);e=e.format||f;f=N(255,B(h.r,0));g=N(255,B(h.g,0));h=N(255,B(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=q;this._roundA=w(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
...
a){return b&&a?u(b).toRgbString()==u(a).toRgbString():!1};u.random=function(){return u.fromRatio({r:aa(),g:aa(),b:aa()})};u.mix=function(b,a,c){c=0===c?0:c||50;b=u(b).toRgb();a=u(a).toRgb();c/=100;var d=2*c-1,e=a.a-b.a,d=((-1==d*e?d:(d+e)/(1+d*e))+1)/2,e=1-d;return u({r:a.r*d+b.r*e,g:a.g*d+b.g*e,b:a.b*d+b.b*e,a:a.a*c+b.a*(1-c)})};u.readability=function(b,a){var c=u(b),d=u(a),e=c.toRgb(),f=d.toRgb(),c=c.getBrightness(),d=d.getBrightness(),e=Math.max(e.r,f.r)-Math.min(e.r,f.r)+Math.max(e.g,f.g)-Math.min(e.g,
...
(function(b){for(var a=CryptoJS,c=a.lib,e=c.WordArray,d=c.Hasher,c=a.algo,f=[],g=[],h=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var n;a:{n=k;for(var m=b.sqrt(n),r=2;r<=m;r++)if(!(n%r)){n=!1;break a}n=!0}n&&(8>l&&(f[l]=h(b.pow(k,0.5))),g[l]=h(b.pow(k,1/3)),l++);k++}var p=[],c=c.SHA256=d.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,d=c[0],e=c[1],f=c[2],h=c[3],k=c[4],m=c[5],l=c[6],n=c[7],r=0;64>r;r++){if(16>r)p[r]=
b[a+r]|0;else{var I=p[r-15],y=p[r-2];p[r]=((I<<25|I>>>7)^(I<<14|I>>>18)^I>>>3)+p[r-7]+((y<<15|y>>>17)^(y<<13|y>>>19)^y>>>10)+p[r-16]}I=n+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&m^~k&l)+g[r]+p[r];y=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);n=l;l=m;m=k;k=h+I|0;h=f;f=e;e=d;d=I+y|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+m|0;c[6]=c[6]+l|0;c[7]=c[7]+n|0},_doFinalize:function(){var a=this._data,c=a.words,d=8*this._nDataBytes,e=8*a.sigBytes;
...
m=this;k.addEventListener(c,function(){l.innerHTML="<b>"+b+":</b> "+k.value;g&&g(parseFloat(k.value));n&&n();m._callCallbacks(b,{value:parseFloat(k.value)})})},_isIE:function(){return-1!=navigator.userAgent.indexOf("rv:11")||-1!=navigator.userAgent.indexOf("MSIE")?!0:!1},getRangeValue:function(b){return this._controls[b].control.value},setRangeValue:function(b,c,e){var d=this._controls[b];d.control.value=c;d.label.innerHTML="<b>"+b+":</b> "+d.control.value;e&&(d.callback&&d.callback(parseFloat(d.control.value)),
...
b),f.startDragY=h.page("Y",b),f.dragWatchers={current:0,last:0,hold:0,state:""},f.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(b){if(f.isDragging&&d.touchToDrag){var c=h.page("X",b),e=h.page("Y",b),g=f.translation,p=k.translate.get.matrix(4),q=c-f.startDragX,v=0<p,z=q;if(!f.intentChecked||f.hasIntent){d.addBodyClasses&&(0<p?(h.klass.add(a.body,"snapjs-left"),h.klass.remove(a.body,
"snapjs-right")):0>p&&(h.klass.add(a.body,"snapjs-right"),h.klass.remove(a.body,"snapjs-left")));if(!1===f.hasIntent||null===f.hasIntent){var e=h.angleOfDrag(c,e),G=0<=e&&e<=d.slideIntent||360>=e&&e>360-d.slideIntent;f.hasIntent=180<=e&&e<=180+d.slideIntent||180>=e&&e>=180-d.slideIntent||G?!0:!1;f.intentChecked=!0}d.minDragDistance>=Math.abs(c-f.startDragX)||!1===f.hasIntent||(h.events.prevent(b),h.dispatchEvent("drag"),f.dragWatchers.current=c,f.dragWatchers.last>c?("left"!==f.dragWatchers.state&&
(f.dragWatchers.state="left",f.dragWatchers.hold=c),f.dragWatchers.last=c):f.dragWatchers.last<c&&("right"!==f.dragWatchers.state&&(f.dragWatchers.state="right",f.dragWatchers.hold=c),f.dragWatchers.last=c),v?(d.maxPosition<p&&(b=(p-d.maxPosition)*d.resistance,z=q-b),f.simpleStates={opening:"left",towards:f.dragWatchers.state,hyperExtending:d.maxPosition<p,halfway:p>d.maxPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:p,relative:q,sinceDirectionChange:f.dragWatchers.current-
f.dragWatchers.hold,percentage:100*(p/d.maxPosition)}}):(d.minPosition>p&&(b=(p-d.minPosition)*d.resistance,z=q-b),f.simpleStates={opening:"right",towards:f.dragWatchers.state,hyperExtending:d.minPosition>p,halfway:p<d.minPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:p,relative:q,sinceDirectionChange:f.dragWatchers.current-f.dragWatchers.hold,percentage:100*(p/d.minPosition)}}),k.translate.x(z+g))}}},endDrag:function(b){if(f.isDragging){h.dispatchEvent("end");
...
!this._reconnection||0!==this.attempts)||(this.openReconnect=!0,this.reconnect())};d.prototype.open=d.prototype.connect=function(a){n("readyState %s",this.readyState);if(~this.readyState.indexOf("open"))return this;n("opening %s",this.uri);var c=this.engine=f(this.uri,this.opts),d=this;this.readyState="opening";var e=k(c,"open",function(){d.onopen();a&&a()}),g=k(c,"error",function(c){n("connect_error");d.cleanup();d.readyState="closed";d.emitAll("connect_error",c);if(a){var e=Error("Connection error");
e.data=c;a(e)}d.maybeReconnectOnOpen()});if(!1!==this._timeout){var h=this._timeout;n("connect attempt will timeout after %d",h);var G=setTimeout(function(){n("connect attempt timed out after %d",h);e.destroy();c.close();c.emit("error","timeout");d.emitAll("connect_timeout",h)},h);this.subs.push({destroy:function(){clearTimeout(G)}})}this.subs.push(e);this.subs.push(g);return this};d.prototype.onopen=function(){n("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(k(a,
...
this.io;this.subs=[h(a,"open",k(this,"onopen")),h(a,"packet",k(this,"onpacket")),h(a,"close",k(this,"onclose"))]};d.prototype.open=d.prototype.connect=function(){if(this.connected)return this;this.io.open();if("open"==this.io.readyState)this.onopen();return this};d.prototype.send=function(){var a=g(arguments);a.unshift("message");this.emit.apply(this,a);return this};d.prototype.emit=function(a){if(m.hasOwnProperty(a))return r.apply(this,arguments),this;var c=g(arguments),d=f.EVENT;n(c)&&(d=f.BINARY_EVENT);
...
c):this.receiveBuffer.push(c)};d.prototype.ack=function(a){var c=this,d=!1;return function(){if(!d){d=!0;var e=g(arguments);l("sending ack %j",e);var h=n(e)?f.BINARY_ACK:f.ACK;c.packet({type:h,id:a,data:e})}}};d.prototype.onack=function(a){l("calling ack %s with %j",a.id,a.data);this.acks[a.id].apply(this,a.data);delete this.acks[a.id]};d.prototype.onconnect=function(){this.connected=!0;this.disconnected=!1;this.emit("connect");this.emitBuffered()};d.prototype.emitBuffered=function(){var a;for(a=
...
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=m.name,D.emit("upgradeError",c)))}))}function d(){r||(r=!0,l(),m.close(),m=null)}function g(c){var e=Error("probe error: "+c);e.transport=m.name;d();k('probe transport "%s" failed because of error: %s',a,c);D.emit("upgradeError",e)}function h(){g("transport closed")}function p(){g("socket closed")}function n(a){m&&a.name!=m.name&&(k('"%s" works - aborting "%s"',a.name,m.name),d())}function l(){m.removeListener("open",c);m.removeListener("error",
g);m.removeListener("close",h);D.removeListener("close",p);D.removeListener("upgrading",n)}k('probing transport "%s"',a);var m=this.createTransport(a,{probe:1}),r=!1,D=this;e.priorWebsocketSuccess=!1;m.once("open",c);m.once("error",g);m.once("close",h);this.once("close",p);this.once("upgrading",n);m.open()};e.prototype.onOpen=function(){k("socket open");this.readyState="open";e.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
...
this.form=g;this.area=h}this.form.action=this.uri();e();a=a.replace(n,"\\\n");this.area.value=a.replace(l,"\\n");try{this.form.submit()}catch(F){}this.iframe.attachEvent?this.iframe.onreadystatechange=function(){"complete"==f.iframe.readyState&&d()}:this.iframe.onload=d}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./polling":17,"component-inherit":20}],16:[function(a,c,e){(function(d){function e(){}function g(a){n.call(this,a);if(d.location){var c="https:"==
...
n=a("./polling"),m=a("component-emitter"),r=a("component-inherit"),p=a("debug")("engine.io-client:polling-xhr");c.exports=g;c.exports.Request=h;r(g,n);g.prototype.supportsBinary=!0;g.prototype.request=function(a){a=a||{};a.uri=this.uri();a.xd=this.xd;a.xs=this.xs;a.agent=this.agent||!1;a.supportsBinary=this.supportsBinary;a.enablesXDR=this.enablesXDR;return new h(a)};g.prototype.doWrite=function(a,c){var d=this.request({method:"POST",data:a,isBinary:"string"!==typeof a&&void 0!==a}),e=this;d.on("success",
c);d.on("error",function(a){e.onError("xhr post error",a)});this.sendXhr=d};g.prototype.doPoll=function(){p("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};m(h.prototype);h.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{p("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
...
new Uint8Array(1);d[0]=1;if("string"===typeof a){for(var e=new Uint8Array(a.length),f=0;f<a.length;f++)e[f]=a.charCodeAt(f);a=e.buffer;d[0]=0}for(var e=(a instanceof ArrayBuffer?a.byteLength:a.size).toString(),g=new Uint8Array(e.length+1),f=0;f<e.length;f++)g[f]=parseInt(e[f]);g[e.length]=255;z&&(a=new z([d.buffer,g.buffer,a]),c(null,a))})},function(a,d){return c(new z(d))})};e.decodePayloadAsBinary=function(a,c,d){"function"===typeof c&&(d=c,c=null);for(var f=[],g=!1;0<a.byteLength;){for(var h=new Uint8Array(a),
p=0===h[0],l="",m=1;255!=h[m];m++){if(310<l.length){g=!0;break}l+=h[m]}if(g)return d(v,0,1);a=k(a,2+l.length);l=parseInt(l);h=k(a,0,l);if(p)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(n){for(p=new Uint8Array(h),h="",m=0;m<p.length;m++)h+=String.fromCharCode(p[m])}f.push(h);a=k(a,l)}var q=f.length;f.forEach(function(a,f){d(e.decodePacket(a,c,!0),f,q)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
56320==(g&64512)?c.push(((f&1023)<<10)+(g&1023)+65536):(c.push(f),d--)):c.push(f);return c}function h(){if(v>=q)throw Error("Invalid byte index");var a=p[v]&255;v++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,d,e;if(v>q)throw Error("Invalid byte index");if(v==q)return!1;a=p[v]&255;v++;if(0==(a&128))return a;if(192==(a&224)){c=h();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=h();d=h();a=(a&15)<<12|c<<6|
d;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=h(),d=h(),e=h(),a=(a&15)<<18|c<<12|d<<6|e,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof e&&e,n="object"==typeof c&&c&&c.exports==l&&c,m="object"==typeof a&&a;if(m.global===m||m.window===m)f=m;var r=String.fromCharCode,p,q,v,m={version:"2.0.0",encode:function(a){a=g(a);for(var c=a.length,d=-1,e,f="";++d<c;){e=a[d];if(0==(e&4294967168))e=r(e);else{var h="";0==(e&4294965248)?
h=r(e>>6&31|192):0==(e&4294901760)?(h=r(e>>12&15|224),h+=r(e>>6&63|128)):0==(e&4292870144)&&(h=r(e>>18&7|240),h+=r(e>>12&63|128),h+=r(e>>6&63|128));e=h+=r(e&63|128)}f+=e}return f},decode:function(a){p=g(a);q=p.length;v=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var d=-1,e,f="";++d<c;)e=a[d],65535<e&&(e-=65536,f+=r(e>>>10&1023|55296),e=56320|e&1023),f+=r(e);return f}};if(l&&!l.nodeType)if(n)n.exports=m;else{f={}.hasOwnProperty;for(var z in m)f.call(m,z)&&(l[z]=m[z])}else f.utf8=m})(this)}).call(this,
"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{}],28:[function(a,c,e){(function(a){var e=/^[\],:{}\s]*$/,g=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,h=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,k=/(?:^|:|,)(?:\s*\[)+/g,l=/^\s+/,n=/\s+$/;c.exports=function(c){if("string"!=typeof c||!c)return null;c=c.replace(l,"").replace(n,"");if(a.JSON&&JSON.parse)return JSON.parse(c);if(e.test(c.replace(g,"@").replace(h,"]").replace(k,"")))return(new Function("return "+
...
f="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");c.exports=function(a){var c=a,e=a.indexOf("["),l=a.indexOf("]");-1!=e&&-1!=l&&(a=a.substring(0,e)+a.substring(e,l).replace(/:/g,";")+a.substring(l,a.length));a=d.exec(a||"");for(var n={},m=14;m--;)n[f[m]]=a[m]||"";-1!=e&&-1!=l&&(n.source=c,n.host=n.host.substring(1,n.host.length-1).replace(/;/g,":"),n.authority=n.authority.replace("[","").replace("]","").replace(/;/g,":"),n.ipv6uri=
...
a._placeholder)return c[a.num];if(f(a))for(var e=0;e<a.length;e++)a[e]=d(a[e]);else if(a&&"object"==typeof a)for(e in a)a[e]=d(a[e]);return a}a.data=d(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,h,q){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){n++;var v=new FileReader;v.onload=function(){q?q[h]=this.result:m=this.result;--n||e(m)};v.readAsArrayBuffer(a)}else if(f(a))for(v=0;v<a.length;v++)l(a[v],v,a);else if(a&&"object"==typeof a&&!g(a))for(v in a)l(a[v],
v,a)}var n=0,m=a;l(m);n||e(m)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=n.stringify(a.data));l("encoded %j as %s",a,c);return c}function g(a,c){m.removeBlobs(a,function(a){var d=m.deconstructPacket(a);
a=f(d.packet);d=d.buffers;d.unshift(a);c(d)})}function h(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),n=a("json3");a("isarray");c=a("component-emitter");var m=a("./binary"),r=a("./is-buffer");e.protocol=4;e.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");e.CONNECT=0;e.DISCONNECT=1;e.EVENT=2;e.ACK=3;e.ERROR=4;e.BINARY_EVENT=5;e.BINARY_ACK=6;e.Encoder=d;e.Decoder=h;d.prototype.encode=function(a,c){l("encoding packet %j",
...
d("01")}catch(q){}if(p)try{p=1!==d("1.")}catch(t){}}}}catch(s){p=!1}d=p}}return c[a]=!!d}var g={}.toString,h,k,l,n="object"==typeof JSON&&JSON,m="object"==typeof e&&e&&!e.nodeType&&e;m&&n?(m.stringify=n.stringify,m.parse=n.parse):m=a.JSON=n||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(p){}if(!c("json")){var q=c("bug-string-char-index");
...
k=function(a,c){var d="[object Function]"==g.call(a),e,k;if(k=!d)if(k="function"!=typeof a.constructor)k=typeof a.hasOwnProperty,k="object"==k?!!a.hasOwnProperty:!H[k];k=k?a.hasOwnProperty:h;for(e in a)d&&"prototype"==e||!k.call(a,e)||c(e);for(d=f.length;e=f[--d];k.call(a,e)&&c(e));});return k(a,c)};if(!c("json-stringify")){var J={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},E=function(a,c){return("000000"+(c||0)).slice(-a)},F=function(a){var c='"',d=0,e=a.length,f=10<e&&q,h;for(f&&
(h=a.split(""));d<e;d++){var g=a.charCodeAt(d);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=J[g];break;default:if(32>g){c+="\\u00"+E(2,g.toString(16));break}c+=f?h[d]:q?a.charAt(d):a[d]}}return c+'"'},x=function(a,c,d,e,f,m,p){var n,q,s,r,t,w,y,B,z;try{n=c[a]}catch(u){}if("object"==typeof n&&n)if(q=g.call(n),"[object Date]"!=q||h.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=q&&"[object String]"!=q&&"[object Array]"!=q||h.call(n,"toJSON"))&&(n=n.toJSON(a));
...
d.call(c,a,n));if(null===n)return"null";q=g.call(n);if("[object Boolean]"==q)return""+n;if("[object Number]"==q)return n>-1/0&&n<1/0?""+n:"null";if("[object String]"==q)return F(""+n);if("object"==typeof n){for(a=p.length;a--;)if(p[a]===n)throw TypeError();p.push(n);z=[];c=m;m+=f;if("[object Array]"==q){s=0;for(a=n.length;s<a;s++)q=x(s,n,d,e,f,m,p),z.push(q===l?"null":q);a=z.length?f?"[\n"+m+z.join(",\n"+m)+"\n"+c+"]":"["+z.join(",")+"]":"[]"}else k(e||n,function(a){var c=x(a,n,d,e,f,m,p);c!==l&&
z.push(F(a)+":"+(f?" ":"")+c)}),a=z.length?f?"{\n"+m+z.join(",\n"+m)+"\n"+c+"}":"{"+z.join(",")+"}":"{}";p.pop();return a}};m.stringify=function(a,c,d){var e,f,h,k;if("function"==typeof c||"object"==typeof c&&c)if("[object Function]"==(k=g.call(c)))f=c;else if("[object Array]"==k){h={};for(var l=0,m=c.length,n;l<m;n=c[l++],(k=g.call(n),"[object String]"==k||"[object Number]"==k)&&(h[n]=1));}if(d)if("[object Number]"==(k=g.call(d))){if(0<(d-=d%1))for(e="",10<d&&(d=10);e.length<d;e+=" ");}else"[object String]"==
k&&(e=10>=d.length?d:d.slice(0,10));return x("",(n={},n[""]=a,n),f,h,e,"",[])}}if(!c("json-parse")){var S=String.fromCharCode,D={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},t,I,y=function(){t=I=null;throw SyntaxError();},R=function(){for(var a=I,c=a.length,d,e,f,h,g;t<c;)switch(g=a.charCodeAt(t),g){case 9:case 10:case 13:case 32:t++;break;case 123:case 125:case 91:case 93:case 58:case 44:return d=q?a.charAt(t):a[t],t++,d;case 34:d="@";for(t++;t<c;)if(g=a.charCodeAt(t),32>g)y();
else if(92==g)switch(g=a.charCodeAt(++t),g){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:d+=D[g];t++;break;case 117:e=++t;for(f=t+4;t<f;t++)g=a.charCodeAt(t),48<=g&&57>=g||(97<=g&&102>=g||65<=g&&70>=g)||y();d+=S("0x"+a.slice(e,t));break;default:y()}else{if(34==g)break;g=a.charCodeAt(t);for(e=t;32<=g&&92!=g&&34!=g;)g=a.charCodeAt(++t);d+=a.slice(e,t)}if(34==a.charCodeAt(t))return t++,d;y();default:e=t;45==g&&(h=!0,g=a.charCodeAt(++t));if(48<=g&&57>=g){for(48==g&&(g=a.charCodeAt(t+
...
g.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};m.parse=function(a,c){var d,e;t=0;I=""+a;d=ja(R());"$"!=R()&&y();t=I=null;return c&&"[object Function]"==g.call(c)?oa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],h=(c=c||0)||0;h<a.length;h++)e[h-c]=a[h];return e}},{}]},{},[1])(1)});
