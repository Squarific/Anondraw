...
c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Lastly we like to create, not destroy. Griefing will result in a ban of up to 10 years."));c=a.appendChild(document.createElement("p"));c.appendChild(document.createTextNode("Regards,"));c.appendChild(document.createElement("br"));c.appendChild(document.createTextNode("Anondraw Team"));c=a.appendChild(document.createElement("div"));c.appendChild(document.createTextNode("Tutorial"));c.className="drawtogether-button";
c.addEventListener("click",function(){b.parentNode&&b.parentNode.removeChild(b);introJs().setOptions({tooltipPosition:"auto",showProgress:!0}).onchange(function(){ga("send","event","tutorial","next")}).onexit(function(){ga("send","event","tutorial","exit");this.openWelcomeWindow()}.bind(this)).oncomplete(function(){ga("send","event","tutorial","complete");this.openWelcomeWindow()}.bind(this)).start()}.bind(this));a=a.appendChild(document.createElement("div"));a.appendChild(document.createTextNode("Close welcome window"));
a.className="drawtogether-button drawtogether-close-button";a.addEventListener("click",function(){b.parentNode&&b.parentNode.removeChild(b)})};
...
b.effectsCanvas.height)}"mousemove"!=a.type&&"touchmove"!=a.type||!b.lastZoomPoint||(b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,b.effectsCanvas.height),d=e[0],f=e[1],g=b.lastZoomPoint[0],h=b.lastZoomPoint[1],c=Math.min(d,g),k=Math.min(f,h),d=Math.abs(d-g),f=Math.abs(f-h),e=b.effectsCanvasCtx,e.beginPath(),"function"==typeof e.setLineDash&&e.setLineDash([6]),e.rect(c,k,d,f),e.lineWidth=3,e.strokeStyle="gray",e.stroke())}},grab:function(b,a){if("remove"==a||"mouseup"==a.type||"touchend"==
a.type||"mouseleave"===a.type)delete b.lastGrabCoords,b.effectsCanvas.style.cursor="";else{var c=b.getCoords(a),c=b.scaledCoords(c,a);b.lastGrabCoords||"mousedown"!=a.type&&"touchstart"!=a.type||(b.lastGrabCoords=c,b.effectsCanvas.style.cursor="move");"mousemove"!=a.type&&"touchmove"!=a.type||!b.lastGrabCoords||(b.goto(b.local.leftTopX+(b.lastGrabCoords[0]-c[0])/b.local.zoom,b.local.leftTopY+(b.lastGrabCoords[1]-c[1])/b.local.zoom),b.lastGrabCoords=c)}},line:function(b,a){if("remove"==a)delete b.lastLinePoint,
b.effectsCanvas.style.cursor="";else{var c=b.getCoords(a),c=b.scaledCoords(c,a);"mousedown"!=a.type&&"touchstart"!=a.type||b.lastLinePoint||(b.lastLinePoint=c);if("mouseup"==a.type||"touchend"==a.type){if(b.lastLinePoint[0]==c[0]&&b.lastLinePoint[1]==c[1])return;b.addUserDrawing({type:"line",x:Math.round(b.local.leftTopX+b.lastLinePoint[0]/b.local.zoom),y:Math.round(b.local.leftTopY+b.lastLinePoint[1]/b.local.zoom),x1:Math.round(b.local.leftTopX+c[0]/b.local.zoom),y1:Math.round(b.local.leftTopY+c[1]/
b.local.zoom),size:2*b.current_size,color:b.current_color});delete b.lastLinePoint;b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,b.effectsCanvas.height)}if(("mousemove"==a.type||"touchmove"==a.type)&&b.lastLinePoint){b.effectsCanvasCtx.clearRect(0,0,b.effectsCanvas.width,b.effectsCanvas.height);var e=b.effectsCanvasCtx;e.beginPath();e.arc(b.lastLinePoint[0],b.lastLinePoint[1],b.current_size*b.local.zoom,0,2*Math.PI,!0);e.fillStyle=b.current_color.toRgbString();e.fill();e.beginPath();e.moveTo(b.lastLinePoint[0],
b.lastLinePoint[1]);e.lineTo(c[0],c[1]);e.strokeStyle=b.current_color.toRgbString();e.lineWidth=2*b.current_size*b.local.zoom;e.stroke();e.beginPath();e.arc(c[0],c[1],b.current_size*b.local.zoom,0,2*Math.PI,!0);e.fillStyle=b.current_color.toRgbString();e.fill()}}},brush:function(b,a,c){if("remove"==a)delete b.lastMovePoint,delete b.lockcolor,delete b.brushing;else{b.lastMovePoint=b.lastMovePoint||[0,0];c=b.getCoords(a);c=b.scaledCoords(c,a);if("mousedown"==a.type||"touchstart"==a.type)b.brushing=
!0,b.addUserPath(),b.addUserPathPoint([Math.round(b.local.leftTopX+c[0]/b.local.zoom),Math.round(b.local.leftTopY+c[1]/b.local.zoom)]);if("mouseup"==a.type||"touchend"==a.type||"mouseleave"==a.type)b.endUserPath(),b.brushing=!1;if("mousemove"==a.type||"touchmove"==a.type)b.effectsCanvasCtx.clearRect(b.lastMovePoint[0]-2*b.current_size*b.local.zoom,b.lastMovePoint[1]-2*b.current_size*b.local.zoom,4*b.current_size*b.local.zoom,4*b.current_size*b.local.zoom),a=b.effectsCanvasCtx,a.beginPath(),a.arc(c[0],
c[1],b.current_size*b.local.zoom,0,2*Math.PI,!0),a.fillStyle=b.current_color.toRgbString(),a.fill(),b.lastMovePoint[0]=c[0],b.lastMovePoint[1]=c[1],b.brushing&&b.addUserPathPoint([Math.round(b.local.leftTopX+c[0]/b.local.zoom),Math.round(b.local.leftTopY+c[1]/b.local.zoom)])}},picker:function(b,a){if("remove"==a)delete b.picking,b.effectsCanvas.style.cursor="";else{var c=b.getCoords(a);"mousedown"!=a.type&&"touchstart"!=a.type||b.picking||(b.picking=!0,b.setColor(b.getColorAt(c).setAlpha(b.current_color.getAlpha())),
b.effectsCanvas.style.cursor="crosshair");if("mouseup"==a.type||"touchend"==a.type)delete b.picking,b.effectsCanvas.style.cursor="";("mousemove"==a.type||"touchmove"==a.type)&&b.picking&&b.setColor(b.getColorAt(c).setAlpha(b.current_color.getAlpha()))}},block:function(b,a){this.brush(b,a,"block")},text:function(b,a){if("remove"==a)delete b.lastMovePoint,delete b.lastToolText,b.textToolInput&&b.container.removeChild(b.textToolInput),delete b.textToolInput;else{var c=b.getCoords(a),c=b.scaledCoords(c,
a);b.textToolInput||(b.textToolInput=document.createElement("input"),b.textToolInput.className="paint-texttool",b.textToolInput.placeholder="Type some text",b.container.appendChild(b.textToolInput),b.textToolInput.addEventListener("input",function(){this.exectool("redraw")}.bind(b)));b.textToolInput.focus();"mouseup"!=a.type&&"touchend"!=a.type||!b.textToolInput.value||(b.addUserDrawing({type:"text",text:b.textToolInput.value.slice(0,256)||"",x:Math.round(b.local.leftTopX+c[0]/b.local.zoom),y:Math.round(b.local.leftTopY+
c[1]/b.local.zoom),size:b.current_size,color:b.current_color}),b.textToolInput.value="");if("mousemove"==a.type||"touchmove"==a.type)b.lastMovePoint=b.lastMovePoint||[0,0],b.effectsCanvasCtx.font=b.current_size*b.local.zoom+"px Verdana, Geneva, sans-serif",b.effectsCanvasCtx.clearRect(b.lastMovePoint[0],b.lastMovePoint[1]-1.5*b.current_size*b.local.zoom,b.effectsCanvasCtx.measureText(b.lastToolText).width,2*b.current_size*b.local.zoom),b.effectsCanvasCtx.fillStyle=b.current_color.toRgbString(),b.effectsCanvasCtx.fillText(b.textToolInput.value.slice(0,
256),c[0],c[1]),b.lastToolText=b.textToolInput.value.slice(0,256),b.lastMovePoint=c;"redraw"==a&&(b.effectsCanvasCtx.font=b.current_size*b.local.zoom+"px Verdana, Geneva, sans-serif",b.effectsCanvasCtx.clearRect(b.lastMovePoint[0],b.lastMovePoint[1]-1.5*b.current_size*b.local.zoom,b.effectsCanvasCtx.measureText(b.lastToolText).width,2*b.current_size*b.local.zoom),b.effectsCanvasCtx.fillStyle=b.current_color.toRgbString(),b.effectsCanvasCtx.fillText(b.textToolInput.value.slice(0,256),b.lastMovePoint[0],
b.lastMovePoint[1]),b.lastToolText=b.textToolInput.value.slice(0,256))}}};
