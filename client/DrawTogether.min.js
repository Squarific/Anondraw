...
b+="</form>",b+="<br/>",b+='<a class="coinbase-button" data-code="8be6985bf22cfd01ca0877cb6fb97249" data-button-style="custom_small" href="https://www.coinbase.com/checkouts/8be6985bf22cfd01ca0877cb6fb97249">Pay With Bitcoin</a>'):b="You should first login!";a.innerHTML=b;(function(){var b,a,c;b=function(b){return"development"===b||"test"===b?document.location.protocol+"//"+document.location.host:"sandbox"===b?"https://sandbox.coinbase.com":"https://www.coinbase.com"};a=function(c,e){var g,n;if(window.coinbaseCookieLoaded)return e(c);
if(window.coinbaseCookieLoading)return setTimeout(function(){return a(c,e)},200);g=b(c("body").data("env"));window.coinbaseCookieLoading=!0;n=document.createElement("script");n.src=g+"/checkouts/get_cookie.js";n.onload=n.onreadystatechange=function(){window.coinbaseCookieLoaded=!0;window.coinbaseCookieLoading=!1;c(n).remove();return e(c)};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(n)};c=function(a){var c,e,f,g,r;e=c=!1;r=b(a("body").data("env"));g=function(b){switch(b){case "custom_large":return 276;
...
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,e)return a(document).trigger("coinbase_button_loaded",d)}else if("checkouts frame loaded"===f&&(e=!0,c))return a(document).trigger("coinbase_button_loaded",d)}},!1);a(".coinbase-button").each(function(e){return function(e,m){var l,G,B,H,C;l=a(m);B=l.data();B.referrer=document.domain;H=a.param(B);B=l.data("code");C=l.data("width")||g(l.data("button-style"));G=l.data("height")||f(l.data("button-style"));r=b(l.data("env"));
