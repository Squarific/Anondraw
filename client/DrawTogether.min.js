...
DrawTogether.prototype.CLIENT_VERSION=1;DrawTogether.prototype.defaultSettings={mode:"ask",room:"main",leftTopX:0,leftTopY:0,loadbalancer:"http://direct.anondraw.com:3552",accountServer:"http://direct.anondraw.com:4552",imageServer:"http://direct.anondraw.com:5552"};DrawTogether.prototype.defaultUserSettings=[{title:"Mute chat",type:"boolean",value:!1},{title:"Show tips",type:"boolean",value:!0},{title:"Show welcome",type:"boolean",value:!0}];DrawTogether.prototype.drawingTypes=["line","brush","block"];
...
a||{};b.chat.addMessage(a.user,a.message)});this.network.on("emote",function(a){a=a||{};b.chat.addMessage(a.user+" "+a.message)});this.network.on("setmemberlevel",function(a){b.memberlevel=a;console.log("We have memberlevel ",a)});this.network.on("setreputation",function(a){b.reputation=a;console.log("Our reputation is ",a)});this.network.on("setink",function(a){b.ink=a;b.updateInk()})};DrawTogether.prototype.sendMessage=function(b){this.network.socket.emit("chatmessage",b)};
...
DrawTogether.prototype.populateRedditDrawings=function(){var b=new XMLHttpRequest;b.addEventListener("readystatechange",function(a){if(4==b.readyState&&200==b.status){a=JSON.parse(b.responseText).data.children;var c=this.redditDrawings.appendChild(document.createElement("a"));c.appendChild(document.createTextNode("Reddit gallery (/r/anondraw)"));c.href="http://www.reddit.com/r/anondraw";c.className="drawtogether-redditdrawings-title";this.redditDrawings.appendChild(this.createThumbLink("http://nyrrti.tumblr.com/",
"Nyrrtis tumblr","http://40.media.tumblr.com/fafb08a2535fa9e32cd54d5add9321d0/tumblr_o3w1sm1NYg1tyibijo1_1280.png"));this.redditDrawings.appendChild(this.createThumbLink("http://dojaboys.tumblr.com/","Dojaboys (alien) tumblr","http://40.media.tumblr.com/222bcca3dcd8d86ba27d02a9e8cba560/tumblr_o3zfyfHJfj1u8vwn5o1_1280.png"));for(c=0;c<a.length;c++)this.redditDrawings.appendChild(this.createRedditPost(a[c].data))}}.bind(this));b.open("GET","https://www.reddit.com/r/anondraw/.json");b.send()};
...
"nsfw"==b.thumbnail?(c=a.appendChild(document.createElement("img")),c.className="drawtogether-redditpost-thumb",c.src=b.url):a.appendChild(document.createElement("div")).className="drawtogether-redditpost-thumbfiller";return a};
...
b="You should first login!";a.innerHTML=b;(function(){var b,a,c;b=function(b){return"development"===b||"test"===b?document.location.protocol+"//"+document.location.host:"sandbox"===b?"https://sandbox.coinbase.com":"https://www.coinbase.com"};a=function(c,e){var g,n;if(window.coinbaseCookieLoaded)return e(c);if(window.coinbaseCookieLoading)return setTimeout(function(){return a(c,e)},200);g=b(c("body").data("env"));window.coinbaseCookieLoading=!0;n=document.createElement("script");n.src=g+"/checkouts/get_cookie.js";
n.onload=n.onreadystatechange=function(){window.coinbaseCookieLoaded=!0;window.coinbaseCookieLoading=!1;c(n).remove();return e(c)};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(n)};c=function(a){var c,e,f,g,r;e=c=!1;r=b(a("body").data("env"));g=function(b){switch(b){case "custom_large":return 276;case "custom_small":return 210;case "subscription_large":return 263;case "subscription_small":return 210;case "donation_large":return 189;case "donation_small":return 148;
case "buy_now_large":return 211;case "buy_now_small":return 170;default:return 211}};f=function(b){switch(b){case "custom_large":return 62;case "custom_small":return 48;default:return 46}};window.addEventListener("message",function(b){var d,f;d=b.data.split("|");f=d[0];d=d[1];d=escape(d);if(b.origin===r){if("show modal iframe"===f)return a("#coinbase_modal_iframe_"+d).show();if("coinbase_payment_complete"===f)return a("#coinbase_button_iframe_"+d).attr("src",r+"/buttons/paid"),a(document).trigger("coinbase_payment_complete",
d);if("coinbase_payment_mispaid"===f)return a(document).trigger("coinbase_payment_mispaid",d);if("coinbase_payment_expired"===f)return a(document).trigger("coinbase_payment_expired",d);if("hide modal"===f)return a("#coinbase_modal_iframe_"+d).hide(),a(document).trigger("coinbase_modal_closed",d);if("signup redirect"===f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,e)return a(document).trigger("coinbase_button_loaded",d)}else if("checkouts frame loaded"===f&&(e=
!0,c))return a(document).trigger("coinbase_button_loaded",d)}},!1);a(".coinbase-button").each(function(e){return function(e,m){var l,G,B,H,C;l=a(m);B=l.data();B.referrer=document.domain;H=a.param(B);B=l.data("code");C=l.data("width")||g(l.data("button-style"));G=l.data("height")||f(l.data("button-style"));r=b(l.data("env"));G="<iframe src='"+r+"/buttons/"+B+"?"+H+"' id='coinbase_button_iframe_"+B+"' name='coinbase_button_iframe_"+B+"' style='width: "+C+"px; height: "+G+"px; border: none; overflow: hidden;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";
B="<iframe src='"+r+"/checkouts/"+B+"/widget?"+H+"' id='coinbase_modal_iframe_"+B+"' name='coinbase_modal_iframe_"+B+"' style='background-color: transparent; border: 0px none transparent; display: none; position: fixed; visibility: visible; margin: 0px; padding: 0px; left: 0px; top: 0px; width: 100%; height: 100%; z-index: 9999;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";"none"===l.data("button-style")?c=!0:l.replaceWith(G);return a("body").append(B)}}(this));return a(document).on("coinbase_show_modal",
function(b,c){if(0<a("#coinbase_modal_iframe_"+c).length)return a("#coinbase_modal_iframe_"+c).show(),frames["coinbase_modal_iframe_"+c].postMessage("show modal|"+c,r)})};(function(b,a){var c,d,e,f,g,q,u,A;f=[null,null,!1];e=f[0];d=f[1];g=f[2];if(e=window.jQuery)u=parseInt(b.split(".")[0])||0,A=parseInt(b.split(".")[1])||0,c=parseInt(e.fn.jquery.split(".")[0])||0,f=parseInt(e.fn.jquery.split(".")[1])||0,c=c>u||c===u&&f>=A;if(e&&c)return a(e);q=document.createElement("script");q.type="text/javascript";
q.src="https://code.jquery.com/jquery-1.8.3.min.js";q.onload=q.onreadystatechange=function(){if(!(g||(d=this.readyState)&&"loaded"!==d&&"complete"!==d))return a((e=window.jQuery).noConflict(1)),e(q).remove()};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(q)})("1.7",function(b){return a(b,c)})}).call(this)};
...
positionPrecedence:["bottom","top","right","left"],disableInteraction:!1,hintPosition:"top-middle",hintButtonLabel:"Got it"}}function c(b){var a=[],c=this;if(this._options.steps)for(var h=0,q=this._options.steps.length;h<q;h++){var m=e(this._options.steps[h]);m.step=a.length+1;"string"===typeof m.element&&(m.element=document.querySelector(m.element));if("undefined"===typeof m.element||null==m.element){var l=document.querySelector(".introjsFloatingElement");null==l&&(l=document.createElement("div"),
l.className="introjsFloatingElement",document.body.appendChild(l));m.element=l;m.position="floating"}null!=m.element&&a.push(m)}else{q=b.querySelectorAll("*[data-intro]");if(1>q.length)return!1;h=0;for(m=q.length;h<m;h++){var l=q[h],k=parseInt(l.getAttribute("data-step"),10);0<k&&(a[k-1]={element:l,intro:l.getAttribute("data-intro"),step:parseInt(l.getAttribute("data-step"),10),tooltipClass:l.getAttribute("data-tooltipClass"),highlightClass:l.getAttribute("data-highlightClass"),position:l.getAttribute("data-position")||
this._options.tooltipPosition})}h=k=0;for(m=q.length;h<m;h++)if(l=q[h],null==l.getAttribute("data-step")){for(;"undefined"!=typeof a[k];)k++;a[k]={element:l,intro:l.getAttribute("data-intro"),step:k+1,tooltipClass:l.getAttribute("data-tooltipClass"),highlightClass:l.getAttribute("data-highlightClass"),position:l.getAttribute("data-position")||this._options.tooltipPosition}}}h=[];for(q=0;q<a.length;q++)a[q]&&h.push(a[q]);a=h;a.sort(function(b,a){return b.step-a.step});c._introItems=a;B.call(c,b)&&
...
typeof c._introCompleteCallback&&c._introCompleteCallback.call(c),void 0!=c._introExitCallback&&c._introExitCallback.call(c),g.call(c,b)):d.call(c);a.preventDefault?a.preventDefault():a.returnValue=!1}},c._onResize=function(b){p.call(c,document.querySelector(".introjs-helperLayer"));p.call(c,document.querySelector(".introjs-tooltipReferenceLayer"))},window.addEventListener?(this._options.keyboardNavigation&&window.addEventListener("keydown",c._onKeyDown,!0),window.addEventListener("resize",c._onResize,
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=A();var q=t(a).height+10,m=t(a).width+20,p=t(b),u="floating";p.left+m>h.width||0>p.left+p.width/2-m?(n(g,"bottom"),n(g,"top")):(p.height+p.top+q>h.height&&n(g,"bottom"),0>p.top-q&&n(g,"top"));p.width+p.left+m>h.width&&n(g,"right");0>p.left-m&&n(g,"left");0<g.length&&(u=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(u=f);h=u}f=t(b);b=t(a);g=A();switch(h){case "top":c.className="introjs-arrow bottom";k(f,e?0:15,b,g,a);a.style.bottom=f.height+20+
...
"").replace(/^\s+|\s+$/g,"");x=document.querySelector(".introjs-showElement");x.className=x.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");a._lastShowElementTimer&&clearTimeout(a._lastShowElementTimer);a._lastShowElementTimer=setTimeout(function(){null!=l&&(l.innerHTML=b.step);k.innerHTML=b.intro;u.style.display="block";h.call(a,b.element,u,n,l);e.querySelector(".introjs-bullets li > a.active").className="";e.querySelector('.introjs-bullets li > a[data-stepnumber="'+b.step+'"]').className=
...
b-2;"undefined"!==typeof this._introItems&&d.call(this);return this},nextStep:function(){d.call(this);return this},previousStep:function(){f.call(this);return this},exit:function(){g.call(this,this._targetElement);return this},refresh:function(){p.call(this,document.querySelector(".introjs-helperLayer"));p.call(this,document.querySelector(".introjs-tooltipReferenceLayer"));return this},onbeforechange:function(b){if("function"===typeof b)this._introBeforeChangeCallback=b;else throw Error("Provided callback for onbeforechange was not a function");
...
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,d,e){for(var f=[],g=0;g<a.length;g++){var h=a[g];if(h){var m=tinycolor(h),l=0.5>m.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l=l+(tinycolor.equals(c,h)?" sp-thumb-active":""),h=m.toString(e.preferredFormat||"rgb"),k=q?"background-color:"+m.toRgbString():"filter:"+m.toFilter();f.push('<span title="'+
...
!0);va.addClass("sp-disabled")}var s=e(g,d),U=s.flat,Z=s.showSelectionPalette,w=s.localStorageKey,N=s.theme,D=s.callbacks,aa=n(Q,10),v=!1,L=0,T=0,M=0,Aa=0,ia=0,Ra=0,Sa=0,qa=0,ra=0,sa=0,W=1,ya=[],pa=[],za={},V=s.selectionPalette.slice(0),Wa=s.maxSelectionSize,Qa="sp-dragging",ba=null,Ia=d.ownerDocument,K=b(d),La=!1,z=b(G,Ia).addClass(N),Ya=z.find(".sp-picker-container"),Ba=z.find(".sp-color"),Ea=z.find(".sp-dragger"),Ka=z.find(".sp-hue"),Da=z.find(".sp-slider"),ua=z.find(".sp-alpha-inner"),Ta=z.find(".sp-alpha"),
...
a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(K.is(":disabled")||!0===s.disabled)&&xa();z.click(h);ca.change(R);ca.bind("paste",function(){setTimeout(R,1)});ca.keydown(function(b){13==b.keyCode&&R()});Ua.text(s.cancelText);Ua.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();Y(ha,!0);ea()});Ma.attr("title",s.clearText);Ma.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();da=!0;la();U&&P(!0)});Va.text(s.chooseText);Va.bind("click.spectrum",
...
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=E(b,360);c=E(c,100);d=E(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,g=2*d-f;d=e(g,f,b+1/3);c=e(g,f,b);b=e(g,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=E(b,255);a=E(a,255);d=E(d,255);var e=D(b,a,d),f=N(b,a,d),g,h=e-f;if(e==f)g=0;else{switch(e){case b:g=(a-d)/h+(a<d?6:0);break;case a:g=(d-b)/h+2;break;case d:g=(b-a)/h+4}g/=6}return{h:g,s:0===e?0:h/e,v:e}}function d(b,a,c,e){b=[P(w(b).toString(16)),
P(w(a).toString(16)),P(w(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[P(Math.round(255*parseFloat(d)).toString(16)),P(w(b).toString(16)),P(w(a).toString(16)),P(w(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s-=a/100;c.s=N(1,D(0,c.s));return v(c)}function g(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.s+=a/100;
c.s=N(1,D(0,c.s));return v(c)}function h(b){return v(b).desaturate(100)}function q(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l+=a/100;c.l=N(1,D(0,c.l));return v(c)}function m(b,a){a=0===a?0:a||10;var c=v(b).toRgb();c.r=D(0,N(255,c.r-w(255*-(a/100))));c.g=D(0,N(255,c.g-w(255*-(a/100))));c.b=D(0,N(255,c.b-w(255*-(a/100))));return v(c)}function l(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l-=a/100;c.l=N(1,D(0,c.l));return v(c)}function k(b,a){var c=v(b).toHsl(),d=(w(c.h)+a)%360;c.h=0>d?360+d:d;return v(c)}
...
(d.h-(c*a>>1)+720)%360;--a;)d.h=(d.h+c)%360,b.push(v(d));return b}function r(b,a){a=a||6;for(var c=v(b).toHsv(),d=c.h,e=c.s,c=c.v,f=[],g=1/a;a--;)f.push(v({h:d,s:e,v:c})),c=(c+g)%1;return f}function X(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function E(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=N(a,D(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>Z.abs(b-a)?1:b%a/parseFloat(a)}function P(b){return 1==
b.length?"0"+b:""+b}function Q(b){1>=b&&(b=100*b+"%");return b}var xa=/^[\s,#]+/,s=/\s+$/,U=0,Z=Math,w=Z.round,N=Z.min,D=Z.max,aa=Z.random,v=function ia(b,c){var d,e,f,g,h;b=b?b:"";c=c||{};if(b instanceof ia)return b;if(!(this instanceof ia))return new ia(b,c);e=b;h={r:0,g:0,b:0};var q=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(xa,"").replace(s,"").toLowerCase();var m=!1;if(L[e])e=L[e],m=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(g=M.rgb.exec(e))?{r:g[1],g:g[2],b:g[3]}:
(g=M.rgba.exec(e))?{r:g[1],g:g[2],b:g[3],a:g[4]}:(g=M.hsl.exec(e))?{h:g[1],s:g[2],l:g[3]}:(g=M.hsla.exec(e))?{h:g[1],s:g[2],l:g[3],a:g[4]}:(g=M.hsv.exec(e))?{h:g[1],s:g[2],v:g[3]}:(g=M.hsva.exec(e))?{h:g[1],s:g[2],v:g[3],a:g[4]}:(g=M.hex8.exec(e))?{a:parseInt(g[1],16)/255,r:parseInt(g[2],16),g:parseInt(g[3],16),b:parseInt(g[4],16),format:m?"name":"hex8"}:(g=M.hex6.exec(e))?{r:parseInt(g[1],16),g:parseInt(g[2],16),b:parseInt(g[3],16),format:m?"name":"hex"}:(g=M.hex3.exec(e))?{r:parseInt(g[1]+""+g[1],
16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:m?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))h={r:255*E(e.r,255),g:255*E(e.g,255),b:255*E(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=Q(e.s);e.v=Q(e.v);f=e.h;m=e.s;h=e.v;f=6*E(f,360);m=E(m,100);h=E(h,100);d=Z.floor(f);var l=f-d;f=h*(1-m);g=h*(1-l*m);m=h*(1-(1-l)*m);d%=6;
h={r:255*[h,g,f,f,m,h][d],g:255*[m,h,h,g,f,f][d],b:255*[f,f,m,h,h,g][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=Q(e.s),e.l=Q(e.l),h=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(q=e.a)}q=X(q);e=e.format||f;f=N(255,D(h.r,0));g=N(255,D(h.g,0));h=N(255,D(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=q;this._roundA=w(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
...
f.g)+Math.max(e.b,f.b)-Math.min(e.b,f.b);return{brightness:Math.abs(c-d),color:e}};v.isReadable=function(b,a){var c=v.readability(b,a);return 125<c.brightness&&500<c.color};v.mostReadable=function(b,a){for(var c=null,d=0,e=!1,f=0;f<a.length;f++){var g=v.readability(b,a[f]),h=125<g.brightness&&500<g.color,g=3*(g.brightness/125)+g.color/500;if(h&&!e||h&&e&&g>d||!h&&!e&&g>d)e=h,d=g,c=v(a[f])}return c};var L=v.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",
...
p=e.BufferedBlockAlgorithm=f.extend({reset:function(){this._data=new g.init;this._nDataBytes=0},_append:function(b){"string"==typeof b&&(b=n.parse(b));this._data.concat(b);this._nDataBytes+=b.sigBytes},_process:function(a){var c=this._data,d=c.words,e=c.sigBytes,f=this.blockSize,h=e/(4*f),h=a?b.ceil(h):b.max((h|0)-this._minBufferSize,0);a=h*f;e=b.min(4*a,e);if(a){for(var l=0;l<a;l+=f)this._doProcessBlock(d,l);l=d.splice(0,a);c.sigBytes-=e}return new g.init(l,e)},clone:function(){var b=f.clone.call(this);
...
(function(b){for(var a=CryptoJS,c=a.lib,e=c.WordArray,d=c.Hasher,c=a.algo,f=[],g=[],h=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var n;a:{n=k;for(var p=b.sqrt(n),r=2;r<=p;r++)if(!(n%r)){n=!1;break a}n=!0}n&&(8>l&&(f[l]=h(b.pow(k,0.5))),g[l]=h(b.pow(k,1/3)),l++);k++}var m=[],c=c.SHA256=d.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,d=c[0],e=c[1],f=c[2],h=c[3],l=c[4],k=c[5],p=c[6],n=c[7],r=0;64>r;r++){if(16>r)m[r]=
b[a+r]|0;else{var J=m[r-15],y=m[r-2];m[r]=((J<<25|J>>>7)^(J<<14|J>>>18)^J>>>3)+m[r-7]+((y<<15|y>>>17)^(y<<13|y>>>19)^y>>>10)+m[r-16]}J=n+((l<<26|l>>>6)^(l<<21|l>>>11)^(l<<7|l>>>25))+(l&k^~l&p)+g[r]+m[r];y=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);n=p;p=k;k=l;l=h+J|0;h=f;f=e;e=d;d=J+y|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+l|0;c[5]=c[5]+k|0;c[6]=c[6]+p|0;c[7]=c[7]+n|0},_doFinalize:function(){var a=this._data,c=a.words,d=8*this._nDataBytes,e=8*a.sigBytes;
...
p=this;k.addEventListener(c,function(){l.innerHTML="<b>"+b+":</b> "+k.value;g&&g(parseFloat(k.value));n&&n();p._callCallbacks(b,{value:parseFloat(k.value)})})},_isIE:function(){return-1!=navigator.userAgent.indexOf("rv:11")||-1!=navigator.userAgent.indexOf("MSIE")?!0:!1},getRangeValue:function(b){return this._controls[b].control.value},setRangeValue:function(b,c,e){var d=this._controls[b];d.control.value=c;d.label.innerHTML="<b>"+b+":</b> "+d.control.value;e&&(d.callback&&d.callback(parseFloat(d.control.value)),
...
e.data=c;a(e)}d.maybeReconnectOnOpen()});if(!1!==this._timeout){var h=this._timeout;n("connect attempt will timeout after %d",h);var l=setTimeout(function(){n("connect attempt timed out after %d",h);e.destroy();c.close();c.emit("error","timeout");d.emitAll("connect_timeout",h)},h);this.subs.push({destroy:function(){clearTimeout(l)}})}this.subs.push(e);this.subs.push(g);return this};d.prototype.onopen=function(){n("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(k(a,
...
this.io;this.subs=[h(a,"open",k(this,"onopen")),h(a,"packet",k(this,"onpacket")),h(a,"close",k(this,"onclose"))]};d.prototype.open=d.prototype.connect=function(){if(this.connected)return this;this.io.open();if("open"==this.io.readyState)this.onopen();return this};d.prototype.send=function(){var a=g(arguments);a.unshift("message");this.emit.apply(this,a);return this};d.prototype.emit=function(a){if(p.hasOwnProperty(a))return r.apply(this,arguments),this;var c=g(arguments),d=f.EVENT;n(c)&&(d=f.BINARY_EVENT);
...
c)};var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(c,d);this.script=c;"undefined"!=typeof navigator&&/gecko/i.test(navigator.userAgent)&&setTimeout(function(){var a=document.createElement("iframe");document.body.appendChild(a);document.body.removeChild(a)},100)};g.prototype.doWrite=function(a,c){function d(){e();c()}function e(){if(f.iframe)try{f.form.removeChild(f.iframe)}catch(a){f.onError("jsonp polling iframe removal error",a)}try{p=document.createElement('<iframe src="javascript:0" name="'+
f.iframeId+'">')}catch(c){p=document.createElement("iframe"),p.name=f.iframeId,p.src="javascript:0"}p.id=f.iframeId;f.form.appendChild(p);f.iframe=p}var f=this;if(!this.form){var g=document.createElement("form"),h=document.createElement("textarea"),k=this.iframeId="eio_iframe_"+this.index,p;g.className="socketio";g.style.position="absolute";g.style.top="-1000px";g.style.left="-1000px";g.target=k;g.method="POST";g.setAttribute("accept-charset","utf-8");h.name="d";g.appendChild(h);document.body.appendChild(g);
...
n=a("./polling"),p=a("component-emitter"),r=a("component-inherit"),m=a("debug")("engine.io-client:polling-xhr");c.exports=g;c.exports.Request=h;r(g,n);g.prototype.supportsBinary=!0;g.prototype.request=function(a){a=a||{};a.uri=this.uri();a.xd=this.xd;a.xs=this.xs;a.agent=this.agent||!1;a.supportsBinary=this.supportsBinary;a.enablesXDR=this.enablesXDR;return new h(a)};g.prototype.doWrite=function(a,c){var d=this.request({method:"POST",data:a,isBinary:"string"!==typeof a&&void 0!==a}),e=this;d.on("success",
c);d.on("error",function(a){e.onError("xhr post error",a)});this.sendXhr=d};g.prototype.doPoll=function(){m("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};p(h.prototype);h.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{m("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
...
l=0===h[0],m="",p=1;255!=h[p];p++){if(310<m.length){g=!0;break}m+=h[p]}if(g)return d(u,0,1);a=k(a,2+m.length);m=parseInt(m);h=k(a,0,m);if(l)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(n){for(l=new Uint8Array(h),h="",p=0;p<l.length;p++)h+=String.fromCharCode(l[p])}f.push(h);a=k(a,m)}var q=f.length;f.forEach(function(a,f){d(e.decodePacket(a,c,!0),f,q)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
56320==(g&64512)?c.push(((f&1023)<<10)+(g&1023)+65536):(c.push(f),d--)):c.push(f);return c}function h(){if(u>=q)throw Error("Invalid byte index");var a=m[u]&255;u++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,d,e;if(u>q)throw Error("Invalid byte index");if(u==q)return!1;a=m[u]&255;u++;if(0==(a&128))return a;if(192==(a&224)){c=h();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=h();d=h();a=(a&15)<<12|c<<6|
d;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=h(),d=h(),e=h(),a=(a&15)<<18|c<<12|d<<6|e,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof e&&e,n="object"==typeof c&&c&&c.exports==l&&c,p="object"==typeof a&&a;if(p.global===p||p.window===p)f=p;var r=String.fromCharCode,m,q,u,p={version:"2.0.0",encode:function(a){a=g(a);for(var c=a.length,d=-1,e,f="";++d<c;){e=a[d];if(0==(e&4294967168))e=r(e);else{var h="";0==(e&4294965248)?
h=r(e>>6&31|192):0==(e&4294901760)?(h=r(e>>12&15|224),h+=r(e>>6&63|128)):0==(e&4292870144)&&(h=r(e>>18&7|240),h+=r(e>>12&63|128),h+=r(e>>6&63|128));e=h+=r(e&63|128)}f+=e}return f},decode:function(a){m=g(a);q=m.length;u=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var d=-1,e,f="";++d<c;)e=a[d],65535<e&&(e-=65536,f+=r(e>>>10&1023|55296),e=56320|e&1023),f+=r(e);return f}};if(l&&!l.nodeType)if(n)n.exports=p;else{f={}.hasOwnProperty;for(var A in p)f.call(p,A)&&(l[A]=p[A])}else f.utf8=p})(this)}).call(this,
...
a._placeholder)return c[a.num];if(f(a))for(var e=0;e<a.length;e++)a[e]=d(a[e]);else if(a&&"object"==typeof a)for(e in a)a[e]=d(a[e]);return a}a.data=d(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,h,q){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){n++;var u=new FileReader;u.onload=function(){q?q[h]=this.result:p=this.result;--n||e(p)};u.readAsArrayBuffer(a)}else if(f(a))for(u=0;u<a.length;u++)l(a[u],u,a);else if(a&&"object"==typeof a&&!g(a))for(u in a)l(a[u],
u,a)}var n=0,p=a;l(p);n||e(p)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=n.stringify(a.data));l("encoded %j as %s",a,c);return c}function g(a,c){p.removeBlobs(a,function(a){var e=p.deconstructPacket(a);
a=f(e.packet);e=e.buffers;e.unshift(a);c(e)})}function h(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),n=a("json3");a("isarray");c=a("component-emitter");var p=a("./binary"),r=a("./is-buffer");e.protocol=4;e.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");e.CONNECT=0;e.DISCONNECT=1;e.EVENT=2;e.ACK=3;e.ERROR=4;e.BINARY_EVENT=5;e.BINARY_ACK=6;e.Encoder=d;e.Decoder=h;d.prototype.encode=function(a,c){l("encoding packet %j",
...
var d;if("bug-string-char-index"==a)d="a"!="a"[0];else if("json"==a)d=c("json-stringify")&&c("json-parse");else{var e;if("json-stringify"==a){d=p.stringify;var h="function"==typeof d&&r;if(h){(e=function(){return 1}).toJSON=e;try{h="0"===d(0)&&"0"===d(new Number)&&'""'==d(new String)&&d(g)===l&&d(l)===l&&d()===l&&"1"===d(e)&&"[1]"==d([e])&&"[null]"==d([l])&&"null"==d(null)&&"[null,null,null]"==d([l,g,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==d({a:[e,!0,!1,null,"\x00\b\n\f\r\t"]})&&
"1"===d(null,e)&&"[\n 1,\n 2\n]"==d([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==d(new Date(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==d(new Date(864E13))&&'"-000001-01-01T00:00:00.000Z"'==d(new Date(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==d(new Date(-1))}catch(k){h=!1}}d=h}if("json-parse"==a){d=p.parse;if("function"==typeof d)try{if(0===d("0")&&!d(!1)){e=d('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var m=5==e.a.length&&1===e.a[0];if(m){try{m=!d('"\t"')}catch(n){}if(m)try{m=1!==
d("01")}catch(q){}if(m)try{m=1!==d("1.")}catch(u){}}}}catch(s){m=!1}d=m}}return c[a]=!!d}var g={}.toString,h,k,l,n="object"==typeof JSON&&JSON,p="object"==typeof e&&e&&!e.nodeType&&e;p&&n?(p.stringify=n.stringify,p.parse=n.parse):p=a.JSON=n||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(m){}if(!c("json")){var q=c("bug-string-char-index");
...
(h=a.split(""));d<e;d++){var g=a.charCodeAt(d);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=H[g];break;default:if(32>g){c+="\\u00"+C(2,g.toString(16));break}c+=f?h[d]:q?a.charAt(d):a[d]}}return c+'"'},x=function(a,c,d,e,f,m,p){var n,q,s,r,t,w,y,A,B;try{n=c[a]}catch(v){}if("object"==typeof n&&n)if(q=g.call(n),"[object Date]"!=q||h.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=q&&"[object String]"!=q&&"[object Array]"!=q||h.call(n,"toJSON"))&&(n=n.toJSON(a));
...
d.call(c,a,n));if(null===n)return"null";q=g.call(n);if("[object Boolean]"==q)return""+n;if("[object Number]"==q)return n>-1/0&&n<1/0?""+n:"null";if("[object String]"==q)return I(""+n);if("object"==typeof n){for(a=p.length;a--;)if(p[a]===n)throw TypeError();p.push(n);B=[];c=m;m+=f;if("[object Array]"==q){s=0;for(a=n.length;s<a;s++)q=x(s,n,d,e,f,m,p),B.push(q===l?"null":q);a=B.length?f?"[\n"+m+B.join(",\n"+m)+"\n"+c+"]":"["+B.join(",")+"]":"[]"}else k(e||n,function(a){var c=x(a,n,d,e,f,m,p);c!==l&&
...
g.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};p.parse=function(a,c){var d,e;t=0;J=""+a;d=ja(R());"$"!=R()&&y();t=J=null;return c&&"[object Function]"==g.call(c)?oa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],h=(c=c||0)||0;h<a.length;h++)e[h-c]=a[h];return e}},{}]},{},[1])(1)});
