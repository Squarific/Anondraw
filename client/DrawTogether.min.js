...
a||{};b.chat.addMessage(a.user,a.message)});this.network.on("emote",function(a){a=a||{};b.chat.addMessage(a.user+" "+a.message)});this.network.on("setreputation",function(a){b.reputation=a});this.network.on("setink",function(a){b.ink=a;b.updateInk()})};DrawTogether.prototype.sendMessage=function(b){this.network.socket.emit("chatmessage",b)};
...
e.className="drawtogether-player-button drawtogether-kickban-button";e.innerText="B";e.textContent="B";e.addEventListener("click",this.kickban.bind(this,b.id));a.appendChild(e)}e=document.createElement("span");e.className="drawtogether-player-name";var d="",f="",g="";"undefined"!==typeof b.reputation&&(d=" ("+b.reputation+" R)");"undefined"!==typeof b.gamescore&&(f=" ["+b.gamescore+" Points]");b.currentPlayer&&(g=" | DRAWING");e.appendChild(document.createTextNode(b.name+d+f+g));a.appendChild(c);
