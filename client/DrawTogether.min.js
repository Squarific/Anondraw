...
setTimeout(c,100)});this.paint.changeTool("grab");b=this.paint.coordDiv.appendChild(document.createElement("div"));b.className="control-button";b=b.appendChild(document.createElement("img"));b.src="images/icons/locations.png";b.alt="Locations";b.title="Locations"};
...
{question:"So this is basicly a ms paint multiplayer app?",answer:"You could call it that yea, it's a draw pad where you can draw something online."},{question:"How long will my sketches be saved?",answer:"Your sketches should remain forever. All drawings are saved on the pads every 6 hours, after this period they should be permanent."},{question:"Can I play this like draw something but online?",answer:"Yes, there is a gamemode where you get words and other people have to guess what you just drew."}],
