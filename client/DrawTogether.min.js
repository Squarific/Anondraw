...
this._forceFollow;this._autoMoveScreen;this._followingPlayer;this.network=new Network(this.settings.loadbalancer);this.account=new Account(this.settings.accountServer);this.bindSocketHandlers();this.initDom();this.gui=new Gui(b);this.updateInk();"ask"==this.settings.mode?this.openModeSelector():"askjoin"==this.settings.mode?(this.changeRoom("main"),this.openModeSelector()):"join"==this.settings.mode?(0==this.settings.room.indexOf("private_")?0==this.settings.room.indexOf("private_game_")?ga("send",
"event","autojoin","privategame"):ga("send","event","autojoin","private"):this.settings.room.indexOf("game_")?ga("send","event","autojoin","game"):ga("send","event","autojoin","public"),this.changeRoom(this.settings.room,void 0,this.settings.leftTopX,this.settings.leftTopY,!0)):"private"==this.settings.mode?(this.settings.room="private_"+Math.random().toString(36).substr(2,5),this.changeRoom(this.settings.room,void 0,0,0,!0)):"member"==this.settings.mode?this.changeRoom("member-main"):"auto"==this.settings.mode&&
this.changeRoom("main");requestAnimationFrame(this.drawLoop.bind(this));this.needsClear=!1;document.addEventListener("keydown",function(b){b.target===document.body&&(27==b.keyCode&&(this.closeAccountWindow(),this.closeShareWindow(),this.closeRoomWindow(),this.closeSettingsWindow()),65==b.keyCode&&this.advancedOptions.toggleVisibility())}.bind(this));setInterval(this.displayTip.bind(this),3E5);setTimeout(this.autoMoveScreen.bind(this),0)}DrawTogether.prototype.KICKBAN_MIN_REP=50;
...
a=b.appendChild(document.createElement("img"));a.src="images/icons/locations.png";a.alt="Open Favorites Menu";a.title="Open Favorites Menu";b.addEventListener("click",function(){$(".favorites-window").is(":visible")?$(".favorites-window").hide():$(".favorites-window").show()}.bind(this));b=this.coordDiv.appendChild(document.createElement("div"));b.className="favorites-window";b=b.appendChild(document.createElement("div"));b.className="favorites-container";b=b.appendChild(document.createElement("div"));
b.className="favorite-container";a=b.appendChild(document.createElement("div"));a.className="fav-button fav-plus-button";a.innerHTML="+";a=b.appendChild(document.createElement("div"));a.className="fav-button fav-pencil-button";a.innerHTML="\u270e";a=a.appendChild(document.createElement("div"));a.className="fav-rename-container";a=a.appendChild(document.createElement("input"));a.className="fav-rename-input";a.type="text";b=b.appendChild(document.createElement("div"));b.className="fav-button fav-coor-button";
b.innerHTML="0,0"};Paint.prototype.setMouseCoords=function(b,a){for(var c=!1,e=0;e<this.coordDiv.children.length;e++)if("number"==this.coordDiv.children[e].type){this.coordDiv.children[e].value=c?a.toFixed():b.toFixed();if(c)break;c=!0}};
