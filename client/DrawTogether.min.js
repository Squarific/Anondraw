...
b.innerHTML="&#9825;...";b.alt="Open Favorites Menu";b.title="Open Favorites Menu"};Paint.prototype.setMouseCoords=function(b,a){for(var c=!1,e=0;e<this.coordDiv.children.length;e++)if("number"==this.coordDiv.children[e].type){this.coordDiv.children[e].value=c?a.toFixed():b.toFixed();if(c)break;c=!0}};
