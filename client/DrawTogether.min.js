...
(function(b){for(var a=CryptoJS,c=a.lib,d=c.WordArray,e=c.Hasher,c=a.algo,f=[],g=[],h=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var m;a:{m=k;for(var n=b.sqrt(m),r=2;r<=n;r++)if(!(m%r)){m=!1;break a}m=!0}m&&(8>l&&(f[l]=h(b.pow(k,0.5))),g[l]=h(b.pow(k,1/3)),l++);k++}var q=[],c=c.SHA256=e.extend({_doReset:function(){this._hash=new d.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,e=c[0],d=c[1],f=c[2],h=c[3],k=c[4],n=c[5],l=c[6],m=c[7],r=0;64>r;r++){if(16>r)q[r]=
b[a+r]|0;else{var I=q[r-15],x=q[r-2];q[r]=((I<<25|I>>>7)^(I<<14|I>>>18)^I>>>3)+q[r-7]+((x<<15|x>>>17)^(x<<13|x>>>19)^x>>>10)+q[r-16]}I=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&n^~k&l)+g[r]+q[r];x=((e<<30|e>>>2)^(e<<19|e>>>13)^(e<<10|e>>>22))+(e&d^e&f^d&f);m=l;l=n;n=k;k=h+I|0;h=f;f=d;d=e;e=I+x|0}c[0]=c[0]+e|0;c[1]=c[1]+d|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+n|0;c[6]=c[6]+l|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,e=8*this._nDataBytes,d=8*a.sigBytes;
...
DrawTogether.prototype.kickban=function(b){this.gui.prompt("How long do you want to kickban this person for? (minutes)","freepick;10 year;1 year;1 week;1 day;1 hour;5 minutes;1 minute;Cancel".split(";"),function(a){"Cancel"!=a&&("10 year"==a&&(a=5126400),"1 year"==a&&(a=512640),"1 week"==a&&(a=10080),"1 day"==a&&(a=1440),"1 hour"==a&&(a=60),"5 minutes"==a&&(a=5),"1 minute"==a&&(a=1),this.gui.prompt("Should we ban the account, the ip or both?",["account","ip","both","Cancel"],function(c){"Cancel"!=
c&&this.gui.prompt("What is the reason you want to ban him?","freepick;Drawings swastikas;Destroying drawings;Being a dick in chat;Spam;Cancel".split(";"),function(d){"Cancel"!=d&&this.gui.prompt("Are you sure you want to ban "+this.usernameFromSocketid(b)+" (bantype: "+c+") for "+a+" minutes. Reason: "+d,["Yes","No"],function(e){"Yes"==e&&this.network.socket.emit("kickban",[b,a,c,d],function(b){this.chat.addMessage("SERVER",b.error||b.success)}.bind(this))}.bind(this))}.bind(this))}.bind(this)))}.bind(this))};
...
setTimeout(c,100)});this.paint.changeTool("grab");this.paint.coordDiv.appendChild(document.createElement("span")).innerHTML="&nbsp;";b=this.paint.coordDiv.appendChild(document.createElement("div"));b.className="control-button favorites-button";var d=b.appendChild(document.createElement("img"));d.src="images/icons/locations.png";d.alt="Open Favorites Menu";d.title="Open Favorites Menu";b.addEventListener("click",function(){$(".favorites-window").is(":visible")?$(".favorites-window").hide():(this.updateFavoriteDom(),
$(".favorites-window").show())}.bind(this));b=this.paint.coordDiv.appendChild(document.createElement("div"));b.className="favorites-window";this.favoritesContainer=b.appendChild(document.createElement("div"));this.favoritesContainer.className="favorites-container"};
...
m=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);if(b.srcElement.classList.contains("fav-button-confirmation")){var n=b.srcElement.parentElement.getElementsByClassName("fav-coor-button")[0];n.innerHTML=n.dataset.tempConf;b.srcElement.innerHTML="+";b.srcElement.classList.remove("fav-button-confirmation");this.setCoordFavorite(m,a,c,e,d,b.srcElement.parentElement)}else n=b.srcElement.parentElement.getElementsByClassName("fav-coor-button")[0],n.dataset.tempConf=
n.innerHTML,n.innerHTML=m+","+a+"?",b.srcElement.classList.add("fav-button-confirmation"),b.srcElement.innerHTML="?",setTimeout(function(){var a=this.parentElement.getElementsByClassName("fav-coor-button")[0];a.innerHTML=a.dataset.tempConf;b.srcElement.innerHTML="+";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),2E3)}.bind(this));d.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],
c=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);b.srcElement.title="Change to "+c+","+a+" ?"}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-pencil-button";d.innerHTML="\u270e";d=d.appendChild(document.createElement("div"));d.className="fav-rename-container";d=d.appendChild(document.createElement("input"));d.className="fav-rename-input";d.type="text";d.placeholder="Rename";d.addEventListener("input",function(b){void 0!==
this._favoriteRenameDelayTimeout&&clearTimeout(this._favoriteRenameDelayTimeout);this._favoriteRenameDelayTimeout=setTimeout(function(){var a=b.srcElement.parentElement.parentElement.parentElement;this.renameFavorite(a.dataset.x,a.dataset.y,b.srcElement.value,a)}.bind(this),1500)}.bind(this));e=e.appendChild(document.createElement("div"));e.className="fav-button fav-coor-button";e.addEventListener("click",function(b){var a=parseInt(b.srcElement.parentElement.dataset.x);b=parseInt(b.srcElement.parentElement.dataset.y);
this.moveScreenToPosition([a,b],0)}.bind(this));0<c.length?(e.innerHTML=c,e.title=b+","+a,d.value=c):e.innerHTML=b+","+a};
...
if(window.coinbaseCookieLoading)return setTimeout(function(){return a(c,d)},200);g=b(c("body").data("env"));window.coinbaseCookieLoading=!0;m=document.createElement("script");m.src=g+"/checkouts/get_cookie.js";m.onload=m.onreadystatechange=function(){window.coinbaseCookieLoaded=!0;window.coinbaseCookieLoading=!1;c(m).remove();return d(c)};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(m)};c=function(a){var c,d,f,g,r;d=c=!1;r=b(a("body").data("env"));g=function(b){switch(b){case "custom_large":return 276;
case "custom_small":return 210;case "subscription_large":return 263;case "subscription_small":return 210;case "donation_large":return 189;case "donation_small":return 148;case "buy_now_large":return 211;case "buy_now_small":return 170;default:return 211}};f=function(b){switch(b){case "custom_large":return 62;case "custom_small":return 48;default:return 46}};window.addEventListener("message",function(b){var e,f;e=b.data.split("|");f=e[0];e=e[1];e=escape(e);if(b.origin===r){if("show modal iframe"===
f)return a("#coinbase_modal_iframe_"+e).show();if("coinbase_payment_complete"===f)return a("#coinbase_button_iframe_"+e).attr("src",r+"/buttons/paid"),a(document).trigger("coinbase_payment_complete",e);if("coinbase_payment_mispaid"===f)return a(document).trigger("coinbase_payment_mispaid",e);if("coinbase_payment_expired"===f)return a(document).trigger("coinbase_payment_expired",e);if("hide modal"===f)return a("#coinbase_modal_iframe_"+e).hide(),a(document).trigger("coinbase_modal_closed",e);if("signup redirect"===
f)return document.location=r+"/users/verify";if("button frame loaded"===f){if(c=!0,d)return a(document).trigger("coinbase_button_loaded",e)}else if("checkouts frame loaded"===f&&(d=!0,c))return a(document).trigger("coinbase_button_loaded",e)}},!1);a(".coinbase-button").each(function(d){return function(d,l){var q,K,B,G,D;q=a(l);B=q.data();B.referrer=document.domain;G=a.param(B);B=q.data("code");D=q.data("width")||g(q.data("button-style"));K=q.data("height")||f(q.data("button-style"));r=b(q.data("env"));
K="<iframe src='"+r+"/buttons/"+B+"?"+G+"' id='coinbase_button_iframe_"+B+"' name='coinbase_button_iframe_"+B+"' style='width: "+D+"px; height: "+K+"px; border: none; overflow: hidden;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";B="<iframe src='"+r+"/checkouts/"+B+"/widget?"+G+"' id='coinbase_modal_iframe_"+B+"' name='coinbase_modal_iframe_"+B+"' style='background-color: transparent; border: 0px none transparent; display: none; position: fixed; visibility: visible; margin: 0px; padding: 0px; left: 0px; top: 0px; width: 100%; height: 100%; z-index: 9999;' scrolling='no' allowtransparency='true' frameborder='0'></iframe>";
"none"===q.data("button-style")?c=!0:q.replaceWith(K);return a("body").append(B)}}(this));return a(document).on("coinbase_show_modal",function(b,c){if(0<a("#coinbase_modal_iframe_"+c).length)return a("#coinbase_modal_iframe_"+c).show(),frames["coinbase_modal_iframe_"+c].postMessage("show modal|"+c,r)})};(function(b,a){var c,e,d,f,g,p,u,A;f=[null,null,!1];d=f[0];e=f[1];g=f[2];if(d=window.jQuery)u=parseInt(b.split(".")[0])||0,A=parseInt(b.split(".")[1])||0,c=parseInt(d.fn.jquery.split(".")[0])||0,f=
parseInt(d.fn.jquery.split(".")[1])||0,c=c>u||c===u&&f>=A;if(d&&c)return a(d);p=document.createElement("script");p.type="text/javascript";p.src="https://code.jquery.com/jquery-1.8.3.min.js";p.onload=p.onreadystatechange=function(){if(!(g||(e=this.readyState)&&"loaded"!==e&&"complete"!==e))return a((d=window.jQuery).noConflict(1)),d(p).remove()};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(p)})("1.7",function(b){return a(b,c)})}).call(this)};
...
l=0===h[0],q="",m=1;255!=h[m];m++){if(310<q.length){g=!0;break}q+=h[m]}if(g)return e(u,0,1);a=k(a,2+q.length);q=parseInt(q);h=k(a,0,q);if(l)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(n){for(l=new Uint8Array(h),h="",m=0;m<l.length;m++)h+=String.fromCharCode(l[m])}f.push(h);a=k(a,q)}var p=f.length;f.forEach(function(a,f){e(d.decodePacket(a,c,!0),f,p)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
