...
Paint.prototype.tools = {
	...
	brush: function brush (paint, event, type) {
		...
		if (event.type == "mousemove" || event.type == "touchmove") {
			paint.effectsCanvasCtx.clearRect(this.lastMovePoint[0] - paint.current_size, this.lastMovePoint[1] - paint.current_size, paint.current_size * 2, paint.current_size * 2);
