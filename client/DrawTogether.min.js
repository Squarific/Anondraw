...
c)));return b};
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,d,e){for(var f=[],g=0;g<a.length;g++){var h=a[g];if(h){var n=tinycolor(h),k=0.5>n.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k=k+(tinycolor.equals(c,h)?" sp-thumb-active":""),h=n.toString(e.preferredFormat||"rgb"),l=t?"background-color:"+n.toRgbString():"filter:"+n.toFilter();f.push('<span title="'+h+
'" data-color="'+n.toRgbString()+'" class="'+k+'"><span class="sp-thumb-inner" style="'+l+';" /></span>')}else f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",e.noColorSelectedText)).html())}return"<div class='sp-cf "+d+"'>"+f.join("")+"</div>"}function e(a,c){var d=b.extend({},m,a);d.callbacks={move:k(d.move,c),change:k(d.change,c),show:k(d.show,c),hide:k(d.hide,c),beforeShow:k(d.beforeShow,c)};return d}function d(d,
g){function k(){r.showPaletteOnly&&(r.showPalette=!0);Fa.text(r.showPaletteOnly?r.togglePaletteMoreText:r.togglePaletteLessText);if(r.palette){ta=r.palette.slice(0);ka=b.isArray(ta[0])?ta:[ta];ua={};for(var a=0;a<ka.length;a++)for(var c=0;c<ka[a].length;c++){var d=tinycolor(ka[a][c]).toRgbString();ua[d]=!0}}x.toggleClass("sp-flat",N);x.toggleClass("sp-input-disabled",!r.showInput);x.toggleClass("sp-alpha-enabled",r.showAlpha);x.toggleClass("sp-clear-enabled",Z);x.toggleClass("sp-buttons-disabled",
!r.showButtons);x.toggleClass("sp-palette-buttons-disabled",!r.togglePaletteOnly);x.toggleClass("sp-palette-disabled",!r.showPalette);x.toggleClass("sp-palette-only",r.showPaletteOnly);x.toggleClass("sp-initial-disabled",!r.showInitial);x.addClass(r.className).addClass(r.containerClassName);K()}function m(){if(v&&window.localStorage){try{var a=window.localStorage[v].split(",#");1<a.length&&(delete window.localStorage[v],b.each(a,function(b,a){Y(a)}))}catch(c){}try{O=window.localStorage[v].split(";")}catch(d){}}}
function Y(a){if(T){a=tinycolor(a).toRgbString();if(!ua[a]&&-1===b.inArray(a,O))for(O.push(a);O.length>Wa;)O.shift();if(v&&window.localStorage)try{window.localStorage[v]=O.join(";")}catch(c){}}}function Ea(){var b=[];if(r.showPalette)for(var a=0;a<O.length;a++){var c=tinycolor(O[a]).toRgbString();ua[c]||b.push(O[a])}return b.reverse().slice(0,r.maxSelectionSize)}function z(){var a=J(),d=b.map(ka,function(b,d){return c(b,a,"sp-palette-row sp-palette-row-"+d,r)});m();O&&d.push(c(Ea(),a,"sp-palette-row sp-palette-row-selection",
r));Ma.html(d.join(""))}function s(){if(r.showInitial){var b=aa,a=J();Na.html(c([b,a],a,"sp-palette-row-initial",r))}}function F(){(0>=M||0>=P||0>=va)&&K();x.addClass(Oa);U=null;C.trigger("dragstart.spectrum",[J()])}function y(){x.removeClass(Oa);C.trigger("dragstop.spectrum",[J()])}function L(){var b=V.val();null!==b&&""!==b||!Z?(b=tinycolor(b),b.isValid()?(W(b),H(!0)):V.addClass("sp-validation-error")):(W(null),H(!0))}function da(){u?ba():ea()}function ea(){var a=b.Event("beforeShow.spectrum");
if(u)K();else if(C.trigger(a,[J()]),!1!==E.beforeShow(J())&&!a.isDefaultPrevented()){for(a=0;a<q.length;a++)q[a]&&q[a].hide();u=!0;b(Ga).bind("click.spectrum",la);b(window).bind("resize.spectrum",fa);ha.addClass("sp-active");x.removeClass("sp-hidden");K();S();aa=J();s();E.show(aa);C.trigger("show.spectrum",[aa])}}function la(b){2!=b.button&&(Xa?H(!0):W(aa,!0),ba())}function ba(){u&&!N&&(u=!1,b(Ga).unbind("click.spectrum",la),b(window).unbind("resize.spectrum",fa),ha.removeClass("sp-active"),x.addClass("sp-hidden"),
E.hide(J()),C.trigger("hide.spectrum",[J()]))}function W(b,a){if(tinycolor.equals(b,J()))S();else{var c,d;!b&&Z?X=!0:(X=!1,c=tinycolor(b),d=c.toHsv(),ma=d.h%360/360,na=d.s,oa=d.v,Q=d.a);S();c&&(c.isValid()&&!a)&&(pa=Ha||c.getFormat())}}function J(b){b=b||{};return Z&&X?null:tinycolor.fromRatio({h:ma,s:na,v:oa,a:Math.round(100*Q)/100},{format:b.format||pa})}function ia(){S();E.move(J());C.trigger("move.spectrum",[J()])}function S(){V.removeClass("sp-validation-error");B();var b=tinycolor.fromRatio({h:ma,
s:1,v:1});wa.css("background-color",b.toHexString());b=pa;!(1>Q)||0===Q&&"name"===b||"hex"!==b&&"hex3"!==b&&"hex6"!==b&&"name"!==b||(b="rgb");var a=J({format:b}),c="";ja.removeClass("sp-clear-display");ja.css("background-color","transparent");if(!a&&Z)ja.addClass("sp-clear-display");else{var c=a.toHexString(),d=a.toRgbString();t||1===a.alpha?ja.css("background-color",d):(ja.css("background-color","transparent"),ja.css("filter",a.toFilter()));if(r.showAlpha){d=a.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),
e="linear-gradient(left, "+d+", "+c+")";n?qa.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(qa.css("background","-webkit-"+e),qa.css("background","-moz-"+e),qa.css("background","-ms-"+e),qa.css("background","linear-gradient(to right, "+d+", "+c+")"))}c=a.toString(b)}r.showInput&&V.val(c);r.showPalette&&z();s()}function B(){var b=na,a=oa;Z&&X?(xa.hide(),ya.hide(),za.hide()):(xa.show(),ya.show(),za.show(),b*=P,a=M-a*M,b=Math.max(-G,Math.min(P-G,b-G)),a=Math.max(-G,Math.min(M-G,a-G)),za.css({top:a+
"px",left:b+"px"}),xa.css({left:Q*ca-Pa/2+"px"}),ya.css({top:ma*va-Qa+"px"}))}function H(b){var a=J(),c="",d=!tinycolor.equals(a,aa);a&&(c=a.toString(pa),Y(a));Aa&&C.val(c);b&&d&&(E.change(a),C.trigger("change",[a]))}function K(){P=wa.width();M=wa.height();G=za.height();Ia.width();va=Ia.height();Qa=ya.height();ca=Ra.width();Pa=xa.width();N||(x.css("position","absolute"),r.offset?x.offset(r.offset):x.offset(f(x,ra)));B();r.showPalette&&z();C.trigger("reflow.spectrum")}function Ba(){ba();Ja=!0;C.attr("disabled",
!0);ra.addClass("sp-disabled")}var r=e(g,d),N=r.flat,T=r.showSelectionPalette,v=r.localStorageKey,I=r.theme,E=r.callbacks,fa=p(K,10),u=!1,P=0,M=0,G=0,va=0,ca=0,Pa=0,Qa=0,ma=0,na=0,oa=0,Q=1,ta=[],ka=[],ua={},O=r.selectionPalette.slice(0),Wa=r.maxSelectionSize,Oa="sp-dragging",U=null,Ga=d.ownerDocument,C=b(d),Ja=!1,x=b(D,Ga).addClass(I),Ya=x.find(".sp-picker-container"),wa=x.find(".sp-color"),za=x.find(".sp-dragger"),Ia=x.find(".sp-hue"),ya=x.find(".sp-slider"),qa=x.find(".sp-alpha-inner"),Ra=x.find(".sp-alpha"),
xa=x.find(".sp-alpha-handle"),V=x.find(".sp-input"),Ma=x.find(".sp-palette"),Na=x.find(".sp-initial"),Sa=x.find(".sp-cancel"),Ka=x.find(".sp-clear"),Ta=x.find(".sp-choose"),Fa=x.find(".sp-palette-toggle"),Aa=C.is("input"),Za=Aa&&w&&"color"===C.attr("type"),La=Aa&&!N,ha=La?b(A).addClass(I).addClass(r.className).addClass(r.replacerClassName):b([]),ra=La?ha:C,ja=ha.find(".sp-preview-inner"),sa=r.color||Aa&&C.val(),aa=!1,Ha=r.preferredFormat,pa=Ha,Xa=!r.showButtons||r.clickoutFiresChange,X=!sa,Z=r.allowEmpty&&
!Za;(function(){function a(c){c.data&&c.data.ignore?(W(b(c.target).closest(".sp-thumb-el").data("color")),ia()):(W(b(c.target).closest(".sp-thumb-el").data("color")),ia(),H(!0),r.hideAfterPaletteSelect&&ba());return!1}n&&x.find("*:not(input)").attr("unselectable","on");k();La&&C.after(ha).hide();Z||Ka.hide();if(N)C.after(x).hide();else{var c="parent"===r.appendTo?C.parent():b(r.appendTo);1!==c.length&&(c=b("body"));c.append(x)}m();ra.bind("click.spectrum touchstart.spectrum",function(a){Ja||da();
a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(C.is(":disabled")||!0===r.disabled)&&Ba();x.click(h);V.change(L);V.bind("paste",function(){setTimeout(L,1)});V.keydown(function(b){13==b.keyCode&&L()});Sa.text(r.cancelText);Sa.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();W(aa,!0);ba()});Ka.attr("title",r.clearText);Ka.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();X=!0;ia();N&&H(!0)});Ta.text(r.chooseText);Ta.bind("click.spectrum",
function(b){b.stopPropagation();b.preventDefault();V.hasClass("sp-validation-error")||(H(!0),ba())});Fa.text(r.showPaletteOnly?r.togglePaletteMoreText:r.togglePaletteLessText);Fa.bind("click.spectrum",function(b){b.stopPropagation();b.preventDefault();r.showPaletteOnly=!r.showPaletteOnly;r.showPaletteOnly||N||x.css("left","-="+(Ya.outerWidth(!0)+5));k()});l(Ra,function(b,a,c){Q=b/ca;X=!1;c.shiftKey&&(Q=Math.round(10*Q)/10);ia()},F,y);l(Ia,function(b,a){ma=parseFloat(a/va);X=!1;r.showAlpha||(Q=1);
ia()},F,y);l(wa,function(b,a,c){c.shiftKey?U||(c=M-oa*M,U=Math.abs(b-na*P)>Math.abs(a-c)?"x":"y"):U=null;c=!U||"y"===U;U&&"x"!==U||(na=parseFloat(b/P));c&&(oa=parseFloat((M-a)/M));X=!1;r.showAlpha||(Q=1);ia()},F,y);sa?(W(sa),S(),pa=Ha||tinycolor(sa).format,Y(sa)):S();N&&ea();c=n?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Ma.delegate(".sp-thumb-el",c,a);Na.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},a)})();var Ca={show:ea,hide:ba,toggle:da,reflow:K,option:function(c,d){if(c===
a)return b.extend({},r);if(d===a)return r[c];r[c]=d;k()},enable:function(){Ja=!1;C.attr("disabled",!1);ra.removeClass("sp-disabled")},disable:Ba,offset:function(b){r.offset=b;K()},set:function(b){W(b);H()},get:J,destroy:function(){C.show();ra.unbind("click.spectrum touchstart.spectrum");x.remove();ha.remove();q[Ca.id]=null},container:x};Ca.id=q.push(Ca)-1;return Ca}function f(a,c){var d=a.outerWidth(),e=a.outerHeight(),f=c.outerHeight(),g=a[0].ownerDocument,h=g.documentElement,t=h.clientWidth+b(g).scrollLeft(),
g=h.clientHeight+b(g).scrollTop(),h=c.offset();h.top+=f;h.left-=Math.min(h.left,h.left+d>t&&t>d?Math.abs(h.left+d-t):0);h.top-=Math.min(h.top,h.top+e>g&&g>e?Math.abs(e+f-0):0);return h}function g(){}function h(b){b.stopPropagation()}function k(b,a){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return b.apply(a,d.concat(c.call(arguments)))}}function l(a,c,d,e){function f(b){b.stopPropagation&&b.stopPropagation();b.preventDefault&&b.preventDefault();b.returnValue=!1}function g(b){if(k){if(n&&
9>t.documentMode&&!b.button)return h();var d=b.originalEvent&&b.originalEvent.touches,e=d?d[0].pageY:b.pageY,d=Math.max(0,Math.min((d?d[0].pageX:b.pageX)-l.left,p)),e=Math.max(0,Math.min(e-l.top,m));w&&f(b);c.apply(a,[d,e,b])}}function h(){k&&(b(t).unbind(D),b(t.body).removeClass("sp-dragging"),e.apply(a,arguments));k=!1}c=c||function(){};d=d||function(){};e=e||function(){};var t=document,k=!1,l={},m=0,p=0,w="ontouchstart"in window,D={};D.selectstart=f;D.dragstart=f;D["touchmove mousemove"]=g;D["touchend mouseup"]=
h;b(a).bind("touchstart mousedown",function(c){(c.which?3==c.which:2==c.button)||k||!1===d.apply(a,arguments)||(k=!0,m=b(a).height(),p=b(a).width(),l=b(a).offset(),b(t).bind(D),b(t.body).addClass("sp-dragging"),w||g(c),f(c))})}function p(b,a,c){var d;return function(){var e=this,f=arguments,g=function(){d=null;b.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(g,a)}}var m={beforeShow:g,move:g,change:g,show:g,hide:g,color:!1,flat:!1,showInput:!1,allowEmpty:!1,showButtons:!0,clickoutFiresChange:!1,
...
1);this.each(function(){var c=q[b(this).data("spectrum.id")];if(c){var d=c[a];if(!d)throw Error("Spectrum: no such method: '"+a+"'");"get"==a?e=c.get():"container"==a?e=c.container:"option"==a?e=c.option.apply(c,f):"destroy"==a?(c.destroy(),b(this).removeData("spectrum.id")):d.apply(c,f)}});return e}return this.spectrum("destroy").each(function(){var c=b.extend({},a,b(this).data()),c=d(this,c);b(this).data("spectrum.id",c.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.loadOpts={};b.fn.spectrum.draggable=
l;b.fn.spectrum.defaults=m;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){w||b("input[type=color]").spectrum({preferredFormat:"hex6"})};(function(){function b(a,c,d){a=B(a,255);c=B(c,255);d=B(d,255);var e=E(a,c,d),f=I(a,c,d),g,h=(e+f)/2;if(e==f)g=f=0;else{var t=e-f,f=0.5<h?t/(2-e-f):t/(e+f);switch(e){case a:g=(c-d)/t+(c<d?6:0);break;case c:g=(d-a)/t+2;break;case d:g=(a-c)/t+4}g/=6}return{h:g,s:f,l:h}}function a(b,c,d){function e(b,
a,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?b+6*(a-b)*c:0.5>c?a:c<2/3?b+6*(a-b)*(2/3-c):b}b=B(b,360);c=B(c,100);d=B(d,100);if(0===c)d=c=b=d;else{var f=0.5>d?d*(1+c):d+c-d*c,g=2*d-f;d=e(g,f,b+1/3);c=e(g,f,b);b=e(g,f,b-1/3)}return{r:255*d,g:255*c,b:255*b}}function c(b,a,d){b=B(b,255);a=B(a,255);d=B(d,255);var e=E(b,a,d),f=I(b,a,d),g,h=e-f;if(e==f)g=0;else{switch(e){case b:g=(a-d)/h+(a<d?6:0);break;case a:g=(d-b)/h+2;break;case d:g=(b-a)/h+4}g/=6}return{h:g,s:0===e?0:h/e,v:e}}function d(b,a,c,e){b=[H(v(b).toString(16)),
H(v(a).toString(16)),H(v(c).toString(16))];return e&&b[0].charAt(0)==b[0].charAt(1)&&b[1].charAt(0)==b[1].charAt(1)&&b[2].charAt(0)==b[2].charAt(1)?b[0].charAt(0)+b[1].charAt(0)+b[2].charAt(0):b.join("")}function e(b,a,c,d){return[H(Math.round(255*parseFloat(d)).toString(16)),H(v(b).toString(16)),H(v(a).toString(16)),H(v(c).toString(16))].join("")}function f(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.s-=a/100;c.s=I(1,E(0,c.s));return u(c)}function g(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.s+=a/100;
c.s=I(1,E(0,c.s));return u(c)}function h(b){return u(b).desaturate(100)}function t(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.l+=a/100;c.l=I(1,E(0,c.l));return u(c)}function n(b,a){a=0===a?0:a||10;var c=u(b).toRgb();c.r=E(0,I(255,c.r-v(255*-(a/100))));c.g=E(0,I(255,c.g-v(255*-(a/100))));c.b=E(0,I(255,c.b-v(255*-(a/100))));return u(c)}function k(b,a){a=0===a?0:a||10;var c=u(b).toHsl();c.l-=a/100;c.l=I(1,E(0,c.l));return u(c)}function l(b,a){var c=u(b).toHsl(),d=(v(c.h)+a)%360;c.h=0>d?360+d:d;return u(c)}
function m(b){b=u(b).toHsl();b.h=(b.h+180)%360;return u(b)}function p(b){var a=u(b).toHsl(),c=a.h;return[u(b),u({h:(c+120)%360,s:a.s,l:a.l}),u({h:(c+240)%360,s:a.s,l:a.l})]}function D(b){var a=u(b).toHsl(),c=a.h;return[u(b),u({h:(c+90)%360,s:a.s,l:a.l}),u({h:(c+180)%360,s:a.s,l:a.l}),u({h:(c+270)%360,s:a.s,l:a.l})]}function w(b){var a=u(b).toHsl(),c=a.h;return[u(b),u({h:(c+72)%360,s:a.s,l:a.l}),u({h:(c+216)%360,s:a.s,l:a.l})]}function A(b,a,c){a=a||6;c=c||30;var d=u(b).toHsl();c=360/c;b=[u(b)];for(d.h=
(d.h-(c*a>>1)+720)%360;--a;)d.h=(d.h+c)%360,b.push(u(d));return b}function q(b,a){a=a||6;for(var c=u(b).toHsv(),d=c.h,e=c.s,c=c.v,f=[],g=1/a;a--;)f.push(u({h:d,s:e,v:c})),c=(c+g)%1;return f}function S(b){b=parseFloat(b);if(isNaN(b)||0>b||1<b)b=1;return b}function B(b,a){"string"==typeof b&&(-1!=b.indexOf(".")&&1===parseFloat(b))&&(b="100%");var c="string"===typeof b&&-1!=b.indexOf("%");b=I(a,E(0,parseFloat(b)));c&&(b=parseInt(b*a,10)/100);return 1E-6>T.abs(b-a)?1:b%a/parseFloat(a)}function H(b){return 1==
b.length?"0"+b:""+b}function K(b){1>=b&&(b=100*b+"%");return b}var Ba=/^[\s,#]+/,r=/\s+$/,N=0,T=Math,v=T.round,I=T.min,E=T.max,fa=T.random,u=function ca(b,c){var d,e,f,g,h;b=b?b:"";c=c||{};if(b instanceof ca)return b;if(!(this instanceof ca))return new ca(b,c);e=b;h={r:0,g:0,b:0};var t=1;f=d=!1;if("string"==typeof e)a:{e=e.replace(Ba,"").replace(r,"").toLowerCase();var n=!1;if(P[e])e=P[e],n=!0;else if("transparent"==e){e={r:0,g:0,b:0,a:0,format:"name"};break a}e=(g=G.rgb.exec(e))?{r:g[1],g:g[2],b:g[3]}:
(g=G.rgba.exec(e))?{r:g[1],g:g[2],b:g[3],a:g[4]}:(g=G.hsl.exec(e))?{h:g[1],s:g[2],l:g[3]}:(g=G.hsla.exec(e))?{h:g[1],s:g[2],l:g[3],a:g[4]}:(g=G.hsv.exec(e))?{h:g[1],s:g[2],v:g[3]}:(g=G.hsva.exec(e))?{h:g[1],s:g[2],v:g[3],a:g[4]}:(g=G.hex8.exec(e))?{a:parseInt(g[1],16)/255,r:parseInt(g[2],16),g:parseInt(g[3],16),b:parseInt(g[4],16),format:n?"name":"hex8"}:(g=G.hex6.exec(e))?{r:parseInt(g[1],16),g:parseInt(g[2],16),b:parseInt(g[3],16),format:n?"name":"hex"}:(g=G.hex3.exec(e))?{r:parseInt(g[1]+""+g[1],
16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:n?"name":"hex"}:!1}if("object"==typeof e){if(e.hasOwnProperty("r")&&e.hasOwnProperty("g")&&e.hasOwnProperty("b"))h={r:255*B(e.r,255),g:255*B(e.g,255),b:255*B(e.b,255)},d=!0,f="%"===String(e.r).substr(-1)?"prgb":"rgb";else if(e.hasOwnProperty("h")&&e.hasOwnProperty("s")&&e.hasOwnProperty("v")){e.s=K(e.s);e.v=K(e.v);f=e.h;n=e.s;h=e.v;f=6*B(f,360);n=B(n,100);h=B(h,100);d=T.floor(f);var k=f-d;f=h*(1-n);g=h*(1-k*n);n=h*(1-(1-k)*n);d%=6;
h={r:255*[h,g,f,f,n,h][d],g:255*[n,h,h,g,f,f][d],b:255*[f,f,n,h,h,g][d]};d=!0;f="hsv"}else e.hasOwnProperty("h")&&(e.hasOwnProperty("s")&&e.hasOwnProperty("l"))&&(e.s=K(e.s),e.l=K(e.l),h=a(e.h,e.s,e.l),d=!0,f="hsl");e.hasOwnProperty("a")&&(t=e.a)}t=S(t);e=e.format||f;f=I(255,E(h.r,0));g=I(255,E(h.g,0));h=I(255,E(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=t;this._roundA=v(100*this._a)/100;this._format=c.format||e;this._gradientType=c.gradientType;1>this._r&&(this._r=v(this._r));
1>this._g&&(this._g=v(this._g));1>this._b&&(this._b=v(this._b));this._ok=d;this._tc_id=N++};u.prototype={isDark:function(){return 128>this.getBrightness()},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var b=this.toRgb();return(299*b.r+587*b.g+114*b.b)/1E3},setAlpha:function(b){this._a=S(b);this._roundA=v(100*
this._a)/100;return this},toHsv:function(){var b=c(this._r,this._g,this._b);return{h:360*b.h,s:b.s,v:b.v,a:this._a}},toHsvString:function(){var b=c(this._r,this._g,this._b),a=v(360*b.h),d=v(100*b.s),b=v(100*b.v);return 1==this._a?"hsv("+a+", "+d+"%, "+b+"%)":"hsva("+a+", "+d+"%, "+b+"%, "+this._roundA+")"},toHsl:function(){var a=b(this._r,this._g,this._b);return{h:360*a.h,s:a.s,l:a.l,a:this._a}},toHslString:function(){var a=b(this._r,this._g,this._b),c=v(360*a.h),d=v(100*a.s),a=v(100*a.l);return 1==
...
arguments)},complement:function(){return this._applyCombination(m,arguments)},monochromatic:function(){return this._applyCombination(q,arguments)},splitcomplement:function(){return this._applyCombination(w,arguments)},triad:function(){return this._applyCombination(p,arguments)},tetrad:function(){return this._applyCombination(D,arguments)}};u.fromRatio=function(b,a){if("object"==typeof b){var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]="a"===d?b[d]:K(b[d]));b=c}return u(b,a)};u.equals=function(b,
a){return b&&a?u(b).toRgbString()==u(a).toRgbString():!1};u.random=function(){return u.fromRatio({r:fa(),g:fa(),b:fa()})};u.mix=function(b,a,c){c=0===c?0:c||50;b=u(b).toRgb();a=u(a).toRgb();c/=100;var d=2*c-1,e=a.a-b.a,d=((-1==d*e?d:(d+e)/(1+d*e))+1)/2,e=1-d;return u({r:a.r*d+b.r*e,g:a.g*d+b.g*e,b:a.b*d+b.b*e,a:a.a*c+b.a*(1-c)})};u.readability=function(b,a){var c=u(b),d=u(a),e=c.toRgb(),f=d.toRgb(),c=c.getBrightness(),d=d.getBrightness(),e=Math.max(e.r,f.r)-Math.min(e.r,f.r)+Math.max(e.g,f.g)-Math.min(e.g,
f.g)+Math.max(e.b,f.b)-Math.min(e.b,f.b);return{brightness:Math.abs(c-d),color:e}};u.isReadable=function(b,a){var c=u.readability(b,a);return 125<c.brightness&&500<c.color};u.mostReadable=function(b,a){for(var c=null,d=0,e=!1,f=0;f<a.length;f++){var g=u.readability(b,a[f]),h=125<g.brightness&&500<g.color,g=3*(g.brightness/125)+g.color/500;if(h&&!e||h&&e&&g>d||!h&&!e&&g>d)e=h,d=g,c=u(a[f])}return c};var P=u.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",
...
thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},M=u.hexNames=function(b){var a={},c;for(c in b)b.hasOwnProperty(c)&&(a[b[c]]=c);return a}(P),G={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),rgba:RegExp("rgba[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
Paint.prototype.keypress=function(b){var a=b.keyCode||b.which;if(b.target==document.body){console.log("Keypress",b);99==a&&(console.log("Pressed C, toggling color selector."),$(this.controls.byName["tool-color"].input).spectrum("toggle"));if(47<a&&58>a){var c=a-48;this.setColor(tinycolor(this.current_color.toRgb()).setAlpha(c/9))}91!=a&&44!=a&&45!=a&&219!=a&&186!=a&&96!=a||this.changeToolSize(--this.current_size,!0);93!=a&&46!=a&&221!=a&&187!=a&&43!=a&&61!=a||this.changeToolSize(++this.current_size,
!0);26==a&&b.ctrlKey&&this.undo();114==a&&this.setRotation(this.rotation+1);109==a&&this.setHorizontalMirror(1==this.scale[0]);107==a&&this.setVerticalMirror(1==this.scale[1]);b={98:"brush",103:"grab",108:"line",112:"picker",116:"text",118:"picker"};b[a]&&(console.log("Switching tool to "+b[a]),this.changeTool(b[a]))}};
Paint.prototype.keydown=function(b){var a=b.keyCode||b.which;b.target==document.body&&(console.log("Keydown",b),27==a&&(this.setRotation(0),this.setHorizontalMirror(!1),this.setVerticalMirror(!1)),"grab"!==this.current_tool&&32==a&&(this.previous_tool=this.current_tool,this.changeTool("grab")),"picker"!==this.current_tool&&18==a&&(this.previous_tool=this.current_tool,this.changeTool("picker")))};
...
title:"Change tool to text",value:"text",action:this.changeTool.bind(this)},{name:"picker",type:"button",image:"images/icons/picker.png",title:"Change tool to picker",value:"picker",action:this.changeTool.bind(this)},{name:"undo",type:"button",image:"images/icons/undo.png",title:"Undo drawing",action:this.undo.bind(this)},{name:"tool-size",type:"integer",range:!0,text:"Tool size",min:1,max:50,value:5,title:"Change the size of the tool",action:this.changeToolSize.bind(this)},{name:"zoom-in",type:"button",
image:"images/icons/zoomin.png",title:"Zoom in",value:2,action:this.zoom.bind(this)},{name:"zoom-reset",type:"button",image:"images/icons/zoomreset.png",title:"Reset zoom",value:1,action:this.zoomAbsolute.bind(this)},{name:"zoom-out",type:"button",image:"images/icons/zoomout.png",title:"Zoom out",value:0.5,action:this.zoom.bind(this)},{name:"tool-color",type:"color",text:"Tool color",value:"#FFFFFF",title:"Change the color of the tool",action:this._changeColor.bind(this)}]};
...
Paint.prototype.getCoords=function(b){if(!("number"===typeof b.clientX||b.changedTouches&&b.changedTouches[0])||!("number"===typeof b.clientY||b.changedTouches&&b.changedTouches[0]))return[0,0];var a="number"===typeof b.clientX?b.clientX:b.changedTouches[0].clientX,c="number"===typeof b.clientY?b.clientY:b.changedTouches[0].clientY,e=b.target||document.elementFromPoint(a,c);-1==this.boundingBoxList.indexOf(e)&&this.boundingBoxList.push(e);e.boundingBoxCache=e.boundingBoxCache||e.getBoundingClientRect();
a-=e.boundingBoxCache.left;c-=e.boundingBoxCache.top;if(0!==this.rotation||1!==this.scale[0]||1!==this.scale[1])a-=b.target.width/2,c-=b.target.height/2,a*=this.scale[0],c*=this.scale[1],e=a,a=a*Math.cos(-this.rotation*Math.PI/180)-c*Math.sin(-this.rotation*Math.PI/180),c=e*Math.sin(-this.rotation*Math.PI/180)+c*Math.cos(-this.rotation*Math.PI/180),a+=b.target.width/2,c+=b.target.height/2;return[a,c]};
...
e.fill();e.beginPath();e.moveTo(b.lastLinePoint[0],b.lastLinePoint[1]);e.lineTo(c[0],c[1]);e.strokeStyle=b.current_color.toRgbString();e.lineWidth=2*b.current_size*b.local.zoom;e.stroke();e.beginPath();e.arc(c[0],c[1],b.current_size*b.local.zoom,0,2*Math.PI,!0);e.fillStyle=b.current_color.toRgbString();e.fill()}}},brush:function(b,a,c){if("remove"==a)delete b.lastMovePoint,delete b.lockcolor,delete b.brushing;else{b.lastMovePoint=b.lastMovePoint||[0,0];c=b.getCoords(a);if("mousedown"==a.type||"touchstart"==
...
b._data=this._data.clone();return b},_minBufferSize:0});e.Hasher=m.extend({cfg:f.extend(),init:function(b){this.cfg=this.cfg.extend(b);this.reset()},reset:function(){m.reset.call(this);this._doReset()},update:function(b){this._append(b);this._process();return this},finalize:function(b){b&&this._append(b);return this._doFinalize()},blockSize:16,_createHelper:function(b){return function(a,c){return(new b.init(c)).finalize(a)}},_createHmacHelper:function(b){return function(a,c){return(new q.HMAC.init(b,
c)).finalize(a)}}});var q=c.algo={};return c}(Math);
(function(b){for(var a=CryptoJS,c=a.lib,e=c.WordArray,d=c.Hasher,c=a.algo,f=[],g=[],h=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var p;a:{p=k;for(var m=b.sqrt(p),q=2;q<=m;q++)if(!(p%q)){p=!1;break a}p=!0}p&&(8>l&&(f[l]=h(b.pow(k,0.5))),g[l]=h(b.pow(k,1/3)),l++);k++}var n=[],c=c.SHA256=d.extend({_doReset:function(){this._hash=new e.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,d=c[0],e=c[1],f=c[2],h=c[3],k=c[4],l=c[5],m=c[6],p=c[7],q=0;64>q;q++){if(16>q)n[q]=
b[a+q]|0;else{var F=n[q-15],y=n[q-2];n[q]=((F<<25|F>>>7)^(F<<14|F>>>18)^F>>>3)+n[q-7]+((y<<15|y>>>17)^(y<<13|y>>>19)^y>>>10)+n[q-16]}F=p+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&l^~k&m)+g[q]+n[q];y=((d<<30|d>>>2)^(d<<19|d>>>13)^(d<<10|d>>>22))+(d&e^d&f^e&f);p=m;m=l;l=k;k=h+F|0;h=f;f=e;e=d;d=F+y|0}c[0]=c[0]+d|0;c[1]=c[1]+e|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+l|0;c[6]=c[6]+m|0;c[7]=c[7]+p|0},_doFinalize:function(){var a=this._data,c=a.words,d=8*this._nDataBytes,e=8*a.sigBytes;
...
b),f.startDragY=h.page("Y",b),f.dragWatchers={current:0,last:0,hold:0,state:""},f.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(b){if(f.isDragging&&d.touchToDrag){var c=h.page("X",b),e=h.page("Y",b),g=f.translation,n=k.translate.get.matrix(4),t=c-f.startDragX,w=0<n,A=t;if(!f.intentChecked||f.hasIntent){d.addBodyClasses&&(0<n?(h.klass.add(a.body,"snapjs-left"),h.klass.remove(a.body,
"snapjs-right")):0>n&&(h.klass.add(a.body,"snapjs-right"),h.klass.remove(a.body,"snapjs-left")));if(!1===f.hasIntent||null===f.hasIntent){var e=h.angleOfDrag(c,e),D=0<=e&&e<=d.slideIntent||360>=e&&e>360-d.slideIntent;f.hasIntent=180<=e&&e<=180+d.slideIntent||180>=e&&e>=180-d.slideIntent||D?!0:!1;f.intentChecked=!0}d.minDragDistance>=Math.abs(c-f.startDragX)||!1===f.hasIntent||(h.events.prevent(b),h.dispatchEvent("drag"),f.dragWatchers.current=c,f.dragWatchers.last>c?("left"!==f.dragWatchers.state&&
(f.dragWatchers.state="left",f.dragWatchers.hold=c),f.dragWatchers.last=c):f.dragWatchers.last<c&&("right"!==f.dragWatchers.state&&(f.dragWatchers.state="right",f.dragWatchers.hold=c),f.dragWatchers.last=c),w?(d.maxPosition<n&&(b=(n-d.maxPosition)*d.resistance,A=t-b),f.simpleStates={opening:"left",towards:f.dragWatchers.state,hyperExtending:d.maxPosition<n,halfway:n>d.maxPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:n,relative:t,sinceDirectionChange:f.dragWatchers.current-
f.dragWatchers.hold,percentage:100*(n/d.maxPosition)}}):(d.minPosition>n&&(b=(n-d.minPosition)*d.resistance,A=t-b),f.simpleStates={opening:"right",towards:f.dragWatchers.state,hyperExtending:d.minPosition>n,halfway:n<d.minPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>d.flickThreshold,translation:{absolute:n,relative:t,sinceDirectionChange:f.dragWatchers.current-f.dragWatchers.hold,percentage:100*(n/d.minPosition)}}),k.translate.x(A+g))}}},endDrag:function(b){if(f.isDragging){h.dispatchEvent("end");
...
e.data=c;a(e)}d.maybeReconnectOnOpen()});if(!1!==this._timeout){var h=this._timeout;p("connect attempt will timeout after %d",h);var D=setTimeout(function(){p("connect attempt timed out after %d",h);e.destroy();c.close();c.emit("error","timeout");d.emitAll("connect_timeout",h)},h);this.subs.push({destroy:function(){clearTimeout(D)}})}this.subs.push(e);this.subs.push(g);return this};d.prototype.onopen=function(){p("open");this.cleanup();this.readyState="open";this.emit("open");var a=this.engine;this.subs.push(k(a,
...
this.receiveBuffer=[];this.sendBuffer=[];this.connected=!1;this.disconnected=!0;this.subEvents()}var f=a("socket.io-parser");e=a("component-emitter");var g=a("to-array"),h=a("./on"),k=a("component-bind"),l=a("debug")("socket.io-client:socket"),p=a("has-binary");a("indexof");c.exports=d;var m={connect:1,connect_error:1,connect_timeout:1,disconnect:1,error:1,reconnect:1,reconnect_attempt:1,reconnect_failed:1,reconnect_error:1,reconnecting:1},q=e.prototype.emit;e(d.prototype);d.prototype.subEvents=function(){var a=
this.io;this.subs=[h(a,"open",k(this,"onopen")),h(a,"packet",k(this,"onpacket")),h(a,"close",k(this,"onclose"))]};d.prototype.open=d.prototype.connect=function(){if(this.connected)return this;this.io.open();if("open"==this.io.readyState)this.onopen();return this};d.prototype.send=function(){var a=g(arguments);a.unshift("message");this.emit.apply(this,a);return this};d.prototype.emit=function(a){if(m.hasOwnProperty(a))return q.apply(this,arguments),this;var c=g(arguments),d=f.EVENT;p(c)&&(d=f.BINARY_EVENT);
...
0;a<this.receiveBuffer.length;a++)q.apply(this,this.receiveBuffer[a]);this.receiveBuffer=[];for(a=0;a<this.sendBuffer.length;a++)this.packet(this.sendBuffer[a]);this.sendBuffer=[]};d.prototype.ondisconnect=function(){l("server disconnect (%s)",this.nsp);this.destroy();this.onclose("io server disconnect")};d.prototype.destroy=function(){for(var a=0;a<this.subs.length;a++)this.subs[a].destroy();this.io.destroy(this)};d.prototype.close=d.prototype.disconnect=function(){if(!this.connected)return this;
...
function(a){k("setting transport %s",a.name);var c=this;this.transport&&(k("clearing existing transport %s",this.transport.name),this.transport.removeAllListeners());this.transport=a;a.on("drain",function(){c.onDrain()}).on("packet",function(a){c.onPacket(a)}).on("error",function(a){c.onError(a)}).on("close",function(){c.onClose("transport close")})};e.prototype.probe=function(a){function c(){if(z.onlyBinaryUpgrades){var d=!this.supportsBinary&&z.transport.supportsBinary;q=q||d}q||(k('probe transport "%s" opened',
a),m.send([{type:"ping",data:"probe"}]),m.once("packet",function(c){q||("pong"==c.type&&"probe"==c.data?(k('probe transport "%s" pong',a),z.upgrading=!0,z.emit("upgrading",m),e.priorWebsocketSuccess="websocket"==m.name,k('pausing current transport "%s"',z.transport.name),z.transport.pause(function(){q||("closed"==z.readyState||"closing"==z.readyState)||(k("changing transport and sending upgrade packet"),n(),z.setTransport(m),m.send([{type:"upgrade"}]),z.emit("upgrade",m),m=null,z.upgrading=!1,z.flush())})):
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=m.name,z.emit("upgradeError",c)))}))}function d(){q||(q=!0,n(),m.close(),m=null)}function g(c){var e=Error("probe error: "+c);e.transport=m.name;d();k('probe transport "%s" failed because of error: %s',a,c);z.emit("upgradeError",e)}function h(){g("transport closed")}function p(){g("socket closed")}function l(a){m&&a.name!=m.name&&(k('"%s" works - aborting "%s"',a.name,m.name),d())}function n(){m.removeListener("open",c);m.removeListener("error",
g);m.removeListener("close",h);z.removeListener("close",p);z.removeListener("upgrading",l)}k('probing transport "%s"',a);var m=this.createTransport(a,{probe:1}),q=!1,z=this;e.priorWebsocketSuccess=!1;m.once("open",c);m.once("error",g);m.once("close",h);this.once("close",p);this.once("upgrading",l);m.open()};e.prototype.onOpen=function(){k("socket open");this.readyState="open";e.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
this.transport.pause){k("starting upgrade probes");for(var a=0,c=this.upgrades.length;a<c;a++)this.probe(this.upgrades[a])}};e.prototype.onPacket=function(a){if("opening"==this.readyState||"open"==this.readyState)switch(k('socket receive: type "%s", data "%s"',a.type,a.data),this.emit("packet",a),this.emit("heartbeat"),a.type){case "open":this.onHandshake(q(a.data));break;case "pong":this.setPing();break;case "error":var c=Error("server error");c.code=a.data;this.emit("error",c);break;case "message":this.emit("data",
...
"engine.io-parser":21}],14:[function(a,c,e){(function(c){var f=a("xmlhttprequest"),g=a("./polling-xhr"),h=a("./polling-jsonp"),k=a("./websocket");e.polling=function(a){var e=!1,k=!1,q=!1!==a.jsonp;c.location&&(k="https:"==location.protocol,(e=location.port)||(e=k?443:80),e=a.hostname!=location.hostname||e!=a.port,k=a.secure!=k);a.xdomain=e;a.xscheme=k;if("open"in new f(a)&&!a.forceJSONP)return new g(a);if(!q)throw Error("JSONP disabled");return new h(a)};e.websocket=k}).call(this,"undefined"!==typeof self?
...
new Uint8Array(1);d[0]=1;if("string"===typeof a){for(var e=new Uint8Array(a.length),f=0;f<a.length;f++)e[f]=a.charCodeAt(f);a=e.buffer;d[0]=0}for(var e=(a instanceof ArrayBuffer?a.byteLength:a.size).toString(),g=new Uint8Array(e.length+1),f=0;f<e.length;f++)g[f]=parseInt(e[f]);g[e.length]=255;A&&(a=new A([d.buffer,g.buffer,a]),c(null,a))})},function(a,d){return c(new A(d))})};e.decodePayloadAsBinary=function(a,c,d){"function"===typeof c&&(d=c,c=null);for(var f=[],g=!1;0<a.byteLength;){for(var h=new Uint8Array(a),
l=0===h[0],n="",m=1;255!=h[m];m++){if(310<n.length){g=!0;break}n+=h[m]}if(g)return d(w,0,1);a=k(a,2+n.length);n=parseInt(n);h=k(a,0,n);if(l)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(p){for(l=new Uint8Array(h),h="",m=0;m<l.length;m++)h+=String.fromCharCode(l[m])}f.push(h);a=k(a,n)}var q=f.length;f.forEach(function(a,f){d(e.decodePacket(a,c,!0),f,q)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
return k};e.decode=function(c){var e=0.75*c.length,h=c.length,k=0,l,p,m,q;"="===c[c.length-1]&&(e--,"="===c[c.length-2]&&e--);for(var n=new ArrayBuffer(e),t=new Uint8Array(n),e=0;e<h;e+=4)l=a.indexOf(c[e]),p=a.indexOf(c[e+1]),m=a.indexOf(c[e+2]),q=a.indexOf(c[e+3]),t[k++]=l<<2|p>>4,t[k++]=(p&15)<<4|m>>2,t[k++]=(m&3)<<6|q&63;return n}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")},{}],26:[function(a,c,e){(function(a){function e(a,c){c=c||{};for(var d=new g,f=0;f<a.length;f++)d.append(a[f]);
...
56320==(g&64512)?c.push(((f&1023)<<10)+(g&1023)+65536):(c.push(f),d--)):c.push(f);return c}function h(){if(w>=t)throw Error("Invalid byte index");var a=n[w]&255;w++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,d,e;if(w>t)throw Error("Invalid byte index");if(w==t)return!1;a=n[w]&255;w++;if(0==(a&128))return a;if(192==(a&224)){c=h();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=h();d=h();a=(a&15)<<12|c<<6|
d;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=h(),d=h(),e=h(),a=(a&15)<<18|c<<12|d<<6|e,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof e&&e,p="object"==typeof c&&c&&c.exports==l&&c,m="object"==typeof a&&a;if(m.global===m||m.window===m)f=m;var q=String.fromCharCode,n,t,w,m={version:"2.0.0",encode:function(a){a=g(a);for(var c=a.length,d=-1,e,f="";++d<c;){e=a[d];if(0==(e&4294967168))e=q(e);else{var h="";0==(e&4294965248)?
h=q(e>>6&31|192):0==(e&4294901760)?(h=q(e>>12&15|224),h+=q(e>>6&63|128)):0==(e&4292870144)&&(h=q(e>>18&7|240),h+=q(e>>12&63|128),h+=q(e>>6&63|128));e=h+=q(e&63|128)}f+=e}return f},decode:function(a){n=g(a);t=n.length;w=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var d=-1,e,f="";++d<c;)e=a[d],65535<e&&(e-=65536,f+=q(e>>>10&1023|55296),e=56320|e&1023),f+=q(e);return f}};if(l&&!l.nodeType)if(p)p.exports=m;else{f={}.hasOwnProperty;for(var A in m)f.call(m,A)&&(l[A]=m[A])}else f.utf8=m})(this)}).call(this,
...
a._placeholder)return c[a.num];if(f(a))for(var e=0;e<a.length;e++)a[e]=d(a[e]);else if(a&&"object"==typeof a)for(e in a)a[e]=d(a[e]);return a}a.data=d(a.data);a.attachments=void 0;return a};e.removeBlobs=function(a,e){function l(a,h,t){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){p++;var w=new FileReader;w.onload=function(){t?t[h]=this.result:m=this.result;--p||e(m)};w.readAsArrayBuffer(a)}else if(f(a))for(w=0;w<a.length;w++)l(a[w],w,a);else if(a&&"object"==typeof a&&!g(a))for(w in a)l(a[w],
w,a)}var p=0,m=a;l(m);p||e(m)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,e){function d(){}function f(a){var c,d=!1;c=""+a.type;if(e.BINARY_EVENT==a.type||e.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(d=!0,c+=a.nsp);null!=a.id&&(d&&(c+=",",d=!1),c+=a.id);null!=a.data&&(d&&(c+=","),c+=p.stringify(a.data));l("encoded %j as %s",a,c);return c}function g(a,c){m.removeBlobs(a,function(a){var d=m.deconstructPacket(a);
a=f(d.packet);d=d.buffers;d.unshift(a);c(d)})}function h(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),p=a("json3");a("isarray");c=a("component-emitter");var m=a("./binary"),q=a("./is-buffer");e.protocol=4;e.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");e.CONNECT=0;e.DISCONNECT=1;e.EVENT=2;e.ACK=3;e.ERROR=4;e.BINARY_EVENT=5;e.BINARY_ACK=6;e.Encoder=d;e.Decoder=h;d.prototype.encode=function(a,c){l("encoding packet %j",
...
var d;if("bug-string-char-index"==a)d="a"!="a"[0];else if("json"==a)d=c("json-stringify")&&c("json-parse");else{var e;if("json-stringify"==a){d=m.stringify;var h="function"==typeof d&&q;if(h){(e=function(){return 1}).toJSON=e;try{h="0"===d(0)&&"0"===d(new Number)&&'""'==d(new String)&&d(g)===l&&d(l)===l&&d()===l&&"1"===d(e)&&"[1]"==d([e])&&"[null]"==d([l])&&"null"==d(null)&&"[null,null,null]"==d([l,g,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==d({a:[e,!0,!1,null,"\x00\b\n\f\r\t"]})&&
"1"===d(null,e)&&"[\n 1,\n 2\n]"==d([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==d(new Date(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==d(new Date(864E13))&&'"-000001-01-01T00:00:00.000Z"'==d(new Date(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==d(new Date(-1))}catch(k){h=!1}}d=h}if("json-parse"==a){d=m.parse;if("function"==typeof d)try{if(0===d("0")&&!d(!1)){e=d('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var p=5==e.a.length&&1===e.a[0];if(p){try{p=!d('"\t"')}catch(H){}if(p)try{p=1!==
d("01")}catch(n){}if(p)try{p=1!==d("1.")}catch(s){}}}}catch(r){p=!1}d=p}}return c[a]=!!d}var g={}.toString,h,k,l,p="object"==typeof JSON&&JSON,m="object"==typeof e&&e&&!e.nodeType&&e;m&&p?(m.stringify=p.stringify,m.parse=p.parse):m=a.JSON=p||{};var q=new Date(-0xc782b5b800cec);try{q=-109252==q.getUTCFullYear()&&0===q.getUTCMonth()&&1===q.getUTCDate()&&10==q.getUTCHours()&&37==q.getUTCMinutes()&&6==q.getUTCSeconds()&&708==q.getUTCMilliseconds()}catch(n){}if(!c("json")){var t=c("bug-string-char-index");
if(!q)var w=Math.floor,A=[0,31,59,90,120,151,181,212,243,273,304,334],D=function(a,c){return A[c]+365*(a-1970)+w((a-1969+(c=+(1<c)))/4)-w((a-1901+c)/100)+w((a-1601+c)/400)};(h={}.hasOwnProperty)||(h=function(a){var c={},d;(c.__proto__=null,c.__proto__={toString:1},c).toString!=g?h=function(a){var c=this.__proto__;a=a in(this.__proto__=null,this);this.__proto__=c;return a}:(d=c.constructor,h=function(a){var c=(this.constructor||d).prototype;return a in this&&!(a in c&&this[a]===c[a])});c=null;return h.call(this,
...
k=function(a,c){var d="[object Function]"==g.call(a),e,k;if(k=!d)if(k="function"!=typeof a.constructor)k=typeof a.hasOwnProperty,k="object"==k?!!a.hasOwnProperty:!Ua[k];k=k?a.hasOwnProperty:h;for(e in a)d&&"prototype"==e||!k.call(a,e)||c(e);for(d=f.length;e=f[--d];k.call(a,e)&&c(e));});return k(a,c)};if(!c("json-stringify")){var Va={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},R=function(a,c){return("000000"+(c||0)).slice(-a)},Da=function(a){var c='"',d=0,e=a.length,f=10<e&&t,h;
for(f&&(h=a.split(""));d<e;d++){var g=a.charCodeAt(d);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=Va[g];break;default:if(32>g){c+="\\u00"+R(2,g.toString(16));break}c+=f?h[d]:t?a.charAt(d):a[d]}}return c+'"'},Y=function(a,c,d,e,f,m,p){var n,q,r,s,t,v,y,A,z;try{n=c[a]}catch(u){}if("object"==typeof n&&n)if(q=g.call(n),"[object Date]"!=q||h.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=q&&"[object String]"!=q&&"[object Array]"!=q||h.call(n,"toJSON"))&&(n=n.toJSON(a));
else if(n>-1/0&&n<1/0){if(D){s=w(n/864E5);for(q=w(s/365.2425)+1970-1;D(q+1,0)<=s;q++);for(r=w((s-D(q,0))/30.42);D(q,r+1)<=s;r++);s=1+s-D(q,r);t=(n%864E5+864E5)%864E5;v=w(t/36E5)%24;y=w(t/6E4)%60;A=w(t/1E3)%60;t%=1E3}else q=n.getUTCFullYear(),r=n.getUTCMonth(),s=n.getUTCDate(),v=n.getUTCHours(),y=n.getUTCMinutes(),A=n.getUTCSeconds(),t=n.getUTCMilliseconds();n=(0>=q||1E4<=q?(0>q?"-":"+")+R(6,0>q?-q:q):R(4,q))+"-"+R(2,r+1)+"-"+R(2,s)+"T"+R(2,v)+":"+R(2,y)+":"+R(2,A)+"."+R(3,t)+"Z"}else n=null;d&&(n=
d.call(c,a,n));if(null===n)return"null";q=g.call(n);if("[object Boolean]"==q)return""+n;if("[object Number]"==q)return n>-1/0&&n<1/0?""+n:"null";if("[object String]"==q)return Da(""+n);if("object"==typeof n){for(a=p.length;a--;)if(p[a]===n)throw TypeError();p.push(n);z=[];c=m;m+=f;if("[object Array]"==q){r=0;for(a=n.length;r<a;r++)q=Y(r,n,d,e,f,m,p),z.push(q===l?"null":q);a=z.length?f?"[\n"+m+z.join(",\n"+m)+"\n"+c+"]":"["+z.join(",")+"]":"[]"}else k(e||n,function(a){var c=Y(a,n,d,e,f,m,p);c!==l&&
z.push(Da(a)+":"+(f?" ":"")+c)}),a=z.length?f?"{\n"+m+z.join(",\n"+m)+"\n"+c+"}":"{"+z.join(",")+"}":"{}";p.pop();return a}};m.stringify=function(a,c,d){var e,f,h,k;if("function"==typeof c||"object"==typeof c&&c)if("[object Function]"==(k=g.call(c)))f=c;else if("[object Array]"==k){h={};for(var l=0,n=c.length,m;l<n;m=c[l++],(k=g.call(m),"[object String]"==k||"[object Number]"==k)&&(h[m]=1));}if(d)if("[object Number]"==(k=g.call(d))){if(0<(d-=d%1))for(e="",10<d&&(d=10);e.length<d;e+=" ");}else"[object String]"==
k&&(e=10>=d.length?d:d.slice(0,10));return Y("",(m={},m[""]=a,m),f,h,e,"",[])}}if(!c("json-parse")){var Ea=String.fromCharCode,z={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},s,F,y=function(){s=F=null;throw SyntaxError();},L=function(){for(var a=F,c=a.length,d,e,f,h,g;s<c;)switch(g=a.charCodeAt(s),g){case 9:case 10:case 13:case 32:s++;break;case 123:case 125:case 91:case 93:case 58:case 44:return d=t?a.charAt(s):a[s],s++,d;case 34:d="@";for(s++;s<c;)if(g=a.charCodeAt(s),32>g)y();
else if(92==g)switch(g=a.charCodeAt(++s),g){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:d+=z[g];s++;break;case 117:e=++s;for(f=s+4;s<f;s++)g=a.charCodeAt(s),48<=g&&57>=g||(97<=g&&102>=g||65<=g&&70>=g)||y();d+=Ea("0x"+a.slice(e,s));break;default:y()}else{if(34==g)break;g=a.charCodeAt(s);for(e=s;32<=g&&92!=g&&34!=g;)g=a.charCodeAt(++s);d+=a.slice(e,s)}if(34==a.charCodeAt(s))return s++,d;y();default:e=s;45==g&&(h=!0,g=a.charCodeAt(++s));if(48<=g&&57>=g){for(48==g&&(g=a.charCodeAt(s+
1),48<=g&&57>=g)&&y();s<c&&(g=a.charCodeAt(s),48<=g&&57>=g);s++);if(46==a.charCodeAt(s)){for(f=++s;f<c&&(g=a.charCodeAt(f),48<=g&&57>=g);f++);f==s&&y();s=f}g=a.charCodeAt(s);if(101==g||69==g){g=a.charCodeAt(++s);43!=g&&45!=g||s++;for(f=s;f<c&&(g=a.charCodeAt(f),48<=g&&57>=g);f++);f==s&&y();s=f}return+a.slice(e,s)}h&&y();if("true"==a.slice(s,s+4))return s+=4,!0;if("false"==a.slice(s,s+5))return s+=5,!1;if("null"==a.slice(s,s+4))return s+=4,null;y()}return"$"},da=function(a){var c,d;"$"==a&&y();if("string"==
typeof a){if("@"==(t?a.charAt(0):a[0]))return a.slice(1);if("["==a){for(c=[];;d||(d=!0)){a=L();if("]"==a)break;d&&(","==a?(a=L(),"]"==a&&y()):y());","==a&&y();c.push(da(a))}return c}if("{"==a){for(c={};;d||(d=!0)){a=L();if("}"==a)break;d&&(","==a?(a=L(),"}"==a&&y()):y());","!=a&&"string"==typeof a&&"@"==(t?a.charAt(0):a[0])&&":"==L()||y();c[a.slice(1)]=da(L())}return c}y()}return a},ea=function(a,c,d){d=la(a,c,d);d===l?delete a[c]:a[c]=d},la=function(a,c,d){var e=a[c],f;if("object"==typeof e&&e)if("[object Array]"==
g.call(e))for(f=e.length;f--;)ea(e,f,d);else k(e,function(a){ea(e,a,d)});return d.call(a,c,e)};m.parse=function(a,c){var d,e;s=0;F=""+a;d=da(L());"$"!=L()&&y();s=F=null;return c&&"[object Function]"==g.call(c)?la((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,e){c.exports=function(a,c){for(var e=[],h=(c=c||0)||0;h<a.length;h++)e[h-c]=a[h];return e}},{}]},{},[1])(1)});
