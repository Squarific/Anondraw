function Account(b,a){this.uKey=a||localStorage.getItem("drawtogether-uKey")||"";this.mail=localStorage.getItem("drawtogether-mail");this.server=b;this.favList=[];setInterval(this.checkLogin.bind(this),18E5)}Account.prototype.login=function(b,a,c){this.loginNoHash(b,CryptoJS.SHA256(a).toString(CryptoJS.enc.Base64),c)};
Account.prototype.genericRequest=function(b,a,c){if(""!==this.uKey){var d=new XMLHttpRequest;d.addEventListener("readystatechange",function(b){200==d.status&&4==d.readyState?(b=JSON.parse(d.responseText),b.error?c(b.error):setTimeout(c,0,null,b)):4==d.readyState&&c("Connection error, status code: "+d.status)}.bind(this));d.open("GET",this.server+"/"+b+"?"+a);d.send()}else c("Not logged in!")};
Account.prototype.setCoordFavorite=function(b,a,c,d,e,f){b="uKey="+encodeURIComponent(this.uKey)+"&room="+encodeURIComponent(room)+"&newX="+encodeURIComponent(b)+"&newY="+encodeURIComponent(a)+"&x="+encodeURIComponent(c)+"&y="+encodeURIComponent(d)+"&name="+encodeURIComponent(e);this.genericRequest("setcoordfavorite",b,f)};
Account.prototype.removeFavorite=function(b,a,c,d){b="uKey="+encodeURIComponent(this.uKey)+"&room="+encodeURIComponent(room)+"&x="+encodeURIComponent(b)+"&y="+encodeURIComponent(a)+"&name="+encodeURIComponent(c);this.genericRequest("removefavorite",b,d)};
Account.prototype.renameFavorite=function(b,a,c,d){b="uKey="+encodeURIComponent(this.uKey)+"&room="+encodeURIComponent(room)+"&x="+encodeURIComponent(b)+"&y="+encodeURIComponent(a)+"&name="+encodeURIComponent(c);this.genericRequest("renamefavorite",b,d)};
Account.prototype.createFavorite=function(b,a,c,d){b="uKey="+encodeURIComponent(this.uKey)+"&room="+encodeURIComponent(room)+"&x="+encodeURIComponent(b)+"&y="+encodeURIComponent(a)+"&name="+encodeURIComponent(c);this.genericRequest("createfavorite",b,d)};Account.prototype.getFavorites=function(b,a){var c="uKey="+encodeURIComponent(this.uKey)+"&room="+encodeURIComponent(b);this.genericRequest("getfavorites",c,a)};
...
b._data=this._data.clone();return b},_minBufferSize:0});d.Hasher=q.extend({cfg:f.extend(),init:function(b){this.cfg=this.cfg.extend(b);this.reset()},reset:function(){q.reset.call(this);this._doReset()},update:function(b){this._append(b);this._process();return this},finalize:function(b){b&&this._append(b);return this._doFinalize()},blockSize:16,_createHelper:function(b){return function(a,c){return(new b.init(c)).finalize(a)}},_createHmacHelper:function(b){return function(a,c){return(new r.HMAC.init(b,
c)).finalize(a)}}});var r=c.algo={};return c}(Math);
(function(b){for(var a=CryptoJS,c=a.lib,d=c.WordArray,e=c.Hasher,c=a.algo,f=[],g=[],h=function(b){return 4294967296*(b-(b|0))|0},k=2,l=0;64>l;){var m;a:{m=k;for(var q=b.sqrt(m),r=2;r<=q;r++)if(!(m%r)){m=!1;break a}m=!0}m&&(8>l&&(f[l]=h(b.pow(k,0.5))),g[l]=h(b.pow(k,1/3)),l++);k++}var n=[],c=c.SHA256=e.extend({_doReset:function(){this._hash=new d.init(f.slice(0))},_doProcessBlock:function(b,a){for(var c=this._hash.words,e=c[0],d=c[1],f=c[2],h=c[3],k=c[4],q=c[5],l=c[6],m=c[7],r=0;64>r;r++){if(16>r)n[r]=
b[a+r]|0;else{var I=n[r-15],x=n[r-2];n[r]=((I<<25|I>>>7)^(I<<14|I>>>18)^I>>>3)+n[r-7]+((x<<15|x>>>17)^(x<<13|x>>>19)^x>>>10)+n[r-16]}I=m+((k<<26|k>>>6)^(k<<21|k>>>11)^(k<<7|k>>>25))+(k&q^~k&l)+g[r]+n[r];x=((e<<30|e>>>2)^(e<<19|e>>>13)^(e<<10|e>>>22))+(e&d^e&f^d&f);m=l;l=q;q=k;k=h+I|0;h=f;f=d;d=e;e=I+x|0}c[0]=c[0]+e|0;c[1]=c[1]+d|0;c[2]=c[2]+f|0;c[3]=c[3]+h|0;c[4]=c[4]+k|0;c[5]=c[5]+q|0;c[6]=c[6]+l|0;c[7]=c[7]+m|0},_doFinalize:function(){var a=this._data,c=a.words,e=8*this._nDataBytes,d=8*a.sigBytes;
...
this._forceFollow;this._autoMoveScreen;this._followingPlayer;this._favoriteRenameDelayTimeout;this.favoritesContainer=null;this.network=new Network(this.settings.loadbalancer);this.account=new Account(this.settings.accountServer);this.bindSocketHandlers();this.initDom();this.gui=new Gui(b);this.updateInk();"ask"==this.settings.mode?this.openModeSelector():"askjoin"==this.settings.mode?(this.changeRoom("main"),this.openModeSelector()):"join"==this.settings.mode?(0==this.settings.room.indexOf("private_")?
0==this.settings.room.indexOf("private_game_")?ga("send","event","autojoin","privategame"):ga("send","event","autojoin","private"):this.settings.room.indexOf("game_")?ga("send","event","autojoin","game"):ga("send","event","autojoin","public"),this.changeRoom(this.settings.room,void 0,this.settings.leftTopX,this.settings.leftTopY,!0)):"private"==this.settings.mode?(this.settings.room="private_"+Math.random().toString(36).substr(2,5),this.changeRoom(this.settings.room,void 0,0,0,!0)):"member"==this.settings.mode?
this.changeRoom("member-main"):"auto"==this.settings.mode&&this.changeRoom("main");requestAnimationFrame(this.drawLoop.bind(this));this.needsClear=!1;document.addEventListener("keydown",function(b){b.target===document.body&&(27==b.keyCode&&(this.closeAccountWindow(),this.closeShareWindow(),this.closeRoomWindow(),this.closeSettingsWindow()),65==b.keyCode&&this.advancedOptions.toggleVisibility())}.bind(this));setInterval(this.displayTip.bind(this),3E5);setTimeout(this.autoMoveScreen.bind(this),0)}
DrawTogether.prototype.KICKBAN_MIN_REP=50;DrawTogether.prototype.MODERATORWELCOMEWINDOWOPENAFTER=12096E5;DrawTogether.prototype.BIG_BRUSH_MIN_REP=5;DrawTogether.prototype.ZOOMED_OUT_MIN_REP=2;DrawTogether.prototype.CLIENT_VERSION=3;DrawTogether.prototype.SOCKET_TIMEOUT=1E4;DrawTogether.prototype.TIME_BETWEEN_TIMEOUT_WARNINGS=5E3;
...
DrawTogether.prototype.updateIndividualFavoriteDom=function(b,a,c,d,e){null!==b&&(e.dataset.x=b);null!==a&&(e.dataset.y=a);null!==c&&(e.dataset.name=c);null!==d&&(e.dataset.owner=d);d=e.getElementsByClassName("fav-coor-button")[0];var f=e.getElementsByClassName("fav-rename-input")[0];""===(c||e.dataset.name)?(f.value="",d.innerHTML=(b||e.dataset.x)+","+(a||e.dataset.y),d.title=""):(f.value=c||e.dataset.name,d.innerHTML=c||e.dataset.name,d.title=(b||e.dataset.x)+","+(a||e.dataset.y))};
DrawTogether.prototype.insertOneFavorite=function(b,a,c,d){var e=this.favoritesContainer.appendChild(document.createElement("div"));e.className="favorite-container";e.dataset.x=b;e.dataset.y=a;e.dataset.name=c;e.dataset.owner=d;d=e.appendChild(document.createElement("div"));d.className="fav-button fav-minus-button";d.innerHTML="-";d.addEventListener("click",function(b){if(b.srcElement.classList.contains("fav-button-confirmation")){var a=b.srcElement.parentElement.getElementsByClassName("fav-coor-button")[0];
a.dataset.tempConf=a.innerHTML;b.srcElement.innerHTML="-";b.srcElement.classList.remove("fav-button-confirmation");a=b.srcElement.parentElement;this.removeFavorite(a.dataset.x,a.dataset.y,a.dataset.name,a)}else a=b.srcElement.parentElement.getElementsByClassName("fav-coor-button")[0],a.dataset.tempConf=a.innerHTML,a.innerHTML="Delete?",b.srcElement.classList.add("fav-button-confirmation"),b.srcElement.innerHTML="?",setTimeout(function(){var a=this.parentElement.getElementsByClassName("fav-coor-button")[0];
a.innerHTML=a.dataset.tempConf;b.srcElement.innerHTML="-";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),4E3)}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-plus-button";d.innerHTML="+";d.addEventListener("click",function(b){var a=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=b.srcElement.parentElement.dataset.x,e=b.srcElement.parentElement.dataset.y,d=b.srcElement.parentElement.dataset.name,
m=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);if(b.srcElement.classList.contains("fav-button-confirmation")){var q=b.srcElement.parentElement.getElementsByClassName("fav-coor-button")[0];q.innerHTML=q.dataset.tempConf;q.dataset.tempConf="5215random_string_tempconf5152";b.srcElement.innerHTML="+";b.srcElement.classList.remove("fav-button-confirmation");this.setCoordFavorite(m,a,c,e,d,b.srcElement.parentElement)}else q=b.srcElement.parentElement.getElementsByClassName("fav-coor-button")[0],
q.dataset.tempConf=q.innerHTML,q.innerHTML=m+","+a+"?",b.srcElement.classList.add("fav-button-confirmation"),b.srcElement.innerHTML="?",setTimeout(function(){var a=this.parentElement.getElementsByClassName("fav-coor-button")[0];"5215random_string_tempconf5152"!==a.dataset.tempConf&&(a.innerHTML=a.dataset.tempConf);b.srcElement.innerHTML="+";b.srcElement.classList.remove("fav-button-confirmation")}.bind(b.srcElement),2E3)}.bind(this));d.addEventListener("mouseover",function(b){var a=[this.paint.public.canvas.width/
this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom],c=parseInt(this.paint.public.leftTopX+a[0]/2),a=parseInt(this.paint.public.leftTopY+a[1]/2);b.srcElement.title="Change to "+c+","+a+" ?"}.bind(this));d=e.appendChild(document.createElement("div"));d.className="fav-button fav-pencil-button";d.innerHTML="\u270e";d=d.appendChild(document.createElement("div"));d.className="fav-rename-container";d=d.appendChild(document.createElement("input"));d.className="fav-rename-input";
d.type="text";d.placeholder="Rename";d.addEventListener("input",function(b){void 0!==this._favoriteRenameDelayTimeout&&clearTimeout(this._favoriteRenameDelayTimeout);this._favoriteRenameDelayTimeout=setTimeout(function(){var a=b.srcElement.parentElement.parentElement.parentElement;this.renameFavorite(a.dataset.x,a.dataset.y,b.srcElement.value,a)}.bind(this),1500)}.bind(this));e=e.appendChild(document.createElement("div"));e.className="fav-button fav-coor-button";e.addEventListener("click",function(b){var a=
parseInt(b.srcElement.parentElement.dataset.x);b=parseInt(b.srcElement.parentElement.dataset.y);this.moveScreenToPosition([a,b],0)}.bind(this));0<c.length?(e.innerHTML=c,e.title=b+","+a,d.value=c):e.innerHTML=b+","+a};
DrawTogether.prototype.updateFavoriteDom=function(){for(;this.favoritesContainer.firstChild;)this.favoritesContainer.removeChild(this.favoritesContainer.firstChild);var b=this.favoritesContainer.appendChild(document.createElement("div"));b.className="fav-button fav-add-new-fav";b.innerHTML="^";b.title="Add new Favorite.";b.addEventListener("click",function(b){var c=[this.paint.public.canvas.width/this.paint.public.zoom,this.paint.public.canvas.height/this.paint.public.zoom];b=parseInt(this.paint.public.leftTopX+
...
DrawTogether.prototype.createFavorite=function(b,a,c){null===this.account.mail?this.chat.addMessage("You must login to save or create favorites!"):!this.memberlevel&&5<=this.favList.length?this.chat.addMessage("Creating favorites past 5 is limited to Premium Users."):this.account.createFavorite(b,a,c,function(d,e){d?this.chat.addMessage("Favorite","Error: "+d):e.success&&(this.chat.addMessage("Favorite added",e.success),this.insertOneFavorite(b,a,c,e.owner),this.getFavorites())}.bind(this))};
...
DrawTogether.prototype.resetProtectedRegions=function(){this.network.socket.emit("resetprotectedregions",function(b,a){b?this.chat.addMessage("Regions","Reset Error: "+b):this.chat.addMessage("Regions","Reset your regions")}.bind(this))};DrawTogether.prototype.exportImage=function(b,a){var c=document.createElement("img");c.src=this.paint.exportImage(b,a);c.alt="Exported image";var d=this.gui.createWindow({title:"Exported image (right click to save)"});d.classList.add("exportwindow");d.appendChild(c)};
...
p.src="https://code.jquery.com/jquery-1.8.3.min.js";p.onload=p.onreadystatechange=function(){if(!(g||(e=this.readyState)&&"loaded"!==e&&"complete"!==e))return a((d=window.jQuery).noConflict(1)),d(p).remove()};return(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(p)})("1.7",function(b){return a(b,c)})}).call(this)};
...
typeof c._introCompleteCallback&&c._introCompleteCallback.call(c),void 0!=c._introExitCallback&&c._introExitCallback.call(c),g.call(c,b)):e.call(c);a.preventDefault?a.preventDefault():a.returnValue=!1}},c._onResize=function(b){q.call(c,document.querySelector(".introjs-helperLayer"));q.call(c,document.querySelector(".introjs-tooltipReferenceLayer"))},window.addEventListener?(this._options.keyboardNavigation&&window.addEventListener("keydown",c._onKeyDown,!0),window.addEventListener("resize",c._onResize,
...
"floating"!=h){f=h;g=this._options.positionPrecedence.slice();h=A();var p=s(a).height+10,q=s(a).width+20,n=s(b),u="floating";n.left+q>h.width||0>n.left+n.width/2-q?(m(g,"bottom"),m(g,"top")):(n.height+n.top+p>h.height&&m(g,"bottom"),0>n.top-p&&m(g,"top"));n.width+n.left+q>h.width&&m(g,"right");0>n.left-q&&m(g,"left");0<g.length&&(u=g[0]);f&&"auto"!=f&&-1<g.indexOf(f)&&(u=f);h=u}f=s(b);b=s(a);g=A();switch(h){case "top":c.className="introjs-arrow bottom";k(f,d?0:15,b,g,a);a.style.bottom=f.height+20+
...
b-2;"undefined"!==typeof this._introItems&&e.call(this);return this},nextStep:function(){e.call(this);return this},previousStep:function(){f.call(this);return this},exit:function(){g.call(this,this._targetElement);return this},refresh:function(){q.call(this,document.querySelector(".introjs-helperLayer"));q.call(this,document.querySelector(".introjs-tooltipReferenceLayer"));return this},onbeforechange:function(b){if("function"===typeof b)this._introBeforeChangeCallback=b;else throw Error("Provided callback for onbeforechange was not a function");
...
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"==typeof exports&&"object"==typeof module?module.exports=b:b(jQuery)})(function(b,a){function c(a,c,e,d){for(var f=[],g=0;g<a.length;g++){var h=a[g];if(h){var k=tinycolor(h),l=0.5>k.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",l=l+(tinycolor.equals(c,h)?" sp-thumb-active":""),h=k.toString(d.preferredFormat||"rgb"),q=p?"background-color:"+k.toRgbString():"filter:"+k.toFilter();f.push('<span title="'+
h+'" data-color="'+k.toRgbString()+'" class="'+l+'"><span class="sp-thumb-inner" style="'+q+';" /></span>')}else f.push(b("<div />").append(b('<span data-color="" style="background-color:transparent;" class="sp-clear-display"></span>').attr("title",d.noColorSelectedText)).html())}return"<div class='sp-cf "+e+"'>"+f.join("")+"</div>"}function d(a,c){var e=b.extend({},q,a);e.callbacks={move:k(e.move,c),change:k(e.change,c),show:k(e.show,c),hide:k(e.hide,c),beforeShow:k(e.beforeShow,c)};return e}function e(e,
...
!Za;(function(){function a(c){c.data&&c.data.ignore?(Y(b(c.target).closest(".sp-thumb-el").data("color")),la()):(Y(b(c.target).closest(".sp-thumb-el").data("color")),la(),P(!0),t.hideAfterPaletteSelect&&ea());return!1}n&&z.find("*:not(input)").attr("unselectable","on");k();Na&&J.after(ma).hide();fa||Ma.hide();if(U)J.after(z).hide();else{var c="parent"===t.appendTo?J.parent():b(t.appendTo);1!==c.length&&(c=b("body"));c.append(z)}q();va.bind("click.spectrum touchstart.spectrum",function(a){La||ja();
...
1);la()},I,x);l(Ba,function(b,a,c){c.shiftKey?ba||(c=T-sa*T,ba=Math.abs(b-ra*L)>Math.abs(a-c)?"x":"y"):ba=null;c=!ba||"y"===ba;ba&&"x"!==ba||(ra=parseFloat(b/L));c&&(sa=parseFloat((T-a)/T));da=!1;t.showAlpha||(W=1);la()},I,x);wa?(Y(wa),X(),ta=Ja||tinycolor(wa).format,y(wa)):X();U&&ka();c=n?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Oa.delegate(".sp-thumb-el",c,a);Pa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},a)})();var Ga={show:ka,hide:ea,toggle:ja,reflow:Q,option:function(c,
...
!1}function g(b){if(p){if(n&&9>k.documentMode&&!b.button)return h();var e=b.originalEvent&&b.originalEvent.touches,d=e?e[0].pageY:b.pageY,e=Math.max(0,Math.min((e?e[0].pageX:b.pageX)-l.left,m)),d=Math.max(0,Math.min(d-l.top,q));u&&f(b);c.apply(a,[e,d,b])}}function h(){p&&(b(k).unbind(r),b(k.body).removeClass("sp-dragging"),d.apply(a,arguments));p=!1}c=c||function(){};e=e||function(){};d=d||function(){};var k=document,p=!1,l={},q=0,m=0,u="ontouchstart"in window,r={};r.selectstart=f;r.dragstart=f;r["touchmove mousemove"]=
g;r["touchend mouseup"]=h;b(a).bind("touchstart mousedown",function(c){(c.which?3==c.which:2==c.button)||p||!1===e.apply(a,arguments)||(p=!0,q=b(a).height(),m=b(a).width(),l=b(a).offset(),b(k).bind(r),b(k.body).addClass("sp-dragging"),u||g(c),f(c))})}function m(b,a,c){var e;return function(){var d=this,f=arguments,g=function(){e=null;b.apply(d,f)};c&&clearTimeout(e);if(c||!e)e=setTimeout(g,a)}}var q={beforeShow:g,move:g,change:g,show:g,hide:g,color:!1,flat:!1,showInput:!1,allowEmpty:!1,showButtons:!0,
...
c.s=N(1,C(0,c.s));return v(c)}function h(b){return v(b).desaturate(100)}function k(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l+=a/100;c.l=N(1,C(0,c.l));return v(c)}function p(b,a){a=0===a?0:a||10;var c=v(b).toRgb();c.r=C(0,N(255,c.r-w(255*-(a/100))));c.g=C(0,N(255,c.g-w(255*-(a/100))));c.b=C(0,N(255,c.b-w(255*-(a/100))));return v(c)}function l(b,a){a=0===a?0:a||10;var c=v(b).toHsl();c.l-=a/100;c.l=N(1,C(0,c.l));return v(c)}function q(b,a){var c=v(b).toHsl(),e=(w(c.h)+a)%360;c.h=0>e?360+e:e;return v(c)}
function m(b){b=v(b).toHsl();b.h=(b.h+180)%360;return v(b)}function n(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+120)%360,s:a.s,l:a.l}),v({h:(c+240)%360,s:a.s,l:a.l})]}function u(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+90)%360,s:a.s,l:a.l}),v({h:(c+180)%360,s:a.s,l:a.l}),v({h:(c+270)%360,s:a.s,l:a.l})]}function r(b){var a=v(b).toHsl(),c=a.h;return[v(b),v({h:(c+72)%360,s:a.s,l:a.l}),v({h:(c+216)%360,s:a.s,l:a.l})]}function K(b,a,c){a=a||6;c=c||30;var e=v(b).toHsl();c=360/c;b=[v(b)];for(e.h=
...
(g=M.rgba.exec(d))?{r:g[1],g:g[2],b:g[3],a:g[4]}:(g=M.hsl.exec(d))?{h:g[1],s:g[2],l:g[3]}:(g=M.hsla.exec(d))?{h:g[1],s:g[2],l:g[3],a:g[4]}:(g=M.hsv.exec(d))?{h:g[1],s:g[2],v:g[3]}:(g=M.hsva.exec(d))?{h:g[1],s:g[2],v:g[3],a:g[4]}:(g=M.hex8.exec(d))?{a:parseInt(g[1],16)/255,r:parseInt(g[2],16),g:parseInt(g[3],16),b:parseInt(g[4],16),format:p?"name":"hex8"}:(g=M.hex6.exec(d))?{r:parseInt(g[1],16),g:parseInt(g[2],16),b:parseInt(g[3],16),format:p?"name":"hex"}:(g=M.hex3.exec(d))?{r:parseInt(g[1]+""+g[1],
16),g:parseInt(g[2]+""+g[2],16),b:parseInt(g[3]+""+g[3],16),format:p?"name":"hex"}:!1}if("object"==typeof d){if(d.hasOwnProperty("r")&&d.hasOwnProperty("g")&&d.hasOwnProperty("b"))h={r:255*F(d.r,255),g:255*F(d.g,255),b:255*F(d.b,255)},e=!0,f="%"===String(d.r).substr(-1)?"prgb":"rgb";else if(d.hasOwnProperty("h")&&d.hasOwnProperty("s")&&d.hasOwnProperty("v")){d.s=Q(d.s);d.v=Q(d.v);f=d.h;p=d.s;h=d.v;f=6*F(f,360);p=F(p,100);h=F(h,100);e=Z.floor(f);var l=f-e;f=h*(1-p);g=h*(1-l*p);p=h*(1-(1-l)*p);e%=6;
h={r:255*[h,g,f,f,p,h][e],g:255*[p,h,h,g,f,f][e],b:255*[f,f,p,h,h,g][e]};e=!0;f="hsv"}else d.hasOwnProperty("h")&&(d.hasOwnProperty("s")&&d.hasOwnProperty("l"))&&(d.s=Q(d.s),d.l=Q(d.l),h=a(d.h,d.s,d.l),e=!0,f="hsl");d.hasOwnProperty("a")&&(k=d.a)}k=X(k);d=d.format||f;f=N(255,C(h.r,0));g=N(255,C(h.g,0));h=N(255,C(h.b,0));this._originalInput=b;this._r=f;this._g=g;this._b=h;this._a=k;this._roundA=w(100*this._a)/100;this._format=c.format||d;this._gradientType=c.gradientType;1>this._r&&(this._r=w(this._r));
...
arguments)},complement:function(){return this._applyCombination(m,arguments)},monochromatic:function(){return this._applyCombination(A,arguments)},splitcomplement:function(){return this._applyCombination(r,arguments)},triad:function(){return this._applyCombination(n,arguments)},tetrad:function(){return this._applyCombination(u,arguments)}};v.fromRatio=function(b,a){if("object"==typeof b){var c={},e;for(e in b)b.hasOwnProperty(e)&&(c[e]="a"===e?b[e]:Q(b[e]));b=c}return v(b,a)};v.equals=function(b,
...
q=this;k.addEventListener(c,function(){l.innerHTML="<b>"+b+":</b> "+k.value;g&&g(parseFloat(k.value));m&&m();q._callCallbacks(b,{value:parseFloat(k.value)})})},_isIE:function(){return-1!=navigator.userAgent.indexOf("rv:11")||-1!=navigator.userAgent.indexOf("MSIE")?!0:!1},getRangeValue:function(b){return this._controls[b].control.value},setRangeValue:function(b,c,d){var e=this._controls[b];e.control.value=c;e.label.innerHTML="<b>"+b+":</b> "+e.control.value;d&&(e.callback&&e.callback(parseFloat(e.control.value)),
...
b),f.startDragY=h.page("Y",b),f.dragWatchers={current:0,last:0,hold:0,state:""},f.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(b){if(f.isDragging&&e.touchToDrag){var c=h.page("X",b),d=h.page("Y",b),g=f.translation,n=k.translate.get.matrix(4),p=c-f.startDragX,u=0<n,A=p;if(!f.intentChecked||f.hasIntent){e.addBodyClasses&&(0<n?(h.klass.add(a.body,"snapjs-left"),h.klass.remove(a.body,
"snapjs-right")):0>n&&(h.klass.add(a.body,"snapjs-right"),h.klass.remove(a.body,"snapjs-left")));if(!1===f.hasIntent||null===f.hasIntent){var d=h.angleOfDrag(c,d),K=0<=d&&d<=e.slideIntent||360>=d&&d>360-e.slideIntent;f.hasIntent=180<=d&&d<=180+e.slideIntent||180>=d&&d>=180-e.slideIntent||K?!0:!1;f.intentChecked=!0}e.minDragDistance>=Math.abs(c-f.startDragX)||!1===f.hasIntent||(h.events.prevent(b),h.dispatchEvent("drag"),f.dragWatchers.current=c,f.dragWatchers.last>c?("left"!==f.dragWatchers.state&&
(f.dragWatchers.state="left",f.dragWatchers.hold=c),f.dragWatchers.last=c):f.dragWatchers.last<c&&("right"!==f.dragWatchers.state&&(f.dragWatchers.state="right",f.dragWatchers.hold=c),f.dragWatchers.last=c),u?(e.maxPosition<n&&(b=(n-e.maxPosition)*e.resistance,A=p-b),f.simpleStates={opening:"left",towards:f.dragWatchers.state,hyperExtending:e.maxPosition<n,halfway:n>e.maxPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>e.flickThreshold,translation:{absolute:n,relative:p,sinceDirectionChange:f.dragWatchers.current-
f.dragWatchers.hold,percentage:100*(n/e.maxPosition)}}):(e.minPosition>n&&(b=(n-e.minPosition)*e.resistance,A=p-b),f.simpleStates={opening:"right",towards:f.dragWatchers.state,hyperExtending:e.minPosition>n,halfway:n<e.minPosition/2,flick:Math.abs(f.dragWatchers.current-f.dragWatchers.hold)>e.flickThreshold,translation:{absolute:n,relative:p,sinceDirectionChange:f.dragWatchers.current-f.dragWatchers.hold,percentage:100*(n/e.minPosition)}}),k.translate.x(A+g))}}},endDrag:function(b){if(f.isDragging){h.dispatchEvent("end");
...
a),n.send([{type:"ping",data:"probe"}]),n.once("packet",function(c){r||("pong"==c.type&&"probe"==c.data?(k('probe transport "%s" pong',a),E.upgrading=!0,E.emit("upgrading",n),d.priorWebsocketSuccess="websocket"==n.name,k('pausing current transport "%s"',E.transport.name),E.transport.pause(function(){r||("closed"==E.readyState||"closing"==E.readyState)||(k("changing transport and sending upgrade packet"),q(),E.setTransport(n),n.send([{type:"upgrade"}]),E.emit("upgrade",n),n=null,E.upgrading=!1,E.flush())})):
(k('probe transport "%s" failed',a),c=Error("probe error"),c.transport=n.name,E.emit("upgradeError",c)))}))}function e(){r||(r=!0,q(),n.close(),n=null)}function g(c){var d=Error("probe error: "+c);d.transport=n.name;e();k('probe transport "%s" failed because of error: %s',a,c);E.emit("upgradeError",d)}function h(){g("transport closed")}function m(){g("socket closed")}function l(a){n&&a.name!=n.name&&(k('"%s" works - aborting "%s"',a.name,n.name),e())}function q(){n.removeListener("open",c);n.removeListener("error",
g);n.removeListener("close",h);E.removeListener("close",m);E.removeListener("upgrading",l)}k('probing transport "%s"',a);var n=this.createTransport(a,{probe:1}),r=!1,E=this;d.priorWebsocketSuccess=!1;n.once("open",c);n.once("error",g);n.once("close",h);this.once("close",m);this.once("upgrading",l);n.open()};d.prototype.onOpen=function(){k("socket open");this.readyState="open";d.priorWebsocketSuccess="websocket"==this.transport.name;this.emit("open");this.flush();if("open"==this.readyState&&this.upgrade&&
...
c)};var e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(c,e);this.script=c;"undefined"!=typeof navigator&&/gecko/i.test(navigator.userAgent)&&setTimeout(function(){var a=document.createElement("iframe");document.body.appendChild(a);document.body.removeChild(a)},100)};g.prototype.doWrite=function(a,c){function e(){d();c()}function d(){if(f.iframe)try{f.form.removeChild(f.iframe)}catch(a){f.onError("jsonp polling iframe removal error",a)}try{q=document.createElement('<iframe src="javascript:0" name="'+
f.iframeId+'">')}catch(c){q=document.createElement("iframe"),q.name=f.iframeId,q.src="javascript:0"}q.id=f.iframeId;f.form.appendChild(q);f.iframe=q}var f=this;if(!this.form){var g=document.createElement("form"),h=document.createElement("textarea"),k=this.iframeId="eio_iframe_"+this.index,q;g.className="socketio";g.style.position="absolute";g.style.top="-1000px";g.style.left="-1000px";g.target=k;g.method="POST";g.setAttribute("accept-charset","utf-8");h.name="d";g.appendChild(h);document.body.appendChild(g);
...
m=a("./polling"),q=a("component-emitter"),r=a("component-inherit"),n=a("debug")("engine.io-client:polling-xhr");c.exports=g;c.exports.Request=h;r(g,m);g.prototype.supportsBinary=!0;g.prototype.request=function(a){a=a||{};a.uri=this.uri();a.xd=this.xd;a.xs=this.xs;a.agent=this.agent||!1;a.supportsBinary=this.supportsBinary;a.enablesXDR=this.enablesXDR;return new h(a)};g.prototype.doWrite=function(a,c){var e=this.request({method:"POST",data:a,isBinary:"string"!==typeof a&&void 0!==a}),d=this;e.on("success",
c);e.on("error",function(a){d.onError("xhr post error",a)});this.sendXhr=e};g.prototype.doPoll=function(){n("xhr poll");var a=this.request(),c=this;a.on("data",function(a){c.onData(a)});a.on("error",function(a){c.onError("xhr poll error",a)});this.pollXhr=a};q(h.prototype);h.prototype.create=function(){var a=this.xhr=new l({agent:this.agent,xdomain:this.xd,xscheme:this.xs,enablesXDR:this.enablesXDR}),c=this;try{n("xhr open %s: %s",this.method,this.uri);a.open(this.method,this.uri,this.async);this.supportsBinary&&
(a.responseType="arraybuffer");if("POST"==this.method)try{this.isBinary?a.setRequestHeader("Content-type","application/octet-stream"):a.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch(d){}"withCredentials"in a&&(a.withCredentials=!0);this.hasXDR()?(a.onload=function(){c.onLoad()},a.onerror=function(){c.onError(a.responseText)}):a.onreadystatechange=function(){if(4==a.readyState)if(200==a.status||1223==a.status)c.onLoad();else setTimeout(function(){c.onError(a.status)},0)};n("xhr data %s",
...
c,!0,e)};return f.readAsArrayBuffer(a.data)}function g(a,c,e){var d=Array(a.length);e=m(a.length,e);for(var f=function(a,e,f){c(e,function(c,e){d[a]=e;f(c,d)})},g=0;g<a.length;g++)f(g,a[g],e)}var h=a("./keys"),k=a("arraybuffer.slice"),l=a("base64-arraybuffer"),m=a("after"),q=a("utf8"),r=navigator.userAgent.match(/Android/i);d.protocol=3;var n=d.packets={open:0,close:1,ping:2,pong:3,message:4,upgrade:5,noop:6},p=h(n),u={type:"error",data:"parser error"},A=a("blob");d.encodePacket=function(a,g,h,k){"function"==
typeof g&&(k=g,g=!1);"function"==typeof h&&(k=h,h=null);var l=void 0===a.data?void 0:a.data.buffer||a.data;if(c.ArrayBuffer&&l instanceof ArrayBuffer){if(g){h=a.data;g=new Uint8Array(h);h=new Uint8Array(1+h.byteLength);h[0]=n[a.type];for(a=0;a<g.length;a++)h[a+1]=g[a];a=k(h.buffer)}else a=d.encodeBase64Packet(a,k);return a}if(A&&l instanceof c.Blob)return g?r?a=f(a,g,k):(g=new Uint8Array(1),g[0]=n[a.type],a=new A([g.buffer,a.data]),a=k(a)):a=d.encodeBase64Packet(a,k),a;g=n[a.type];void 0!==a.data&&
(g+=h?q.encode(String(a.data)):String(a.data));return k(""+g)};d.encodeBase64Packet=function(a,f){var g="b"+d.packets[a.type];if(A&&a.data instanceof A){var h=new FileReader;h.onload=function(){var a=h.result.split(",")[1];f(g+a)};return h.readAsDataURL(a.data)}var k;try{k=String.fromCharCode.apply(null,new Uint8Array(a.data))}catch(l){k=new Uint8Array(a.data);for(var n=Array(k.length),m=0;m<k.length;m++)n[m]=k[m];k=String.fromCharCode.apply(null,n)}g+=c.btoa(k);return f(g)};d.decodePacket=function(a,
c,e){if("string"==typeof a||void 0===a){if("b"==a.charAt(0))return d.decodeBase64Packet(a.substr(1),c);if(e)try{a=q.decode(a)}catch(f){return u}e=a.charAt(0);return Number(e)==e&&p[e]?1<a.length?{type:p[e],data:a.substring(1)}:{type:p[e]}:u}e=(new Uint8Array(a))[0];a=k(a,1);A&&"blob"===c&&(a=new A([a]));return{type:p[e],data:a}};d.decodeBase64Packet=function(a,d){var f=p[a.charAt(0)];if(!c.ArrayBuffer)return{type:f,data:{base64:!0,data:a.substr(1)}};var g=l.decode(a.substr(1));"blob"===d&&A&&(g=new A([g]));
...
l=0===h[0],n="",m=1;255!=h[m];m++){if(310<n.length){g=!0;break}n+=h[m]}if(g)return e(u,0,1);a=k(a,2+n.length);n=parseInt(n);h=k(a,0,n);if(l)try{h=String.fromCharCode.apply(null,new Uint8Array(h))}catch(q){for(l=new Uint8Array(h),h="",m=0;m<l.length;m++)h+=String.fromCharCode(l[m])}f.push(h);a=k(a,n)}var p=f.length;f.forEach(function(a,f){e(d.decodePacket(a,c,!0),f,p)})}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./keys":22,after:23,"arraybuffer.slice":24,
...
return k};d.decode=function(c){var d=0.75*c.length,h=c.length,k=0,l,m,q,r;"="===c[c.length-1]&&(d--,"="===c[c.length-2]&&d--);for(var n=new ArrayBuffer(d),p=new Uint8Array(n),d=0;d<h;d+=4)l=a.indexOf(c[d]),m=a.indexOf(c[d+1]),q=a.indexOf(c[d+2]),r=a.indexOf(c[d+3]),p[k++]=l<<2|m>>4,p[k++]=(m&15)<<4|q>>2,p[k++]=(q&3)<<6|r&63;return n}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")},{}],26:[function(a,c,d){(function(a){function d(a,c){c=c||{};for(var e=new g,f=0;f<a.length;f++)e.append(a[f]);
...
56320==(g&64512)?c.push(((f&1023)<<10)+(g&1023)+65536):(c.push(f),e--)):c.push(f);return c}function h(){if(u>=p)throw Error("Invalid byte index");var a=n[u]&255;u++;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function k(){var a,c,e,d;if(u>p)throw Error("Invalid byte index");if(u==p)return!1;a=n[u]&255;u++;if(0==(a&128))return a;if(192==(a&224)){c=h();a=(a&31)<<6|c;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){c=h();e=h();a=(a&15)<<12|c<<6|
e;if(2048<=a)return a;throw Error("Invalid continuation byte");}if(240==(a&248)&&(c=h(),e=h(),d=h(),a=(a&15)<<18|c<<12|e<<6|d,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var l="object"==typeof d&&d,m="object"==typeof c&&c&&c.exports==l&&c,q="object"==typeof a&&a;if(q.global===q||q.window===q)f=q;var r=String.fromCharCode,n,p,u,q={version:"2.0.0",encode:function(a){a=g(a);for(var c=a.length,e=-1,d,f="";++e<c;){d=a[e];if(0==(d&4294967168))d=r(d);else{var h="";0==(d&4294965248)?
h=r(d>>6&31|192):0==(d&4294901760)?(h=r(d>>12&15|224),h+=r(d>>6&63|128)):0==(d&4292870144)&&(h=r(d>>18&7|240),h+=r(d>>12&63|128),h+=r(d>>6&63|128));d=h+=r(d&63|128)}f+=d}return f},decode:function(a){n=g(a);p=n.length;u=0;a=[];for(var c;!1!==(c=k());)a.push(c);c=a.length;for(var e=-1,d,f="";++e<c;)d=a[e],65535<d&&(d-=65536,f+=r(d>>>10&1023|55296),d=56320|d&1023),f+=r(d);return f}};if(l&&!l.nodeType)if(m)m.exports=q;else{f={}.hasOwnProperty;for(var A in q)f.call(q,A)&&(l[A]=q[A])}else f.utf8=q})(this)}).call(this,
...
f="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");c.exports=function(a){var c=a,d=a.indexOf("["),l=a.indexOf("]");-1!=d&&-1!=l&&(a=a.substring(0,d)+a.substring(d,l).replace(/:/g,";")+a.substring(l,a.length));a=e.exec(a||"");for(var m={},q=14;q--;)m[f[q]]=a[q]||"";-1!=d&&-1!=l&&(m.source=c,m.host=m.host.substring(1,m.host.length-1).replace(/;/g,":"),m.authority=m.authority.replace("[","").replace("]","").replace(/;/g,":"),m.ipv6uri=
...
a._placeholder)return c[a.num];if(f(a))for(var e=0;e<a.length;e++)a[e]=d(a[e]);else if(a&&"object"==typeof a)for(e in a)a[e]=d(a[e]);return a}a.data=d(a.data);a.attachments=void 0;return a};d.removeBlobs=function(a,d){function l(a,h,p){if(!a)return a;if(c.Blob&&a instanceof Blob||c.File&&a instanceof File){m++;var u=new FileReader;u.onload=function(){p?p[h]=this.result:q=this.result;--m||d(q)};u.readAsArrayBuffer(a)}else if(f(a))for(u=0;u<a.length;u++)l(a[u],u,a);else if(a&&"object"==typeof a&&!g(a))for(u in a)l(a[u],
u,a)}var m=0,q=a;l(q);m||d(q)}}).call(this,"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./is-buffer":41,isarray:42}],40:[function(a,c,d){function e(){}function f(a){var c,e=!1;c=""+a.type;if(d.BINARY_EVENT==a.type||d.BINARY_ACK==a.type)c+=a.attachments,c+="-";a.nsp&&"/"!=a.nsp&&(e=!0,c+=a.nsp);null!=a.id&&(e&&(c+=",",e=!1),c+=a.id);null!=a.data&&(e&&(c+=","),c+=m.stringify(a.data));l("encoded %j as %s",a,c);return c}function g(a,c){q.removeBlobs(a,function(a){var d=q.deconstructPacket(a);
a=f(d.packet);d=d.buffers;d.unshift(a);c(d)})}function h(){this.reconstructor=null}function k(a){this.reconPack=a;this.buffers=[]}var l=a("debug")("socket.io-parser"),m=a("json3");a("isarray");c=a("component-emitter");var q=a("./binary"),r=a("./is-buffer");d.protocol=4;d.types="CONNECT DISCONNECT EVENT BINARY_EVENT ACK BINARY_ACK ERROR".split(" ");d.CONNECT=0;d.DISCONNECT=1;d.EVENT=2;d.ACK=3;d.ERROR=4;d.BINARY_EVENT=5;d.BINARY_ACK=6;d.Encoder=e;d.Decoder=h;e.prototype.encode=function(a,c){l("encoding packet %j",
...
a.base64)if(this.reconstructor){if(a=this.reconstructor.takeBinaryData(a))this.reconstructor=null,this.emit("decoded",a)}else throw Error("got binary data when not reconstructing a packet");else throw Error("Unknown type: "+a);};h.prototype.destroy=function(){this.reconstructor&&this.reconstructor.finishedReconstruction()};k.prototype.takeBinaryData=function(a){this.buffers.push(a);return this.buffers.length==this.reconPack.attachments?(a=q.reconstructPacket(this.reconPack,this.buffers),this.finishedReconstruction(),
...
var d;if("bug-string-char-index"==a)d="a"!="a"[0];else if("json"==a)d=c("json-stringify")&&c("json-parse");else{var e;if("json-stringify"==a){d=q.stringify;var h="function"==typeof d&&r;if(h){(e=function(){return 1}).toJSON=e;try{h="0"===d(0)&&"0"===d(new Number)&&'""'==d(new String)&&d(g)===l&&d(l)===l&&d()===l&&"1"===d(e)&&"[1]"==d([e])&&"[null]"==d([l])&&"null"==d(null)&&"[null,null,null]"==d([l,g,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==d({a:[e,!0,!1,null,"\x00\b\n\f\r\t"]})&&
"1"===d(null,e)&&"[\n 1,\n 2\n]"==d([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==d(new Date(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==d(new Date(864E13))&&'"-000001-01-01T00:00:00.000Z"'==d(new Date(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==d(new Date(-1))}catch(k){h=!1}}d=h}if("json-parse"==a){d=q.parse;if("function"==typeof d)try{if(0===d("0")&&!d(!1)){e=d('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var m=5==e.a.length&&1===e.a[0];if(m){try{m=!d('"\t"')}catch(n){}if(m)try{m=1!==
d("01")}catch(p){}if(m)try{m=1!==d("1.")}catch(u){}}}}catch(t){m=!1}d=m}}return c[a]=!!d}var g={}.toString,h,k,l,m="object"==typeof JSON&&JSON,q="object"==typeof d&&d&&!d.nodeType&&d;q&&m?(q.stringify=m.stringify,q.parse=m.parse):q=a.JSON=m||{};var r=new Date(-0xc782b5b800cec);try{r=-109252==r.getUTCFullYear()&&0===r.getUTCMonth()&&1===r.getUTCDate()&&10==r.getUTCHours()&&37==r.getUTCMinutes()&&6==r.getUTCSeconds()&&708==r.getUTCMilliseconds()}catch(n){}if(!c("json")){var p=c("bug-string-char-index");
...
k=function(a,c){var d="[object Function]"==g.call(a),e,k;if(k=!d)if(k="function"!=typeof a.constructor)k=typeof a.hasOwnProperty,k="object"==k?!!a.hasOwnProperty:!B[k];k=k?a.hasOwnProperty:h;for(e in a)d&&"prototype"==e||!k.call(a,e)||c(e);for(d=f.length;e=f[--d];k.call(a,e)&&c(e));});return k(a,c)};if(!c("json-stringify")){var G={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},D=function(a,c){return("000000"+(c||0)).slice(-a)},H=function(a){var c='"',d=0,e=a.length,f=10<e&&p,g;for(f&&
(g=a.split(""));d<e;d++){var h=a.charCodeAt(d);switch(h){case 8:case 9:case 10:case 12:case 13:case 34:case 92:c+=G[h];break;default:if(32>h){c+="\\u00"+D(2,h.toString(16));break}c+=f?g[d]:p?a.charAt(d):a[d]}}return c+'"'},y=function(a,c,d,e,f,m,q){var n,p,r,s,x,w,A,C,B;try{n=c[a]}catch(v){}if("object"==typeof n&&n)if(p=g.call(n),"[object Date]"!=p||h.call(n,"toJSON"))"function"==typeof n.toJSON&&("[object Number]"!=p&&"[object String]"!=p&&"[object Array]"!=p||h.call(n,"toJSON"))&&(n=n.toJSON(a));
...
g.call(e))for(f=e.length;f--;)ka(e,f,d);else k(e,function(a){ka(e,a,d)});return d.call(a,c,e)};q.parse=function(a,c){var d,e;s=0;I=""+a;d=ja(R());"$"!=R()&&x();s=I=null;return c&&"[object Function]"==g.call(c)?oa((e={},e[""]=d,e),"",c):d}}}})(this)},{}],44:[function(a,c,d){c.exports=function(a,c){for(var d=[],h=(c=c||0)||0;h<a.length;h++)d[h-c]=a[h];return d}},{}]},{},[1])(1)});
