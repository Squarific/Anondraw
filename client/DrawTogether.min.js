...
DrawTogether.prototype.createFavorite=function(b,a,c){this.chat.addMessage("Hey.");this.network.socket.emit("createfavorite",b,a,c,function(b,a){b?this.chat.addMessage("Favorite","Error: "+b):a.success&&this.chat.addMessage("Favorite",a.success)}.bind(this))};
...
b.className="favorite-container";favoritePlusButton=b.appendChild(document.createElement("div"));favoritePlusButton.className="fav-button fav-plus-button";favoritePlusButton.innerHTML="+";favoritePencilButton=b.appendChild(document.createElement("div"));favoritePencilButton.className="fav-button fav-pencil-button";favoritePencilButton.innerHTML="\u270e";favoriteCoorButton=b.appendChild(document.createElement("div"));favoriteCoorButton.className="fav-button fav-coor-button";favoriteCoorButton.innerHTML=
"0,0"};Paint.prototype.setMouseCoords=function(b,a){for(var c=!1,e=0;e<this.coordDiv.children.length;e++)if("number"==this.coordDiv.children[e].type){this.coordDiv.children[e].value=c?a.toFixed():b.toFixed();if(c)break;c=!0}};Paint.prototype.newCanvasOnTop=function(b){b=this.createCanvas(b||"foreign");this.lastCanvas.parentNode.insertBefore(b,this.lastCanvas.nextSibling);this.lastCanvas=b;this.canvasArray.push(b);b.leftTopX=this.public.leftTopX;b.leftTopY=this.public.leftTopY;this.resize();return b};
