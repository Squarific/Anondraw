...
Paint.prototype.createControlArray = function createControlArray () {
	return [{
		...
		name: "picker",
		type: "button",
		image: "images/icons/picker.png?v=1",
...
Paint.prototype.tools = {
	grab: function grab (paint, event) {
		...
		paint.local.goto(paint.local.leftTopX + (relativeMotionX / paint.local.zoom), paint.local.leftTopY + (relativeMotionY / paint.local.zoom));
		paint.public.goto(paint.public.leftTopX + (relativeMotionX / paint.public.zoom), paint.public.leftTopY + (relativeMotionY / paint.public.zoom));

		for (var k = 0; k < paint.canvasArray.length; k++) {
