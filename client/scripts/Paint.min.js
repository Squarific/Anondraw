...
Paint.prototype.addCoordDom = function addCoordDom (container) {
	...
	var favoritesContainer = favoritesWindow.appendChild(document.createElement("div"));
	...
	favoritePlusButton = favoriteContainer.appendChild(document.createElement("div"));
	favoritePlusButton.className = "fav-button fav-plus-button";
	favoritePlusButton.innerHTML = "+";
	
	favoritePencilButton = favoriteContainer.appendChild(document.createElement("div"));
	favoritePencilButton.className = "fav-button fav-pencil-button";
	favoritePencilButton.innerHTML = "✎";
	
	favoriteCoorButton = favoriteContainer.appendChild(document.createElement("div"));
