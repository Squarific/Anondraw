...
EventDispatcher.prototype.apply(GradientCreator.prototype);function TiledCanvas (canvas, settings) {
    this.canvas = canvas;
...
Paint.prototype.addCoordDom = function addCoordDom (container) {
	...
	var buffer = this.coordDiv.appendChild(document.createElement("span"));
	buffer.innerHTML = '&nbsp;';
	//Favorites button 
	var favoritesButton = this.coordDiv.appendChild(document.createElement("div"));
    ...
    {
				drawTogether.updateFavoriteDom();
        $(".favorites-window").show();
    }
	}.bind(this));
	
	var favoritesWindow = this.coordDiv.appendChild(document.createElement("div"));
...
Paint.prototype.insertOneFavorite = function insertOneFavorite(x, y, name, owner) {
	...
	favoriteMinusButton.addEventListener("click", function (e) {
		...
		drawTogether.removeFavorite(x, y, name, greatgrandfather);
		console.log("delete", greatgrandfather.dataset.x, greatgrandfather.dataset.y, greatgrandfather.dataset.name);
	}.bind(this));
	...
	favoritePlusButton.addEventListener("click", function (e) {
		...
		var centerX = this.paint.public.leftTopX + screenSize[0] / 2;
		var centerY = this.paint.public.leftTopY + screenSize[1] / 2;                  
		console.log(centerX, centerY);
		//drawTogether.setCoordFavorite(40,500,0,0,'center');
	}.bind(drawTogether));
	...
	favoriteRenameInput.addEventListener("input", function (e) {
		if(drawTogether._favoriteRenameDelayTimeout !== undefined)
			clearTimeout(drawTogether._favoriteRenameDelayTimeout);
		drawTogether._favoriteRenameDelayTimeout = setTimeout(function () {
			var newName = this.srcElement.value;
			var greatgrandfather = this.srcElement.parentElement.parentElement.parentElement;
			var x = greatgrandfather.dataset.x;
			var y = greatgrandfather.dataset.y;
...
Paint.prototype.updateFavoriteDom = function updateFavoriteDom(favorites) {
	...
	addNewFavoriteElementButton.addEventListener("click", function (e) {
		drawTogether.createFavorite(0, 0, "");
	}.bind(this));
