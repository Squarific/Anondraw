...
PlayerDatabase.prototype.deleteClickableArea = function deleteClickableArea (room, areaId, callback) {
	this.database.query("DELETE FROM clickableareas WHERE room = ? AND id = ?", [room, areaId], function (err, rows) {
		if (err) {
