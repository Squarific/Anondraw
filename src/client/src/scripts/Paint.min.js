...
Paint.prototype.generateGrid = function generateGrid (leftTop, squares, sqwidth, sqheight) {
	this.addUserPath();
	for (var k = 0; k < squares; k++) {
		var localLeftTop = [leftTop[0] + squares * sqwidth, leftTop[1]]; 
		this.addPathPoint(localLeftTop);
		this.addPathPoint([localLeftTop[0] + sqwidth, localLeftTop[1]]);
		this.addPathPoint([localLeftTop[0] + sqwidth, localLeftTop[1] + sqheight]);
		this.addPathPoint([localLeftTop[0]          , localLeftTop[1] + sqheight]);
		this.addPathPoint(localLeftTop);
	}
};
