...
TiledCanvas.prototype.reinitializeImageSmoothing = function reinitializeImageSmoothing () {
	var pixelateCanvas = this.settings.blurOnZoom || this.zoom >= this.settings.zoomLevelToPixelate;
	this.ctx.mozImageSmoothingEnabled = pixelateCanvas;
	this.ctx.webkitImageSmoothingEnabled = pixelateCanvas;
	this.ctx.msImageSmoothingEnabled = pixelateCanvas;
	this.ctx.imageSmoothingEnabled = pixelateCanvas;
};
