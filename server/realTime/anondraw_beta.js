...
var register = new Register("beta.anondraw.com", require("./join_code_password.js"), io, port, server);
...
var players = new Players("beta.anondraw.com");
// var players = new Players("localhost");

var Background = require("./scripts/Background.js");
var background = new Background("beta.anondraw.com", undefined, require("./draw_password.js"));
